...
binaries = [".pipx/venvs/mkdocs-publisher/bin/mkdocs"]
// # test = "relocate.sh"
// # source = "https://github.com/pypa/pipx/releases/download/${version}/pipx.pyz"
// # source  "https://github.com/pypa/pipx/releases/download/${version}/pipx.pyz"
source = "https://files.pythonhosted.org/packages/c8/48/6334c850f7e4953a2dc330904a136b91e53b5c053dda094df5779dfe4da5/mkdocs_publisher-${version}-py3-none-any.whl"
requires = ["pipx"]
dont-extract = true
