...

{
  ...
  # This triggers a bunch of compiling when the output is docker!
  # Adding `--system x86_64-linux` fails with error
  # a 'x86_64-linux' with features {} is required to build '/nix/store/fxyx48bi3il89bk7cmg39xn9m5kwh3zp-audit-disable.drv', but I am a 'aarch64-linux' with features {benchmark, big-parallel, nixos-test, uid-range}
