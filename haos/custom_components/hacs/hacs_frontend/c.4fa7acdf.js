...
import { c as y } from "./c.4a97632a.js";
import "./c.f1291e50.js";
import "./c.d262aab0.js";
import { s as v } from "./c.4266acdb.js";
import { f as g, r as u, a as f } from "./c.fe747ba2.js";
import { u as w } from "./c.25ed1ae4.js";
...
let b = o(
  ...
  function (o, t) {
    return {
      ...
      d: [
        { kind: "field", decorators: [s()], key: "repository", value: void 0 },
        { kind: "field", decorators: [e()], key: "_toggle", value: () => !0 },
        {
          kind: "field",
          decorators: [e()],
          key: "_installing",
        ...
        { kind: "field", decorators: [e()], key: "_error", value: void 0 },
        { kind: "field", decorators: [e()], key: "_repository", value: void 0 },
        {
          kind: "field",
          decorators: [e()],
            ...
            return (
              o.forEach((o, t) => {
                "hass" === t &&
                  ...
                  "repositories" === t && this._fetchRepository();
              }),
              o.has("sidebarDocked") ||
                o.has("narrow") ||
                o.has("active") ||
        ...
        },
        {
          ...
          value: () =>
            i((o) => {
              let t = o.local_path;
              return "theme" === o.category && (t = `${t}/${o.file_name}`), t;
            }),
        },
        {
          kind: "method",
          ...
          value: async function () {
            ...
            await this._fetchRepository(),
              (this._toggle = !1),
              a(this.hass, (o) => (this._error = o), r.ERROR),
        ...
        },
        {
          ...
          value: async function () {
            this._repository = await g(this.hass, this.repository);
          },
        },
        {
          kind: "method",
          ...
          value: function () {
            var o;
            if (!this.active || !this._repository) return l``;
            const t = this._getInstallPath(this._repository),
              s = [
      ...
      >
        <div class="content">
          ...
          ${
            this._repository.can_download
              ? ""
              : l`<ha-alert alert-type="error" .rtl=${y(this.hass)}>
                ${this.hacs.localize(
          ...
          <div class="note">
            ...
            ${
              "integration" === this._repository.category
                ? l`<p>${this.hacs.localize("dialog_download.restart")}</p>`
                : ""
            }
          </div>
          ${
        ...
        >
          ${
            this._installing
              ? l`<ha-circular-progress active size="small"></ha-circular-progress>`
          ...
          value: async function (o) {
            ...
            if (
              (this._downloadRepositoryData.beta !== o.detail.value.beta &&
                ((t = !0),
                (this._toggle = !0),
                await h(this.hass, this.repository, o.detail.value.beta)),
              o.detail.value.version &&
                ((t = !0),
                (this._toggle = !0),
                await u(this.hass, this.repository, o.detail.value.version)),
              t)
            ) {
              const o = await c(this.hass);
              await this._fetchRepository(),
                this.dispatchEvent(
        ...
        },
        {
          ...
          value: async function () {
            ...
            (null === (o = this._repository) || void 0 === o
              ? void 0
              : o.version_or_commit)
              ? await f(this.hass, String(this._repository.id), t)
              : await f(this.hass, String(this._repository.id)),
              this.hacs.log.debug(
              ...
              "plugin" === this._repository.category &&
                "storage" === this.hacs.info.lovelace_mode &&
                (await w(this.hass, this._repository, t)),
              (this._installing = !1),
              this.dispatchEvent(
...
export { b as HacsDonwloadDialog };
