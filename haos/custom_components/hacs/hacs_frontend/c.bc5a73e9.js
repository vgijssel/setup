  ...
  _updateScrollState: function (t, e) {
    if (0 !== this._height) {
      var i = 0,
        ...
        n = this._top;
      this._lastScrollTop;
      var o = this._maxHeaderTop,
        r = t - this._lastScrollTop,
        a = Math.abs(r),
        l = t > this._lastScrollTop,
        h = performance.now();
      if (
        (this._mayMove() && (s = this._clamp(this.reveals ? n + r : t, 0, o)),
        t >= this._dHeight &&
        ...
        this.reveals &&
          !this.disabled &&
          a < 100 &&
          ((h - this._initTimestamp > 300 || this._wasScrollingDown !== l) &&
