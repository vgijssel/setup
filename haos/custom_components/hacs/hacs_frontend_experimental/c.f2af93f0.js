import { c as e, a as n, g as t } from "./c.743a15a1.js";
import { y as r } from "./main-85e087f9.js";
import "./c.5ebe89cb.js";
var o = e(function (e, n) {
    e.exports = (function () {
      ...
      var y = T(Array.prototype.forEach),
        D = T(Array.prototype.pop),
        A = T(Array.prototype.push),
        x = T(String.prototype.toLowerCase),
        v = T(String.prototype.toString),
        E = T(String.prototype.match),
        C = T(String.prototype.replace),
        F = T(String.prototype.indexOf),
        B = T(String.prototype.trim),
        z = T(RegExp.prototype.test),
        S = N(TypeError);
      function T(e) {
        return function (n) {
          for (
      ...
      function R(e, n) {
        for (; null !== e; ) {
          var t = m(e, n);
          if (t) {
            if (t.get) return T(t.get);
            if ("function" == typeof t.value) return T(t.value);
          }
          e = p(e);
        }
        function r(e) {
      ...
      function ae() {
        ...
        var ie = oe(_, r),
          ...
          he = le.getElementsByTagName,
          pe = r.importNode,
          me = {};
        try {
          me = j(a).documentMode ? a.documentMode : {};
        } catch (e) {}
        var ge = {};
        t.isSupported =
          "function" == typeof T &&
        ...
        var _e,
          ...
          ve = V,
          Ee = null,
          Ce = O({}, [].concat(o(M), o(I), o(L), o(U), o(q))),
          Fe = null,
          Be = O({}, [].concat(o(H), o(G), o(Z), o(W))),
          ze = Object.seal(
            Object.create(null, {
              tagNameCheck: {
                writable: !0,
          ...
          sn = null,
          ln = O({}, [nn, tn, rn], v),
          un = ["application/xhtml+xml", "text/html"],
          cn = "text/html",
          dn = null,
          hn = a.createElement("form"),
          pn = function (e) {
          ...
          mn = function (n) {
            (dn && dn === n) ||
              ...
              (n = j(n)),
              (_e = _e =
                -1 === un.indexOf(n.PARSER_MEDIA_TYPE)
                  ? cn
                  : n.PARSER_MEDIA_TYPE),
              (fe = "application/xhtml+xml" === _e ? v : x),
              (Ee = "ALLOWED_TAGS" in n ? O({}, n.ALLOWED_TAGS, fe) : Ce),
              (Fe = "ALLOWED_ATTR" in n ? O({}, n.ALLOWED_ATTR, fe) : Be),
              (sn =
                "ALLOWED_NAMESPACES" in n
                  ? O({}, n.ALLOWED_NAMESPACES, v)
                  : ln),
              (Ve =
                "ADD_URI_SAFE_ATTR" in n
                  ? O(j(en), n.ADD_URI_SAFE_ATTR, fe)
                  : en),
              (Xe =
                "ADD_DATA_URI_TAGS" in n
                  ? O(j(Je), n.ADD_DATA_URI_TAGS, fe)
                  : Je),
              (Ye = "FORBID_CONTENTS" in n ? O({}, n.FORBID_CONTENTS, fe) : Ke),
              (Se = "FORBID_TAGS" in n ? O({}, n.FORBID_TAGS, fe) : {}),
              (Te = "FORBID_ATTR" in n ? O({}, n.FORBID_ATTR, fe) : {}),
              (Qe = "USE_PROFILES" in n && n.USE_PROFILES),
              (Ne = !1 !== n.ALLOW_ARIA_ATTR),
              (Oe = !1 !== n.ALLOW_DATA_ATTR),
              (je = n.ALLOW_UNKNOWN_PROTOCOLS || !1),
              (Re = n.SAFE_FOR_TEMPLATES || !1),
              (Me = n.WHOLE_DOCUMENT || !1),
              ($e = n.RETURN_DOM || !1),
              (Ue = n.RETURN_DOM_FRAGMENT || !1),
              (Pe = n.RETURN_TRUSTED_TYPE || !1),
              (Le = n.FORCE_BODY || !1),
              (qe = !1 !== n.SANITIZE_DOM),
              (He = n.SANITIZE_NAMED_PROPS || !1),
              (Ze = !1 !== n.KEEP_CONTENT),
              (We = n.IN_PLACE || !1),
              (ve = n.ALLOWED_URI_REGEXP || ve),
              (on = n.NAMESPACE || rn),
              n.CUSTOM_ELEMENT_HANDLING &&
                pn(n.CUSTOM_ELEMENT_HANDLING.tagNameCheck) &&
                (ze.tagNameCheck = n.CUSTOM_ELEMENT_HANDLING.tagNameCheck),
              n.CUSTOM_ELEMENT_HANDLING &&
                pn(n.CUSTOM_ELEMENT_HANDLING.attributeNameCheck) &&
                (ze.attributeNameCheck =
              ...
              Qe &&
                ((Ee = O({}, o(q))),
                (Fe = []),
                !0 === Qe.html && (O(Ee, M), O(Fe, H)),
                !0 === Qe.svg && (O(Ee, I), O(Fe, G), O(Fe, W)),
                !0 === Qe.svgFilters && (O(Ee, L), O(Fe, G), O(Fe, W)),
                !0 === Qe.mathMl && (O(Ee, U), O(Fe, Z), O(Fe, W))),
              n.ADD_TAGS && (Ee === Ce && (Ee = j(Ee)), O(Ee, n.ADD_TAGS, fe)),
              n.ADD_ATTR && (Fe === Be && (Fe = j(Fe)), O(Fe, n.ADD_ATTR, fe)),
              n.ADD_URI_SAFE_ATTR && O(Ve, n.ADD_URI_SAFE_ATTR, fe),
              n.FORBID_CONTENTS &&
                (Ye === Ke && (Ye = j(Ye)), O(Ye, n.FORBID_CONTENTS, fe)),
              Ze && (Ee["#text"] = !0),
              Me && O(Ee, ["html", "head", "body"]),
              Ee.table && (O(Ee, ["tbody"]), delete Se.tbody),
              g && g(n),
              (dn = n));
          },
          gn = O({}, ["mi", "mo", "mn", "ms", "mtext"]),
          _n = O({}, ["foreignobject", "desc", "title", "annotation-xml"]),
          fn = O({}, ["title", "style", "font", "a", "script"]),
          bn = O({}, I);
        O(bn, L), O(bn, $);
        var wn = O({}, U);
        O(wn, P);
        var kn = function (e) {
            var n = T(e);
            (n && n.tagName) || (n = { namespaceURI: on, tagName: "template" });
            var t = x(e.tagName),
              r = x(n.tagName);
            return (
              !!sn[e.namespaceURI] &&
              (e.namespaceURI === tn
                ...
                ? n.namespaceURI === rn
                  ...
                  : Boolean(wn[t])
                : e.namespaceURI === rn
                ? !(n.namespaceURI === tn && !_n[r]) &&
                  !(n.namespaceURI === nn && !gn[r]) &&
                  !wn[t] &&
                  (fn[t] || !bn[t])
                : !("application/xhtml+xml" !== _e || !sn[e.namespaceURI]))
            );
          },
          yn = function (e) {
          ...
          Dn = function (e, n) {
            ...
            if ((n.removeAttribute(e), "is" === e && !Fe[e]))
              if ($e || Ue)
                try {
                  yn(n);
                } catch (e) {}
          ...
          An = function (e) {
            ...
            if (on === rn)
              try {
                n = new m().parseFromString(o, _e);
              } catch (e) {}
            if (!n || !n.documentElement) {
              n = ue.createDocument(on, "template", null);
              try {
                n.documentElement.innerHTML = an ? "" : o;
              } catch (e) {}
            }
          ...
          Fn = function (e) {
            var n;
            if ((Cn("beforeSanitizeElements", e, null), vn(e)))
              return yn(e), !0;
            if (z(/[\u0080-\uFFFF]/, e.nodeName)) return yn(e), !0;
            var r = fe(e.nodeName);
            if (
              (Cn("uponSanitizeElement", e, { tagName: r, allowedTags: Ee }),
              e.hasChildNodes() &&
                !En(e.firstElementChild) &&
                (!En(e.content) || !En(e.content.firstElementChild)) &&
                z(/<[/\w]/g, e.innerHTML) &&
                z(/<[/\w]/g, e.textContent))
            )
              return yn(e), !0;
            if ("select" === r && z(/<template/i, e.innerHTML))
              return yn(e), !0;
            if (!Ee[r] || Se[r]) {
              if (!Se[r] && zn(r)) {
                if (ze.tagNameCheck instanceof RegExp && z(ze.tagNameCheck, r))
                  return !1;
            ...
            return e instanceof u && !kn(e)
              ? (yn(e), !0)
              : ("noscript" !== r && "noembed" !== r) ||
                !z(/<\/no(script|embed)/i, e.innerHTML)
              ? (Re &&
                  3 === e.nodeType &&
                  ((n = e.textContent),
                  (n = C(n, be, " ")),
                  ...
                  e.textContent !== n &&
                    ...
                    (e.textContent = n))),
                Cn("afterSanitizeElements", e, null),
                !1)
              : (yn(e), !0);
          },
          Bn = function (e, n, t) {
            if (qe && ("id" === n || "name" === n) && (t in a || t in hn))
              return !1;
            if (Oe && !Te[n] && z(ye, n));
            else if (Ne && z(De, n));
            else if (!Fe[n] || Te[n]) {
                ...
                !(
                  (zn(e) &&
                    ...
                    ((ze.attributeNameCheck instanceof RegExp &&
                      z(ze.attributeNameCheck, n)) ||
                      (ze.attributeNameCheck instanceof Function &&
                        ze.attributeNameCheck(n)))) ||
                  ("is" === n &&
                    ze.allowCustomizedBuiltInElements &&
                    ((ze.tagNameCheck instanceof RegExp &&
                      z(ze.tagNameCheck, t)) ||
          ...
          Sn = function (n) {
            var r, o, a, i;
            Cn("beforeSanitizeAttributes", n, null);
            var s = n.attributes;
            if (s) {
              var l = {
                attrName: "",
              ...
              for (i = s.length; i--; ) {
                var u = (r = s[i]),
                  ...
                  d = u.namespaceURI;
                if (
                  ((o = "value" === c ? r.value : B(r.value)),
                  (a = fe(c)),
                  (l.attrName = a),
                  (l.attrValue = o),
                  (l.keepAttr = !0),
                  (l.forceKeepAttr = void 0),
                  Cn("uponSanitizeAttribute", n, l),
                  (o = l.attrValue),
                  !l.forceKeepAttr && (Dn(c, n), l.keepAttr))
                )
                  if (z(/\/>/i, o)) Dn(c, n);
                  else {
                    Re &&
              ...
              Cn("afterSanitizeAttributes", n, null);
            }
          },
          Tn = function e(n) {
            var t,
              r = xn(n);
            for (Cn("beforeSanitizeShadowDOM", n, null); (t = r.nextNode()); )
              Cn("uponSanitizeShadowNode", t, null),
                Fn(t) || (t.content instanceof i && e(t.content), Sn(t));
            Cn("afterSanitizeShadowDOM", n, null);
          };
        return (
          (t.sanitize = function (o) {
            var a,
              ...
              h =
                arguments.length > 1 && void 0 !== arguments[1]
                  ...
                  : {};
            if (
              ((an = !o) && (o = "\x3c!--\x3e"), "string" != typeof o && !En(o))
            ) {
            ...
            if (!t.isSupported) {
              if (
                ...
                if (En(o)) return n.toStaticHTML(o.outerHTML);
              }
              return o;
            }
            if (
              ...
              (1 ===
                (s = (a = An("\x3c!----\x3e")).ownerDocument.importNode(o, !0))
                  .nodeType &&
                "BODY" === s.nodeName) ||
              "HTML" === s.nodeName
                ? (a = s)
              ...
              if (!$e && !Re && !Me && -1 === o.indexOf("<"))
                return ie && Pe ? ie.createHTML(o) : o;
              if (!(a = An(o))) return $e ? null : Pe ? se : "";
            }
            a && Le && yn(a.firstChild);
            for (var m = xn(We ? o : a); (u = m.nextNode()); )
              (3 === u.nodeType && u === c) ||
                Fn(u) ||
                (u.content instanceof i && Tn(u.content), Sn(u), (c = u));
            if (((c = null), We)) return o;
            if ($e) {
              if (Ue)
                for (d = de.call(a.ownerDocument); a.firstChild; )
                  d.appendChild(a.firstChild);
              else d = a;
              return Fe.shadowroot && (d = pe.call(r, d, !0)), d;
            }
            var g = Me ? a.outerHTML : a.innerHTML;
            return (
              Me &&
                Ee["!doctype"] &&
                a.ownerDocument &&
                ...
                z(te, a.ownerDocument.doctype.name) &&
                (g = "<!DOCTYPE " + a.ownerDocument.doctype.name + ">\n" + g),
              Re &&
                ((g = C(g, be, " ")), (g = C(g, we, " ")), (g = C(g, ke, " "))),
              ie && Pe ? ie.createHTML(g) : g
            );
          }),
...
const x = "[a-zA-Z]\\w*",
  ...
  T = function (e, n, t = {}) {
    const r = u({ scope: "comment", begin: e, end: n, contains: [] }, t);
    r.contains.push({
      scope: "doctag",
  ...
  O = T("/\\*", "\\*/"),
  j = T("#", "$"),
  R = { scope: "number", begin: E, relevance: 0 },
  M = { scope: "number", begin: C, relevance: 0 },
  I = { scope: "number", begin: F, relevance: 0 },
  L = {
    begin: /(?=\/[^/\n]*\/)/,
    contains: [
      {
  ...
  $ = { scope: "title", begin: x, relevance: 0 },
  U = { scope: "title", begin: v, relevance: 0 },
  P = { begin: "\\.\\s*" + v, relevance: 0 };
var q = Object.freeze({
  __proto__: null,
  ...
  SHEBANG: (e = {}) => {
    const n = /^#![ ]*\//;
    return (
      e.binary && (e.begin = w(n, /.*\b/, e.binary, /\b.*/)),
      u(
        {
          scope: "meta",
          begin: n,
...
function W(e, n) {
  Array.isArray(e.illegal) && (e.illegal = k(...e.illegal));
}
function Q(e, n) {
  if (e.match) {
    if (e.begin || e.end)
...
const K = (e, n) => {
    ...
    Object.keys(e).forEach((n) => {
      ...
      (e.begin = w(t.beforeMatch, _(t.begin))),
      (e.starts = {
        relevance: 0,
...
const ee = {},
  ...
  re = (e, n) => {
    ee[`${e}/${n}`] ||
      (console.log(`Deprecated as of ${e}. ${n}`), (ee[`${e}/${n}`] = !0));
  },
  oe = new Error();
function ae(e, n, { key: t }) {
  let r = 0;
  const o = e[t],
    a = {},
    i = {};
  for (let e = 1; e <= n.length; e++)
    (i[e + r] = o[e]), (a[e + r] = !0), (r += y(n[e - 1]));
    ...
    (function (e) {
      if (Array.isArray(e.begin)) {
        ...
        if ("object" != typeof e.beginScope || null === e.beginScope)
          throw (ne("beginScope must be object"), oe);
        ae(e, e.begin, { key: "beginScope" }),
          (e.begin = A(e.begin, { joinWith: "" }));
      }
    })(e),
    (function (e) {
      if (Array.isArray(e.end)) {
        if (e.skip || e.excludeEnd || e.returnEnd)
          throw (
            (ne("skip, excludeEnd, returnEnd not compatible with endScope: {}"),
            oe)
          );
        if ("object" != typeof e.endScope || null === e.endScope)
          throw (ne("endScope must be object"), oe);
        ae(e, e.end, { key: "endScope" }), (e.end = A(e.end, { joinWith: "" }));
      }
    })(e);
}
function se(e) {
  ...
  class t {
    ...
    compile() {
      ...
      (this.matcherRe = n(A(e, { joinWith: "|" }), !0)), (this.lastIndex = 0);
    }
    exec(e) {
  ...
  return (
    (e.classNameAliases = u(e.classNameAliases || {})),
    (function t(o, a) {
      const i = o;
      if (o.isCompiled) return i;
      [G, Q, ie, K].forEach((e) => e(o, a)),
        e.compilerExtensions.forEach((e) => e(o, a)),
        (o.__beforeBegin = null),
        [Z, W, Y].forEach((e) => e(o, a)),
        (o.isCompiled = !0);
      let s = null;
      return (
        ...
        (s = s || /\w+/),
        o.keywords && (o.keywords = J(o.keywords, e.case_insensitive)),
        ...
        (o.contains = [].concat(
          ...o.contains.map(function (e) {
            return (function (e) {
              ...
              if (le(e)) return u(e, { starts: e.starts ? u(e.starts) : null });
              if (Object.isFrozen(e)) return u(e);
              return e;
            })("self" === e ? o : e);
          })
        )),
...
function le(e) {
  return !!e && (e.endsWithParent || le(e.starts));
}
...
var pe = (function (e) {
    ...
    function h(e, t, r, a) {
      ...
      if (!y)
        throw (
          (ne(i.replace("{}", e)), new Error('Unknown language: "' + e + '"'))
        );
      const D = se(y);
      let x = "",
        v = a || D;
    ...
    function g(e) {
      ...
      const r = (function (e) {
        ...
        if (t) {
          ...
          return (
            n ||
              (te(i.replace("{}", t[1])),
              te("Falling back to no-highlight mode for this block.", e)),
            n ? t[1] : "no-highlight"
          );
        }
      ...
      const o = n.textContent,
        a = r ? d(o, { language: r, ignoreIllegals: !0 }) : p(o);
      (e.innerHTML = a.value),
        (function (e, n, r) {
          const o = (n && t[n]) || r;
        ...
        E("after:highlightElement", { el: e, result: a, text: o });
    }
    let y = !1;
    function D() {
      if ("loading" === document.readyState) return void (y = !0);
      document.querySelectorAll(u.cssSelector).forEach(g);
    }
    function A(e) {
    ...
    for (const e in q) "object" == typeof q[e] && a.exports(q[e]);
    return Object.assign(e, q), e;
  })({}),
  me = pe;
(pe.HighlightJS = pe), (pe.default = pe);
var ge = me;
...
var xe = function (e) {
        ...
        isTrulyOpeningTag: (e, n) => {
          ...
          ">" === r &&
            (((e, { after: n }) => {
              ...
              n.ignoreMatch());
          const a = e.input.substring(t);
          ((o = a.match(/^\s*=/)) ||
            ((o = a.match(/^\s+extends\s+/)) && 0 === o.index)) &&
            n.ignoreMatch();
        },
      },
      i = {
    ...
    const f = [].concat(g, d.contains),
      b = f.concat([
        { begin: /\(/, end: /\)/, keywords: i, contains: ["self"].concat(f) },
      ]),
      w = {
        className: "params",
        begin: /\(/,
      ...
      A = {
        match: n.concat(
          /\b/,
          ((x = [...ye, "super", "import"]), n.concat("(?!", x.join("|"), ")")),
          t,
          n.lookahead(/\(/)
        ),
...
var Fe = function (e) {
  ...
  ze = e(function (e, n) {
    !(function (e) {
      ...
      function _(e, n) {
        if (n) {
          if (c.test(e)) return e.replace(d, g);
        } else if (h.test(e)) return e.replace(p, g);
        return e;
      }
      ...
      function A(e, n, t) {
        if (e) {
          var r;
          try {
            r = decodeURIComponent(b(t)).replace(y, "").toLowerCase();
          } catch (e) {
            return null;
          }
          if (
      ...
      function F(e, n) {
        x[" " + e] ||
          (v.test(e) ? (x[" " + e] = e + "/") : (x[" " + e] = T(e, "/", !0)));
        var t = -1 === (e = x[" " + e]).indexOf(":");
      ...
      function R(e, n, t, r) {
        ...
        return { type: "image", raw: t, href: o, title: a, text: _(i) };
      }
      function M(e, n) {
        var t = e.match(/^(\s+)(?:```)/);
        if (null === t) return n;
          ...
          return (
            ...
            (t.blockquote = function (e) {
              ...
              if (n) {
                ...
                var o = this.lexer.blockTokens(t);
                return (
                  (this.lexer.state.top = r),
                  { type: "blockquote", raw: n[0], tokens: o, text: t }
                );
              }
            }),
            (t.list = function (e) {
              ...
              if (n) {
                ...
                (_.items[_.items.length - 1].raw = t.trimRight()),
                  (_.items[_.items.length - 1].text = h.trimRight()),
                  (_.raw = _.raw.trimRight());
                var D = _.items.length;
                for (i = 0; i < D; i++)
                  if (
                    ((this.lexer.state.top = !1),
                    (_.items[i].tokens = this.lexer.blockTokens(
                      _.items[i].text,
                      []
                    )),
                    !_.loose)
                  ) {
                    var A = _.items[i].tokens.filter(function (e) {
                        return "space" === e.type;
                      }),
                      x =
                        A.length > 0 &&
                ...
                if (_.loose) for (i = 0; i < D; i++) _.items[i].loose = !0;
                return _;
              }
            }),
            (t.html = function (e) {
                ...
                var t = n[1].toLowerCase().replace(/\s+/g, " "),
                  ...
                  o = n[3]
                    ? n[3]
                        ...
                        .replace(this.rules.inline._escapes, "$1")
                    : n[3];
                return { type: "def", tag: t, raw: n[0], href: r, title: o };
              }
            }),
            (t.table = function (e) {
              ...
              if (n) {
                ...
                if (t.header.length === t.align.length) {
                  ...
                  for (s = t.rows.length, r = 0; r < s; r++)
                    t.rows[r] = S(t.rows[r], t.header.length).map(function (e) {
                      return { text: e };
                    });
                  ...
                  for (s = t.rows.length, o = 0; o < s; o++)
                    for (i = t.rows[o], a = 0; a < i.length; a++)
                      i[a].tokens = this.lexer.inline(i[a].text);
                  return t;
                }
              }
            }),
            ...
            (t.escape = function (e) {
              ...
              if (n) return { type: "escape", raw: n[0], text: _(n[1]) };
            }),
            (t.tag = function (e) {
                    ...
                    if ((a = r[1] || r[2] || r[3] || r[4] || r[5] || r[6]))
                      if (((i = a.length), r[3] || r[4])) l += i;
                        ...
                        if (!((l -= i) > 0)) {
                          ...
                          var d = e.slice(
                            0,
                            s + r.index + (r[0].length - a.length) + i
                          );
                          if (Math.min(s, i) % 2) {
                            var h = d.slice(1, -1);
                            return {
              ...
              if (o)
                return (
                  (r =
                    "@" === o[2]
                      ? "mailto:" +
                        (t = _(this.options.mangle ? n(o[1]) : o[1]))
                      : (t = _(o[1]))),
                  {
                    type: "link",
                    raw: o[0],
            ...
            (t.url = function (e, n) {
              ...
              if ((t = this.rules.inline.url.exec(e))) {
                var r, o;
                if ("@" === t[2])
                  o = "mailto:" + (r = _(this.options.mangle ? n(t[0]) : t[0]));
                else {
                  var a;
                  do {
                    (a = t[0]),
                  ...
                  (t = this.lexer.state.inRawBlock
                    ? this.options.sanitize
                      ? this.options.sanitizer
                        ...
                        : _(r[0])
                      : r[0]
                    : _(this.options.smartypants ? n(r[0]) : r[0])),
      ...
      (L.def = k(L.def)
        ...
        (L.gfm.table = k(L.gfm.table)
          ...
          .replace("tag", L._tag)
          .getRegex()),
        (L.gfm.paragraph = k(L._paragraph)
          .replace("hr", L.hr)
          .replace("heading", " {0,3}#{1,6} ")
          .replace("|lheading", "")
        ...
        (L.pedantic = z({}, L.normal, {
          ...
          fences: B,
          lheading: /^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,
          paragraph: k(L.normal._paragraph)
            .replace("hr", L.hr)
            .replace("heading", " *#{1,6} *[^\n]")
      ...
      ($._punctuation = "!\"#$%&'()+\\-.,/:;<=>?@\\[\\]`^{|}~"),
        ...
        ($.blockSkip = /\[[^\]]*?\]\([^\)]*?\)|`[^`]*?`|<[^>]*?>/g),
        ($.escapedEmSt = /(?:^|[^\\])(?:\\\\)*\\[*_]/g),
        ($._comment = k(L._comment)
          .replace("(?:--\x3e|$)", "--\x3e")
          .getRegex()),
        ($.emStrong.lDelim = k($.emStrong.lDelim)
          .replace(/punct/g, $._punctuation)
          .getRegex()),
        ($.emStrong.rDelimAst = k($.emStrong.rDelimAst, "g")
          .replace(/punct/g, $._punctuation)
          .getRegex()),
        ($.emStrong.rDelimUnd = k($.emStrong.rDelimUnd, "g")
          .replace(/punct/g, $._punctuation)
          .getRegex()),
        ($._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g),
        ...
        ($.reflink = k($.reflink)
          ...
          .getRegex()),
        ($.nolink = k($.nolink).replace("ref", L._label).getRegex()),
        ($.reflinkSearch = k($.reflinkSearch, "g")
        ...
        ($.gfm = z({}, $.normal, {
          escape: k($.escape).replace("])", "~|])").getRegex(),
          _extended_email:
      ...
      var q = (function () {
          function n(n) {
            ...
            var t = { block: L.normal, inline: $.normal };
            this.options.pedantic
              ? ((t.block = L.pedantic), (t.inline = $.pedantic))
              : this.options.gfm &&
                ((t.block = L.gfm),
                this.options.breaks
                  ? (t.inline = $.breaks)
          ...
          return (
            ...
            (r.inlineTokens = function (e, n) {
              ...
              for (
                ...
                (u =
                  u.slice(0, i.index + i[0].length - 2) +
                  "++" +
              ...
              for (; e; )
                if (
                  ...
                  if ((t = this.tokenizer.escape(e)))
                    ...
                    (e = e.substring(t.raw.length)), n.push(t);
                  else if ((t = this.tokenizer.autolink(e, P)))
                    (e = e.substring(t.raw.length)), n.push(t);
                  else if (
                    this.state.inLink ||
                    !(t = this.tokenizer.url(e, P))
                  ) {
                    if (
                      ((o = e),
                      this.options.extensions &&
                      ...
                      (t = this.tokenizer.inlineText(o, U)))
                    )
                      (e = e.substring(t.raw.length)),
                  ...
                  switch (d.type) {
                    ...
                    case "heading":
                      D += this.renderer.heading(
                        ...
                        d.depth,
                        b(this.parseInline(d.tokens, this.textRenderer)),
                        this.slugger
                      );
                      continue;
                    case "code":
                                ...
                                ? ((_.tokens[0].text =
                                  ...
                                  _.tokens[0].tokens &&
                                    ...
                                    (_.tokens[0].tokens[0].text =
                                      k + " " + _.tokens[0].tokens[0].text))
                                : _.tokens.unshift({ type: "text", text: k })
                              : (g += k)),
                          (g += this.parse(_.tokens, m)),
                          (c += this.renderer.listitem(g, w, f));
      ...
      function Q(e, n, t) {
        ...
        if (
          ...
          var a = function (e) {
            ...
            if (!e)
              try {
                n.walkTokens && Q.walkTokens(r, n.walkTokens),
                  (a = W.parse(r, n));
              } catch (n) {
                e = n;
              }
        ...
        try {
          ...
          if (n.walkTokens) {
            if (n.async)
              return Promise.all(Q.walkTokens(l, n.walkTokens))
                .then(function () {
                  return W.parse(l, n);
                })
                .catch(s);
            Q.walkTokens(l, n.walkTokens);
          }
          return W.parse(l, n);
        } catch (e) {
          s(e);
      ...
      (Q.options = Q.setOptions =
        function (e) {
          return z(Q.defaults, e), u(Q.defaults), Q;
        }),
        (Q.getDefaults = l),
        (Q.defaults = e.defaults),
        (Q.use = function () {
          for (
            var e = Q.defaults.extensions || { renderers: {}, childTokens: {} },
              n = arguments.length,
              t = new Array(n),
              r = 0;
            r < n;
          ...
          t.forEach(function (n) {
            ...
            if (
              ...
              n.renderer &&
                (function () {
                  var e = Q.defaults.renderer || new H(),
                    r = function (t) {
                      var r = e[t];
                      e[t] = function () {
                        for (
                          ...
                          a[i] = arguments[i];
                        var s = n.renderer[t].apply(e, a);
                        return !1 === s && (s = r.apply(e, a)), s;
                      };
                    };
                  for (var o in n.renderer) r(o);
                  t.renderer = e;
                })(),
              n.tokenizer &&
                (function () {
                  var e = Q.defaults.tokenizer || new I(),
                    r = function (t) {
                      var r = e[t];
                      e[t] = function () {
                        for (
                          ...
                          a[i] = arguments[i];
                        var s = n.tokenizer[t].apply(e, a);
                        return !1 === s && (s = r.apply(e, a)), s;
                      };
                    };
                  for (var o in n.tokenizer) r(o);
                  t.tokenizer = e;
                })(),
              n.walkTokens)
            ) {
              var r = Q.defaults.walkTokens;
              t.walkTokens = function (e) {
                var t = [];
                return (
                  t.push(n.walkTokens.call(this, e)),
                  r && (t = t.concat(r.call(this, e))),
                  t
                );
              };
            }
        ...
        (Q.walkTokens = function (e, n) {
          for (
            var t,
              r = [],
              o = function () {
                var e = t.value;
                switch (((r = r.concat(n.call(Q, e))), e.type)) {
                  case "table":
                    for (var o, i = a(e.header); !(o = i()).done; ) {
                      var s = o.value;
                      r = r.concat(Q.walkTokens(s.tokens, n));
                    }
                    for (var l, u = a(e.rows); !(l = u()).done; )
                      for (var c, d = a(l.value); !(c = d()).done; ) {
                        var h = c.value;
                        r = r.concat(Q.walkTokens(h.tokens, n));
                      }
                    break;
                  case "list":
                    r = r.concat(Q.walkTokens(e.items, n));
                    break;
                  default:
                    ...
                    Q.defaults.extensions.childTokens[e.type]
                      ? Q.defaults.extensions.childTokens[e.type].forEach(
                          function (t) {
                            r = r.concat(Q.walkTokens(e[t], n));
                          }
                        )
                      : e.tokens && (r = r.concat(Q.walkTokens(e.tokens, n)));
                }
              },
              i = a(e);
            !(t = i()).done;
        ...
        (Q.parseInline = function (e, n) {
          ...
          O((n = z({}, Q.defaults, n || {})));
          try {
            var t = q.lexInline(e, n);
            return (
              n.walkTokens && Q.walkTokens(t, n.walkTokens), W.parseInline(t, n)
            );
          } catch (e) {
            if (
              ((e.message +=
  ...
  Ve =
    Je +
    Xe +
    ("(?:" + Ke + "(?:" + [We, Qe, Ye].join("|") + ")" + Je + Xe + ")*"),
  en = "(?:" + [We + Ge + "?", Ge, Qe, Ye, He].join("|") + ")",
  nn = RegExp(Ze + "(?=" + Ze + ")|" + en + Ve, "g"),
  tn = RegExp("[" + Ke + $e + Ue + Pe + qe + "]"),
  rn = "object" == typeof n && n && n.Object === Object && n,
...
var dn,
  ...
  gn = Object.prototype,
  _n = an["__core-js_shared__"],
  fn = (dn = /[^.]+$/.exec((_n && _n.keys && _n.keys.IE_PROTO) || ""))
    ? "Symbol(src)_1." + dn
    : "",
  bn = mn.toString,
  ...
  Dn = an.Symbol,
  An = Dn ? Dn.iterator : void 0,
  xn = gn.propertyIsEnumerable,
  vn =
    ((hn = Object.keys),
    (pn = Object),
    function (e) {
...
function Rn(e, n) {
  var t =
    ...
    o = !!r;
  for (var a in e)
    (!n && !wn.call(e, a)) || (o && ("length" == a || Un(a, r))) || t.push(a);
  return t;
}
function Mn(e) {
  if (
...
function In(e) {
  if (
    ((t = (n = e) && n.constructor),
    (r = ("function" == typeof t && t.prototype) || gn),
    n !== r)
  )
    return vn(e);
  var n,
    ...
    r,
    o = [];
  for (var a in Object(e)) wn.call(e, a) && "constructor" != a && o.push(a);
  return o;
}
function Ln(e, n) {
  var t = (function (e, n) {
...
((En && $n(new En(new ArrayBuffer(1))) != Me) ||
  (Cn && $n(new Cn()) != Ne) ||
  (Fn && $n(Fn.resolve()) != Oe) ||
  (Bn && $n(new Bn()) != je) ||
  (zn && $n(new zn()) != Re)) &&
...
var Yn = function (e) {
  ...
  if (Hn(e))
    return (function (e) {
      return (
        "string" == typeof e ||
        (!qn(e) && Wn(e) && "[object String]" == kn.call(e))
      );
    })(e)
      ? cn(e)
      : (function (e, n) {
...
var tr = {
    ...
    woman_in_steamy_room: vt,
    man_in_steamy_room: Et,
    person_in_steamy_room: Ct,
    woman_climbing: Ft,
    person_climbing: Bt,
    man_climbing: zt,
    woman_in_lotus_position: St,
    person_in_lotus_position: Tt,
    man_in_lotus_position: Nt,
    female_mage: Ot,
    mage: jt,
    male_mage: Rt,
    female_fairy: Mt,
...
var lr = Object.keys(rr).reduce(function (e, n) {
    return (e[rr[n]] = n), e;
  }, {}),
  ur = { emoji: rr };
(ur._get = function (e) {
  return rr.hasOwnProperty(e)
    ? rr[e]
  ...
  (ur.get = function (e) {
    return (e = ir(e)), ur._get(e);
  }),
  (ur.find = function (e) {
    return ur.findByName(e) || ur.findByCode(e);
  }),
  (ur.findByName = function (e) {
    var n = ir(e),
      t = rr[n];
    return t ? { emoji: t, key: n } : void 0;
  }),
  (ur.findByCode = function (e) {
    var n = lr[e];
    return n ? { emoji: rr[n], key: n } : void 0;
  }),
  (ur.hasEmoji = function (e) {
    return ur.hasEmojiByName(e) || ur.hasEmojiByCode(e);
  }),
  (ur.hasEmojiByName = function (e) {
    var n = ur.findByName(e);
    return !!n && n.key === ir(e);
  }),
  (ur.hasEmojiByCode = function (e) {
    var n = ur.findByCode(e);
    return !!n && n.emoji === e;
  }),
  (ur.which = function (e, n) {
    var t = lr[e];
    return n ? sr(t) : t;
  }),
  (ur.emojify = function (e, n, t) {
    return e
      ? e
          .split(or)
          .map(function (e, r) {
  ...
  (ur.random = function () {
    var e = Object.keys(rr),
      n = e[Math.floor(Math.random() * e.length)];
    return { key: n, emoji: ur._get(n) };
  }),
  (ur.search = function (e) {
    var n = Object.keys(rr),
      t = ir(e),
      r = n.filter(function (e) {
        return 0 === e.toString().indexOf(t);
      });
    return r.map(function (e) {
      return { key: e, emoji: ur._get(e) };
    });
  }),
  (ur.unemojify = function (e) {
    return e
      ? Yn(e)
          .map(function (e) {
            return ur.which(e, !0) || e;
          })
          .join("")
      : "";
  }),
  (ur.replace = function (e, n, t) {
    if (!e) return "";
    var r =
        "function" == typeof n
          ? n
      ...
      a = o
        .map(function (e, n) {
          var a = ur.findByCode(e);
          return a && t && " " === o[n + 1] && (o[n + 1] = ""), a ? r(a) : e;
        })
        .join("");
    return t ? a.replace(ar, "") : a;
  }),
  (ur.strip = function (e) {
    return ur.replace(e, "", !0);
  });
var cr = ur;
ge.registerLanguage("yaml", Be),
  ge.registerLanguage("javascript", ve),
  ge.registerLanguage("json", Ce);
const dr = ze;
dr.setOptions({
  highlight: function (e, n) {
    return n && ge.getLanguage(n)
      ? ge.highlight(e, { language: n, ignoreIllegals: !0 }).value
      : ge.highlightAuto(e).value;
  },
  breaks: !0,
  gfm: !0,
  tables: !0,
