...
import { c as f } from "./c.eab7754a.js";
        ...
        },
        {
          ...
          value: () =>
            h((o) => {
              let e = o.local_path;
              return (
                ["template", "theme"].includes(o.category) &&
                  (e = `${e}/${o.file_name}`),
                e
              );
            }),
        },
        {
          ...
          value: async function () {
            ...
            await this._fetchRepository(),
              (this._toggle = !1),
              c(this.hass, (o) => (this._error = o), d.ERROR),
              ...
              "plugin" === this._repository.category &&
                ...
                (await (async function (a, r, l) {
                  const n = new o("updateLovelaceResources"),
                    h = await e(a),
                    c = `/hacsfiles/${r.full_name.split("/")[1]}`,
                    d = s({ repository: r, version: l }),
                    p = h.find((o) => o.url.includes(c));
                  n.debug({ namespace: c, url: d, exsisting: p }),
                    p && p.url !== d
                      ? (n.debug(`Updating exsusting resource for ${c}`),
                        await t(a, {
                          url: d,
                          resource_id: p.id,
                          res_type: p.type,
                        }))
                      : h.map((o) => o.url).includes(d) ||
