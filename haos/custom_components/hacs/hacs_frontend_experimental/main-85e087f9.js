...
class f {
  ...
  get styleSheet() {
    let e = g.get(this.cssText);
    return (
      m &&
        void 0 === e &&
        (g.set(this.cssText, (e = new CSSStyleSheet())),
...
const y = (e) => new f("string" == typeof e ? e : e + "", _),
  b = (e, ...t) => {
    const o =
      1 === e.length
        ? e[0]
...
const S = window,
  ...
  Q = new WeakMap(),
  ee = O.createTreeWalker(O, 129, null, !1),
  te = (e, t) => {
    const o = e.length - 1,
      r = [];
    let i,
...
class ae {
  ...
  k(e) {
    ...
    for (const i of e)
      r === t.length
        ? t.push((o = new ae(this.O(R()), this.O(R()), this, this.options)))
        : (o = t[r]),
        o._$AI(i),
        r++;
...
(fe.finalized = !0),
  ...
  null === (_e = globalThis.litElementHydrateSupport) ||
    void 0 === _e ||
    _e.call(globalThis, { LitElement: fe });
const ye = globalThis.litElementPolyfillSupport;
null == ye || ye({ LitElement: fe }),
...
const Oe = (e) => {
  ...
  Ze = (e) => (e > 0.008856452 ? e ** (1 / 3) : e / Fe + $e),
  Ge = (e) => 255 * (e <= 0.00304 ? 12.92 * e : 1.055 * e ** (1 / 2.4) - 0.055),
  qe = (e) => (e > 0.206896552 ? e * e * e : Fe * (e - $e)),
  Ke = (e) => {
    const [t, o, r] = ((e) => {
        let [t, o, r] = e;
        return (
          ...
          (r = Ue(r)),
          [
            Ze((0.4124564 * t + 0.3575761 * o + 0.1804375 * r) / je),
            Ze((0.2126729 * t + 0.7151522 * o + 0.072175 * r) / 1),
            Ze((0.0193339 * t + 0.119192 * o + 0.9503041 * r) / Be),
          ]
        );
      })(e),
      i = 116 * o - 16;
  ...
  Ye = (e) => {
    ...
    let i = (t + 16) / 116,
      a = isNaN(o) ? i : i + o / 500,
      n = isNaN(r) ? i : i - r / 200;
    (i = 1 * qe(i)), (a = je * qe(a)), (n = Be * qe(n));
    return [
      Ge(3.2404542 * a - 1.5371385 * i - 0.4985314 * n),
      Ge(-0.969266 * a + 1.8760108 * i + 0.041556 * n),
      Ge(0.0556434 * a - 0.2040259 * i + 1.0572252 * n),
    ];
  },
  Xe = (e, t = 1) => [e[0] - 18 * t, e[1], e[2]],
  Je = (e) => {
    const t = [0, 0, 0];
...
const et = (e, t, o, r, i) => {
      ...
      if (
        ...
        (c["light-primary-color"] = De(r)),
          ...
          (c["text-primary-color"] =
            We(e, [33, 33, 33]) < 6 ? "#fff" : "#212121"),
          (c["text-light-primary-color"] =
            We(r, [33, 33, 33]) < 6 ? "#fff" : "#212121"),
          (c["state-icon-color"] = c["dark-primary-color"]);
      }
      if (o) {
        (d = `${d}__accent_${o}`), (c["accent-color"] = o);
        const e = Ie(o);
        c["text-accent-color"] = We(e, [33, 33, 33]) < 6 ? "#fff" : "#212121";
      }
      if (
    ...
    if (
      ...
      return;
    const u = Object.keys(c).length && d ? Qe[d] || tt(d, c) : void 0,
      h = {
  ...
  tt = (e, t) => {
    ...
    return (Qe[e] = { styles: r, keys: i }), { styles: r, keys: i };
  },
  ot = "ha-main-window",
  rt = window.name === ot ? window : parent.name === ot ? parent : top,
  it = (e, t, o, r) => {
    (r = r || {}), (o = null == o ? {} : o);
    const i = new Event(t, {
  ...
  at = !(window.ShadyDOM && window.ShadyDOM.inUse);
let nt, st;
function lt(e) {
  nt =
...
window.ShadyCSS &&
  ...
  (st = window.ShadyCSS.cssBuild);
const dt = Boolean(window.ShadyCSS && window.ShadyCSS.disableRuntime);
window.ShadyCSS && void 0 !== window.ShadyCSS.nativeCss
  ? (nt = window.ShadyCSS.nativeCss)
  : window.ShadyCSS
  ? (lt(window.ShadyCSS), (window.ShadyCSS = void 0))
  : lt(window.WebComponents && window.WebComponents.flags);
const ct = nt;
class pt {
  constructor() {
    (this.start = 0),
      ...
      for (let r = 0, i = e.length; r < i; r++)
        if (e[r] === gt) {
          ...
          (o = new pt()),
            ...
            (o.previous = t),
            e.rules.push(o);
        } else e[r] === ft && ((o.end = r + 1), (o = o.parent || t));
      return t;
    })((e = e.replace(yt.comments, "").replace(yt.port, ""))),
    e
  );
}
function ht(e, t) {
  ...
  if (((e.parsedCssText = e.cssText = o.trim()), e.parent)) {
    ...
    (o = t.substring(r, e.start - 1)),
      ...
      (o = o.replace(yt.multipleSpaces, " ")),
      (o = o.substring(o.lastIndexOf(";") + 1));
    let i = (e.parsedSelector = e.selector = o.trim());
    (e.atRule = 0 === i.indexOf(Ct)),
      e.atRule
        ? 0 === i.indexOf(vt)
          ? (e.type = _t.MEDIA_RULE)
          : i.match(yt.keyframesRule) &&
            ((e.type = _t.KEYFRAMES_RULE),
            (e.keyframesName = e.selector.split(yt.multipleSpaces).pop()))
        : 0 === i.indexOf(bt)
        ? (e.type = _t.MIXIN_RULE)
        : (e.type = _t.STYLE_RULE);
  }
  let r = e.rules;
  if (r) for (let e, o = 0, i = r.length; o < i && (e = r[o]); o++) ht(e, t);
  return e;
}
function mt(e, t, o = "") {
  let r = "";
  if (e.cssText || e.rules) {
    ...
    if (
      ...
      !(function (e) {
        let t = e[0];
        return (
          Boolean(t) && Boolean(t.selector) && 0 === t.selector.indexOf(bt)
        );
      })(o)
    )
      ...
      (r = t
        ...
        : (function (e) {
            return (
              (e = (function (e) {
                return e.replace(yt.customProp, "").replace(yt.mixinProp, "");
              })(e)),
              (function (e) {
                return e.replace(yt.mixinApply, "").replace(yt.varApply, "");
              })(e)
            );
          })(e.cssText)),
        (r = r.trim()),
  ...
  return (
    r &&
      (e.selector && (o += e.selector + " " + gt + "\n"),
      (o += r),
      e.selector && (o += ft + "\n\n")),
    o
  );
}
const _t = { STYLE_RULE: 1, KEYFRAMES_RULE: 7, MEDIA_RULE: 4, MIXIN_RULE: 1e3 },
  gt = "{",
  ft = "}",
  yt = {
    comments: /\/\*[^*]*\*+([^/*][^*]*\*+)*\//gim,
...
function Mt(e, t) {
  return e
    ? ("string" == typeof e && (e = ut(e)), t && St(e, t), mt(e, ct))
    : "";
}
function xt(e) {
  return (
    !e.__cssRules && e.textContent && (e.__cssRules = ut(e.textContent)),
    e.__cssRules || null
  );
}
function St(e, t, o, r) {
  ...
  let i = !1,
    a = e.type;
  if (r && a === _t.MEDIA_RULE) {
    let t = e.selector.match(wt);
    t && (window.matchMedia(t[1]).matches || (i = !0));
  }
  a === _t.STYLE_RULE
    ? t(e)
    : o && a === _t.KEYFRAMES_RULE
    ? o(e)
    : a === _t.MIXIN_RULE && (i = !0);
  let n = e.rules;
  if (n && !i)
    for (let e, i = 0, a = n.length; i < a && (e = n[i]); i++) St(e, t, o, r);
}
function Et(e, t) {
  let o = e.indexOf("var(");
  if (-1 === o) return t(e, "", "", "");
...
class Ft {
  ...
  detectMixin(e) {
    return (function (e) {
      const t = Ht.test(e) || At.test(e);
      return (Ht.lastIndex = 0), (At.lastIndex = 0), t;
    })(e);
  }
  gatherStyles(e) {
    const t = (function (e) {
      ...
      for (let e = 0; e < o.length; e++) {
        const r = o[e];
        kt(r)
          ? at || (Vt(r), r.parentNode.removeChild(r))
  ...
  transformStyle(e, t = "") {
    let o = xt(e);
    return this.transformRules(o, t), (e.textContent = Mt(o)), o;
  }
  ...
  _consumeCssProperties(e, t) {
    ...
    for (; (o = Ht.exec(e)); ) {
      ...
      (e = `${l}${p}${d}`), (Ht.lastIndex = a + p.length);
    }
    return e;
  }
  _atApplyToCssProperties(e, t) {
    ...
    if ((r || (this._map.set(e, {}), (r = this._map.get(e))), r)) {
      ...
      for (i in s)
        (n = t && t[i]),
          (a = [i, ": var(", e, jt, i]),
          n && a.push(",", n.replace(Dt, "")),
          a.push(")"),
          Dt.test(s[i]) && a.push(" !important"),
          o.push(a.join(""));
    }
    return o.join("; ");
  }
  ...
  _invalidateMixinEntry(e) {
    if ($t) for (let t in e.dependants) t !== this._currentElement && $t(t);
  }
...
(Ft.prototype.detectMixin = Ft.prototype.detectMixin),
  (Ft.prototype.transformStyle = Ft.prototype.transformStyle),
  (Ft.prototype.transformCustomStyle = Ft.prototype.transformCustomStyle),
  (Ft.prototype.transformRules = Ft.prototype.transformRules),
  (Ft.prototype.transformRule = Ft.prototype.transformRule),
  (Ft.prototype.transformTemplate = Ft.prototype.transformTemplate),
  (Ft.prototype._separator = jt),
  Object.defineProperty(Ft.prototype, "invalidCallback", {
    get: () => $t,
    set(e) {
      $t = e;
    },
...
function Yt(e) {
  ...
  t &&
    (function (e) {
      (e[Zt] = e[Zt] || 0), (e[qt] = e[qt] || 0), (e[Gt] = (e[Gt] || 0) + 1);
    })(t);
}
function Xt(e) {
  return e[Zt] === e[Gt];
...
let Jt,
  Wt = null,
  Qt = (window.HTMLImports && window.HTMLImports.whenReady) || null;
function eo(e) {
...
const to = "__seenByShadyCSS",
  oo = "__shadyCSSCachedStyle";
let ro = null,
  io = null;
class ao {
  constructor() {
  ...
  enqueueDocumentValidation() {
    !this.enqueued && io && ((this.enqueued = !0), eo(io));
  }
  addCustomStyle(e) {
    e[to] ||
      ((e[to] = !0),
...
(ao.prototype.addCustomStyle = ao.prototype.addCustomStyle),
  (ao.prototype.getStyleForCustomStyle = ao.prototype.getStyleForCustomStyle),
  (ao.prototype.processStyles = ao.prototype.processStyles),
...
class so {
  constructor() {
    (this.customStyleInterface = null), (no.invalidCallback = Yt);
  }
  ensure() {
  ...
  prepareTemplate(e, t) {
    if ((this.ensure(), zt(e))) return;
    Ut[t] = e;
    let o = no.transformTemplate(e, t);
    e._styleAst = o;
  }
  flushCustomStyles() {
    ...
    if (this.customStyleInterface.enqueued) {
      for (let t = 0; t < e.length; t++) {
        ...
        r && no.transformCustomStyle(r);
      }
      this.customStyleInterface.enqueued = !1;
    }
  }
  styleSubtree(e, t) {
    if ((this.ensure(), t && Nt(e, t), e.shadowRoot)) {
      this.styleElement(e);
        ...
        (function (e) {
          (e[qt] = e[Gt]),
            e._validating ||
              ((e._validating = !0),
              Kt.then(function () {
                (e[Zt] = e[Gt]), (e._validating = !1);
              }));
        })(o));
      let r = e.shadowRoot;
      if (r) {
        let e = r.querySelector("style");
        e && ((e.__cssRules = o._styleAst), (e.textContent = Mt(o._styleAst)));
      }
    }
  }
  styleDocument(e) {
...
if (!window.ShadyCSS || !window.ShadyCSS.ScopingShim) {
  ...
  (window.ShadyCSS = {
    ...
    getComputedStyleValue: (e, t) => Ot(e, t),
    flushCustomStyles() {
      e.flushCustomStyles();
    },
    nativeCss: ct,
...
function mo(e, t) {
  return e.replace(po, function (e, o, r, i) {
    return o + "'" + ho(r.replace(/["']/g, ""), t) + "'" + i;
  });
}
function _o(e) {
  return e.substring(0, e.lastIndexOf("/") + 1);
}
const go = !window.ShadyDOM || !window.ShadyDOM.inUse;
...
let yo =
    ...
    _o(document.baseURI || window.location.href),
  bo = (window.Polymer && window.Polymer.sanitizeDOMValue) || void 0,
  vo = (window.Polymer && window.Polymer.setPassiveTouchGestures) || !1,
  ...
  Lo = (window.Polymer && window.Polymer.syncInitialRender) || !1,
  Vo = (window.Polymer && window.Polymer.legacyUndefined) || !1,
  ko = (window.Polymer && window.Polymer.orderedComputed) || !1,
  Mo = (window.Polymer && window.Polymer.removeNestedTemplates) || !1,
  xo = (window.Polymer && window.Polymer.fastDomIf) || !1,
  So = (window.Polymer && window.Polymer.suppressTemplateNotifications) || !1,
...
let No = {},
  Oo = {};
function Ro(e, t) {
  No[e] = Oo[e.toLowerCase()] = t;
}
function Io(e) {
  return No[e] || Oo[e.toLowerCase()];
}
    ...
    if (!this.__assetpath) {
      const e =
          window.HTMLImports && HTMLImports.importForElement
            ...
            : this.ownerDocument,
        t = ho(this.getAttribute("assetpath") || "", e.baseURI);
      this.__assetpath = _o(t);
    }
...
(Do.prototype.modules = No), customElements.define("dom-module", Do);
const jo = "shady-unscoped";
function Bo(e) {
  return Do.import(e);
}
function $o(e) {
  const t = mo((e.body ? e.body : e).textContent, e.baseURI),
...
function Fo(e) {
  const t = e.trim().split(/\s+/),
    o = [];
  for (let e = 0; e < t.length; e++) o.push(...Uo(t[e]));
  return o;
}
function Uo(e) {
  const t = Bo(e);
  ...
  if (void 0 === t._styles) {
    ...
    o && e.push(...Zo(o, t.assetpath)), (t._styles = e);
  }
  return t._styles;
}
function Zo(e, t) {
  if (!e._styles) {
    ...
    for (let e = 0; e < r.length; e++) {
      ...
      a &&
        o.push(
          ...Fo(a).filter(function (e, t, o) {
            return o.indexOf(e) === t;
          })
        ),
        t && (i.textContent = mo(i.textContent, t)),
        o.push(i);
    }
    e._styles = o;
  }
  ...
  for (let e = 0; e < o.length; e++) {
    ...
    if (r.import) {
      ...
      if (o && !e._unscopedStyle) {
        const t = $o(e);
        t.setAttribute(jo, ""), (e._unscopedStyle = t);
      } else e._style || (e._style = $o(e));
...
function tr(e) {
  return Array.isArray(e) ? er(e).split(".") : e.toString().split(".");
}
function or(e, t, o) {
  let r = e,
    i = tr(t);
...
function sr(e) {
  return (
    ir[e] ||
    (ir[e] = e.indexOf("-") < 0 ? e : e.replace(ar, (e) => e[1].toUpperCase()))
  );
}
function lr(e) {
  return ir[e] || (ir[e] = e.replace(nr, "-$1").toLowerCase());
}
let dr = 0,
  cr = 0,
  pr = [],
...
const _r = {
  ...
  fr = {
    run: (e) => (hr || ((hr = !0), (mr.textContent = ur++)), pr.push(e), dr++),
    cancel(e) {
      const t = e - cr;
      if (t >= 0) {
        if (!pr[t]) throw new Error("invalid async handle: " + e);
        pr[t] = null;
      }
    },
  },
  ...
  vr = {};
let Cr = HTMLElement.prototype;
for (; Cr; ) {
  let e = Object.getOwnPropertyNames(Cr);
  for (let t = 0; t < e.length; t++) vr[e[t]] = !0;
  Cr = Object.getPrototypeOf(Cr);
}
const Ar = zo((e) => {
    const t = br(e);
    return class extends t {
      static createPropertiesForAttributes() {
        ...
        for (let t = 0; t < e.length; t++)
          this.prototype._createPropertyAccessor(sr(e[t]));
      }
      static attributeNameForProperty(e) {
        return lr(e);
      }
...
function Vr(e) {
  (function () {
    if (!wr) {
      ...
      (e.placeholder = "a"), (Lr = e.placeholder === e.textContent);
    }
    return Lr;
  })() &&
...
function Mr(e, t) {
  let o = t.parentInfo && Mr(e, t.parentInfo);
  if (!o) return e;
    ...
    class extends e {
      ...
      _stampTemplate(e, t) {
        ...
        for (let e, r = 0, n = o.length; r < n && (e = o[r]); r++) {
          let o = (a[r] = Mr(i, e));
          xr(0, i.$, o, e), Er(0, o, e, t), Sr(this, o, e);
        }
        return i;
      }
...
function Br(e, t) {
  if (t) {
    let o = t.name;
    return (
      o == e || !(!t.structured || !Jo(o, e)) || !(!t.wildcard || !Wo(o, e))
    );
  }
  return !0;
}
...
function Fr(e, t, o) {
  let r = Xo(t);
  if (r !== t) {
    return Ur(e, lr(r) + "-changed", o[t], t), !0;
  }
  return !1;
}
function Ur(e, t, o, r) {
  let i = { value: o, queueProperty: !0 };
  r && (i.path = r), Ko(e).dispatchEvent(new CustomEvent(t, { detail: i }));
}
function Zr(e, t, o, r, i, a) {
  let n = (a ? Xo(t) : t) != t ? t : null,
    s = n ? or(e, n) : e.__data[t];
  n && void 0 === s && (s = o[t]), Ur(e, i.eventName, s, n);
}
function Gr(e, t, o, r, i) {
  let a = e.__data[t];
  bo && (a = bo(a, i.attrName, "attribute", e)),
  ...
  if (i)
    if (ko) {
      ...
      const a = (function (e) {
        ...
        n = [];
      for (let e in t) Yr(e, i, n, a, r);
      let s;
      for (; (s = n.shift()); )
        Xr(e, "", t, o, s) && Yr(s.methodInfo, i, n, a, r);
  ...
  Yr = (e, t, o, r, i) => {
    ...
    if (a)
      for (let t = 0; t < a.length; t++) {
        ...
        n.info.lastRun === Tr ||
          (i && !Br(e, n.trigger)) ||
          ((n.info.lastRun = Tr), Kr(n.info, o, r));
      }
  };
function Xr(e, t, o, r, i) {
  let a = ri(e, t, o, r, i);
  if (a === zr) return !1;
  let n = i.methodInfo;
...
function Jr(e, t, o, r, i, a, n) {
  ...
  if (
    ...
    (s.listenerEvent = e || lr(i) + "-changed"), (s.listenerNegate = t);
  }
  ...
  if (!r.literal)
    if ("attribute" === o.kind && "-" === o.target[0])
      ...
      for (let o = 0; o < a.length; o++) {
        let r = a[o];
        "string" == typeof r && ((r = ci(r)), (r.wildcard = !0)),
      ...
      (function (e, t, o, r, i) {
        ...
        if ("attribute" == o.kind) e._valueToNodeAttribute(t, i, o.target);
          ...
          t.__dataHasAccessor[r]
            ? (t[Nr.READ_ONLY] && t[Nr.READ_ONLY][r]) ||
...
function ei(e, t) {
  if (t.isCompound) {
    ...
    (o[a] = i),
      t.literal &&
        "property" == t.kind &&
        ("className" === a && (e = Ko(e)), (e[a] = t.literal));
  }
}
function ti(e, t, o) {
  if (o.listenerEvent) {
    ...
    e.addEventListener(o.listenerEvent, function (e) {
      !(function (e, t, o, r, i) {
        let a,
          n = e.detail,
          s = n && n.path;
        s ? ((r = Qo(o, r, s)), (a = n && n.value)) : (a = e.currentTarget[o]),
          (a = i ? !a : a),
          (t[Nr.READ_ONLY] && t[Nr.READ_ONLY][r]) ||
...
function di(e) {
  let t = e.match(/([^\s]+?)\(([\s\S]*)\)/);
  if (t) {
    let e = { methodName: t[1], static: !0, args: ii };
    if (t[2].trim()) {
      return (function (e, t) {
        return (
...
const mi = zo((e) => {
    ...
    return class extends t {
      ...
      _addPropertyEffect(e, t, o) {
        this._createPropertyAccessor(e, t == Nr.READ_ONLY);
        let r = Ir(this, t, !0)[e];
      ...
      _hasReadOnlyEffect(e) {
        return this._hasPropertyEffect(e, Nr.READ_ONLY);
      }
      _hasNotifyEffect(e) {
        return this._hasPropertyEffect(e, Nr.NOTIFY);
      }
      _hasReflectEffect(e) {
        return this._hasPropertyEffect(e, Nr.REFLECT);
      }
      _hasComputedEffect(e) {
        return this._hasPropertyEffect(e, Nr.COMPUTE);
      }
      _setPendingPropertyOrPath(e, t, o, r) {
        if (r || Xo(Array.isArray(e) ? e[0] : e) !== e) {
          if (!r) {
            let o = or(this, e);
            if (!(e = rr(this, e, t)) || !super._shouldPropertyChange(e, t, o))
              return !1;
          }
      ...
      _setUnmanagedPropertyToNode(e, t, o) {
        (o === e[t] && "object" != typeof o) ||
          ("className" === t && (e = Ko(e)), (e[t] = o));
      }
      _setPendingProperty(e, t, o) {
        let r = this.__dataHasPaths && Yo(e),
        ...
        return (
          ...
          (this.__dataPending[e] = t),
          (r || (this[Nr.NOTIFY] && this[Nr.NOTIFY][e])) &&
      ...
      setProperties(e, t) {
        for (let o in e)
          (!t && this[Nr.READ_ONLY] && this[Nr.READ_ONLY][o]) ||
      ...
      _propertiesChanged(e, t, o) {
        ...
        (this.__dataHasPaths = !1),
          ...
          this._flushClients(),
          Dr(this, this[Nr.REFLECT], t, o, i),
          Dr(this, this[Nr.OBSERVE], t, o, i),
          r &&
            (function (e, t, o, r, i) {
              let a,
                n,
      ...
      _propagatePropertyChanges(e, t, o) {
        this[Nr.PROPAGATE] && Dr(this, this[Nr.PROPAGATE], e, t, o),
          this.__templateInfo &&
            this._runEffectsForTemplate(this.__templateInfo, e, t, o);
      }
      _runEffectsForTemplate(e, t, o, r) {
        const i = (t, r) => {
          Dr(this, e.propertyEffects, t, o, r, e.nodeList);
      ...
      unlinkPaths(e) {
        (e = er(e)), this.__dataLinkedPaths && delete this.__dataLinkedPaths[e];
      }
      notifySplices(e, t) {
        let o = { path: "" };
        ui(this, or(this, e, o), o.path, t);
      }
      get(e, t) {
        return or(t || this, e);
      }
      set(e, t, o) {
        o
          ? rr(o, e, t)
          : (this[Nr.READ_ONLY] && this[Nr.READ_ONLY][e]) ||
      ...
      push(e, ...t) {
        let o = { path: "" },
          ...
          i = r.length,
          a = r.push(...t);
        return t.length && hi(this, r, o.path, i, t.length, []), a;
      }
      pop(e) {
        let t = { path: "" },
          o = or(this, e, t),
          r = Boolean(o.length),
          i = o.pop();
        return r && hi(this, o, t.path, o.length, 0, [i]), i;
      }
      splice(e, t, o, ...r) {
        let i,
          a = { path: "" },
        ...
        return (
          ...
          (r.length || i.length) && hi(this, n, a.path, t, r.length, i),
          i
        );
      }
      shift(e) {
        let t = { path: "" },
          ...
          r = Boolean(o.length),
          i = o.shift();
        return r && hi(this, o, t.path, 0, 0, [i]), i;
      }
      unshift(e, ...t) {
        let o = { path: "" },
          r = or(this, e, o),
          i = r.unshift(...t);
        return t.length && hi(this, r, o.path, 0, t.length, []), i;
      }
      notifyPath(e, t) {
        let o;
        if (1 == arguments.length) {
          let r = { path: "" };
          (t = or(this, e, r)), (o = r.path);
        } else o = Array.isArray(e) ? er(e) : e;
        this._setPendingPropertyOrPath(o, t, !0, !0) &&
          this._invalidateProperties();
      }
      _createReadOnlyProperty(e, t) {
        var o;
        this._addPropertyEffect(e, Nr.READ_ONLY),
          t &&
      ...
      _createPropertyObserver(e, t, o) {
        ...
        this._addPropertyEffect(e, Nr.OBSERVE, {
          fn: $r,
          info: r,
          trigger: { name: e },
        }),
          o &&
            this._addPropertyEffect(t, Nr.OBSERVE, {
              fn: $r,
              info: r,
              trigger: { name: t },
            });
      ...
      _createMethodObserver(e, t) {
        ...
        oi(this, o, Nr.OBSERVE, ri, null, t);
      }
      _createNotifyingProperty(e) {
        this._addPropertyEffect(e, Nr.NOTIFY, {
          fn: Zr,
          info: { eventName: lr(e) + "-changed", property: e },
        });
      }
      _createReflectedProperty(e) {
        ...
        "-" === t[0]
          ...
          : this._addPropertyEffect(e, Nr.REFLECT, {
              fn: Gr,
              info: { attrName: t },
            });
      }
      _createComputedProperty(e, t, o) {
        ...
        const i = oi(this, r, Nr.COMPUTE, Xr, e, o);
        Ir(this, Or)[e] = i;
      }
      _marshalArgs(e, t, o) {
        const r = this.__data,
        ...
        for (let a = 0, n = e.length; a < n; a++) {
          ...
          if (!c)
            if (l) {
              const e = Wo(n, t),
                i = pi(r, o, e ? t : n);
              d = { path: e ? t : n, value: i, base: e ? or(r, n) : i };
            } else d = s ? pi(r, o, n) : r[n];
          if (
            Vo &&
            !this._overrideLegacyUndefined &&
            void 0 === d &&
      ...
      _stampTemplate(e, t) {
        (t = t || this._bindTemplate(e, !0)), _i.push(this);
        let o = super._stampTemplate(e, t);
        if ((_i.pop(), (t.nodeList = o.nodeList), !t.wasPreBound)) {
          let e = (t.childNodes = []);
      ...
      _removeBoundDom(e) {
        ...
        for (let e = 0; e < a.length; e++) {
          let t = a[e];
          Ko(Ko(t).parentNode).removeChild(t);
        }
      }
      static _parseTemplateNode(e, o, r) {
        ...
        if (e.nodeType === Node.TEXT_NODE) {
          ...
          t &&
            ((e.textContent = li(t) || " "),
            Jr(this, o, r, "text", "textContent", t),
            (i = !0));
        }
        return i;
      }
      ...
      static _parseTemplateNestedTemplate(e, o, r) {
        ...
        if (xo && s)
          d &&
            ...
            Mo || (r.parentInfo.noted = !0));
        else {
          let e = "{";
          for (let t in d) {
            Jr(this, o, r, "property", "_host_" + t, [
...
const gi = zo((e) => {
  ...
  fi = window.ShadyCSS && window.ShadyCSS.cssBuild,
  yi = zo((e) => {
    const t = gi(mi(e));
    function o(e, t, o, r) {
    ...
    return class extends t {
      ...
      static get importPath() {
        if (
          ...
          if (e) this._importPath = _o(e.url);
          else {
            const e = Do.import(this.is);
            this._importPath =
              (e && e.assetpath) ||
      ...
      static _finalizeTemplate(e) {
        ...
        if (t && !t.__polymerFinalized) {
          ...
          r(this, t, e, o ? ho(o) : ""), this.prototype._bindTemplate(t);
        }
      }
      connectedCallback() {
      ...
      resolveUrl(e, t) {
        return !t && this.importPath && (t = ho(this.importPath)), ho(e, t);
      }
...
class bi {
  ...
  static debounce(e, t, o) {
    return (
      e instanceof bi ? e._cancelAsync() : (e = new bi()), e.setConfig(t, o), e
    );
  }
}
let vi = new Set();
...
let Hi = "string" == typeof document.head.style.touchAction,
  wi = "__polymerGestures",
  Li = "__polymerGesturesHandled",
  Vi = "__polymerGesturesTouchAction",
  ki = ["mousedown", "mousemove", "mouseup", "click"],
  Mi = [0, 1, 4, 2],
  xi = (function () {
    try {
...
function Pi(e) {
  if (!Si(e) && "touchend" !== e)
    return Hi && Ei && vo ? { passive: !0 } : void 0;
}
!(function () {
  try {
...
let Ti = navigator.userAgent.match(/iP(?:[oa]d|hone)|Android/);
const zi = [],
  Ni = {
    button: !0,
    input: !0,
...
let Ii = function (e) {
  ...
  if (
    ...
    ((e[Li] = { skip: !0 }), "click" === e.type)
  ) {
    let t = !1,
      r = Ui(e);
    for (let e = 0; e < r.length; e++) {
      if (r[e].nodeType === Node.ELEMENT_NODE)
        if ("label" === r[e].localName) zi.push(r[e]);
        else if (((o = r[e]), Ni[o.localName])) {
          let o = Ri(r[e]);
          for (let e = 0; e < o.length; e++) t = t || zi.indexOf(o[e]) > -1;
        }
      if (r[e] === Bi.mouse.target) return;
    }
    if (t) return;
...
function Di(e) {
  ...
  for (let o, r = 0; r < t.length; r++)
    (o = t[r]),
      e
        ? ((zi.length = 0), document.addEventListener(o, Ii, !0))
        : document.removeEventListener(o, Ii, !0);
}
function ji(e) {
  let t = e.type;
  if (!Si(t)) return !1;
  if ("mousemove" === t) {
    ...
    return (
      e instanceof window.MouseEvent && !xi && (t = Mi[e.which] || 0),
      Boolean(1 & t)
    );
  }
...
document.addEventListener(
  "touchend",
  function (e) {
    Bi.mouse.mouseIgnoreJob || Di(!0),
      (Bi.mouse.target = Ui(e)[0]),
      (Bi.mouse.mouseIgnoreJob = bi.debounce(
        Bi.mouse.mouseIgnoreJob,
        _r.after(2500),
        function () {
          Di(), (Bi.mouse.target = null), (Bi.mouse.mouseIgnoreJob = null);
        }
      ));
  },
  !!Ei && { passive: !0 }
...
function Ki(e) {
  let t,
    o = e.type,
    r = e.currentTarget[wi];
  if (!r) return;
  let i = r[o];
  if (i) {
    if (!e[Li] && ((e[Li] = {}), "touch" === o.slice(0, 5))) {
      let t = e.changedTouches[0];
      if (
        ("touchstart" === o &&
          1 === e.touches.length &&
          (Bi.touch.id = t.identifier),
        Bi.touch.id !== t.identifier)
      )
        return;
      Hi ||
        ...
        (function (e) {
          let t = e.changedTouches[0],
            o = e.type;
          if ("touchstart" === o)
            (Bi.touch.x = t.clientX),
              (Bi.touch.y = t.clientY),
              (Bi.touch.scrollDecided = !1);
          else if ("touchmove" === o) {
            if (Bi.touch.scrollDecided) return;
            Bi.touch.scrollDecided = !0;
            let o = (function (e) {
                let t = "auto",
                  o = Ui(e);
              ...
              r = !1,
              i = Math.abs(Bi.touch.x - t.clientX),
              a = Math.abs(Bi.touch.y - t.clientY);
            e.cancelable &&
              ("none" === o
                ? (r = !0)
                : "pan-x" === o
                ? (r = a > i)
                : "pan-y" === o && (r = i > a)),
              r ? e.preventDefault() : ea("track");
          }
        })(e);
    }
    if (((t = e[Li]), !t.skip)) {
      for (let o, r = 0; r < Gi.length; r++)
        (o = Gi[r]),
          i[o.name] &&
            !t[o.name] &&
            o.flow &&
            ...
            o.reset &&
            o.reset();
      for (let r, a = 0; a < Gi.length; a++)
        (r = Gi[a]), i[r.name] && !t[r.name] && ((t[r.name] = !0), r[o](e));
    }
  }
}
function Yi(e, t, o) {
      ...
      for (let t, o, r = 0; r < i.length; r++)
        (t = i[r]),
          (Ti && Si(t) && "click" !== t) ||
            ((o = n[t]),
            o || (n[t] = o = { _count: 0 }),
            0 === o._count && e.addEventListener(t, Ki, Pi(t)),
            (o[a] = (o[a] || 0) + 1),
            (o._count = (o._count || 0) + 1));
      e.addEventListener(t, o), r.touchAction && Wi(e, r.touchAction);
    })(e, t, o),
    !0)
  );
}
        ...
        for (let t, o, r = 0; r < i.length; r++)
          (t = i[r]),
            ...
            o &&
              ...
              0 === o._count && e.removeEventListener(t, Ki, Pi(t)));
      e.removeEventListener(t, o);
    })(e, t, o),
    !0)
  );
...
function Ji(e) {
  Gi.push(e);
  for (let t = 0; t < e.emits.length; t++) Zi[e.emits[t]] = e;
}
function Wi(e, t) {
  Hi &&
...
function Qi(e, t, o) {
  ...
  if (((r.detail = o), Ko(e).dispatchEvent(r), r.defaultPrevented)) {
...
function ia(e, t, o) {
  let r = Math.abs(t.clientX - e.x),
    ...
    a = qi(o || t);
  !a ||
    (Oi[a.localName] && a.hasAttribute("disabled")) ||
    ((isNaN(r) ||
      isNaN(i) ||
      (r <= 25 && i <= 25) ||
      (function (e) {
...
Ji({
  ...
  touchstart: function (e) {
    ta("down", qi(e), e.changedTouches[0], e);
  },
  touchend: function (e) {
    ta("up", qi(e), e.changedTouches[0], e);
  },
}),
  Ji({
    name: "track",
          ...
          oa(o.info, r, i) &&
            ((o.info.state = o.info.started
              ? "mouseup" === e.type
                ...
                : "track"
              : "start"),
            "start" === o.info.state && ea("tap"),
            o.info.addMove({ x: r, y: i }),
            ji(e) || ((o.info.state = "end"), Fi(o.info)),
            t && ra(o.info, t, e),
            (o.info.started = !0));
        };
      $i(this.info, r, function (e) {
        o.info.started && r(e), Fi(o.info);
      }),
  ...
  Ji({
    ...
    mousedown: function (e) {
      ji(e) && ((this.info.x = e.clientX), (this.info.y = e.clientY));
    },
    click: function (e) {
      ji(e) && ia(this.info, e);
    },
    ...
    touchend: function (e) {
      ia(this.info, e.changedTouches[0], e);
    },
  });
const aa = zo(
    (e) =>
      class extends e {
        _addEventListenerToNode(e, t, o) {
          Yi(e, t, o) || super._addEventListenerToNode(e, t, o);
        }
        _removeEventListenerFromNode(e, t, o) {
          Xi(e, t, o) || super._removeEventListenerFromNode(e, t, o);
        }
      }
  ),
  na = /:host\(:dir\((ltr|rtl)\)\)/g,
  sa = /([\s\w-#\.\[\]\*]*):dir\((ltr|rtl)\)/g,
  la = /:dir\((?:ltr|rtl)\)/,
  da = Boolean(window.ShadyDOM && window.ShadyDOM.inUse),
  ca = [];
let pa = null,
  ua = "";
function ha() {
  ua = document.documentElement.getAttribute("dir");
}
function ma(e) {
  if (!e.__autoDirOptOut) {
    e.setAttribute("dir", ua);
  }
}
function _a() {
  ha(), (ua = document.documentElement.getAttribute("dir"));
  for (let e = 0; e < ca.length; e++) ma(ca[e]);
}
const ga = zo((e) => {
  da ||
    pa ||
    (ha(),
    (pa = new MutationObserver(_a)),
    pa.observe(document.documentElement, {
      attributes: !0,
      attributeFilter: ["dir"],
    }));
  const t = Ar(e);
  class o extends t {
    ...
    static _replaceDirInCssText(e) {
      let t = e;
      return (
        (t = t.replace(na, ':host([dir="$1"])')),
        (t = t.replace(sa, ':host([dir="$2"]) $1')),
        t
      );
    }
    constructor() {
    ...
    connectedCallback() {
      t.prototype.connectedCallback && super.connectedCallback(),
        this.constructor.__activateDir &&
          (pa && pa.takeRecords().length && _a(), ca.push(this), ma(this));
    }
    disconnectedCallback() {
      if (
...
function ba(e, t, o, r, i, a) {
  ...
  if (
    (0 == t &&
      0 == i &&
      (s = (function (e, t, o) {
        for (let r = 0; r < o; r++) if (!Ca(e[r], t[r])) return r;
        return o;
      })(e, r, d)),
    o == e.length &&
      a == r.length &&
    ...
    return [];
  if (t == o) {
    for (n = ya(t, [], 0); i < a; ) n.removed.push(r[i++]);
    return [n];
  }
  if (i == a) return [ya(t, [], o - t)];
  let c = (function (e) {
    let t = e.length - 1,
      o = e[0].length - 1,
      r = e[t][o],
    ...
    (function (e, t, o, r, i, a) {
      ...
      for (let o = 1; o < n; o++)
        for (let a = 1; a < s; a++)
          if (Ca(e[t + a - 1], r[i + o - 1])) l[o][a] = l[o - 1][a - 1];
          else {
            let e = l[o - 1][a] + 1,
              t = l[o][a - 1] + 1;
            l[o][a] = e < t ? e : t;
  ...
  for (let e = 0; e < c.length; e++)
    switch (c[e]) {
      case 0:
        ...
        break;
      case 1:
        n || (n = ya(u, [], 0)), n.addedCount++, u++, n.removed.push(r[h]), h++;
        break;
      case 2:
        n || (n = ya(u, [], 0)), n.addedCount++, u++;
        break;
      case 3:
        n || (n = ya(u, [], 0)), n.removed.push(r[h]), h++;
    }
  return n && p.push(n), p;
}
function va(e, t) {
  return ba(e, 0, e.length, t, 0, t.length);
}
function Ca(e, t) {
  return e === t;
}
...
let Ha = class {
  static getFlattenedNodes(e) {
    ...
    return Aa(e)
      ...
      : Array.from(t.childNodes)
          .map((e) => (Aa(e) ? Ko(e).assignedNodes({ flatten: !0 }) : [e]))
  ...
  connect() {
    Aa(this._target)
      ...
      : Ko(this._target).children &&
        (this._listenSlots(Ko(this._target).children),
        window.ShadyDOM
  ...
  disconnect() {
    Aa(this._target)
      ...
      : Ko(this._target).children &&
        (this._unlistenSlots(Ko(this._target).children),
  ...
  _schedule() {
    this._scheduled || ((this._scheduled = !0), fr.run(() => this.flush()));
  }
  _processMutations(e) {
  ...
  _listenSlots(e) {
    for (let t = 0; t < e.length; t++) {
      let o = e[t];
      Aa(o) && o.addEventListener("slotchange", this._boundSchedule);
    }
  }
  _unlistenSlots(e) {
    for (let t = 0; t < e.length; t++) {
      let o = e[t];
      Aa(o) && o.removeEventListener("slotchange", this._boundSchedule);
    }
  }
};
const wa = function () {
...
class Ma {
  ...
  notifyObserver() {}
  deepContains(e) {
    if (Ko(this.node).contains(e)) return !0;
    let t = e,
      o = e.ownerDocument;
    for (; t && t !== o && t !== this.node; )
      t = Ko(t).parentNode || Ko(t).host;
    return t === this.node;
  }
  getOwnerRoot() {
    return Ko(this.node).getRootNode();
  }
  getDistributedNodes() {
    return "slot" === this.node.localName
      ? Ko(this.node).assignedNodes({ flatten: !0 })
      : [];
  }
  getDestinationInsertionPoints() {
    let e = [],
      t = Ko(this.node).assignedSlot;
    for (; t; ) e.push(t), (t = Ko(t).assignedSlot);
    return e;
  }
  importNode(e, t) {
    let o = this.node instanceof Document ? this.node : this.node.ownerDocument;
    return Ko(o).importNode(e, t);
  }
  ...
  queryDistributedElements(e) {
    ...
    for (let r, i = 0, a = t.length; i < a && (r = t[i]); i++)
      r.nodeType === Node.ELEMENT_NODE && ka(r, e) && o.push(r);
    return o;
  }
  get activeElement() {
    let e = this.node;
...
Ma.prototype.cloneNode,
  Ma.prototype.appendChild,
  Ma.prototype.insertBefore,
  Ma.prototype.removeChild,
  Ma.prototype.replaceChild,
  Ma.prototype.setAttribute,
  Ma.prototype.removeAttribute,
  Ma.prototype.querySelector,
  Ma.prototype.querySelectorAll,
  Ma.prototype.parentNode,
  Ma.prototype.firstChild,
  Ma.prototype.lastChild,
  Ma.prototype.nextSibling,
  Ma.prototype.previousSibling,
  Ma.prototype.firstElementChild,
  Ma.prototype.lastElementChild,
  Ma.prototype.nextElementSibling,
  Ma.prototype.previousElementSibling,
  Ma.prototype.childNodes,
  Ma.prototype.children,
  Ma.prototype.classList,
  Ma.prototype.textContent,
  Ma.prototype.innerHTML;
let Ea = Ma;
if (
  window.ShadyDOM &&
  ...
  Object.getOwnPropertyNames(Ma.prototype).forEach((t) => {
    "activeElement" != t && (e.prototype[t] = Ma.prototype[t]);
  }),
    xa(e.prototype, ["classList"]),
    (Ea = e),
    Object.defineProperties(Sa.prototype, {
      localTarget: {
        get() {
          const e = this.event.currentTarget,
            t = e && Pa(e).getOwnerRoot(),
            o = this.path;
          for (let e = 0; e < o.length; e++) {
            const r = o[e];
            if (Pa(r).getOwnerRoot() === t) return r;
          }
        },
        configurable: !0,
      },
  ...
  !(function (e, t) {
    ...
    })(Ma.prototype, ["textContent", "innerHTML", "className"]);
const Pa = function (e) {
    if ((e = e || document) instanceof Ea) return e;
    if (e instanceof Sa) return e;
    let t = e.__domApi;
    return (
      t || ((t = e instanceof Event ? new Sa(e) : new Ea(e)), (e.__domApi = t)),
      t
    );
  },
  Ta = window.ShadyDOM,
  za = window.ShadyCSS;
function Na(e, t) {
  return Ko(e).getRootNode() === t;
}
const Oa = "disable-upgrade",
  Ra = (e) => {
    for (; e; ) {
    ...
    attributeChangedCallback(e, t, o, r) {
      e == Oa
        ? this.__isUpgradeDisabled &&
          ...
          Ko(this).isConnected && super.connectedCallback())
        : super.attributeChangedCallback(e, t, o, r);
    }
    connectedCallback() {
...
const Ia = "disable-upgrade";
let Da = window.ShadyCSS;
const ja = zo((e) => {
    const t = aa(yi(e)),
      o = fi ? t : ga(t),
      r = Ra(o),
    ...
    class a extends o {
      ...
      __attributeReaction(e, t, o) {
        ((this.__dataAttributes && this.__dataAttributes[e]) || e === Ia) &&
        ...
        t !== o &&
          (e == Ia
            ? this.__isUpgradeDisabled &&
              ...
              (this._initializeProperties(),
              (this.__isUpgradeDisabled = !1),
              Ko(this).isConnected && this.connectedCallback())
            : (super.attributeChangedCallback(e, t, o, r),
              this.attributeChanged(e, t, o)));
      }
      attributeChanged(e, t, o) {}
      _initializeProperties() {
        if (Ho && this.hasAttribute(Ia)) this.__isUpgradeDisabled = !0;
        else {
      ...
      getEffectiveChildNodes() {
        return Pa(this).getEffectiveChildNodes();
      }
      queryDistributedElements(e) {
        return Pa(this).queryDistributedElements(e);
      }
      ...
      getContentChildNodes(e) {
        ...
        return t ? Pa(t).getDistributedNodes() : [];
      }
      ...
      isLightDescendant(e) {
        ...
        return (
          t !== e &&
          Ko(t).contains(e) &&
          Ko(t).getRootNode() === Ko(e).getRootNode()
        );
      }
      isLocalDescendant(e) {
        return this.root === Ko(e).getRootNode();
      }
      scopeSubtree(e, t = !1) {
        return (function (e, t = !1) {
          if (!Ta || !za) return null;
          if (!Ta.handlesDynamicScoping) return null;
          const o = za.ScopingShim;
          if (!o) return null;
          const r = o.scopeForNode(e),
            ...
            a = (e) => {
              if (!Na(e, i)) return;
              const t = Array.from(
                Ta.nativeMethods.querySelectorAll.call(e, "*")
              );
              t.push(e);
      ...
      getComputedStyleValue(e) {
        return Da.getComputedStyleValue(this, e);
      }
      debounce(e, t, o) {
        return (
          (this._debouncers = this._debouncers || {}),
          (this._debouncers[e] = bi.debounce(
            this._debouncers[e],
            o > 0 ? _r.after(o) : fr,
            t.bind(this)
          ))
      ...
      async(e, t) {
        return t > 0 ? _r.run(e.bind(this), t) : ~fr.run(e.bind(this));
      }
      cancelAsync(e) {
        e < 0 ? fr.cancel(~e) : _r.cancel(e);
      }
      create(e, t) {
      ...
      toggleAttribute(e, t) {
        ...
        return (
          ...
          t ? (Ko(o).setAttribute(e, ""), !0) : (Ko(o).removeAttribute(e), !1)
        );
      }
      toggleClass(e, t, o) {
        (o = o || this),
...
function Ua(e, t, o, r) {
  ...
  for (let e in Ba) t[e] && ((o[e] = o[e] || []), o[e].push(t[e]));
}
function Za(e, t, o) {
  t = t || [];
...
function Ka(e, t, o) {
  ...
  class a extends t {
    ...
    static get properties() {
      const t = {};
      if (r) for (let e = 0; e < r.length; e++) Ga(t, r[e].properties);
      return Ga(t, e.properties), t;
    }
    ...
    _registered() {
      ...
      if (
        ...
        (e.__hasRegisterFinished = !0), super._registered(), Ho && n(e);
  ...
  if (o) {
    ...
    (r = Za(o, null, e)), (a.prototype.behaviors = e ? e.concat(o) : r);
  }
  const n = (t) => {
    r &&
      (function (e, t, o) {
        for (let r = 0; r < t.length; r++) Ua(e, t[r], o, Fa);
      })(t, r, i),
      Ua(t, e, i, $a);
  };
  return Ho || n(a.prototype), (a.generatedFrom = e), a;
}
const Ya = function (e) {
  let t;
  return (
    (t = "function" == typeof e ? e : Ya.Class(e)),
  ...
  Wa = zo(
    (e) =>
      class extends e {
        ...
        _shouldPropertyChange(e, t, o) {
          return Xa(this, e, t, o, this.mutableData);
        }
      }
  );
Ja._mutablePropertyChange = Xa;
let Qa = null;
function en() {
  return Qa;
}
en.prototype = Object.create(HTMLTemplateElement.prototype, {
  constructor: { value: en, writable: !0 },
});
const tn = mi(en),
  on = Ja(tn);
const rn = mi(class {});
      ...
      if (r.nodeType === Node.TEXT_NODE)
        ...
        if (e)
          (r.__polymerReplaced__ = document.createComment("hidden-slot")),
            Ko(Ko(r).parentNode).replaceChild(r.__polymerReplaced__, r);
        else {
          const e = r.__polymerReplaced__;
          e && Ko(Ko(e).parentNode).replaceChild(r, e);
        }
      else
        r.style &&
          (e
...
nn.prototype.__dataHost,
  nn.prototype.__templatizeOptions,
  nn.prototype._methodHost,
  nn.prototype.__templatizeOwner,
  nn.prototype.__hostProps;
const sn = Ja(nn);
function ln(e) {
  let t = e.__dataHost;
...
function dn(e, t, o) {
  let r = o.mutableData ? sn : nn;
  hn.mixin && (r = hn.mixin(r));
...
function cn(e, t, o, r) {
  ...
  if (i && t.hasHostProps) {
    ...
    if ((e.__dataProto && Object.assign(e.__data, e.__dataProto), a))
      !(function (e, t) {
        (Qa = e), Object.setPrototypeOf(e, t.prototype), new t(), (Qa = null);
      })(e, n),
        (e.__dataTemp = {}),
        (e.__dataPending = null),
        (e.__dataOld = null),
...
function hn(e, t, o) {
  ...
  let r = (t ? t.constructor : nn)._parseTemplate(e),
    i = r.templatizeInstanceClass;
  i || ((i = dn(e, r, o)), (r.templatizeInstanceClass = i));
  const a = ln(e);
  cn(e, r, o, a);
...
customElements.define(
  ...
  class extends gn {
    ...
    connectedCallback() {
      _n() || (this.style.display = "none"), this.render();
    }
    disconnectedCallback() {
      this.__removeChildren();
    }
    __insertChildren() {
      Ko(Ko(this).parentNode).insertBefore(this.root, this);
    }
    __removeChildren() {
      if (this.__children)
...
function yn(e) {
  ...
  if (e instanceof fn)
    return (function (e) {
      if (e instanceof fn) return e.value;
      throw new Error(
...
const bn = function (e, ...t) {
    ...
    return (o.innerHTML = t.reduce((t, o, r) => t + yn(o) + e[r + 1], e[0])), o;
  },
  vn = yi(HTMLElement),
  Cn = Wa(vn);
class An extends Cn {
  ...
  static get properties() {
    return {
      ...
      delay: Number,
      renderedItemCount: { type: Number, notify: !So, readOnly: !0 },
  ...
  connectedCallback() {
    if (
      (super.connectedCallback(),
      _n() || (this.style.display = "none"),
      this.__isDetached)
    ) {
      this.__isDetached = !1;
      let e = Ko(Ko(this).parentNode);
      ...
      (o[this.as] = !0),
        ...
        (this.__ctor = hn(t, this, {
          ...
          notifyInstanceProp: function (e, t, o) {
            if ((r = this.as) === (i = t) || Jo(r, i) || Wo(r, i)) {
  ...
  __debounceRender(e, t = 0) {
    (this.__renderDebouncer = bi.debounce(
      this.__renderDebouncer,
      t > 0 ? _r.after(t) : fr,
      e.bind(this)
    )),
      Ci(this.__renderDebouncer);
  }
  render() {
  ...
  __insertInstance(e, t, o) {
    ...
    return (
      Ko(Ko(this).parentNode).insertBefore(r.root, a),
...
class Hn extends vn {
  ...
  __debounceRender() {
    (this.__renderDebouncer = bi.debounce(this.__renderDebouncer, fr, () =>
      this.__render()
    )),
      Ci(this.__renderDebouncer);
  }
  disconnectedCallback() {
    super.disconnectedCallback();
    const e = Ko(this).parentNode;
    (e && (e.nodeType != Node.DOCUMENT_FRAGMENT_NODE || Ko(e).host)) ||
  ...
  __ensureTemplate() {
    if (!this.__template) {
      const e = this;
      let t = e._templateInfo ? e : Ko(e).querySelector("template");
      if (!t) {
        let e = new MutationObserver(() => {
          if (!Ko(this).querySelector("template"))
  ...
  __ensureInstance() {
    let e = Ko(this).parentNode;
    if (this.__hasInstance()) {
      let t = this.__getInstanceNodes();
      if (t && t.length) {
        if (Ko(this).previousSibling !== t[t.length - 1])
          for (let o, r = 0; r < t.length && (o = t[r]); r++)
            Ko(e).insertBefore(o, this);
      }
    } else {
      if (!e) return !1;
...
const wn = xo
  ? class extends Hn {
      ...
      __createAndInsertInstance(e) {
        ...
        (o.runEffects = (e, t, o) => {
          ...
          Ko(e).insertBefore(this.__instance, this);
      }
      ...
      _showHideChildren() {
        ...
        this.__instance &&
          ...
          an(e, this.__instance.templateInfo.childNodes)),
  ...
  : class extends Hn {
      ...
      __createAndInsertInstance(e) {
        this.__ctor ||
          (this.__ctor = hn(this.__template, this, {
            mutableData: !0,
            forwardHostProp: function (e, t) {
              this.__instance &&
                (this.if
                  ...
                  : ((this.__invalidProps =
                    ...
                    (this.__invalidProps[Xo(e)] = !0)));
            },
          })),
          (this.__instance = new this.__ctor()),
          Ko(e).insertBefore(this.__instance.root, this);
      }
      __teardownInstance() {
        if (this.__instance) {
          let e = this.__instance.children;
          if (e && e.length) {
            let t = Ko(e[0]).parentNode;
            if (t) {
              t = Ko(t);
...
customElements.define(wn.is, wn);
let Ln = zo((e) => {
    let t = yi(e);
    return class extends t {
      static get properties() {
...
window.ShadyCSS ||
  (window.ShadyCSS = {
    ...
    prepareTemplateStyles(e, t, o) {},
    styleSubtree(e, t) {
      Mn.processStyles(), Nt(e, t);
    },
    styleElement(e) {
      Mn.processStyles();
    },
    styleDocument(e) {
      Mn.processStyles(), Nt(document.body, e);
    },
    getComputedStyleValue: (e, t) => Ot(e, t),
    flushCustomStyles() {},
    nativeCss: ct,
  ...
  (window.ShadyCSS.CustomStyleInterface = Mn);
const xn = "include",
  Sn = window.ShadyCSS.CustomStyleInterface;
class En extends HTMLElement {
  constructor() {
    super(), (this._style = null), Sn.addCustomStyle(this);
  }
  getStyle() {
...
window.customElements.define("custom-style", En), ja(HTMLElement).prototype;
const Pn = bn`
<custom-style>
...
Pn.setAttribute("style", "display: none;"),
  document.head.appendChild(Pn.content);
var Tn = document.createElement("style");
(Tn.textContent = "[hidden] { display: none !important; }"),
...
Rn([Ce({ type: Boolean, reflect: !0 })], Wn.prototype, "indeterminate", void 0),
  Rn([Ce({ type: Number, reflect: !0 })], Wn.prototype, "progress", void 0),
  Rn([Ce({ type: Number, reflect: !0 })], Wn.prototype, "density", void 0),
  Rn([Ce({ type: Boolean, reflect: !0 })], Wn.prototype, "closed", void 0),
  Rn(
    [Zn, Ce({ type: String, attribute: "aria-label" })],
    Wn.prototype,
    "ariaLabel",
    void 0
  );
...
let es = class extends Wn {};
(es.styles = [Qn]),
  (es = Rn([be("mwc-circular-progress")], es)),
  s(
...
var ts =
  ...
  cs = "M13 14H11V9H13M13 18H11V16H13M1 21H23L12 2L1 21Z",
  ps =
  ...
  hs = "M12,2L1,21H23M12,6L19.53,19H4.47M11,10V14H13V10M11,16V18H13V16",
  ms =
  ...
  ws = "M20,11V13H8L13.5,18.5L12.08,19.92L4.16,12L12.08,4.08L13.5,5.5L8,11H20Z",
  Ls =
  ...
  ks = "M13,20H11V8L5.5,13.5L4.08,12.08L12,4.16L19.92,12.08L18.5,13.5L13,8V20Z",
  Ms =
  ...
  nl =
    "M20 19V3H4V19H2V21H22V19H20M16 9H18V11H16V9M14 11H6V9H14V11M18 7H16V5H18V7M14 5V7H6V5H14M6 19V13H14V14.82C13.55 15.14 13.25 15.66 13.25 16.25C13.25 17.22 14.03 18 15 18S16.75 17.22 16.75 16.25C16.75 15.66 16.45 15.13 16 14.82V13H18V19H6Z",
  sl =
    "M20 19V3H4V19H2V21H13.25C13.25 21.97 14.03 22.75 15 22.75S16.75 21.97 16.75 21H22V19H20M18 11H16V9H18V11M14 11H6V9H14V11M14 13V15H6V13H14M16 13H18V15H16V13M18 7H16V5H18V7M14 5V7H6V5H14M6 19V17H14V19H6M16 19V17H18V19H16Z",
  ll =
  ...
  cl = "M17,3H7A2,2 0 0,0 5,5V21L12,18L19,21V5C19,3.89 18.1,3 17,3Z",
  pl =
  ...
  Hl = "M21,7L9,19L3.5,13.5L4.91,12.09L9,16.17L19.59,5.59L21,7Z",
  wl =
  ...
  Ml = "M7.41,8.58L12,13.17L16.59,8.58L18,10L12,16L6,10L7.41,8.58Z",
  xl =
  ...
  td = "M5,20H19V18H5M19,9H15V3H9V9H5L12,16L19,9Z",
  od =
  ...
  ad = "M10 3H14V14H10V3M10 21V17H14V21H10Z",
  nd =
  ...
  ud = "M6,13H18V11H6M3,6V8H21V6M10,18H14V16H10V18Z",
  hd =
  ...
  md = "M7,2V13H10V22L17,10H13L17,2H7Z",
  _d =
  ...
  Hd = "M19,20H17V11H7V20H5V9L12,5L19,9V20M8,12H16V14H8V12Z",
  wd =
  ...
  Rd = "M10,20V14H14V20H19V12H22L12,3L2,12H5V20H10Z",
  Id =
  ...
  Xd = "M11 15H6L13 1V9H18L11 23V15Z",
  Jd =
  ...
  ac = "M7,10L12,15L17,10H7Z",
  nc = "M7,15L12,10L17,15H7Z",
  sc =
  ...
  kc = "M8,5.14V19.14L19,12.14L8,5.14Z",
  Mc =
  ...
  Ec = "M19,13H13V19H11V13H5V11H11V5H13V11H19V13Z",
  Pc =
  ...
  Gc =
    "M20 19V3H4V19H2V21H10.25C10.25 21.97 11.03 22.75 12 22.75S13.75 21.97 13.75 21H22V19H20M6 19V17H11V19H6M13 19V17H18V19H13Z",
  qc =
  ...
  rp = "M16,4.5V7H5V9H16V11.5L19.5,8M16,12.5V15H5V17H16V19.5L19.5,16",
  ip =
  ...
  fp = "M3,3V21H21V3",
  yp = "M3,3H21V21H3V3M5,5V19H19V5H5Z",
  bp =
  ...
  wp = "M21,9L17,5V8H10V10H17V13M7,11L3,15L7,19V16H14V14H7V11Z",
  Lp =
  ...
  Dp = "M9,16V10H5L12,3L19,10H15V16H9M5,20V18H19V20H5Z",
  jp =
  ...
  $p = "M13,3V9H21V3M13,21H21V11H13M3,21H11V15H3M3,13H11V3H3V13Z",
  Fp =
  ...
  _u = "M3 4H21V8H19V20H17V8H7V20H5V8H3V4M8 9H16V11H8V9Z";
function gu(e, t) {
...
const yu = (e) => e.nodeType === Node.ELEMENT_NODE;
function bu(e) {
  return {
    addClass: (t) => {
      e.classList.add(t);
...
document.addEventListener("x", Cu, Au), document.removeEventListener("x", Cu);
const Hu = vu,
  wu = (e = window.document) => {
...
var Eu = ["touchstart", "pointerdown", "mousedown", "keydown"],
  Pu = ["touchend", "pointerup", "mouseup", "contextmenu"],
  Tu = [],
  zu = (function (e) {
    function t(o) {
      var r = e.call(this, On(On({}, t.defaultAdapter), o)) || this;
      return (
    ...
    return (
      ...
      (t.prototype.registerRootHandlers = function (e) {
        ...
        if (e) {
          try {
            for (var r = Dn(Eu), i = r.next(); !i.done; i = r.next()) {
              var a = i.value;
      ...
      (t.prototype.registerDeactivationHandlers = function (e) {
        ...
        if ("keydown" === e.type)
          ...
          try {
            for (var r = Dn(Pu), i = r.next(); !i.done; i = r.next()) {
              var a = i.value;
      ...
      (t.prototype.deregisterRootHandlers = function () {
        var e, t;
        try {
          for (var o = Dn(Eu), r = o.next(); !r.done; r = o.next()) {
            var i = r.value;
      ...
      (t.prototype.deregisterDeactivationHandlers = function () {
        ...
        try {
          for (var o = Dn(Pu), r = o.next(); !r.done; r = o.next()) {
            var i = r.value;
            ...
            if (!(r && void 0 !== e && r.type !== e.type))
              (o.isActivated = !0),
                ...
                Tu.some(function (e) {
                  ...
                  : (void 0 !== e &&
                      (Tu.push(e.target), this.registerDeactivationHandlers(e)),
...
class Ou extends Vu {
  constructor() {
    super(...arguments),
      ...
      (this.leftPos = ""),
      (this.topPos = ""),
      (this.mdcFoundationClass = Nu);
  }
  get isActive() {
    return fu(this.parentElement || this, ":active");
  }
  createAdapter() {
    return {
...
Rn([Le(".mdc-ripple-surface")], Ou.prototype, "mdcRoot", void 0),
  Rn([Ce({ type: Boolean })], Ou.prototype, "primary", void 0),
  Rn([Ce({ type: Boolean })], Ou.prototype, "accent", void 0),
  Rn([Ce({ type: Boolean })], Ou.prototype, "unbounded", void 0),
  Rn([Ce({ type: Boolean })], Ou.prototype, "disabled", void 0),
  Rn([Ce({ type: Boolean })], Ou.prototype, "activated", void 0),
  Rn([Ce({ type: Boolean })], Ou.prototype, "selected", void 0),
  Rn(
    [Ce({ type: Boolean })],
    Ou.prototype,
  ...
  Rn([Ae()], Ou.prototype, "hovering", void 0),
  Rn([Ae()], Ou.prototype, "bgFocused", void 0),
  Rn([Ae()], Ou.prototype, "fgActivation", void 0),
  Rn([Ae()], Ou.prototype, "fgDeactivation", void 0),
  Rn([Ae()], Ou.prototype, "fgScale", void 0),
  Rn([Ae()], Ou.prototype, "fgSize", void 0),
  Rn([Ae()], Ou.prototype, "translateStart", void 0),
  Rn([Ae()], Ou.prototype, "translateEnd", void 0),
  Rn([Ae()], Ou.prototype, "leftPos", void 0),
  Rn([Ae()], Ou.prototype, "topPos", void 0);
...
(Iu.styles = [Ru]), (Iu = Rn([be("mwc-ripple")], Iu));
class Du {
  constructor(e) {
    (this.startPress = (t) => {
      e().then((e) => {
...
Rn([Ce({ type: Boolean, reflect: !0 })], ju.prototype, "disabled", void 0),
  Rn([Ce({ type: String })], ju.prototype, "icon", void 0),
  Rn(
    [Zn, Ce({ type: String, attribute: "aria-label" })],
    ju.prototype,
    "ariaLabel",
    ...
    function (e, o) {
      ...
      return {
        ...
        d: [
          ...
          { kind: "field", decorators: [Ae()], key: "_icon", value: () => ws },
          {
            kind: "method",
...
const Fu = (e) => {
  ...
  Zu = (e, t, o, r, i) => Uu(r, e, t, o).subscribe(i),
  Gu = (e) => e.sendMessagePromise({ type: "persistent_notification/get" }),
  qu = (e, t) =>
    e.subscribeEvents(
      () => Gu(e).then((e) => t.setState(e, !0)),
...
const Ku = (e, t, o = true) => {
  ...
  Ju = {},
  Wu = Symbol.for("HA focus target"),
  Qu = async (e, t, o, r, i, a = !0) => {
    var n;
    if (!(o in Ju)) {
      if (!i)
        return void (
    ...
    if (
      ...
      rt.history.replaceState(
        {
          ...
          open: !1,
          oldState:
            null !== (s = rt.history.state) &&
            void 0 !== s &&
            s.open &&
            (null === (l = rt.history.state) || void 0 === l
              ? void 0
              : l.dialog) !== o
              ? rt.history.state
              : null,
      ...
      try {
        rt.history.pushState({ dialog: o, dialogParams: r, open: !0 }, "");
      } catch (e) {
        rt.history.pushState({ dialog: o, dialogParams: null, open: !0 }, "");
      }
    }
    const d = await Ju[o].element;
    d.addEventListener("dialog-closed", eh), t.appendChild(d), d.showDialog(r);
  },
  eh = async (e) => {
    const t = Ju[e.detail.dialog].closedFocusTargets;
    if ((delete Ju[e.detail.dialog].closedFocusTargets, !t)) return;
    let o = Yu();
    o instanceof HTMLElement && o.blur(), await Xu();
    for (const e of t)
      if (
        e instanceof HTMLElement &&
        (e.focus(), (o = Yu()), o && o !== document.body)
      )
        return;
    __DEV__ &&
  ...
  th = (e, t) => {
    ...
    o
      ? rt.history.replaceState(
          null !== (r = rt.history.state) && void 0 !== r && r.root
            ? { root: !0 }
            : null,
          "",
          e
        )
      : rt.history.pushState(null, "", e),
      it(rt, "location-changed", { replace: o });
  },
  oh = bn`
<custom-style>
  <style is="custom-style">
...
`;
oh.setAttribute("style", "display: none;"),
  document.head.appendChild(oh.content);
const rh = bn`
<custom-style>
  <style is="custom-style">
    html {
...
rh.setAttribute("style", "display: none;"),
  document.head.appendChild(rh.content);
const ih = bn`
<custom-style>
  <style is="custom-style">
    html {
...
ih.setAttribute("style", "display: none;"),
  document.head.appendChild(ih.content);
const ah = bn`<custom-style>
  <style is="custom-style">
    html {
              ...
              e.forEach((e, t) => {
                ...
                "hass" === t &&
                  (this.sidebarDocked =
                    ...
                    (null === (o = window) ||
                    void 0 === o ||
                    null === (r = o.localStorage) ||
                    void 0 === r
                      ? void 0
                      : r.getItem("dockedSidebar")));
              }),
              e.has("sidebarDocked") ||
                e.has("narrow") ||
                e.has("active") ||
          ...
          value: function () {
            ...
            r(t(i.prototype), "connectedCallback", this).call(this),
              (this.sidebarDocked =
                ...
                (null === (e = window) ||
                void 0 === e ||
                null === (o = e.localStorage) ||
                void 0 === o
                  ? void 0
                  : o.getItem("dockedSidebar")));
          },
        },
      ],
    };
...
const lh = {
  "custom-repositories": () => import("./c.7a44e681.js"),
  generic: () => import("./c.cde53df3.js"),
  download: () => import("./c.3cd443fb.js"),
  progress: () => import("./c.9f8c12a9.js"),
};
let dh;
s(
...
const ch = async (e) => e.connection.sendMessagePromise({ type: "hacs/info" }),
  ph = async (e) =>
  ...
  yh = (e) => e.connection.sendMessagePromise({ type: "lovelace/resources" }),
  bh = (e, t) => e.callWS({ type: "lovelace/resources/create", ...t }),
  vh = (e, t) => e.callWS({ type: "lovelace/resources/update", ...t }),
  Ch = (e, t) =>
  ...
  wh = (e, t) => {
    ...
    if (
      ...
      return !0;
    const i = Hh({ repository: t, skipTag: !0 });
    return (
...
var Vh, kh, Mh;
function xh(e) {
  return e.type === kh.literal;
}
function Sh(e) {
  return e.type === kh.argument;
}
function Eh(e) {
  return e.type === kh.number;
}
function Ph(e) {
  return e.type === kh.date;
}
function Th(e) {
  return e.type === kh.time;
}
function zh(e) {
  return e.type === kh.select;
}
function Nh(e) {
  return e.type === kh.plural;
}
function Oh(e) {
  return e.type === kh.pound;
}
function Rh(e) {
  return e.type === kh.tag;
}
function Ih(e) {
  return !(!e || "object" != typeof e || e.type !== Mh.number);
}
function Dh(e) {
  return !(!e || "object" != typeof e || e.type !== Mh.dateTime);
}
!(function (e) {
  ...
  for (var t = {}, o = 0, r = e; o < r.length; o++) {
    ...
    switch (i.stem) {
      ...
      case "integer-width":
        ...
        i.options[0].replace(Gh, function (e, o, r, i, a, n) {
    ...
    if (qh.test(i.stem)) t.minimumIntegerDigits = i.stem.length;
    else if (Uh.test(i.stem)) {
      if (i.options.length > 1)
        throw new RangeError(
          "Fraction-precision stems only accept a single optional option"
        );
      i.stem.replace(Uh, function (e, o, r, i, a, n) {
        return (
          "*" === r
      ...
      var a = i.options[0];
      "w" === a
        ? (t = On(On({}, t), { trailingZeroDisplay: "stripIfInteger" }))
        : a && (t = On(On({}, t), Kh(a)));
    } else if (Zh.test(i.stem)) t = On(On({}, t), Kh(i.stem));
    else {
      var n = Yh(i.stem);
      n && (t = On(On({}, t), n));
      var s = Xh(i.stem);
...
function tm(e) {
  ...
  return (
    ...
    (em[o || ""] || em[r || ""] || em["".concat(r, "-001")] || em["001"])[0]
  );
}
var om = new RegExp("^".concat(jh.source, "*")),
  rm = new RegExp("".concat(jh.source, "*$"));
function im(e, t) {
  return { start: e, end: t };
}
var am = !!String.prototype.startsWith,
  nm = !!String.fromCodePoint,
  sm = !!Object.fromEntries,
  lm = !!String.prototype.codePointAt,
  dm = !!String.prototype.trimStart,
  cm = !!String.prototype.trimEnd,
  pm = !!Number.isSafeInteger
...
try {
  um =
    "a" ===
    (null ===
      (Qh = vm("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu").exec("a")) ||
    void 0 === Qh
      ? void 0
      : Qh[0]);
} catch (U) {
...
if (um) {
  var Cm = vm("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu");
  hm = function (e, t) {
    var o;
    return (
      (Cm.lastIndex = t), null !== (o = Cm.exec(e)[1]) && void 0 !== o ? o : ""
    );
  };
} else
  hm = function (e, t) {
    for (var o = []; ; ) {
      var r = fm(e, t);
      if (void 0 === r || Lm(r) || Vm(r)) break;
      o.push(r), (t += r >= 65536 ? 2 : 1);
    }
    return _m.apply(void 0, o);
  };
var Am = (function () {
  function e(e, t) {
    void 0 === t && (t = {}),
  ...
  return (
        ...
        if (123 === i) {
          ...
          if (35 !== i || ("plural" !== t && "selectordinal" !== t)) {
            if (60 === i && !this.ignoreTag && 47 === this.peek()) {
              if (o) break;
              return this.error(
                Vh.UNMATCHED_CLOSING_TAG,
                im(this.clonePosition(), this.clonePosition())
              );
            }
            if (60 === i && !this.ignoreTag && Hm(this.peek() || 0)) {
            ...
            this.bump(),
              r.push({ type: kh.pound, location: im(n, this.clonePosition()) });
          }
        }
      }
      ...
      if ((this.bumpSpace(), this.bumpIf("/>")))
        return {
          val: {
            type: kh.literal,
            value: "<".concat(r, "/>"),
            location: im(o, this.clonePosition()),
          },
          err: null,
        };
      if (this.bumpIf(">")) {
        ...
        if (this.bumpIf("</")) {
          if (this.isEOF() || !Hm(this.char()))
            return this.error(Vh.INVALID_TAG, im(n, this.clonePosition()));
          var s = this.clonePosition();
          return r !== this.parseTagName()
            ? this.error(Vh.UNMATCHED_CLOSING_TAG, im(s, this.clonePosition()))
            : (this.bumpSpace(),
              this.bumpIf(">")
                ? {
                    val: {
                ...
                : this.error(Vh.INVALID_TAG, im(n, this.clonePosition())));
        }
        return this.error(Vh.UNCLOSED_TAG, im(o, this.clonePosition()));
      }
      return this.error(Vh.INVALID_TAG, im(o, this.clonePosition()));
    }),
    (e.prototype.parseTagName = function () {
      var e = this.offset();
      for (this.bump(); !this.isEOF() && wm(this.char()); ) this.bump();
    ...
    (e.prototype.parseLiteral = function (e, t) {
      ...
      var s = im(o, this.clonePosition());
      return { val: { type: kh.literal, value: r, location: s }, err: null };
    }),
    (e.prototype.tryParseLeftAngleBracket = function () {
      return this.isEOF() ||
        60 !== this.char() ||
        (!this.ignoreTag && (Hm((e = this.peek() || 0)) || 47 === e))
        ? null
        : (this.bump(), "<");
      var e;
    }),
    ...
    (e.prototype.parseArgument = function (e, t) {
      ...
      if ((this.bump(), this.bumpSpace(), this.isEOF()))
        return this.error(
          Vh.EXPECT_ARGUMENT_CLOSING_BRACE,
          im(o, this.clonePosition())
        );
      if (125 === this.char())
        return (
          this.bump(),
          this.error(Vh.EMPTY_ARGUMENT, im(o, this.clonePosition()))
        );
      var r = this.parseIdentifierIfPossible().value;
      if (!r)
        return this.error(Vh.MALFORMED_ARGUMENT, im(o, this.clonePosition()));
    ...
    (e.prototype.parseIdentifierIfPossible = function () {
      var e = this.clonePosition(),
        ...
        r = t + o.length;
      return (
        this.bumpTo(r), { value: o, location: im(e, this.clonePosition()) }
      );
    }),
    (e.prototype.parseArgumentOptions = function (e, t, o, r) {
      ...
      switch (n) {
        case "":
          return this.error(Vh.EXPECT_ARGUMENT_TYPE, im(a, s));
        case "number":
        case "date":
        case "time":
          this.bumpSpace();
          ...
          if (this.bumpIf(",")) {
            ...
            if (0 === (h = bm(f.val)).length)
              return this.error(
                Vh.EXPECT_ARGUMENT_STYLE,
                im(this.clonePosition(), this.clonePosition())
              );
            l = { style: h, styleLocation: im(d, this.clonePosition()) };
          }
          if ((y = this.tryParseArgumentClose(r)).err) return y;
          var c = im(r, this.clonePosition());
          if (l && mm(null == l ? void 0 : l.style, "::", 0)) {
            var p = ym(l.style.slice(2));
            if ("number" === n)
            ...
            if (0 === p.length)
              return this.error(Vh.EXPECT_DATE_TIME_SKELETON, c);
            var u = p;
            this.locale &&
              (u = (function (e, t) {
            ...
            var h = {
              ...
              parsedOptions: this.shouldParseSkeletons ? $h(u) : {},
            };
            return {
              val: {
                type: "date" === n ? kh.date : kh.time,
                value: o,
                location: c,
                style: h,
              },
          ...
          return {
            val: {
              type:
                "number" === n ? kh.number : "date" === n ? kh.date : kh.time,
              value: o,
              location: c,
              style:
        ...
        case "select":
          ...
          if ((this.bumpSpace(), !this.bumpIf(",")))
            return this.error(
              Vh.EXPECT_SELECT_ARGUMENT_OPTIONS,
              im(m, On({}, m))
            );
          this.bumpSpace();
          ...
          if ("select" !== n && "offset" === _.value) {
            if (!this.bumpIf(":"))
              return this.error(
                Vh.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,
                im(this.clonePosition(), this.clonePosition())
              );
            var f;
            if (
              ...
              (f = this.tryParseDecimalInteger(
                Vh.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,
                Vh.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE
              )).err)
            )
              return f;
            this.bumpSpace(),
        ...
        default:
          return this.error(Vh.INVALID_ARGUMENT_TYPE, im(a, s));
      }
    }),
      ...
      for (var e = 0, t = this.clonePosition(); !this.isEOF(); ) {
        switch (this.char()) {
          case 39:
            ...
            if (!this.bumpUntil("'"))
              return this.error(
                Vh.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE,
                im(o, this.clonePosition())
              );
            this.bump();
            break;
    ...
    (e.prototype.parseNumberSkeletonFromString = function (e, t) {
      ...
      try {
        o = (function (e) {
          ...
          for (
            var t = e.split(Fh).filter(function (e) {
                return e.length > 0;
              }),
              o = [],
              r = 0,
      ...
      return {
        val: {
          ...
          tokens: o,
          location: t,
          parsedOptions: this.shouldParseSkeletons ? Wh(o) : {},
        },
        err: null,
      };
    }),
    (e.prototype.tryParsePluralOrSelectOptions = function (e, t, o, r) {
      for (
        ...
        if (0 === l.length) {
          ...
          var p = this.tryParseDecimalInteger(
            Vh.EXPECT_PLURAL_ARGUMENT_SELECTOR,
            Vh.INVALID_PLURAL_ARGUMENT_SELECTOR
          );
          if (p.err) return p;
          (d = im(c, this.clonePosition())),
            (l = this.message.slice(c.offset, this.offset()));
        }
        if (s.has(l))
          return this.error(
            "select" === t
              ? Vh.DUPLICATE_SELECT_ARGUMENT_SELECTOR
              : Vh.DUPLICATE_PLURAL_ARGUMENT_SELECTOR,
            d
          );
        ...
        if (!this.bumpIf("{"))
          return this.error(
            "select" === t
              ? Vh.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT
              : Vh.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT,
            im(this.clonePosition(), this.clonePosition())
          );
        ...
        if (m.err) return m;
        n.push([l, { value: h.val, location: im(u, this.clonePosition()) }]),
          s.add(l),
          this.bumpSpace(),
      ...
      return 0 === n.length
        ? this.error(
            "select" === t
              ? Vh.EXPECT_SELECT_ARGUMENT_SELECTOR
              : Vh.EXPECT_PLURAL_ARGUMENT_SELECTOR,
            im(this.clonePosition(), this.clonePosition())
          )
        : this.requiresOtherClause && !a
        ? this.error(
            Vh.MISSING_OTHER_CLAUSE,
            im(this.clonePosition(), this.clonePosition())
          )
        : { val: n, err: null };
    }),
    ...
    (e.prototype.bumpIf = function (e) {
      if (mm(this.message, e, this.offset())) {
    ...
    (e.prototype.bumpSpace = function () {
      for (; !this.isEOF() && Lm(this.char()); ) this.bump();
    }),
...
function km(e) {
  e.forEach(function (e) {
    if ((delete e.location, zh(e) || Nh(e)))
      for (var t in e.options)
        delete e.options[t].location, km(e.options[t].value);
    else
      (Eh(e) && Ih(e.style)) || ((Ph(e) || Th(e)) && Dh(e.style))
...
function Mm(e, t) {
  void 0 === t && (t = {}),
    (t = On({ shouldParseSkeletons: !0, requiresOtherClause: !0 }, t));
  var o = new Am(e, t).parse();
  if (o.err) {
    var r = SyntaxError(Vh[o.err.kind]);
    throw (
      ((r.location = o.err.location), (r.originalMessage = o.err.message), r)
    );
  }
  return (null == t ? void 0 : t.captureLocation) || km(o.val), o.val;
}
function xm(e, t) {
  var o = t && t.cache ? t.cache : Rm,
    r = t && t.serializer ? t.serializer : zm;
  return (t && t.strategy ? t.strategy : Tm)(e, { cache: o, serializer: r });
}
function Sm(e, t, o, r) {
  var i,
    a =
...
function Pm(e, t, o, r, i) {
  return o.bind(t, e, r, i);
}
function Tm(e, t) {
  return Pm(e, this, 1 === e.length ? Sm : Em, t.cache.create(), t.serializer);
}
var zm = function () {
...
var Om,
  ...
  Im = {
    variadic: function (e, t) {
      return Pm(e, this, Em, t.cache.create(), t.serializer);
    },
    monadic: function (e, t) {
      return Pm(e, this, Sm, t.cache.create(), t.serializer);
    },
  };
!(function (e) {
...
function Zm(e, t, o, r, i, a, n) {
  if (1 === e.length && xh(e[0]))
    return [{ type: Dm.literal, value: e[0].value }];
  for (var s = [], l = 0, d = e; l < d.length; l++) {
    var c = d[l];
    if (xh(c)) s.push({ type: Dm.literal, value: c.value });
    else if (Oh(c))
      "number" == typeof a &&
        s.push({ type: Dm.literal, value: o.getNumberFormat(t).format(a) });
    else {
      var p = c.value;
      if (!i || !(p in i)) throw new Fm(p, n);
      var u = i[p];
      if (Sh(c))
        (u && "string" != typeof u && "number" != typeof u) ||
          (u = "string" == typeof u || "number" == typeof u ? String(u) : ""),
          s.push({
            type: "string" == typeof u ? Dm.literal : Dm.object,
            value: u,
          });
      else if (Ph(c)) {
        var h =
        ...
        if (Rh(c)) {
          var m = c.children,
            _ = c.value,
            g = i[_];
          if (!Um(g)) throw new $m(_, "function", n);
          var f = g(
            Zm(m, t, o, r, i, a).map(function (e) {
              return e.value;
            })
          );
          Array.isArray(f) || (f = [f]),
            s.push.apply(
              ...
              f.map(function (e) {
                return {
                  type: "string" == typeof e ? Dm.literal : Dm.object,
                  value: e,
                };
              })
            );
        ...
        if (zh(c)) {
          if (!(y = c.options[u] || c.options.other))
            throw new Bm(c.value, u, Object.keys(c.options), n);
          s.push.apply(s, Zm(y.value, t, o, r, i));
        } else if (Nh(c)) {
          var y;
          ...
          if (!y) throw new Bm(c.value, u, Object.keys(c.options), n);
          s.push.apply(s, Zm(y.value, t, o, r, i, u - (c.offset || 0)));
        } else;
      }
    }
  }
  return (function (e) {
    return e.length < 2
      ...
      : e.reduce(function (e, t) {
          var o = e[e.length - 1];
          return (
            o && o.type === Dm.literal && t.type === Dm.literal
              ? (o.value += t.value)
              : e.push(t),
            e
          );
        ...
        (this.formatters =
            ...
            (a = { number: {}, dateTime: {}, pluralRules: {} }),
          {
            getNumberFormat: xm(
              ...
              { cache: qm(a.number), strategy: Im.variadic }
            ),
            getDateTimeFormat: xm(
              ...
              { cache: qm(a.dateTime), strategy: Im.variadic }
            ),
            getPluralRules: xm(
              function () {
                for (var e, t = [], o = 0; o < arguments.length; o++)
              ...
              { cache: qm(a.pluralRules), strategy: Im.variadic }
            ),
          }));
    }
    return (
...
const Xm = {
    bg_BG: {
      ...
      "my.add_repository_description":
        "Това ще добави персонализираното хранилище ''{repository}'', което ще бъде проследявано от HACS, искате ли да го добавите?",
      ...
      "my.faq_link": "Често задавани въпроси за моя домашен помощник",
      "my.not_supported":
        "Това пренасочване не се поддържа. Проверете {link} за поддържаните пренасочвания и версията, която са въведени.",
      ...
      "repository_status.pending-restart": "Чакащи рестартиране",
      "repository_status.pending-upgrade": "Чакащи актуализация",
    },
    cs: {
      "column.available_version": "Dostupná verze",
      "column.category": "Kategorie",
      "column.downloads": "Staženo",
      "column.installed_version": "Stažená verze",
      "column.last_updated": "Aktualizováno",
      "column.name": "Název repozitáře",
      "column.stars": "Hodnocení",
      "column.status": "Stav",
      "common.add": "přidat",
      "common.cancel": "Zrušit",
      "common.close": "Zavřít",
      "common.download": "Stáhnout",
      "common.downloaded": "Staženo",
      "common.explore": "Prozkoumejte a stáhněte si repozitáře",
      ...
      "dialog.configured.message":
        "Integrace {name} je nakonfigurována nebo ignorována, před jejím odebráním z HACS je nutné její konfiguraci smazat",
      ...
      "dialog_add_repo.sort_by_values.last_updated": "Naposledy aktualizováno",
      "dialog_add_repo.sort_by_values.name": "Název",
      "dialog_add_repo.sort_by_values.stars": "Hodnocení",
      ...
      "dialog_download.lovelace_instruction":
        "Po dokončení stahování, protože Lovelace nepoužíváte v režimu úložiště, musíte ručně přidat zdroj s těmito nastaveními:",
      "dialog_download.note_downloaded":
        "Po stažení se bude nacházet v {location}",
      "dialog_download.restart":
        "Nezapomeňte, že změny integrace (custom_components) se projeví až po restartu Home Assistant.",
      ...
      "dialog_info.download": "Stáhněte si toto úložiště pomocí HACS",
      ...
      "my.add_repository_description":
        "Tím přidáte vlastní repozitář ''{repository}'', který bude sledován HACS, chcete ho přidat?",
      "my.add_repository_title": "Přidat vlastní repozitář",
      "my.documentation": "dokumentace",
      "my.error": "Nastala neznámá chyba",
      "my.faq_link": "Nejčastější dotazy k aplikaci My Home Assistant",
      "my.not_supported":
        "Toto přesměrování není podporováno. Podívejte se na {link} , kde najdete podporovaná přesměrování a verzi, ve které byla zavedena.",
      "my.repository_not_found": "Repozitář {repository} nenalezen",
      ...
      "repository_status.pending-restart": "Čeká se na restart",
      "repository_status.pending-upgrade": "Čeká na aktualizaci",
    },
    da: {
      "column.available_version": "Tilgængelig version",
      "column.category": "Kategori",
      "column.downloads": "Antal downloads",
      "column.installed_version": "Downloadet version",
      "column.last_updated": "Sidst opdateret",
      "column.name": "Repository-navn",
      "column.stars": "Antal stjerner",
      "column.status": "Status",
      "common.add": "tilføj",
      "common.cancel": "Annuller",
      "common.close": "Luk",
      "common.download": "Download",
      "common.downloaded": "Downloadet",
      "common.explore": "Udforsk og download repositories",
      "common.ignore": "Ignorér",
      ...
      "dialog.configured.message":
        "{name}-integrationen er konfigureret eller ignoreret. Du skal slette konfigurationen til den, før du fjerner den fra HACS",
      "dialog.configured.title": "Integrationen er konfigureret",
      "dialog.reload.confirm": "Vil du gøre det nu?",
      "dialog.reload.description":
        "Du skal genindlæse siden i din browser for at de opdaterede ressourcer tages i brug.",
      "dialog.remove.message": "Ønsker du at fjerne {name}?",
      "dialog.remove.title": "Fjern",
      "dialog_about.downloaded_repositories": "Hentede repositories",
      ...
      "dialog_add_repo.sort_by_values.last_updated": "Senest opdateret",
      "dialog_add_repo.sort_by_values.name": "Navn",
      "dialog_add_repo.sort_by_values.stars": "Antal stjerner",
      ...
      "dialog_download.lovelace_instruction":
        "Når overførslen er færdig, skal du manuelt tilføje ressourcen med disse indstillinger, da du ikke bruger Lovelace i lagringstilstand:",
      "dialog_download.note_downloaded":
        "Når den er downloadet, vil den være placeret i {location}",
      "dialog_download.restart":
        "Husk at du skal genstarte Home Assistant før ændringer til integrationer (custom_components) træder i kraft.",
      "dialog_download.select_version": "Vælg version",
      "dialog_download.show_beta": "Vis betaversioner",
      "dialog_download.type": "Type",
      "dialog_download.url": "URL",
      "dialog_info.author": "Udvikler",
      "dialog_info.download": "Download dette repository med HACS",
      ...
      "dialog_info.version_installed": "Installeret version",
      "dialog_update.available_version": "Tilgængelig version",
      "dialog_update.changelog": "Udgivelsesnoter",
      "dialog_update.downloaded_version": "Downloadet version",
      "dialog_update.message": "En ny version af {name} er tilgængelig",
      "dialog_update.no_info":
        "Forfatteren har ikke givet nogen oplysninger om denne udgivelse",
      ...
      "my.add_repository_description":
        "Dette vil tilføje det brugerdefinerede repository ''{repository}'' til HACS. Vil du tilføje det?",
      "my.add_repository_title": "Tilføj brugerdefineret repository",
      "my.documentation": "dokumentation",
      "my.error": "Der opstod en ukendt fejl",
      "my.faq_link": "Min FAQ om Home Assistant",
      "my.not_supported":
        "Denne omdirigering er ikke understøttet. Tjek {link} for de understøttede omdirigeringer og den version, de blev introduceret.",
      "my.repository_not_found": "Repository {repository} blev ikke fundet",
      ...
      "repository_card.redownload": "Download igen",
      "repository_card.report": "Rapporter til fjernelse",
      "repository_card.update_information": "Opdater oplysninger",
      "repository_status.pending-restart": "Afventer genstart",
      "repository_status.pending-upgrade": "Ventende opdatering",
    },
    de: {
      "column.available_version": "Verfügbare Version",
      "column.category": "Kategorie",
      "column.downloads": "Downloads",
      "column.installed_version": "Heruntergeladene Version",
      "column.last_updated": "Aktualisiert",
      ...
      "common.explore": "Repositories durchsuchen und herunterladen",
      ...
      "repository_status.pending-restart": "Ausstehender Neustart",
      "repository_status.pending-upgrade": "Ausstehende Aktualisierung",
    },
    el: {
      "common.appdaemon": "AppDaemon",
    ...
    en: {
      "column.available_version": "Available version",
      "column.category": "Category",
      "column.downloads": "Downloads",
      "column.installed_version": "Downloaded version",
      ...
      "repository_status.pending-restart": "Pending restart",
      "repository_status.pending-upgrade": "Pending update",
    },
    es: {
    ...
    et: {
      "column.available_version": "Saadaolev versioon",
      "column.category": "Kategooria",
      "column.downloads": "Allalaadimised",
      "column.installed_version": "Allalaaditud versioon",
      "column.last_updated": "Uuendatud",
      ...
      "common.downloaded": "Allalaaditud",
      "common.explore": "Avasta ja laadi alla hoidlaid",
      "common.ignore": "Eira",
      ...
      "repository_status.pending-restart": "Taaskäivitamise ootel",
      "repository_status.pending-upgrade": "Värskendamise ootel",
    },
    fi: {
      "column.available_version": "Saatavilla oleva versio",
      "column.category": "Kategoria",
      "column.downloads": "Lataukset",
      "column.installed_version": "Ladattu versio",
      "column.last_updated": "Päivitetty",
      "column.name": "Repon nimi",
      "column.stars": "Tähdet",
      "column.status": "Tila",
      "common.add": "Lisää",
      ...
      "common.explore": "Selaa & lataa repoja",
      "common.ignore": "Ohita",
      ...
      "common.new": "Uusi",
      "common.plugin": "Lovelace",
      "common.python_script": "Python-skripti",
      ...
      "common.updates": "Päivitykset",
      "common.yes": "Kyllä",
      "dialog.configured.confirm": "Siirry integraatioihin",
      "dialog.configured.message":
        "Integrointi {name} on määritetty tai ohitettu, sinun on poistettava sen määritykset ennen sen poistamista HACS:sta",
      "dialog.configured.title": "Integraatio on määritetty",
      "dialog.reload.confirm": "Haluatko tehdä sen nyt?",
      "dialog.reload.description":
        "Sinun on ladattava selaimesi uudelleen, jotta päivitetyt resurssit voidaan käyttää.",
      "dialog.remove.message": "Haluatko varmasti poistaa {name}?",
      "dialog.remove.title": "Poista",
      "dialog_about.downloaded_repositories": "Ladatut repot",
      ...
      "dialog_add_repo.sort_by_values.last_updated": "Päivitetty viimeksi",
      "dialog_add_repo.sort_by_values.name": "Nimi",
      "dialog_add_repo.sort_by_values.stars": "Tähdet",
      ...
      "dialog_download.restart":
        "Muista, että sinun on käynnistettävä Home Assistant uudelleen ennen kuin muutokset integraatioihin (custom_components) otetaan käyttöön.",
      "dialog_download.select_version": "Valitse versio",
      "dialog_download.show_beta": "Näytä betaversiot",
      "dialog_download.type": "Tyyppi",
      "dialog_download.url": "URL",
      "dialog_info.author": "Luoja",
      "dialog_info.download": "Lataa tämä repo HACS:n avulla",
      ...
      "dialog_info.version_installed": "Versio ladattu",
      "dialog_update.available_version": "Saatavilla oleva versio",
      "dialog_update.changelog": "Muutosloki",
      "dialog_update.downloaded_version": "Ladattu versio",
      "dialog_update.message": "Tuotteesta {name} on saatavilla uusi versio",
      "dialog_update.no_info":
        "Kirjoittaja ei ole antanut mitään tietoja tästä julkaisusta.",
      "dialog_update.releasenotes": "{release}:n julkaisutiedot",
      ...
      "my.add_repository_title": "Lisää kustomoitu repo",
      "my.documentation": "dokumentaatio",
      "my.error": "Tuntematon virhe",
      "my.faq_link": "Home Assistant UKK",
      "my.repository_not_found": "Repoa {repository} ei löytynyt",
      ...
      "repository_card.redownload": "Lataa uudelleen",
      "repository_card.report": "Raportoi poistettavaksi",
      "repository_card.update_information": "Päivitä tiedot",
      "repository_status.pending-restart": "Odottaa uudelleenkäynnistystä",
      "repository_status.pending-upgrade": "Odottaa päivittämistä",
    },
    fr: {
      "column.available_version": "Version disponible",
      "column.category": "Catégorie",
      "column.downloads": "Téléchargements",
      "column.installed_version": "Version téléchargée",
      "column.last_updated": "Actualisé",
      "column.name": "Nom du référentiel",
      "column.stars": "Étoiles",
      ...
      "common.explore": "Explorer et télécharger des référentiels",
      ...
      "my.add_repository_description":
        "Cela ajoutera le référentiel personnalisé ''{repository}'' à suivre par HACS, voulez-vous l'ajouter ?",
      "my.add_repository_title": "Ajouter un référentiel personnalisé",
      "my.documentation": "documentation",
      "my.error": "Une erreur inconnue est survenue",
      "my.faq_link": "Mon Home Assistant FAQ",
      "my.not_supported":
        "Cette redirection n'est pas prise en charge. Vérifiez-le {link} pour les redirections prises en charge et la version qu'ils ont introduite.",
      "my.repository_not_found": "Référentiel {repository} introuvable",
      ...
      "repository_status.pending-restart": "En attente de redémarrage",
      "repository_status.pending-upgrade": "En attente de mise à jour",
    },
    he: {
      "column.available_version": "גירסה זמינה",
      "column.category": "קטגוריה",
      "column.downloads": "הורדות",
      "column.installed_version": "גרסה שהורדה",
      "column.last_updated": "מעודכן",
      ...
      "common.explore": "חקירה והורדת מאגרים",
      "common.ignore": "להתעלם",
      "common.integration": "שילוב",
      "common.integration_plural": "אינטגרציה",
      "common.lovelace": "Lovelace",
      "common.netdaemon": "NetDaemon",
      "common.new": "חדש",
      "common.plugin": "Lovelace",
      ...
      "dialog.configured.confirm": "עבור לאינטגרציות",
      "dialog.configured.message":
      ...
      "repository_status.pending-restart": "ממתין להפעלה מחדש",
      "repository_status.pending-upgrade": "ממתין לעדכון",
    },
    hu: {
      "column.available_version": "Elérhető verzió",
      "column.category": "Kategória",
      "column.downloads": "Letöltések",
      "column.installed_version": "Letöltött verzió",
      "column.last_updated": "Frissítve",
      "column.name": "Repó neve",
      "column.stars": "Csillag",
      "column.status": "Állapot",
      ...
      "common.explore": "Repók keresése és hozzáadása",
      ...
      "repository_status.pending-restart": "Újraindítás függőben",
      "repository_status.pending-upgrade": "Frissítés függőben",
    },
    it: {
      "column.available_version": "Versione disponibile",
      "column.category": "Categoria",
      "column.downloads": "Scaricamenti",
      "column.installed_version": "Versione scaricata",
      "column.last_updated": "Aggiornato",
      "column.name": "Nome archivio digitale",
      "column.stars": "Stelle",
      "column.status": "Stato",
      "common.add": "aggiungi",
      "common.appdaemon": "AppDaemon",
      ...
      "common.explore": "Esplora e scarica gli archivi digitali",
      ...
      "common.repositories": "Archivi digitali",
      "common.repository": "Archivio digitale",
      "common.show": "Mostra",
      "common.theme": "Tema",
      ...
      "common.yes": "Sì",
      "confirm.home_assistant_version_not_correct":
        "Stai eseguendo la versione ''{haversion}'' di Home Assistant, ma questo archivio digitale richiede la versione minima ''{minversion}'' per essere installato.",
      ...
      "dialog_about.downloaded_repositories": "Archivi digitali scaricati",
      ...
      "dialog_add_repo.no_match":
        "Non sono stati trovati archivi digitali corrispondenti al tuo filtro",
      ...
      "dialog_add_repo.title": "Aggiungi archivio digitale",
      "dialog_custom_repositories.category": "Categoria",
      "dialog_custom_repositories.no_category": "Categoria mancante",
      "dialog_custom_repositories.no_repository": "Archivio digitale mancante",
      "dialog_custom_repositories.title": "Archivi digitali personalizzati",
      "dialog_custom_repositories.url_placeholder":
        "Aggiungi l'URL dell'archivio digitale personalizzato",
      "dialog_download.lovelace_instruction":
      ...
      "dialog_info.download": "Scarica questo archivio digitale con HACS",
      "dialog_info.downloads": "Download",
      "dialog_info.loading": "Caricamento informazioni...",
      "dialog_info.no_info":
        "Lo sviluppatore non ha fornito ulteriori informazioni per questo archivio digitale",
      "dialog_info.open_issues": "Problemi irrisolti",
      "dialog_info.open_repo": "Apri l'archivio digitale",
      ...
      "menu.custom_repositories": "Archivi digitali personalizzati",
      "menu.dismiss": "Nascondi nuovi archivi digitali",
      "menu.documentation": "Documentazione",
      "menu.open_issue": "Problemi irrisolti",
      "menu.reload": "Ricarica la finestra",
      "my.add_repository_description":
        "Questo aggiungerà l'archivio digitale personalizzato ''{repository}'' per essere monitorato da HACS, vuoi aggiungerlo?",
      "my.add_repository_title": "Aggiungi archivio digitale personalizzato",
      ...
      "my.repository_not_found": "Archivio digitale {repository} non trovato",
      "repository_card.dismiss": "nascondi",
      "repository_card.information": "Informazioni",
      "repository_card.new_repository": "Nuovo archivio digitale",
      ...
      "repository_status.pending-restart": "In attesa di riavvio",
      "repository_status.pending-upgrade": "In attesa di aggiornamento",
    },
    nb: {
      "column.available_version": "Tilgjengelig versjon",
      "column.category": "Kategori",
      "column.downloads": "Nedlastinger",
      "column.installed_version": "Nedlastet versjon",
      ...
      "repository_status.pending-restart": "Venter på omstart",
      "repository_status.pending-upgrade": "Venter på oppdatering",
    },
    nl: {
      "column.available_version": "Beschikbare versie",
      "column.category": "Categorie",
      "column.downloads": "Downloads",
      "column.installed_version": "Gedownloade versie",
      "column.last_updated": "Bijgewerkt",
      "column.name": "Naam van repository",
      "column.stars": "Sterren",
      "column.status": "Status",
      ...
      "common.explore": "Verken & download repositories",
      ...
      "my.documentation": "documentatie",
      "my.error": "Er is een onbekende fout opgetreden",
      "my.repository_not_found": "Repository {repository} niet gevonden",
    ...
    pl: {
      "column.category": "Kategoria",
      "column.downloads": "Pobieranie",
      "column.last_updated": "Zaktualizowano",
      "column.name": "Nazwa repozytorium",
      "column.stars": "Gwiazdki",
      "common.add": "dodaj",
      "common.appdaemon": "AppDaemon",
      "common.cancel": "Anuluj",
      "common.close": "Zamknij",
      "common.download": "Pobierz",
      "common.downloaded": "Pobrane",
      "common.explore": "Przeglądaj i pobieraj repozytoria",
      ...
      "common.new": "Nowy",
      "common.plugin": "Lovelace",
      "common.python_script": "Skrypt Python",
      ...
      "dialog_download.restart":
        "Pamiętaj, że musisz ponownie uruchomić Home Assistant by zastosować zmiany w integracjach (custom_components).",
      ...
      "my.add_repository_description":
        "Spowoduje to dodanie niestandardowego repozytorium  ''{repository}'' , które będzie śledzone przez system HACS. Czy chcesz je dodać?",
      "my.add_repository_title": "Dodaj niestandardowe repozytorium",
      "my.documentation": "dokumentacja",
      "my.error": "Wystąpił nieznany błąd",
      "my.faq_link": "My Home Assistant FAQ",
      "my.not_supported":
        "To przekierowanie nie jest obsługiwane. Sprawdź {link}, aby zobaczyć obsługiwane przekierowania i wersję, w której zostały wprowadzone.",
      "my.repository_not_found": "Nie znaleziono repozytorium {repository}",
    ...
    pt_BR: {
      "column.available_version": "Versão disponível",
      "column.category": "Categoria",
      "column.downloads": "Downloads",
      "column.installed_version": "Versão baixada",
      ...
      "repository_status.pending-restart": "Reinicialização pendente",
      "repository_status.pending-upgrade": "Atualização pendente",
    },
    pt: {
      "common.add": "adicionar",
      "common.cancel": "Cancelar",
    ...
    ru: {
      ...
      "my.documentation": "документация",
      "my.error": "Произошла неизвестная ошибка",
    ...
    sk: {
      "column.available_version": "Dostupná verzia",
      "column.category": "Kategória",
      "column.downloads": "Stiahnuté",
      "column.installed_version": "Stiahnutá verzia",
      "column.last_updated": "Aktualizované",
      "column.name": "Názov úložiska",
      "column.stars": "Hodnotenie",
      "column.status": "Stav",
      "common.add": "pridať",
      "common.cancel": "Zrušiť",
      "common.close": "Zavrieť",
      "common.download": "Stiahnuť",
      "common.downloaded": "Stiahnuté",
      "common.explore": "Preskúmanie a prevzatie úložísk",
      "common.ignore": "Ignorovať",
      "common.integration": "Integrácia",
      "common.integration_plural": "Integrácie",
      "common.lovelace": "Lovelace",
      "common.netdaemon": "NetDaemon",
      "common.new": "Nový",
      "common.plugin": "Lovelace",
      ...
      "common.repositories": "Úložiská",
      "common.repository": "Úložisko",
      "common.show": "Zobraziť",
      "common.theme": "Téma",
      "common.update": "Aktualizácia",
      "common.updates": "Aktualizácie",
      "common.yes": "Áno",
      "confirm.home_assistant_version_not_correct":
        "Používate verziu Home Assistant ''{haversion}'', ale tento repozitár vyžaduje inštaláciu minimálnej verzie ''{minversion}''.",
      "dialog.configured.confirm": "Prejdite na integrácie",
      "dialog.configured.message":
        "Integrácia {name} je nakonfigurovaná alebo ignorovaná, pred jej odstránením z HACS musíte vymazať jej konfiguráciu",
      "dialog.configured.title": "Integrácia je nakonfigurovaná",
      "dialog.reload.confirm": "Chcete to urobiť teraz?",
      "dialog.reload.description":
        "Ak chcete použiť aktualizované zdroje, musíte znova načítať prehliadač.",
      "dialog.remove.message": "Naozaj chcete odstrániť {name}?",
      "dialog.remove.title": "Odstrániť",
      "dialog_about.downloaded_repositories": "Stiahnuté úložiská",
      "dialog_about.frontend_version": "Frontend verzia",
      "dialog_about.integration_version": "Verzia integrácie",
      "dialog_about.useful_links": "Užitočné odkazy",
      "dialog_add_repo.no_match":
        "Nenašli sa žiadne úložiská vyhovujúce vášmu filtru",
      "dialog_add_repo.sort_by": "Triediť podľa",
      "dialog_add_repo.sort_by_values.last_updated": "Posledná aktualizácia",
      "dialog_add_repo.sort_by_values.name": "Názov",
      "dialog_add_repo.sort_by_values.stars": "Hodnotenie",
      "dialog_add_repo.title": "Pridať úložisko",
      "dialog_custom_repositories.category": "Kategória",
      "dialog_custom_repositories.no_category": "Chýbajúca kategória",
      "dialog_custom_repositories.no_repository": "Chýbajúce úložisko",
      "dialog_custom_repositories.title": "Vlastné úložiská",
      "dialog_custom_repositories.url_placeholder":
        "Pridať vlastnú adresu URL úložiska",
      "dialog_download.lovelace_instruction":
        "Po dokončení sťahovania, keďže nepoužívate Lovelace v režime úložiska, musíte manuálne pridať zdroj s týmito nastaveniami:",
      "dialog_download.note_downloaded":
        "Po stiahnutí sa bude nachádzať v {location}",
      "dialog_download.restart":
        "Nezabudnite, že pred použitím zmien integrácií (custom_components) musíte reštartovať Home Assistant.",
      "dialog_download.select_version": "Vyberte verziu",
      "dialog_download.show_beta": "Zobraziť beta verzie",
      "dialog_download.type": "Typ",
      "dialog_download.url": "URL",
      "dialog_info.author": "Autor",
      "dialog_info.download": "Stiahnite si toto úložisko pomocou HACS",
      "dialog_info.downloads": "Stiahnuté",
      "dialog_info.loading": "Načítavajú sa informácie...",
      "dialog_info.no_info":
        "Vývojár neposkytol žiadne ďalšie informácie o tomto úložisku",
      "dialog_info.open_issues": "Otvorené problémy",
      "dialog_info.open_repo": "Otvoriť úložisko",
      "dialog_info.stars": "Hodnotenie",
      "dialog_info.version_installed": "Stiahnutá verzia",
      "dialog_update.available_version": "Dostupná verzia",
      "dialog_update.changelog": "Zoznam zmien",
      "dialog_update.downloaded_version": "Stiahnutá verzia",
      "dialog_update.message": "K dispozícii je nová verzia {name}",
      "dialog_update.no_info":
        "Autor neposkytol žiadne informácie o tomto vydaní",
      "dialog_update.releasenotes": "Poznámky k vydaniu pre {release}",
      "dialog_update.title": "Čaká sa na aktualizáciu",
      "menu.about": "O HACS",
      "menu.clear": "Vymazať všetko nové",
      "menu.custom_repositories": "Vlastné úložiská",
      "menu.dismiss": "Zrušenie nových úložísk",
      "menu.documentation": "Dokumentácia",
      "menu.open_issue": "Otvorený problém",
      "menu.reload": "Znova načítať okno",
      "my.add_repository_description":
        "Tým sa pridá vlastné úložisko ''{repository}'', ktoré bude sledovať HACS, chcete ho pridať?",
      "my.add_repository_title": "Pridať vlastné úložisko",
      "my.documentation": "dokumentácia",
      "my.error": "Vyskytla sa neznáma chyba",
      "my.faq_link": "Môj Home Assistant – najčastejšie otázky",
      "my.not_supported":
        "Toto presmerovanie nie je podporované. Pozrite si {link}, kde nájdete podporované presmerovania a verziu, v ktorej boli zavedené.",
      "my.repository_not_found": "Úložisko {repository} sa nenašlo",
      "repository_card.dismiss": "prepustenie",
      "repository_card.information": "Informácie",
      "repository_card.new_repository": "Nové úložisko",
      "repository_card.not_loaded": "Nenačítané",
      "repository_card.open_issue": "Otvorený problém",
      "repository_card.open_source": "Open source",
      "repository_card.pending_restart": "Čakajúci reštart",
      "repository_card.pending_update": "Čakajúca aktualizácia",
      "repository_card.redownload": "Opätovné stiahnutie",
      "repository_card.report": "Žiadosť o odstránenie",
      "repository_card.update_information": "Aktualizácia informácií",
      "repository_status.pending-restart": "Čakajúci reštart",
      "repository_status.pending-upgrade": "Čakajúca aktualizácia",
    },
    sl: {
      "common.add": "dodaj",
      "common.appdaemon": "AppDaemon",
    ...
    sv: {
      "column.available_version": "Tillgänglig version",
      "column.category": "Kategori",
      "column.downloads": "Nedladdningar",
      "column.installed_version": "Nedladdad version",
      "column.last_updated": "Uppdaterad",
      "column.stars": "Stjärnor",
      "column.status": "Status",
      "common.appdaemon": "AppDaemon",
      "common.cancel": "Avbryt",
      "common.close": "Stäng",
      "common.download": "Ladda ner",
      "common.downloaded": "Nedladdat",
      "common.explore": "Utforska och ladda ner repositories",
      "common.ignore": "Ignorera",
      "common.integration": "Integration",
      "common.integration_plural": "Integrationer",
      "common.netdaemon": "NetDaemon",
      "common.new": "Ny",
      ...
      "dialog_update.available_version": "Tillgänglig version",
      "dialog_update.changelog": "Ändringslogg",
      "dialog_update.downloaded_version": "Nedladdad version",
      "dialog_update.message": "En ny version av {name} är tillgänglig",
      "dialog_update.no_info":
        "Författaren har inte lämnat någon information för denna utgåva",
      "dialog_update.releasenotes": "Releaseinformation för {release}",
      "dialog_update.title": "Väntande omstart",
      "menu.about": "Om HACS",
      "menu.clear": "Rensa allt nytt",
      "menu.documentation": "Dokumentation",
      "menu.open_issue": "Rapportera problem",
      "menu.reload": "Ladda om fönstret",
      "my.documentation": "dokumentation",
      "my.error": "Ett okänt fel uppstod",
      "my.faq_link": "Min Home Assistant FAQ",
      "repository_card.dismiss": "avfärda",
      "repository_card.information": "Information",
      "repository_card.not_loaded": "Inte laddad",
      "repository_card.open_issue": "Rapportera problem",
      "repository_card.open_source": "Öppen källkod",
      "repository_card.pending_restart": "Väntande omstart",
      "repository_card.pending_update": "Väntande uppdatering",
      "repository_card.redownload": "Ladda ner igen",
      "repository_card.report": "Begäran om borttagning",
      "repository_card.update_information": "Uppdatera information",
      "repository_status.pending-restart": "Väntande omstart",
      "repository_status.pending-upgrade": "Väntande uppdatering",
    },
    vi: {
      "common.add": "thêm",
    ...
    zh_Hans: {
      "column.available_version": "可用版本",
      "column.category": "类别",
      "column.downloads": "下载量",
      "column.installed_version": "已安装版本",
      "column.last_updated": "已更新",
      "column.name": "存储库名称",
      "column.stars": "星标数",
      "column.status": "状态",
      "common.add": "添加",
      ...
      "dialog_download.lovelace_instruction":
        "下载完成后，由于您没有通过WebUI管理Lovelace，您需要使用以下设置手动添加资源：",
      "dialog_download.note_downloaded": "下载后，它将位于 {location}",
      "dialog_download.restart":
      ...
      "menu.reload": "重新加载窗口",
      "my.add_repository_description":
        "这将添加要由 HACS 跟踪的自定义存储库''{repository}''，您要添加它吗？",
      "my.add_repository_title": "添加自定义存储库",
      "my.documentation": "文档",
      "my.error": "未知错误",
      "my.repository_not_found": "未找到存储库 {repository}",
      ...
      "repository_status.pending-restart": "等待重启",
      "repository_status.pending-upgrade": "待更新",
    },
  },
  Jm = "en",
  Wm = new Set(["en_GB"]),
...
function t_(e, t, o) {
  ...
  let n = (
    ...
    (null === (r = window) ||
    void 0 === r ||
    null === (i = r.localStorage) ||
    void 0 === i
      ? void 0
      : i.getItem("selectedLanguage")) ||
    Jm
  )
    .replace(/['"]+/g, "")
    .replace("-", "_");
  (Xm[n] && !Wm.has(n)) || (n = Jm);
  const s = (null === (a = Xm[n]) || void 0 === a ? void 0 : a[t]) || Xm[Jm][t];
  if (!s) {
    if (n !== Jm) throw Error(`'${t}' is unknown'`);
    return t;
  }
  const l = `${t}_${s}`;
  let d = e_[l];
  if (!d) {
    try {
      ...
      if (n !== Jm) throw Error(`Translation problem with '${t}' for '${n}'`);
      return t;
    }
    e_[l] = d;
  }
  try {
    ...
    if (n !== Jm)
      throw Error(
        `Translation problem with placeholders for '${t}' for '${n}'`
      );
    return t;
  }
}
                        ...
                        return (
                          Qm.error(
                            (null == r ? void 0 : r.message) ||
                              `Unknown error translating '${t}' with '${e}'`
                          ),
                          t_(Jm, t, o)
                        );
                      }
...
function n_(e, t) {
  ...
  for (var o = 0; o < e.length; o++)
    if (((r = e[o]), (i = t[o]), !(r === i || (a_(r) && a_(i))))) return !1;
  var r, i;
  return !0;
}
function s_(e, t) {
...
const l_ = b`:host{font-family:var(--mdc-icon-font, "Material Icons");font-weight:normal;font-style:normal;font-size:var(--mdc-icon-size, 24px);line-height:1;letter-spacing:normal;text-transform:none;display:inline-block;white-space:nowrap;word-wrap:normal;direction:ltr;-webkit-font-smoothing:antialiased;text-rendering:optimizeLegibility;-moz-osx-font-smoothing:grayscale;font-feature-settings:"liga"}`;
let d_ = class extends fe {
  render() {
    return Y`<span><slot></slot></span>`;
  }
};
(d_.styles = [l_]), (d_ = Rn([be("mwc-icon")], d_));
class c_ extends fe {
  constructor() {
    super(...arguments),
      (this.raised = !1),
...
(c_.shadowRootOptions = { mode: "open", delegatesFocus: !0 }),
  Rn(
    [Zn, Ce({ type: String, attribute: "aria-haspopup" })],
    c_.prototype,
    "ariaHasPopup",
  ...
  Rn([Ce({ type: Boolean, reflect: !0 })], c_.prototype, "raised", void 0),
  Rn([Ce({ type: Boolean, reflect: !0 })], c_.prototype, "unelevated", void 0),
  Rn([Ce({ type: Boolean, reflect: !0 })], c_.prototype, "outlined", void 0),
  Rn([Ce({ type: Boolean })], c_.prototype, "dense", void 0),
  Rn([Ce({ type: Boolean, reflect: !0 })], c_.prototype, "disabled", void 0),
  Rn(
...
s(
  ...
  function (e, t) {
    return {
      ...
      d: [
        { kind: "field", decorators: [Ce()], key: "title", value: () => "" },
        {
          kind: "field",
          decorators: [Ce({ attribute: "alert-type" })],
          key: "alertType",
          value: () => "info",
        },
        {
    ...
    `;
        ...
        },
        {
          ...
          value: function () {
            it(this, "alert-dismissed-clicked");
          },
        },
        {
          kind: "field",
            ...
            if (o.beforeRender) {
              ...
              if (void 0 !== e) {
                for (s = e, l = o.routes[s]; "string" == typeof l; )
                  (s = l), (l = o.routes[s]);
                a && th(`${a.prefix}/${e}${location.search}`, { replace: !0 });
              }
            }
          ...
          value: function () {
            r(t(i.prototype), "connectedCallback", this).call(this),
              this._listeners.push(
                i_("(min-width: 1040px)", (e) => {
                  this._wide = e;
                })
              ),
              this._listeners.push(
                i_("(min-width: 1296px)", (e) => {
                  this._wideSidebar = e;
                })
              ),
          ...
          value: () => ({
            ...
            routes: {
              _my_redirect: {
                ...
                load: () => import("./c.9fea9e8a.js"),
              },
              dashboard: {
                tag: "hacs-experimental-panel",
                load: () => import("./c.cf116af0.js"),
              },
              entry: {
                tag: "hacs-experimental-panel",
                load: () => import("./c.cf116af0.js"),
        ...
        },
        {
          ...
          value: function (e) {
            r(t(i.prototype), "firstUpdated", this).call(this, e),
              ...
              Ah(this.hass, () => this._updateProperties("status"), dh.STATUS),
              Ah(this.hass, () => this._updateProperties("status"), dh.STAGE),
              Ah(
                this.hass,
              ...
              "" === this.route.path && th("/hacs/entry", { replace: !0 }),
              window.addEventListener("haptic", (e) => {
                it(window.parent, e.type, e.detail, { bubbles: !1 });
              }),
              ...
              rt.addEventListener("location-changed", (e) =>
                it(this, e.type, e.detail, { bubbles: !1 })
              ),
              document.body.addEventListener("keydown", (e) => {
                e.ctrlKey ||
                  ...
                  e.altKey ||
                  (["c", "e"].includes(e.key) &&
                    it(rt, "hass-quick-bar-trigger", e, { bubbles: !1 }));
              }),
              rt
        ...
        },
        {
          ...
          value: async function (e = "all") {
            ...
            "all" === e
              ...
              : "info" === e
              ? (o.info = await ch(this.hass))
              : "repositories" === e && (o.repositories = await ph(this.hass)),
