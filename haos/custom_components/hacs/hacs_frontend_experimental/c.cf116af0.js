...
import { c as Q, b as Z } from "./c.eab7754a.js";
import { p as J } from "./c.ef7f8e16.js";
import { L as ee } from "./c.d32a5f4a.js";
import { d as te, a as ie } from "./c.388f6c87.js";
import { b as ae } from "./c.07e395f8.js";
import { m as oe } from "./c.f2af93f0.js";
import { a as se } from "./c.ccbe2b52.js";
import { r as le, a as re } from "./c.2a64ceac.js";
import "./c.e651e5fa.js";
import { d as ne } from "./c.10855172.js";
import { i as ce } from "./c.21c042d4.js";
import "./c.8e28b461.js";
import "./c.743a15a1.js";
import "./c.2610e8cd.js";
import "./c.a0946910.js";
import "./c.117d0056.js";
...
const he = [
    {
      ...
      _findParent: function () {
        this.assignParentResizable(null),
          ...
          this._parentResizable ? de.delete(this) : de.add(this);
      },
    },
    {
      listeners: {
      ...
      _appResetLayoutHandler: function (e) {
        t(e).path[0] !== this && (this.resetLayout(), e.stopPropagation());
      },
      ...
      resetLayout: function () {
        ...
        (this._layoutDebouncer = i.debounce(this._layoutDebouncer, a, e)),
  ...
  ue = {
    ...
    _scrollTargetChanged: function (e, i) {
      if (
        ...
        if ("document" === e) this.scrollTarget = this._doc;
          ...
          var a = this.domHost;
          this.scrollTarget =
            a && a.$ ? a.$[e] : t(this.ownerDocument).querySelector("#" + e);
        } else
        ...
        var i = parseFloat(t.startsAt || 0),
          ...
          l =
            0 === i && 1 === a
              ? e.run
              : function (t, a) {
                  e.run.call(this, Math.max(0, (t - i) / o), a);
                };
        return {
          setUp: e.setUp ? e.setUp.bind(this, t) : s,
          run: e.run ? l.bind(this) : s,
          tearDown: e.tearDown ? e.tearDown.bind(this) : s,
        };
      },
...
`,
  ...
  get _stickyEl() {
    ...
    for (
      var e, i = t(this.$.slot).getDistributedNodes(), a = 0;
      (e = i[a]);
      a++
    )
  ...
  _updateScrollState: function (e, t) {
    if (0 !== this._height) {
      var i = 0,
        ...
        o = this._top;
      this._lastScrollTop;
      var s = this._maxHeaderTop,
        l = e - this._lastScrollTop,
        r = Math.abs(l),
        n = e > this._lastScrollTop,
        c = performance.now();
      if (
        (this._mayMove() && (a = this._clamp(this.reveals ? o + l : e, 0, s)),
        e >= this._dHeight &&
          ((a = this.condenses && !this.fixed ? Math.max(this._dHeight, a) : a),
          (this.style.transitionDuration = "0ms")),
        this.reveals &&
          !this.disabled &&
          r < 100 &&
          ((c - this._initTimestamp > 300 || this._wasScrollingDown !== n) &&
            ((this._initScrollTop = e), (this._initTimestamp = c)),
          e >= s))
      )
        if (Math.abs(this._initScrollTop - e) > 30 || r > 10) {
          n && e >= s
            ? (a = s)
            : !n &&
              e >= this._dHeight &&
              (a = this.condenses && !this.fixed ? this._dHeight : 0);
          var d = l / (c - this._lastTimestamp);
          this.style.transitionDuration =
            this._clamp((a - o) / d, 0, 300) + "ms";
        } else a = this._top;
      (i = 0 === this._dHeight ? (e > 0 ? 1 : 0) : a / this._dHeight),
        t ||
          ((this._lastScrollTop = e),
          (this._top = a),
          (this._wasScrollingDown = n),
          (this._lastTimestamp = c)),
        (t || i !== this._progress || o !== a || 0 === e) &&
          ((this._progress = i),
          this._runEffects(i, a),
          this._transformHeader(a));
    }
  },
  _mayMove: function () {
  ...
  _ensureBgContainers: function () {
    this._bgContainer ||
      ...
      t(this.root).insertBefore(this._bgContainer, this.$.contentContainer));
  },
  _getDOMRef: function (e) {
    switch (e) {
      ...
      case "mainTitle":
        return t(this).querySelector("[main-title]");
      case "condensedTitle":
        return t(this).querySelector("[condensed-title]");
    }
    return null;
  },
...
const me = { second: 45, minute: 45, hour: 22, day: 5, week: 4, month: 11 };
J && (await J);
const be = r(
    (e) => new Intl.RelativeTimeFormat(e.language, { numeric: "auto" })
  ),
  ve = (e, t, i, a = !0) => {
    const o = (function (e, t = Date.now(), i = {}) {
      const a = { ...me, ...(i || {}) },
        o = (+e - +t) / 1e3;
      if (Math.abs(o) < a.second)
        return { value: Math.round(o), unit: "second" };
      const s = o / 60;
      if (Math.abs(s) < a.minute)
        return { value: Math.round(s), unit: "minute" };
      const l = o / 3600;
      if (Math.abs(l) < a.hour) return { value: Math.round(l), unit: "hour" };
      const r = o / 86400;
      if (Math.abs(r) < a.day) return { value: Math.round(r), unit: "day" };
      const n = o / 604800;
      if (Math.abs(n) < a.week) return { value: Math.round(n), unit: "week" };
      const c = new Date(e),
        d = new Date(t),
        h = c.getFullYear() - d.getFullYear(),
        u = 12 * h + c.getMonth() - d.getMonth();
      return Math.round(Math.abs(u)) < a.month
        ? { value: Math.round(u), unit: "month" }
        : { value: Math.round(h), unit: "year" };
    })(e, i);
    return a
      ? be(t).format(o.value, o.unit)
  ...
  function (e, t) {
    return {
      ...
      d: [
        ...
        { kind: "field", decorators: [d()], key: "filter", value: void 0 },
        {
          kind: "field",
    ...
    `;
        ...
        },
        {
          ...
          value: async function (e) {
            m(this, "value-changed", { value: String(e) });
          },
        },
        {
          kind: "method",
...
const _e = Symbol("Comlink.proxy"),
  ge = Symbol("Comlink.endpoint"),
  ye = Symbol("Comlink.releaseProxy"),
  ke = Symbol("Comlink.thrown"),
  we = (e) => ("object" == typeof e && null !== e) || "function" == typeof e,
  xe = new Map([
    [
      "proxy",
      {
        canHandle: (e) => we(e) && e[_e],
        serialize(e) {
          const { port1: t, port2: i } = new MessageChannel();
          return $e(e, t), [i, [i]];
        },
        deserialize: (e) => (e.start(), Re(e)),
      },
    ],
    [
      "throw",
      {
        canHandle: (e) => we(e) && ke in e,
        serialize({ value: e }) {
          let t;
          return (
            (t =
...
function $e(e, t = self) {
  t.addEventListener("message", function i(a) {
    if (!a || !a.data) return;
    const { id: o, type: s, path: l } = Object.assign({ path: [] }, a.data),
      r = (a.data.argumentList || []).map(He);
    let n;
    try {
      const t = l.slice(0, -1).reduce((e, t) => e[t], e),
        i = l.reduce((e, t) => e[t], e);
      switch (s) {
        case "GET":
          n = i;
          break;
        case "SET":
          (t[l.slice(-1)[0]] = He(a.data.value)), (n = !0);
          break;
        case "APPLY":
          n = i.apply(t, r);
          break;
    ...
    Promise.resolve(n)
      .catch((e) => ({ value: e, [ke]: 0 }))
      .then((e) => {
        const [a, l] = De(e);
        t.postMessage(Object.assign(Object.assign({}, a), { id: o }), l),
          "RELEASE" === s && (t.removeEventListener("message", i), ze(t));
      });
  }),
    t.start && t.start();
}
...
function Ce(e, t = [], i = function () {}) {
  let a = !1;
  const o = new Proxy(i, {
    get(i, s) {
      if ((Se(a), s === ye))
        return () =>
          Ee(e, { type: "RELEASE", path: t.map((e) => e.toString()) }).then(
            () => {
              ze(e), (a = !0);
            }
          );
      if ("then" === s) {
        ...
        const i = Ee(e, { type: "GET", path: t.map((e) => e.toString()) }).then(
          He
        );
    ...
    set(i, o, s) {
      ...
      return Ee(
        e,
        { type: "SET", path: [...t, o].map((e) => e.toString()), value: l },
        r
      ).then(He);
    },
    apply(i, o, s) {
      ...
      if (l === ge) return Ee(e, { type: "ENDPOINT" }).then(He);
      if ("bind" === l) return Ce(e, t.slice(0, -1));
      const [r, n] = Te(s);
      return Ee(
        e,
        { type: "APPLY", path: t.map((e) => e.toString()), argumentList: r },
        n
      ).then(He);
    },
    construct(i, o) {
...
function De(e) {
  for (const [t, i] of xe)
    if (i.canHandle(e)) {
      const [a, o] = i.serialize(e);
      return [{ type: "HANDLER", name: t, value: a }, o];
    }
  return [{ type: "RAW", value: e }, Fe.get(e) || []];
}
function He(e) {
  switch (e.type) {
    case "HANDLER":
      return xe.get(e.name).deserialize(e.value);
    case "RAW":
      return e.value;
  }
}
  ...
  return new Promise((a) => {
    ...
    e.addEventListener("message", function t(i) {
      i.data &&
        i.data.id &&
        i.data.id === o &&
        (e.removeEventListener("message", t), a(i.data));
    }),
      e.start && e.start(),
      e.postMessage(Object.assign({ id: o }, t), i);
  });
}
let Le;
let Me = n(
  ...
  function (e, t) {
    ...
    return {
      ...
      d: [
        ...
        {
          kind: "field",
          decorators: [d({ type: Object })],
          key: "columns",
          value: () => ({}),
        },
        {
          kind: "field",
          decorators: [d({ type: Array })],
          key: "data",
          value: () => [],
        },
        {
        ...
        {
          kind: "field",
          decorators: [d({ type: Boolean, attribute: "auto-height" })],
          key: "autoHeight",
          value: () => !1,
        },
        {
        ...
        {
          kind: "field",
          decorators: [d({ type: Boolean, attribute: "no-label-float" })],
          key: "noLabelFloat",
          value: () => !1,
        },
        {
        ...
        { kind: "field", decorators: [_()], key: "_filter", value: () => "" },
        { kind: "field", decorators: [_()], key: "_sortColumn", value: void 0 },
        {
          kind: "field",
          decorators: [_()],
          key: "_sortDirection",
        ...
        {
          kind: "field",
          decorators: [h("slot[name='header']")],
          key: "_header",
          value: void 0,
        },
        { kind: "field", decorators: [_()], key: "_items", value: () => [] },
        ...
        },
        {
          ...
          value: function () {
            g(y(i.prototype), "connectedCallback", this).call(this),
        ...
        },
        {
          ...
          value: function (e) {
            if (
              (g(y(i.prototype), "willUpdate", this).call(this, e),
              e.has("columns"))
            ) {
              ...
              const e = ne(this.columns);
              Object.values(e).forEach((e) => {
                delete e.title, delete e.type, delete e.template;
              }),
                (this._sortColumns = e);
            }
          ...
          <div class="mdc-data-table__header-row" role="row" aria-rowindex="1">
            ...
            ${Object.entries(this.columns).map(([e, t]) => {
              ...
              const i = e === this._sortColumn,
                a = {
                  "mdc-data-table__header-cell--numeric": "numeric" === t.type,
        ...
        },
        {
          ...
          value() {
            return (e, t) =>
              e
                ? e.append
                  ? u` <div class="mdc-data-table__row">${e.content}</div> `
                  : e.empty
                  ? u` <div class="mdc-data-table__row"></div> `
                  : u`
      <div
        aria-rowindex=${t + 2}
        role="row"
        ...
        aria-selected=${x(
          !!this._checkedRows.includes(String(e[this.id])) || void 0
        )}
        ...
        },
        {
          ...
          value: async function () {
            ...
            const a = this._sortColumn
                ...
                : i,
              [o] = await Promise.all([a, R]),
              s = new Date().getTime() - e;
            if (
              (s < 100 && (await new Promise((e) => setTimeout(e, 100 - s))),
              this.curRequest === t)
            ) {
          ...
          value: () =>
            r(async (e, t, i) =>
              (async (e, t, i) => (
                Le ||
                  (Le = Re(
                    new Worker(new URL("./sort_filter_worker", import.meta.url))
                  )),
                Le.filterData(e, t, i)
              ))(e, t, i)
            ),
        },
        {
          ...
          value: function (e) {
            ...
            this.columns[t].sortable &&
              ...
              (this._sortColumn = null === this._sortDirection ? void 0 : t),
              m(this, "sorting-changed", {
                column: t,
          ...
          value() {
            return (e) => {
              ...
              if (t.checked) {
                ...
                this._checkedRows = this._checkedRows.filter((e) => e !== i);
              this._checkedRowsChanged();
            };
          },
        },
        {
          ...
          value() {
            return (e) => {
              ...
              m(this, "row-click", { id: i }, { bubbles: !1 });
            };
          },
        },
        {
          ...
          value: function () {
            this._items.length && (this._items = [...this._items]),
              m(this, "selection-changed", { value: this._checkedRows });
          },
        },
        {
          kind: "method",
  ...
  function (e, t) {
    return {
      ...
      d: [
        ...
        { kind: "field", decorators: [d()], key: "name", value: void 0 },
        {
          kind: "field",
          decorators: [T("mwc-ripple")],
          key: "_ripple",
          value: void 0,
        },
        {
    ...
    `;
        ...
        },
        {
          ...
          key: "_rippleHandlers",
          value() {
            return new F(() => ((this._shouldRenderRipple = !0), this._ripple));
          },
        },
        {
          kind: "method",
    ...
    function (e, t) {
      ...
      return {
        ...
        d: [
          ...
          {
            kind: "field",
            decorators: [d({ type: String, attribute: "back-path" })],
            key: "backPath",
            value: void 0,
          },
          {
          ...
          {
            kind: "field",
            decorators: [d({ type: Boolean, attribute: "main-page" })],
            key: "mainPage",
            value: () => !1,
          },
          {
          ...
          },
          {
            kind: "field",
            decorators: [
              d({ type: Boolean, reflect: !0, attribute: "is-wide" }),
            ],
            key: "isWide",
            value: () => !1,
          },
          ...
          },
          {
            ...
            key: "_getTabs",
            value() {
              return r((e, t, i, a, o, s, l) => {
                const r = e.filter(
                  (e) =>
                    (!e.component || e.core || ce(this.hass, e.component)) &&
                    (!e.advancedOnly || i)
                );
                if (r.length < 2) {
                  if (1 === r.length) {
                    const e = r[0];
                    return [e.translationKey ? l(e.translationKey) : e.name];
                  }
                  return [""];
                }
                return r.map(
...
let Pe = n(
  [v("hass-tabs-subpage-data-table")],
  function (e, t) {
    return {
      F: class extends t {
        constructor(...t) {
      ...
      d: [
        ...
        { kind: "field", decorators: [d()], key: "searchLabel", value: void 0 },
        {
          kind: "field",
          decorators: [d({ type: Array })],
          key: "activeFilters",
        ...
        { kind: "field", decorators: [d()], key: "hiddenLabel", value: void 0 },
        {
          kind: "field",
          decorators: [d({ type: Number })],
          key: "numHidden",
          value: () => 0,
        },
        {
        ...
        { kind: "field", decorators: [d()], key: "route", value: void 0 },
        { kind: "field", decorators: [d()], key: "tabs", value: () => [] },
        {
          kind: "field",
          decorators: [d({ type: Boolean })],
          key: "hideFilterMenu",
        ...
        },
        {
          ...
          value: function (e) {
            this.filter !== e.detail.value &&
              ((this.filter = e.detail.value),
              m(this, "search-changed", { value: this.filter }));
          },
        },
        {
          kind: "method",
...
const Be = r(
  ...
  Ae = r((e, t, i, a) =>
    e.sort((e, o) => {
      ...
      "desc" === i && (s = -1);
      let l = t.filterKey
          ? e[t.valueColumn || a][t.filterKey]
          : e[t.valueColumn || a],
        r = t.filterKey
          ? o[t.valueColumn || a][t.filterKey]
          : o[t.valueColumn || a];
      return (
        "string" == typeof l && (l = l.toUpperCase()),
...
n(
      ...
      d: [
        {
          ...
          value: async function () {
            ...
            if (
              (o < 100 && (await new Promise((e) => setTimeout(e, 100 - o))),
              this.curRequest === t)
            ) {
              if (this.appendRow || this.hasFab) {
                const e = [...a];
  ...
  n(
    [v("hacs-tabs-subpage-data-table")],
    function (e, t) {
      class i extends t {
        constructor(...t) {
          super(...t), e(this);
    ...
    >
      ${
        this.narrow
          ? ""
          : u`<div class="filters" slot="suffix" @click=${this._preventDefault}>
            ${
              t
                ? u`<div class="active-filters">
                  ${t}
...
const je = {
  ...
  Ne = { title: "", hidden: !0, filterable: !0 };
let We = n(
  [v("hacs-experimental-panel")],
  function (e, t) {
    class i extends t {
      constructor(...t) {
        super(...t), e(this);
    ...
    return {
      ...
      d: [
        ...
        {
          kind: "field",
          decorators: [ee("hacs-table-filters", !0, !1)],
          key: "activeFilters",
          value: () => [],
        },
        {
          kind: "field",
          decorators: [ee("hacs-table-sort", !0, !1)],
          key: "activeSort",
          value: void 0,
        },
        {
          kind: "field",
          decorators: [ee("hacs-active-search", !0, !1)],
          key: "_activeSearch",
          value: void 0,
        },
        {
          kind: "field",
          decorators: [ee("hacs-table-active-columns", !0, !1)],
          key: "_tableColumns",
          value: () => Oe,
        },
        {
          ...
          value: async function (e) {
            ...
            const a =
                this.activeFilters && 0 === this.activeFilters.length
                  ...
                  : this.activeFilters,
              o =
                null !== (t = this._activeSearch) && void 0 !== t && t.length
                  ? null == a
                    ? void 0
                    : a.filter(
                        (e) => e !== this.hacs.localize("common.downloaded")
                      )
                  : a;
            this.activeFilters = null != o && o.length ? o : void 0;
          },
        },
        {
          kind: "method",
        ...
        },
        {
          ...
          value() {
            return () => {
              var e, t, i, a, o, s, l;
              const r = this._filterRepositories(
                  this.hacs.repositories,
                  this.activeFilters
                ),
                n = 0 !== r.filter((e) => e.new).length;
              return u`<hacs-tabs-subpage-data-table
      .tabs=${[
        {
      ...
      .hasFab=${
        null === (e = this.activeFilters) || void 0 === e
          ? void 0
          : e.includes(this.hacs.localize("common.downloaded"))
      }
      .noDataText=${
        null !== (t = this.activeFilters) &&
        void 0 !== t &&
        t.includes(this.hacs.localize("common.downloaded"))
        ...
        .items=${[
          {
            ...
            action: () =>
              j.open("https://hacs.xyz/", "_blank", "noreferrer=true"),
          },
          {
            path: O,
            label: "GitHub",
            action: () =>
              j.open("https://github.com/hacs", "_blank", "noreferrer=true"),
          },
          {
            path: N,
            ...
            action: () => {
              (async (e, t) => {
                se(e, {
                  ...
                  confirmText: t.localize("common.close"),
                  text: oe.html(
                    `\n  **${t.localize(
                      "dialog_about.integration_version"
                    )}:** | ${t.info.version}\n  --|--\n  **${t.localize(
                      "dialog_about.frontend_version"
                    )}:** | 20230406083157\n  **${t.localize(
                      "common.repositories"
                    )}:** | ${t.repositories.length}\n  **${t.localize(
                      "dialog_about.downloaded_repositories"
                    )}:** | ${
                      t.repositories.filter((e) => e.installed).length
                    }\n\n  **${t.localize(
      ...
      <ha-button-menu slot="filter-menu" corner="BOTTOM_START" multi>
          ...
          .selected=${
            null !==
              (i =
                null === (a = this.activeFilters) || void 0 === a
                  ? void 0
                  : a.includes(this.hacs.localize("common.downloaded"))) &&
            void 0 !== i &&
            i
          }
          left
        ...
        <ha-check-list-item
          ...
          .selected=${
            null !==
              (o =
                null === (s = this.activeFilters) || void 0 === s
                  ? void 0
                  : s.includes(this.hacs.localize("common.new"))) &&
            void 0 !== o &&
            o
          }
          left
        ...
        ${
          this.narrow
            ? this.hacs.info.categories.map((e) => {
                var t, i;
                return u`
            ...
            : u`
              <ha-select
                ...
                naturalMenuWidth
                .value=${
                  (null === (l = this.activeFilters) || void 0 === l
                    ? void 0
                    : l.find((e) =>
                        e.startsWith(
                          `${this.hacs.localize(
              ...
              ${Object.keys(Oe).map((e) => {
                ...
                return u`
                  <ha-check-list-item
                    ...
                    .column=${e}
                    .selected=${
                      null !== (t = this._tableColumns[e]) && void 0 !== t
                        ? t
                        : Oe[e]
                    }
                    left
        ...
        },
        {
          ...
          value() {
            return () => {
              ...
              this.activeFilters = null != t && t.length ? t : void 0;
            };
          },
        },
        {
                ...
                .filter((e) => {
                  ...
                  return (
                    !(
                      ...
                      void 0 !== i &&
                      i.includes(this.hacs.localize("common.downloaded")) &&
                      !e.installed
                    ) &&
                    !(
                      null !== (a = this.activeFilters) &&
                      void 0 !== a &&
                      a.includes(this.hacs.localize("common.new")) &&
                      !e.new
                    ) &&
                    !(
                      null != t &&
        ...
        },
        {
            ...
            return r((e, t) => {
              ...
              return {
                icon: {
                  ...
                  template: (e, t) => {
                    var i, a;
                    return "integration" === t.category
                      ? u`
                <img
                  style="height: 32px; width: 32px"
                  slot="item-icon"
                  src=${ae({
                    domain: t.domain || "invalid",
                    type: "icon",
                    useFallback: !0,
                    darkOptimized:
              ...
              `;
                ...
                name: {
                  ...
                  direction:
                    "name" ===
                    (null === (i = this.activeSort) || void 0 === i
                      ? void 0
                      : i.column)
          ...
          `;
                ...
                last_updated: {
                  ...
                  template: (e, t) => {
                    try {
                      return ve(new Date(e), this.hass.locale);
                    } catch (e) {
                      return "-";
                    }
                  },
                ...
                available_version: {
                  ...
                  direction:
                    "available_version" ===
                    (null === (r = this.activeSort) || void 0 === r
                      ? void 0
                      : r.column)
                      ? this.activeSort.direction
                      : null,
                ...
                status: {
                  ...
                  width: "10%",
                  template: (e) =>
                    ["pending-restart", "pending-upgrade"].includes(e)
                      ? this.hacs.localize(`repository_status.${e}`)
                      : "-",
                },
                category: {
                  ...Ne,
                  ...
                  direction:
                    "category" ===
                    (null === (c = this.activeSort) || void 0 === c
                      ? void 0
                      : c.column)
                      ? this.activeSort.direction
                      : null,
                  width: "10%",
                  template: (e) => this.hacs.localize(`common.${e}`),
                },
                authors: Ne,
                description: Ne,
                domain: Ne,
        ...
        },
        {
          ...
          value: function (e) {
            V(`/hacs/repository/${e.detail.id}`);
          },
        },
        {
          kind: "method",
          key: "_handleCategoryFilterChange",
          value: function (e) {
            e.stopPropagation();
            const t = e.target.value;
            var i, a;
            t &&
              ("HA-RADIO" === e.target.nodeName && !1 === e.target.checked
                ? (this.activeFilters = [
                    ...((null === (i = this.activeFilters) || void 0 === i
                      ? void 0
                      : i.filter(
        ...
        {
          kind: "method",
          key: "_handleColumnChange",
          value: function (e) {
            e.stopPropagation();
            const t = {
              ...this._tableColumns,
              [e.currentTarget.column]: e.detail.selected,
            };
            this._tableColumns = Object.keys(Oe).reduce((e, i) => {
              var a;
              return {
                ...e,
                [i]: null !== (a = t[i]) && void 0 !== a ? a : Oe[i],
              };
            }, {});
          },
        },
        ...
        {
          kind: "method",
          key: "_handleDownloadFilterChange",
          value: function (e) {
            var t;
            const i =
              (null === (t = this.activeFilters) || void 0 === t
                ...
                : t.filter(
                    (e) =>
                      !e.startsWith(this.hacs.localize("common.downloaded"))
                  )) || [];
            e.detail.selected &&
              i.push(this.hacs.localize("common.downloaded")),
              (this.activeFilters = i.length ? i : void 0);
          },
        },
        {
          kind: "method",
          key: "_handleNewFilterChange",
          value: function (e) {
            var t;
            const i =
              (null === (t = this.activeFilters) || void 0 === t
                ? void 0
                : t.filter(
                    (e) => !e.startsWith(this.hacs.localize("common.new"))
                  )) || [];
            e.detail.selected && i.push(this.hacs.localize("common.new")),
              (this.activeFilters = i.length ? i : void 0);
          },
        },
        {
...
export { We as HacsExperimentalPanel };
