  ...
  [9460],
  {
    39460: function (a, n, t) {
      ...
      n.getCanonicalLocales = function (a) {
        return (function (a) {
          ...
          for (var t = 0, L = a; t < L.length; t++) {
            var k = L[t],
              u = (0, b.emitUnicodeLocaleId)(
                (0, m.canonicalizeUnicodeLocaleId)(
                  (0, r.parseUnicodeLocaleId)(k)
                )
              );
      ...
      Object.defineProperty(n, "parseUnicodeLocaleId", {
        ...
        L.__exportStar(t(49126), n),
        L.__exportStar(t(55946), n),
        L.__exportStar(t(86638), n);
    },
    10496: function (a, n) {
      Object.defineProperty(n, "__esModule", { value: !0 }),
        (n.variantAlias =
    ...
    73887: function (a, n, t) {
      ...
      function u(a) {
        for (var n = {}, t = [], L = 0, r = a; L < r.length; L++) {
          ...
          b[0] in n ||
            ((n[b[0]] = 1),
            b[1] && "true" !== b[1]
              ? t.push([b[0].toLowerCase(), b[1].toLowerCase()])
              : t.push([b[0].toLowerCase()]));
        }
        return t.sort(s);
      }
      function s(a, n) {
      ...
      function e(a, n) {
        for (
          var t = L.__spreadArray([], a, !0), r = 0, b = n;
          r < b.length;
          r++
        ) {
          var m = b[r];
      ...
      function l(a) {
        ...
        if (a.variants.length)
          for (var t = "", L = 0, u = a.variants; L < u.length; L++) {
            ...
            if (
              (t =
                r.languageAlias[
                  (0, k.emitUnicodeLanguageId)({ lang: a.lang, variants: [s] })
                ])
            ) {
              n = {
                lang: (d = (0, b.parseUnicodeLanguageId)(t.split(b.SEPARATOR)))
                  .lang,
                script: n.script || d.script,
                region: n.region || d.region,
                variants: e(n.variants, d.variants),
              };
              break;
            }
          }
        if (n.script && n.region) {
          ...
          if (i)
            n = {
              lang: (d = (0, b.parseUnicodeLanguageId)(i.split(b.SEPARATOR)))
                .lang,
              script: d.script,
              region: d.region,
              variants: n.variants,
        ...
        if (n.region) {
          ...
          if (l)
            n = {
              lang: (d = (0, b.parseUnicodeLanguageId)(l.split(b.SEPARATOR)))
                .lang,
              script: n.script || d.script,
              region: d.region,
              variants: n.variants,
        ...
        var d,
          o =
            r.languageAlias[
              (0, k.emitUnicodeLanguageId)({ lang: n.lang, variants: [] })
            ];
        o &&
          (n = {
            lang: (d = (0, b.parseUnicodeLanguageId)(o.split(b.SEPARATOR)))
              .lang,
            script: n.script || d.script,
            region: n.region || d.region,
            variants: n.variants,
        ...
        if (n.region) {
          ...
          if (c) {
            ...
            if (y) {
              var w = (0, b.parseUnicodeLanguageId)(
                y.split(b.SEPARATOR)
              ).region;
              w && p.indexOf(w) > -1 && (h = w);
            }
        ...
        if (
          ...
          for (var N = 0; N < n.variants.length; N++) {
            s = n.variants[N].toLowerCase();
            if (r.variantAlias[s]) {
              var Z = r.variantAlias[s];
              (0, b.isUnicodeVariantSubtag)(Z)
                ? (n.variants[N] = Z)
                : (0, b.isUnicodeLanguageSubtag)(Z) && (n.lang = Z);
            }
          }
          n.variants.sort();
        }
      ...
      (n.canonicalizeUnicodeLanguageId = l),
    ...
    55946: function (a, n, t) {
      ...
      function r(a) {
        return a
          ? L.__spreadArray([a.lang, a.script, a.region], a.variants || [], !0)
              .filter(Boolean)
              .join("-")
          : "";
      }
      (n.emitUnicodeLanguageId = r),
        (n.emitUnicodeLocaleId = function (a) {
          for (
            var n = a.lang, t = a.extensions, b = [r(n)], m = 0, k = t;
            m < k.length;
            m++
          ) {
            var u = k[m];
            switch ((b.push(u.type), u.type)) {
              case "u":
                b.push.apply(
                  b,
                  L.__spreadArray(
                    L.__spreadArray([], u.attributes, !1),
                    u.keywords.reduce(function (a, n) {
                      return a.concat(n);
                    }, []),
                    !1
                  )
    ...
    36838: function (a, n, t) {
      ...
      function y(a) {
        ...
        a.length && h(a[0]) && (t = a.shift()),
          a.length && c(a[0]) && (L = a.shift());
        for (var b = {}; a.length && p(a[0]); ) {
          var m = a.shift();
          if (m in b)
            throw new RangeError('Duplicate variant "'.concat(m, '"'));
          b[m] = 1;
        }
        return { lang: r, script: t, region: L, variants: Object.keys(b) };
      }
      function w(a) {
        for (var n, t = []; a.length && (n = N(a)); ) t.push(n);
        if (t.length) return { type: "u", keywords: t, attributes: [] };
        for (var L = []; a.length && m.test(a[0]); ) L.push(a.shift());
        for (; a.length && (n = N(a)); ) t.push(n);
      ...
      function Z(a) {
        ...
        for (var L = []; a.length && o.test(a[0]); ) {
          for (var r = a.shift(), b = []; a.length && m.test(a[0]); )
            b.push(a.shift());
          if (!b.length)
            throw new RangeError('Missing tvalue for tkey "'.concat(r, '"'));
      ...
      (n.SEPARATOR = "-"),
        ...
        (n.isUnicodeVariantSubtag = p),
        (n.parseUnicodeLanguageId = y),
                  ...
                  default:
                    ...
                    if (m in b)
                      throw new RangeError(
                        "There can only be 1 -".concat(m, "- extension")
                      );
                    var k = { type: m, value: G(a) };
                    (b[k.type] = k), r.push(k);
                }
              } while (a.length);
              return { extensions: r };
    ...
    39860: function (a, n, t) {
      var L = t(68360).match(/firefox\/(\d+)/i);
      a.exports = !!L && +L[1];
    },
    93712: function (a, n, t) {
      var L = t(68360);
      a.exports = /MSIE|Trident/.test(L);
    },
    82803: function (a, n, t) {
      var L = t(68360).match(/AppleWebKit\/(\d+)\./);
      a.exports = !!L && +L[1];
    },
    37313: function (a, n, t) {
      var L = t(68077),
        r = t(55418),
        b = t(9160),
        m = t(19480),
        ...
        I = !i(function () {
          ...
          if (!(d && d > 3)) {
            ...
            var a,
              ...
              r = "";
            for (a = 65; a < 76; a++) {
              switch (((n = String.fromCharCode(a)), a)) {
                case 66:
                case 69:
                case 70:
                case 72:
              ...
              for (L = 0; L < 47; L++) h.push({ k: n + L, v: t });
            }
            for (
              h.sort(function (a, n) {
                return n.v - a.v;
              ...
              (n = h[L].k.charAt(0)), r.charAt(r.length - 1) !== n && (r += n);
            return "DGBEFHACIJK" !== r;
          }
        });
      L(
        { target: "Array", proto: !0, forced: w || !N || !Z || !I },
        {
          sort: function (a) {
            void 0 !== a && b(a);
            var n = m(this);
            if (I) return void 0 === a ? p(n) : p(n, a);
            var t,
              L,
              r = [],
              i = k(n);
            for (L = 0; L < i; L++) L in n && y(r, n[L]);
            for (
              e(
                r,
                (function (a) {
...
//# sourceMappingURL=9460.wqYx3_a2Hlc.js.map
