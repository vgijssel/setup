    ...
    59146: function (r, o, e) {
      e.r(o),
        e.d(o, {
          ...
          defaultKeymap: function () {
            return t.wQ;
          },
          drawSelection: function () {
            return l.Uw;
          },
          haSyntaxHighlighting: function () {
            return f;
          },
          haTheme: function () {
            return v;
          ...
          highlightSelectionMatches: function () {
            return m.sW;
          },
          ...
          historyKeymap: function () {
            return t.f$;
          },
          keymap: function () {
            return l.$f;
          },
          langCompartment: function () {
            return u;
          },
          langs: function () {
            return g;
          ...
          readonlyCompartment: function () {
            return s;
          },
          rectangularSelection: function () {
            return l.Zs;
          },
          searchKeymap: function () {
            return m.Lp;
          },
          tabKeyBindings: function () {
            return b;
          },
          tags: function () {
            return p.pJ;
      ...
      var t = e(65300),
        ...
        d = e(90561),
        m = e(52456),
        g = { jinja2: a.il.define(c.b), yaml: a.il.define(n.r) },
        u = new i.F6(),
        s = new i.F6(),
        b = [
          { key: "Tab", run: t.at },
          { key: "Shift-Tab", run: t.xi },
        ],
        v = l.tk.theme({
          "&": {
        ...
        x = a.Qf.define([
          { tag: p.pJ.keyword, color: "var(--codemirror-keyword, #6262FF)" },
          {
            tag: [
              p.pJ.name,
              p.pJ.deleted,
          ...
          {
            tag: [p.pJ.function(p.pJ.variableName), p.pJ.labelName],
            color: "var(--codemirror-variable, #07a)",
          },
          {
            tag: [
              p.pJ.color,
              p.pJ.constant(p.pJ.name),
              p.pJ.standard(p.pJ.name),
            ],
            color: "var(--codemirror-qualifier, #690)",
          },
          {
            tag: [p.pJ.definition(p.pJ.name), p.pJ.separator],
          ...
          },
          {
            tag: [
              p.pJ.operator,
              p.pJ.operatorKeyword,
              p.pJ.url,
              p.pJ.escape,
              p.pJ.regexp,
              p.pJ.link,
              p.pJ.special(p.pJ.string),
            ],
            color: "var(--codemirror-operator, #cda869)",
          },
          { tag: p.pJ.comment, color: "var(--codemirror-comment, #777)" },
          {
            tag: p.pJ.meta,
            color: "var(--codemirror-meta, var(--primary-text-color))",
          },
          { tag: p.pJ.strong, fontWeight: "bold" },
          { tag: p.pJ.emphasis, fontStyle: "italic" },
          {
            tag: p.pJ.link,
            color: "var(--primary-color)",
            textDecoration: "underline",
          },
          { tag: p.pJ.heading, fontWeight: "bold" },
          { tag: p.pJ.atom, color: "var(--codemirror-atom, #F90)" },
          { tag: p.pJ.bool, color: "var(--codemirror-atom, #F90)" },
          {
            tag: p.pJ.special(p.pJ.variableName),
            color: "var(--codemirror-variable-2, #690)",
          },
          {
            tag: p.pJ.processingInstruction,
            color: "var(--secondary-text-color)",
          },
          { tag: p.pJ.string, color: "var(--codemirror-string, #07a)" },
          { tag: p.pJ.inserted, color: "var(--codemirror-string2, #07a)" },
          { tag: p.pJ.invalid, color: "var(--error-color)" },
        ]),
        f = (0, a.nF)(x);
    },
  },
]);
//# sourceMappingURL=9146.ab8uSmRRLIE.js.map
