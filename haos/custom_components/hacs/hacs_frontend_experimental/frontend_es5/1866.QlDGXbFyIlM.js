...
(self.webpackChunkhacs_frontend = self.webpackChunkhacs_frontend || []).push([
  [1866],
  {
    43170: function (e, n, a) {
      a(63789), a(18098), (n.Y = void 0);
      var r = a(46042),
        s = a(52019);
      n.Y = function (e) {
        if (
          ...
          !("DateTimeFormat" in Intl) ||
            ...
            !(function (e) {
              ...
              return (
                Intl.DateTimeFormat.supportedLocalesOf(n).length === n.length
              );
            })(e))
        )
          return e ? (0, r.match)([e], s.supportedLocales, "en") : void 0;
      };
    },
    52019: function (e, n) {
      Object.defineProperty(n, "__esModule", { value: !0 }),
        (n.supportedLocales = void 0),
        (n.supportedLocales = [
          "af",
          "af-NA",
          "agq",
    ...
    27499: function (e, n, a) {
      a(63789), a(18098), (n.Yq = void 0);
      var r = a(46042),
        s = a(30308);
      function t() {
        return (
        ...
        try {
          if (
            ...
            !(function (e) {
              ...
              var n = Array.isArray(e) ? e : [e];
              return (
                Intl.DisplayNames.supportedLocalesOf(n).length === n.length
              );
            })(e)
          )
            return (0, r.match)([e], s.supportedLocales, "en");
        } catch (n) {
          return !0;
        }
      };
    ...
    46042: function (e, n, a) {
      ...
      function c(e, n, a) {
        ...
        if (_ && "$" === _[0]) {
          var o = "!" !== _[1],
            c = (o ? a[_.slice(1)] : a[_.slice(2)])
              .map(function (e) {
                return d[e] || [e];
              })
              .reduce(function (e, n) {
                return (0, s.__spreadArray)(
                  (0, s.__spreadArray)([], e, !0),
                  n,
                  !0
                );
              }, []);
          u && (u = !(c.indexOf(e.region || "") > 1 != o));
        } else u && (u = !e.region || "*" === _ || _ === e.region);
        return (
          u && (u = !e.script || "*" === i || i === e.script),
          u && (u = !e.language || "*" === t || t === e.language),
          u
        );
      }
      function f(e) {
      ...
      function l(e, n, a) {
        for (var r = 0, s = a.matches; r < s.length; r++) {
          var t = s[r],
            d =
              c(e, t.desired, a.matchVariables) &&
              c(n, t.supported, a.matchVariables);
          if (
            (t.oneway ||
              d ||
              (d =
                c(e, t.supported, a.matchVariables) &&
                c(n, t.desired, a.matchVariables)),
            d)
          ) {
            var i = 10 * t.distance;
            return a.paradigmLocales.indexOf(f(e)) > -1 !=
              a.paradigmLocales.indexOf(f(n)) > -1
              ? i - 1
              : i;
          }
        }
      ...
      function y(e, n) {
        var a = new Intl.Locale(e).maximize(),
          ...
          o = (function () {
            ...
            if (!u) {
              var a =
                  null ===
                    (n =
                      null ===
                        (e =
                          t.supplemental.languageMatching["written-new"][0]) ||
                      void 0 === e
                        ? void 0
                        : e.paradigmLocales) || void 0 === n
                    ? void 0
                    : n._locales.split(" "),
                r = t.supplemental.languageMatching["written-new"].slice(1, 5),
                d = t.supplemental.languageMatching["written-new"]
                  .slice(5)
                  .map(function (e) {
              ...
              u = {
                matches: d,
                matchVariables: r.reduce(function (e, n) {
                  var a = Object.keys(n)[0],
                    r = n[a];
                  return (e[a.slice(1)] = r._value.split("+")), e;
                }, {}),
                paradigmLocales: (0, s.__spreadArray)(
                  (0, s.__spreadArray)([], a, !0),
                  a.map(function (e) {
        ...
        return (
          ...
          d.script !== i.script &&
            (_ += l(
              { language: a.language, script: d.script, region: "" },
              { language: r.language, script: d.script, region: "" },
              o
            )),
          d.region !== i.region && (_ += l(d, i, o)),
          _
        );
      }
      function m(e, n, a) {
        var r,
          s,
          t = [],
          d = n.reduce(function (e, n) {
            var a = n.replace(i, "");
            return t.push(a), (e[a] = n), e;
          }, {}),
          _ = (function (e, n, a) {
            void 0 === a && (a = o);
            var r = 1 / 0,
              s = { matchedDesiredLocale: "", distances: {} };
            return (
              e.forEach(function (e, a) {
                s.distances[e] || (s.distances[e] = {}),
                  n.forEach(function (n, t) {
                    var d = y(e, n) + t + 40 * a;
                    (s.distances[e][n] = d),
                      d < r &&
                        ((r = d),
                        (s.matchedDesiredLocale = e),
                        (s.matchedSupportedLocale = n));
                  });
              }),
              r >= a &&
                ((s.matchedDesiredLocale = void 0),
                (s.matchedSupportedLocale = void 0)),
              s
            );
          })(t, e);
        return (
          _.matchedSupportedLocale &&
            _.matchedDesiredLocale &&
            ((r = _.matchedSupportedLocale),
            (s =
              d[_.matchedDesiredLocale].slice(_.matchedDesiredLocale.length) ||
              void 0)),
          r ? { locale: r, extension: s } : { locale: a() }
        );
      }
      a(26349);
      function w(e, n) {
      ...
      function M(e, n) {
        _(2 === n.length, "key must have 2 elements");
        var a = e.length,
          r = "-".concat(n, "-"),
          s = e.indexOf(r);
        if (-1 !== s) {
          for (var t = s + 4, d = t, i = t, u = !1; !u; ) {
            var o = e.indexOf("-", i);
            2 === (-1 === o ? a - i : o - i)
              ? (u = !0)
              : -1 === o
      ...
      function L(e, n, a, s, t, d) {
        var u;
        u =
          "lookup" === a.localeMatcher
            ? (function (e, n, a) {
                for (var r = { locale: "" }, s = 0, t = n; s < t.length; s++) {
                  var d = t[s],
                    _ = d.replace(i, ""),
                    u = w(e, _);
                  if (u)
                    return (
                      (r.locale = u),
                      d !== _ && (r.extension = d.slice(_.length, d.length)),
                      r
                    );
                }
                return (r.locale = a()), r;
        ...
        for (
          ...
          var L = y[l];
          _(o in t, "Missing locale data for ".concat(o));
          var G = t[o];
          _(
            "object" === (0, r.Z)(G) && null !== G,
            "locale data ".concat(L, " must be an object")
          );
          var A = G[L];
          _(
            Array.isArray(A),
            "keyLocaleData for ".concat(L, " must be an array")
          );
          var C = A[0];
          _(
            "string" == typeof C || null === C,
            "value must be string or null but got "
              .concat((0, r.Z)(C), " in key ")
              .concat(L)
          );
          var S = "";
          if (u.extension) {
            var g = M(u.extension, L);
            void 0 !== g &&
              ("" !== g
                ? ~A.indexOf(g) && ((C = g), (S = "-".concat(L, "-").concat(C)))
                : ~g.indexOf("true") && ((C = "true"), (S = "-".concat(L))));
          }
          if (L in a) {
            var h = a[L];
            _(
      ...
      function G(e, n) {
        for (var a = [], r = 0, s = n; r < s.length; r++) {
          var t = w(e, s[r].replace(i, ""));
          t && a.push(t);
        }
        return a;
      }
      function A(e, n, a, r) {
        return L(
          n,
          ((s = e), Intl.getCanonicalLocales(s)),
        ...
        if (
          ...
          "undefined" == typeof Intl ||
            ...
            !(function (e) {
              ...
              var n = Array.isArray(e) ? e : [e];
              return (
                Intl.NumberFormat.supportedLocalesOf(n).length === n.length
              );
            })(e))
        )
          return e ? (0, r.match)([e], s.supportedLocales, "en") : void 0;
        ...
        if (
          ...
          !("RelativeTimeFormat" in Intl) ||
            !(function (e) {
              ...
              var n = Array.isArray(e) ? e : [e];
              return (
                Intl.RelativeTimeFormat.supportedLocalesOf(n).length ===
                n.length
              );
            })(e) ||
            !(function (e) {
...
//# sourceMappingURL=1866.QlDGXbFyIlM.js.map
