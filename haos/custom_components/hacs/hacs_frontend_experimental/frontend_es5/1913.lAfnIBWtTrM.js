  ...
  [1913],
  {
    1913: function (e, r, a) {
      ...
      var n = a(40039),
        ...
        i = 128;
      function o() {
        for (var e = [], r = [], a = 0; a <= i; a++) r[a] = 0;
        for (var n = 0; n <= i; n++) e.push(r.slice(0));
        return e;
      }
      function s(e, r) {
        if (r < 0 || r >= e.length) return !1;
        var a,
          n = e.codePointAt(r);
        switch (n) {
          case t.Underline:
      ...
      function f(e, r, a, n, t, o, s) {
        var u = e.length > i ? i : e.length,
          f = n.length > i ? i : n.length;
        if (
          !(a >= u || o >= f || u - a > f - o) &&
          ...
          for (k = 1, p = a; p < u; k++, p++) {
            var E = h[p],
              N = v[p],
              m = p + 1 < u ? v[p + 1] : f;
            for (L = E - o + 1, C = E; C < m; L++, C++) {
              var B = Number.MIN_SAFE_INTEGER,
                b = !1;
              C <= N &&
                (B = g(e, r, p, a, n, t, C, f, o, 0 === D[k - 1][L - 1], T));
              var P = 0;
              B !== Number.MAX_SAFE_INTEGER &&
                ((b = !0), (P = B + S[k - 1][L - 1]));
              var A = C > E,
                I = A ? S[k][L - 1] + (D[k][L - 1] > 0 ? -5 : 0) : 0,
                w = C > E + 1 && D[k][L - 1] > 0,
                q = w ? S[k][L - 2] + (D[k][L - 2] > 0 ? -5 : 0) : 0;
              if (w && (!A || q >= I) && (!b || q >= P))
                (S[k][L] = q), (d[k][L] = l.LeftLeft), (D[k][L] = 0);
              else if (A && (!b || I >= P))
                (S[k][L] = I), (d[k][L] = l.Left), (D[k][L] = 0);
              else {
                if (!b) throw new Error("not possible");
                (S[k][L] = P),
                  (d[k][L] = l.Diag),
                  (D[k][L] = D[k - 1][L - 1] + 1);
              }
      ...
      function g(e, r, a, n, t, i, o, l, f, g, h) {
        if (r[a] !== i[o]) return Number.MIN_SAFE_INTEGER;
        var v = 1,
          D = !1;
        return (
          o === a - n
            ? (v = e[a] === t[o] ? 7 : 5)
            : !c(o, t, i) || (0 !== o && c(o - 1, t, i))
            ? !s(i, o) || (0 !== o && s(i, o - 1))
              ? (s(i, o - 1) || u(i, o - 1)) && ((v = 5), (D = !0))
              : (v = 5)
            : ((v = e[a] === t[o] ? 7 : 5), (D = !0)),
          v > 1 && a === n && (h[0] = !0),
          D || (D = c(o, t, i) || s(i, o - 1) || u(i, o - 1)),
          a === n
            ? o > f && (v -= D ? 3 : 5)
            : (v += g ? (D ? 2 : 0) : D ? 0 : 1),
          o + 1 === l && (v -= D ? 3 : 5),
            ...
            return (
              (r.score = (function (e, r) {
                ...
                try {
                  for (i.s(); !(a = i.n()).done; ) {
                    var o = a.value,
                      s = f(e, e.toLowerCase(), 0, o, o.toLowerCase(), 0, !0);
                    if (s) {
                      var u = 0 === s[0] ? 1 : s[0];
                      u > t && (t = u);
                    }
...
//# sourceMappingURL=1913.lAfnIBWtTrM.js.map
