    ...
    27716: function (t, e, i) {
      ...
      i(27392),
        ...
        (L.Draw.Polyline = L.Draw.Feature.extend({
          ...
          _endPoint: function (t, e, i) {
            if (this._mouseDownOrigin) {
              ...
              this.options.maxPoints == this._markers.length + 1
                ...
                ? this._finishShape()
                : Math.abs(o) < 9 * (n.devicePixelRatio || 1) &&
                  this.addVertex(i.latlng),
          ...
          _updateFinishHandler: function () {
            ...
            t > 1 && this._markers[t - 1].on("click", this._finishShape, this),
              t > 2 &&
                this._markers[t - 2].off("click", this._finishShape, this);
          },
        ...
        (L.Draw.SimpleShape = L.Draw.Feature.extend({
          ...
          addHooks: function () {
            L.Draw.Feature.prototype.addHooks.call(this),
              this._map &&
                ...
                a.addEventListener("touchstart", L.DomEvent.preventDefault, {
                  passive: !1,
                }));
          },
          removeHooks: function () {
            L.Draw.Feature.prototype.removeHooks.call(this),
              this._map &&
                ...
                L.DomEvent.off(a, "mouseup", this._onMouseUp, this),
                L.DomEvent.off(a, "touchend", this._onMouseUp, this),
                a.removeEventListener("touchstart", L.DomEvent.preventDefault),
                this._shape &&
          ...
          _onMouseDown: function (t) {
            (this._isDrawing = !0),
              ...
              L.DomEvent.on(a, "mouseup", this._onMouseUp, this)
                .on(a, "touchend", this._onMouseUp, this)
        ...
        (L.Edit.PolyVerticesEdit = L.Handler.extend({
          ...
          _initMarkers: function () {
            ...
            var t,
              ...
              n,
              a,
              s = this._defaultShape();
            for (t = 0, i = s.length; t < i; t++)
              (o = this._createMarker(s[t], t)).on(
                "click",
                this._onMarkerClick,
                this
              ),
            ...
            for (t = 0, e = i - 1; t < i; e = t++)
              (0 !== t || (L.Polygon && this._poly instanceof L.Polygon)) &&
                ((n = this._markers[e]),
                (a = this._markers[t]),
                this._createMiddleMarker(n, a),
                this._updatePrevNext(n, a));
          },
        ...
        (L.Edit.Rectangle = L.Edit.SimpleShape.extend({
          ...
          _onMarkerDragEnd: function (t) {
            var e,
              i = t.target;
            i === this._moveMarker &&
              ((e = this._shape.getBounds().getCenter()), i.setLatLng(e)),
                  ...
                  ? ((a = ["ha", "m"]),
                    ...
                    (n =
                      e >= 1e6 && -1 !== a.indexOf("km")
                        ? L.GeometryUtil.formattedNumber(1e-6 * e, o.km) +
                          " km²"
            ...
            readableDistance: function (e, i, o, n, a) {
              ...
              switch (
                ...
                default:
                  s =
                    (e *= 1.09361) > 1760
                      ? L.GeometryUtil.formattedNumber(e / 1760, a.mi) +
                        " miles"
        ...
        (L.DrawToolbar = L.Toolbar.extend({
          ...
          setOptions: function (t) {
            for (var e in (L.setOptions(this, t), this._modes))
        ...
        (L.EditToolbar = L.Toolbar.extend({
          ...
          initialize: function (t) {
            t.edit &&
              ...
              t.remove &&
                (t.remove = L.extend({}, this.options.remove, t.remove)),
    ...
    93892: function (t, e, i) {
      ...
      t.exports = function (t) {
        var e = n(a(this)),
          i = "",
          r = o(t);
        if (r < 0 || r === 1 / 0) throw new s("Wrong number of repetitions");
        for (; r > 0; (r >>>= 1) && (e += e)) 1 & r && (i += e);
        return i;
      };
    },
    5110: function (t, e, i) {
      ...
      var o = i(68077),
        ...
        f = function (t, e, i) {
          for (var o = -1, n = i; ++o < 6; )
            (n += e * t[o]), (t[o] = n % 1e7), (n = c(n / 1e7));
        },
        m = function (t, e) {
          for (var i = 6, o = 0; --i >= 0; )
            (o += t[i]), (t[i] = c(o / e)), (o = (o % e) * 1e7);
        },
        g = function (t) {
          for (var e = 6, i = ""; --e >= 0; )
            if ("" !== i || 0 === e || 0 !== t[e]) {
              var o = d(t[e]);
              i = "" === i ? o : i + _("0", 7 - o.length) + o;
            }
          return i;
        };
      o(
        ...
        },
        {
          toFixed: function (t) {
            var e,
              ...
              u = "",
              v = "0";
            if (l < 0 || l > 20) throw new h("Incorrect fraction digits");
            if (r != r) return "NaN";
            if (r <= -1e21 || r >= 1e21) return d(r);
            if ((r < 0 && ((u = "-"), (r = -r)), r > 1e-21))
              if (
                ((i =
                  (e =
                    (function (t) {
                ...
                for (f(c, 0, i), o = l; o >= 7; ) f(c, 1e7, 0), (o -= 7);
                for (f(c, L(10, o, 1), 0), o = e - 1; o >= 23; )
                  m(c, 1 << 23), (o -= 23);
                m(c, 1 << o), f(c, 1, 1), m(c, 2), (v = g(c));
              } else f(c, 0, i), f(c, 1 << -e, 0), (v = g(c) + _("0", l));
            return (v =
              l > 0
                ? u +
                  ((n = v.length) <= l
...
//# sourceMappingURL=7716.z8X_0aIr8rQ.js.map
