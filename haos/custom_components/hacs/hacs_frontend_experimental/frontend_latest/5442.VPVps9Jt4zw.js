/*! For license information please see 5442.VPVps9Jt4zw.js.LICENSE.txt */
export const id = 5442;
export const ids = [5442];
export const modules = {
  5442: (t, e, n) => {
            ...
            if (r && !this.connected_) {
              if (
                ...
                if ((this.mutationsObserver_.observe(document, t), c)) {
                  ...
                  !(function n(r) {
                    var i = r.shadowRoot;
                    i && (e.mutationsObserver_.observe(i, t), n(i));
                    for (var o = r.firstElementChild; o; )
                      n(o), (o = o.nextElementSibling);
                  })(document),
                    (HTMLElement.prototype.attachShadow = function () {
                      for (var n = [], r = 0; r < arguments.length; r++)
                        n[r] = arguments[r];
                      var i = c.apply(this, n);
                      return e.mutationsObserver_.observe(i, t), i;
                    });
                }
              } else
    ...
    var f = function (t, e) {
        var n, r;
        try {
          for (var i = u(Object.keys(e)), o = i.next(); !o.done; o = i.next()) {
            var s = o.value;
    ...
    function _(t) {
      ...
      var r = d(t).getComputedStyle(t),
        i = (function (t) {
          ...
          return {
            top: v(e["padding-top"]),
            right: v(e["padding-right"]),
            bottom: v(e["padding-bottom"]),
            left: v(e["padding-left"]),
          };
        })(r),
        o = i.left + i.right,
        s = i.top + i.bottom,
        ...
        return (function () {
          ...
          return (
            ...
            (e.prototype.forEach = function (t, e) {
              ...
              try {
                for (
                  var i = u(this.__entries__), o = i.next();
                  !o.done;
                  o = i.next()
                ) {
                  var s = o.value;
    ...
    const x = void 0 !== i.ResizeObserver ? i.ResizeObserver : M;
  },
};
//# sourceMappingURL=5442.VPVps9Jt4zw.js.map
