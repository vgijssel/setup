...
export const modules = {
  4558: (e, t, a) => {
    ...
    t.InitializeRelativeTimeFormat = function (e, t, a, i) {
      ...
      return (
        (0, r.invariant)(!!T, "Missing locale data for ".concat(g.dataLocale)),
        (v.fields = T),
  ...
  41979: (e, t, a) => {
    ...
    t.PartitionRelativeTimePattern = function (e, t, a, i) {
      ...
      "short" === f
        ? (p = "".concat(u, "-short"))
        : "narrow" === f && (p = "".concat(u, "-narrow")),
        p in c || (p = u);
      var y = c[p];
      if ("auto" === v && (0, r.ToString)(t) in y)
        return [{ type: "literal", value: y[(0, r.ToString)(t)] }];
      var b = "future";
      ((0, r.SameValue)(t, -0) || t < 0) && (b = "past");
      var g = y[b],
        h =
          "function" == typeof m.formatToParts
            ? m.formatToParts(Math.abs(t))
            : [{ type: "literal", value: m.format(Math.abs(t)), unit: a }],
        w = g[d.select(t)];
      return (0, o.MakePartsList)(w, u, h);
    };
  },
  8511: (e, t, a) => {
    Object.defineProperty(t, "__esModule", { value: !0 }),
    ...
    t.SingularRelativeTimeUnit = function (e) {
      if (
        ((0, r.invariant)("String" === (0, r.Type)(e), "unit must be a string"),
        "seconds" === e)
      )
        return "second";
      ...
      u = (function () {
        ...
        return (
          (e.prototype.format = function (e, t) {
            ...
            if (!(0, l.default)(this).initializedRelativeTimeFormat)
              throw new TypeError("format was called on a invalid context");
            return (0, i.PartitionRelativeTimePattern)(
              this,
              Number(e),
              (0, n.ToString)(t),
              { getInternalSlots: l.default }
