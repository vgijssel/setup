export const id = 1908;
export const ids = [1908];
export const modules = {
        ...
        return {
          ...
          d: [
            ...
            },
            {
              ...
              key: "render",
              value: function () {
                return a.dy` <div class="issue-type ${(0, s.$)({
                  [this.alertType]: !0,
                  ...
                  this.title ? a.dy`<div class="title">${this.title}</div>` : ""
  ...
  33358: (t, e, i) => {
    i.r(e), i.d(e, { HaIconButtonArrowPrev: () => r });
    var o = i(309),
      a = i(5095),
      n = i(95260),
      s = i(67684);
        ...
        return {
          ...
          d: [
            ...
            },
            {
              ...
              key: "render",
              value: function () {
                return a.dy` <mwc-icon-button aria-label="${(0, s.o)(
                  this.label
                )}" title="${(0, s.o)(
            ...
            },
            {
              ...
              key: "styles",
              value: function () {
                return a.iv`:host{display:inline-block;outline:0}:host([disabled]){pointer-events:none}mwc-icon-button{--mdc-theme-on-primary:currentColor;--mdc-theme-text-disabled-on-light:var(--disabled-text-color)}`;
              },
            },
          ],
        };
  ...
  73957: (t, e, i) => {
    ...
    class c {
      ...
      processMessage(t) {
        ...
        else this.notifications = { ...this.notifications, ...t.notifications };
        ...
        return {
          ...
          d: [
            ...
            },
            {
              ...
              key: "render",
              value: function () {
                if (!this._show) return s.Ld;
                const t =
                  this._hasNotifications &&
                  (this.narrow || "always_hidden" === this.hass.dockedSidebar);
                return s.dy` <ha-icon-button .label="${this.hass.localize(
            ...
            },
            {
              ...
              value: function (t) {
                if (
                  ((0, a.Z)((0, n.Z)(i.prototype), "willUpdate", this).call(
                    this,
                    t
                  ),
                  ...
                  return;
                const e = t.has("hass") ? t.get("hass") : this.hass,
                  o =
                    (t.has("narrow") ? t.get("narrow") : this.narrow) ||
                    "always_hidden" === (null == e ? void 0 : e.dockedSidebar),
                  s =
                    this.narrow || "always_hidden" === this.hass.dockedSidebar;
                (this.hasUpdated && o === s) ||
                  ((this._show = s || this._alwaysVisible),
                  s
                    ? this._subscribeNotifications()
                    : this._unsubNotifications &&
                      (this._unsubNotifications(),
            ...
            },
            {
              ...
              value: function () {
                ...
                this._unsubNotifications = ((t, e) => {
                  const i = new c(),
                    o = t.subscribeMessage((t) => e(i.processMessage(t)), {
                      type: "persistent_notification/subscribe",
                    });
                  return () => {
                    o.then((t) => (null == t ? void 0 : t()));
                  };
                })(this.hass.connection, (t) => {
                  this._hasNotifications = t.length > 0;
                });
              },
            },
            {
            ...
            },
            {
              ...
              key: "styles",
              value: function () {
                return s.iv`:host{position:relative}.dot{pointer-events:none;position:absolute;background-color:var(--accent-color);width:12px;height:12px;top:9px;right:7px;border-radius:50%;border:2px solid var(--app-header-background-color)}`;
              },
            },
          ],
        };
            ...
            },
            {
              ...
              value: function () {
                ...
                return a.dy` ${
                  ...
                  this.error
                }</ha-alert> <slot> <mwc-button @click="${this._handleBack}"> ${
...
//# sourceMappingURL=1908.ck9XYo_a0yM.js.map
