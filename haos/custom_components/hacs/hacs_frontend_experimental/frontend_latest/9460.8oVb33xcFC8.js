...
export const modules = {
    ...
    n.getCanonicalLocales = function (a) {
      return (function (a) {
        ...
        for (var t = 0, L = a; t < L.length; t++) {
          var k = L[t],
            s = (0, r.emitUnicodeLocaleId)(
              (0, m.canonicalizeUnicodeLocaleId)((0, b.parseUnicodeLocaleId)(k))
            );
  ...
  73887: (a, n, t) => {
    ...
    function e(a, n) {
      for (
        var t = L.__spreadArray([], a, !0), b = 0, r = n;
        b < r.length;
        b++
      ) {
        var m = r[b];
    ...
    function l(a) {
      ...
      if (a.variants.length)
        for (var t = "", L = 0, s = a.variants; L < s.length; L++) {
          var u = s[L];
          if (
            (t =
              b.languageAlias[
                (0, k.emitUnicodeLanguageId)({ lang: a.lang, variants: [u] })
              ])
          ) {
            n = {
              lang: (d = (0, r.parseUnicodeLanguageId)(t.split(r.SEPARATOR)))
                .lang,
      ...
      if (n.script && n.region) {
        ...
        if (i)
          n = {
            lang: (d = (0, r.parseUnicodeLanguageId)(i.split(r.SEPARATOR)))
              .lang,
            script: d.script,
            region: d.region,
            variants: n.variants,
      ...
      if (n.region) {
        ...
        if (l)
          n = {
            lang: (d = (0, r.parseUnicodeLanguageId)(l.split(r.SEPARATOR)))
              .lang,
            script: n.script || d.script,
            region: d.region,
            variants: n.variants,
      ...
      g &&
        (n = {
          lang: (d = (0, r.parseUnicodeLanguageId)(g.split(r.SEPARATOR))).lang,
          script: n.script || d.script,
          region: n.region || d.region,
          variants: n.variants,
        });
      if (n.region) {
        var o = n.region.toUpperCase(),
          c = b.territoryAlias[o],
          h = void 0;
        if (c) {
          var p = c.split(" ");
          h = p[0];
          ...
          if (y) {
            var w = (0, r.parseUnicodeLanguageId)(y.split(r.SEPARATOR)).region;
            w && p.indexOf(w) > -1 && (h = w);
          }
        }
      ...
      if (
        (n.script &&
          ...
          b.scriptAlias[n.script] && (n.script = b.scriptAlias[n.script])),
        n.variants.length)
      ) {
        for (var N = 0; N < n.variants.length; N++) {
          u = n.variants[N].toLowerCase();
          if (b.variantAlias[u]) {
            var Z = b.variantAlias[u];
            (0, r.isUnicodeVariantSubtag)(Z)
              ? (n.variants[N] = Z)
              : (0, r.isUnicodeLanguageSubtag)(Z) && (n.lang = Z);
          }
        }
        n.variants.sort();
      }
      ...
      (n.canonicalizeUnicodeLocaleId = function (a) {
        if (((a.lang = l(a.lang)), a.extensions)) {
          for (var n = 0, t = a.extensions; n < t.length; n++) {
            ...
            switch (L.type) {
              case "u":
                (L.keywords = s(L.keywords)),
                  L.attributes &&
                    (L.attributes =
                      ((b = L.attributes),
                      Object.keys(
                        b.reduce(function (a, n) {
  ...
  55946: (a, n, t) => {
    ...
    (n.emitUnicodeLanguageId = b),
      (n.emitUnicodeLocaleId = function (a) {
        for (
          var n = a.lang, t = a.extensions, r = [b(n)], m = 0, k = t;
          m < k.length;
          m++
        ) {
          var s = k[m];
          switch ((r.push(s.type), s.type)) {
            case "u":
              r.push.apply(
                r,
                L.__spreadArray(
                  L.__spreadArray([], s.attributes, !1),
                  s.keywords.reduce(function (a, n) {
                    return a.concat(n);
                  }, []),
                  !1
                )
  ...
  36838: (a, n, t) => {
    ...
    function y(a) {
      ...
      if ("root" === b) return { lang: "root", variants: [] };
      if (!o(b)) throw new RangeError("Malformed unicode_language_subtag");
      ...
      return { lang: b, script: t, region: L, variants: Object.keys(r) };
    }
    function w(a) {
    ...
    function N(a) {
      ...
      if (k.test(a[0])) {
        t = a.shift();
        for (var L = []; a.length && s.test(a[0]); ) L.push(a.shift());
        var b = "";
    ...
    function Z(a) {
      ...
      for (var L = []; a.length && g.test(a[0]); ) {
        for (var b = a.shift(), r = []; a.length && m.test(a[0]); )
          r.push(a.shift());
        if (!r.length)
          throw new RangeError('Missing tvalue for tkey "'.concat(b, '"'));
...
//# sourceMappingURL=9460.8oVb33xcFC8.js.map
