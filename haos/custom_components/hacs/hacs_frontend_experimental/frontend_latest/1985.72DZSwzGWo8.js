...
export const id = 1985;
export const ids = [1985];
export const modules = {
  58417: (c, e, o) => {
    ...
    class k extends a.Wg {
      constructor() {
        super(...arguments),
          ...
          (this.rippleHandlers = new t.A(
            () => (
              (this.shouldRenderRipple = !0),
              this.ripple.then((c) => (this.rippleElement = c)),
              this.ripple
            )
          ));
      }
      ...
      update(c) {
        const e = c.get("indeterminate"),
          o = c.get("checked"),
          d = c.get("disabled");
        if (void 0 !== e || void 0 !== o || void 0 !== d) {
          const c = this.calculateAnimationStateName(!!o, !!e, !!d),
            r = this.calculateAnimationStateName(
              this.checked,
              this.indeterminate,
              this.disabled
            );
          this.animationClass = `${c}-${r}`;
        }
        super.update(c);
      }
      calculateAnimationStateName(c, e, o) {
        return o
          ? "disabled"
          : e
          ? "indeterminate"
      ...
      renderRippleTemplate() {
        return i.dy`<mwc-ripple .disabled="${this.disabled}" unbounded></mwc-ripple>`;
      }
      render() {
        const c = this.indeterminate || this.checked,
          e = {
            "mdc-checkbox--disabled": this.disabled,
            "mdc-checkbox--selected": c,
        ...
        return i.dy` <div class="mdc-checkbox mdc-checkbox--upgraded ${(0, m.$)(
          e
        )}"> <input type="checkbox" class="mdc-checkbox__native-control" name="${(0,
        h.o)(this.name)}" aria-checked="${(0, h.o)(o)}" aria-label="${(0, h.o)(
          this.ariaLabel
        )}" aria-labelledby="${(0, h.o)(
          this.ariaLabelledBy
        )}" aria-describedby="${(0, h.o)(
        ...
        }"> <svg class="mdc-checkbox__checkmark" viewBox="0 0 24 24"> <path class="mdc-checkbox__checkmark-path" fill="none" d="M1.73,12.91 8.1,19.28 22.79,4.59"></path> </svg> <div class="mdc-checkbox__mixedmark"></div> </div> ${this.renderRipple()} </div>`;
      }
      setFormData(c) {
        this.name && this.checked && c.append(this.name, this.value);
      }
      handleFocus() {
      ...
      handleRippleMouseDown(c) {
        const e = () => {
          window.removeEventListener("mouseup", e),
            this.handleRippleDeactivate();
        };
        window.addEventListener("mouseup", e),
          this.rippleHandlers.startPress(c);
      }
      handleRippleTouchStart(c) {
        this.rippleHandlers.startPress(c);
      }
      ...
      get isRippleActive() {
        var c;
        return (
          (null === (c = this.rippleElement) || void 0 === c
            ? void 0
            : c.isActive) || !1
        );
      }
    ...
    (0, d.__decorate)(
      ...
      (0, d.__decorate)(
        [r.L, (0, n.Cb)({ type: String, attribute: "aria-label" })],
        k.prototype,
        "ariaLabel",
        void 0
      ),
      (0, d.__decorate)(
        [r.L, (0, n.Cb)({ type: String, attribute: "aria-labelledby" })],
        k.prototype,
        "ariaLabelledBy",
        void 0
      ),
      (0, d.__decorate)(
        [r.L, (0, n.Cb)({ type: String, attribute: "aria-describedby" })],
        k.prototype,
        "ariaDescribedBy",
        void 0
      ),
      ...
      (0, d.__decorate)([(0, n.SB)()], k.prototype, "animationClass", void 0),
      (0, d.__decorate)(
        [(0, n.SB)()],
        k.prototype,
        "shouldRenderRipple",
      ...
      (0, d.__decorate)([(0, n.SB)()], k.prototype, "focused", void 0),
      (0, d.__decorate)(
        [(0, n.GC)("mwc-ripple")],
        k.prototype,
        "ripple",
