export const id = 6255;
export const ids = [6255];
export const modules = {
  ...
  76255: (e, i, t) => {
    t.r(i), t.d(i, { HaFormTimePeriod: () => l });
    var a = t(309),
      d = t(5095),
      n = t(95260);
    t(92353);
    let l = (0, a.Z)(
      [(0, n.Mo)("ha-form-positive_time_period_dict")],
      function (e, i) {
        return {
          F: class extends i {
            constructor(...i) {
          ...
          d: [
            ...
            {
              kind: "field",
              decorators: [(0, n.IO)("ha-time-input", !0)],
              key: "_input",
              value: void 0,
            },
            {
            ...
            },
            {
              ...
              key: "render",
              value: function () {
                return d.dy` <ha-duration-input .label="${this.label}" ?required="${this.schema.required}" .data="${this.data}" .disabled="${this.disabled}"></ha-duration-input> `;
              },
            },
          ],
        };
        ...
        return {
          ...
          d: [
            ...
            },
            {
              ...
              value: function () {
                (0, d.Z)((0, n.Z)(t.prototype), "connectedCallback", this).call(
                  this
                ),
...
//# sourceMappingURL=6255.O_q0VehTRK4.js.map
