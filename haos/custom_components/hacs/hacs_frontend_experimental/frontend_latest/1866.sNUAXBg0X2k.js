export const id = 1866;
export const ids = [1866];
export const modules = {
  ...
  46042: (e, n, a) => {
    ...
    function u(e, n, a) {
      ...
      if (_ && "$" === _[0]) {
        var u = "!" !== _[1],
          c = (u ? a[_.slice(1)] : a[_.slice(2)])
            .map(function (e) {
              return t[e] || [e];
            })
            .reduce(function (e, n) {
              return (0, r.__spreadArray)(
                (0, r.__spreadArray)([], e, !0),
                n,
                !0
              );
            }, []);
    ...
    function f(e, n, a) {
      for (var r = 0, s = a.matches; r < s.length; r++) {
        var t = s[r],
          d =
            u(e, t.desired, a.matchVariables) &&
            u(n, t.supported, a.matchVariables);
        if (
          (t.oneway ||
            d ||
            (d =
              u(e, t.supported, a.matchVariables) &&
              u(n, t.desired, a.matchVariables)),
          d)
        ) {
          var i = 10 * t.distance;
          return a.paradigmLocales.indexOf(c(e)) > -1 !=
            a.paradigmLocales.indexOf(c(n)) > -1
            ? i - 1
            : i;
        }
      }
          ...
          if (!_) {
            var a =
                null ===
                  (n =
                    null ===
                      (e = s.supplemental.languageMatching["written-new"][0]) ||
                    void 0 === e
                      ? void 0
                      : e.paradigmLocales) || void 0 === n
                  ? void 0
                  : n._locales.split(" "),
              t = s.supplemental.languageMatching["written-new"].slice(1, 5),
              d = s.supplemental.languageMatching["written-new"]
                .slice(5)
                .map(function (e) {
      ...
      return (
        ...
        d.script !== i.script &&
          (o += f(
            ...
            { language: t.language, script: d.script, region: "" },
            u
          )),
        d.region !== i.region && (o += f(d, i, u)),
        o
      );
    }
    function y(e, n, a) {
      ...
      return (
        _.matchedSupportedLocale &&
          ...
          (s =
            i[_.matchedDesiredLocale].slice(_.matchedDesiredLocale.length) ||
            void 0)),
    ...
    function w(e, n) {
      i(2 === n.length, "key must have 2 elements");
      var a = e.length,
        r = "-".concat(n, "-"),
        s = e.indexOf(r);
      if (-1 !== s) {
        for (var t = s + 4, d = t, _ = t, o = !1; !o; ) {
          var u = e.indexOf("-", _);
          2 === (-1 === u ? a - _ : u - _)
            ? (o = !0)
            : -1 === u
    ...
    function M(e, n, a, r, s, t) {
          ...
          ? (function (e, n, a) {
              for (var r = { locale: "" }, s = 0, t = n; s < t.length; s++) {
                ...
                if (o)
                  return (
                    (r.locale = o),
                    i !== _ && (r.extension = i.slice(_.length, i.length)),
                    r
                  );
              }
              return (r.locale = a()), r;
      ...
      for (
        ...
        var M = l[f];
        i(o in s, "Missing locale data for ".concat(o));
        var L = s[o];
        i(
        ...
        i(
          ...
          "value must be string or null but got "
            .concat(typeof A, " in key ")
            .concat(M)
        );
        var C = "";
        if (_.extension) {
          var S = w(_.extension, M);
          void 0 !== S &&
            ("" !== S
              ? ~G.indexOf(S) && ((A = S), (C = "-".concat(M, "-").concat(A)))
              : ~S.indexOf("true") && ((A = "true"), (C = "-".concat(M))));
        }
        if (M in a) {
          var g = a[M];
          i(
...
//# sourceMappingURL=1866.sNUAXBg0X2k.js.map
