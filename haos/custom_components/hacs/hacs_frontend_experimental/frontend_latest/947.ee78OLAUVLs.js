...
export const modules = {
  20947: (e, i, t) => {
    t.r(i), t.d(i, { HaFormString: () => r });
    var d = t(309),
      n = t(5095),
      a = t(95260),
      o = t(18394);
    t(54371), t(51520);
    const l = ["password", "secret", "token"];
    let r = (0, d.Z)(
      [(0, a.Mo)("ha-form-string")],
      function (e, i) {
        return {
          F: class extends i {
            constructor(...i) {
          ...
          d: [
            ...
            {
              kind: "field",
              decorators: [(0, a.IO)("ha-textfield")],
              key: "_input",
              value: void 0,
            },
            {
            ...
            },
            {
              ...
              value: function () {
                ...
                return n.dy` <ha-textfield .type="${
                  ...
                  this.disabled
                }" .required="${this.schema.required}" .autoValidate="${
                  this.schema.required
                }" .name="${this.schema.name}" .autocomplete="${
                  this.schema.autocomplete
                }" .suffix="${
                  this.isPassword
                    ? n.dy`<div style="width:24px"></div>`
            ...
            },
            {
              ...
              value: function () {
                ...
                return this.isPassword
                  ? n.dy` <ha-icon-button toggles .label="${
            ...
            },
            {
              ...
              value: function (e) {
                ...
                this.data !== i &&
                  ("" !== i || this.schema.required || (i = void 0),
            ...
            },
            {
              ...
              key: "isPassword",
              value: function () {
                return l.some((e) => this.schema.name.includes(e));
              },
            },
            {
              kind: "get",
              ...
              key: "styles",
              value: function () {
                return n.iv`:host{display:block;position:relative}:host([own-margin]){margin-bottom:5px}ha-textfield{display:block}ha-icon-button{position:absolute;top:8px;right:8px;inset-inline-start:initial;inset-inline-end:8px;--mdc-icon-button-size:40px;--mdc-icon-size:20px;color:var(--secondary-text-color);direction:var(--direction)}`;
              },
            },
          ],
        };
        ...
        return {
          ...
          d: [
            ...
            },
            {
              ...
              key: "updated",
              value: function (e) {
                (0, n.Z)((0, a.Z)(t.prototype), "updated", this).call(this, e),
                  ((e.has("invalid") &&
            ...
            },
            {
              ...
              value: function (e, i = !1) {
                ...
                return r.dy` <span class="mdc-text-field__icon mdc-text-field__icon--${t}" tabindex="${
                  i ? 1 : -1
