export const id = 7716;
export const ids = [7716];
  ...
  27716: () => {
    ...
    (e = window),
        ...
        _endPoint: function (t, i, o) {
          if (this._mouseDownOrigin) {
            ...
            this.options.maxPoints == this._markers.length + 1
              ...
              ? this._finishShape()
              : Math.abs(a) < 9 * (e.devicePixelRatio || 1) &&
      ...
      (L.Draw.SimpleShape = L.Draw.Feature.extend({
        ...
        addHooks: function () {
          L.Draw.Feature.prototype.addHooks.call(this),
            this._map &&
              ...
              i.addEventListener("touchstart", L.DomEvent.preventDefault, {
                passive: !1,
              }));
        },
        removeHooks: function () {
          L.Draw.Feature.prototype.removeHooks.call(this),
            this._map &&
              ...
              L.DomEvent.off(i, "mouseup", this._onMouseUp, this),
              L.DomEvent.off(i, "touchend", this._onMouseUp, this),
              i.removeEventListener("touchstart", L.DomEvent.preventDefault),
              this._shape &&
        ...
        _onMouseDown: function (t) {
          (this._isDrawing = !0),
            ...
            L.DomEvent.on(i, "mouseup", this._onMouseUp, this)
              .on(i, "touchend", this._onMouseUp, this)
        ...
        _initMarkers: function () {
          ...
          for (t = 0, e = i - 1; t < i; e = t++)
            (0 !== t || (L.Polygon && this._poly instanceof L.Polygon)) &&
              ((a = this._markers[e]),
              (n = this._markers[t]),
              this._createMiddleMarker(a, n),
              this._updatePrevNext(a, n));
        },
      ...
      (L.Edit.Circle = L.Edit.CircleMarker.extend({
        ...
        _resize: function (e) {
          var i = this._moveMarker.getLatLng();
          (t = L.GeometryUtil.isVersion07x()
            ? i.distanceTo(e)
            : this._map.distance(i, e)),
...
//# sourceMappingURL=7716.L65qrSeGm-4.js.map
