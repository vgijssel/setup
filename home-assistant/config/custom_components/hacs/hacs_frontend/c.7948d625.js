...
import { s as p, S as f, a as m } from "./c.42d6aebd.js";
import "./c.f1291e50.js";
import "./c.9b92f489.js";
import "./c.11ad1623.js";
import { f as v } from "./c.3243a8b0.js";
import { b as g } from "./c.0a1cf8d0.js";
...
(y.styles = [p]), (y = e([t("mwc-select")], y));
const _ = ["stars", "last_updated", "name"];
let k = i(
  [t("hacs-add-repository-dialog")],
  function (e, t) {
    return {
      F: class extends t {
        constructor(...t) {
      ...
      d: [
        ...
        { kind: "field", decorators: [s()], key: "_sortBy", value: () => _[0] },
        { kind: "field", decorators: [s()], key: "section", value: void 0 },
        {
          kind: "method",
          key: "shouldUpdate",
          value: function (e) {
              ...
              null == e
                ...
                : e.filter((e) => {
                    ...
                    return (
                      ...
                      void 0 === i ||
                      null ===
                        (a = i.find((e) => e.id === this.section).categories) ||
                      void 0 === a
                        ? void 0
        ...
        },
        {
          ...
          value: async function () {
            ...
            if (
              ...
              var t;
              const e =
                null === (t = r(this.hacs.language, this.route)) || void 0 === t
                  ? void 0
                  : t.categories;
              null == e ||
                e
        ...
        { kind: "field", key: "_filterRepositories", value: () => o(v) },
        {
          kind: "method",
          key: "render",
          value: function () {
            ...
            this._searchInput =
              window.localStorage.getItem("hacs-search") || "";
      ...
      >
          ...
          >
            ${_.map(
              (e) => l`<mwc-list-item .value=${e}>
                  ${
                    this.hacs.localize(`dialog_add_repo.sort_by_values.${e}`) ||
                    e
                  }
                </mwc-list-item>`
            )}
        ...
        <div class=${c({ content: !0, narrow: this.narrow })} @scroll=${
                this._loadMore
              }>
          <mwc-list>
            ${
              0 === t.length
                ? l`<ha-alert>${this.hacs.localize(
        ...
        },
        {
          ...
          value: function (e) {
            ...
            if (null !== (t = e.target) && void 0 !== t && t.outerHTML)
              try {
                e.target.outerHTML = `<ha-svg-icon path="${d}" slot="graphic"></ha-svg-icon>`;
              } catch (e) {}
          },
        },
        {
...
export { k as HacsAddRepositoryDialog };
