...
import { s as g } from "./c.4266acdb.js";
import { f, a as $ } from "./c.fe747ba2.js";
import { m as b } from "./c.f6611997.js";
import { u as x } from "./c.25ed1ae4.js";
...
let k = s(
  ...
  function (s, i) {
    ...
    return {
      F: u,
      d: [
        { kind: "field", decorators: [e()], key: "repository", value: void 0 },
        {
          kind: "field",
        ...
        { kind: "field", decorators: [t()], key: "_repository", value: void 0 },
        {
          kind: "method",
          key: "firstUpdated",
          value: async function (s) {
            a(o(u.prototype), "firstUpdated", this).call(this, s),
              (this._repository = await f(this.hass, this.repository)),
              this._repository &&
                ("commit" !== this._repository.version_or_commit &&
                  (this._releaseNotes = await r(
                    this.hass,
                    String(this._repository.id)
                  )),
                n(this.hass, (s) => (this._error = s), l.ERROR));
          },
        },
        {
          kind: "method",
          ...
          value: function () {
            var s;
            return this.active && this._repository
              ? c`
      <hacs-dialog
        .active=${this.active}
      ...
      >
        <div class=${h({ content: !0, narrow: this.narrow })}>
          <p class="message">
            ${this.hacs.localize("dialog_update.message", {
              ...
              ? this._releaseNotes.map(
                  (s) => c`
                    ...
                    >
                      ${
                        s.body
                          ? b.html(s.body, this._repository)
          ...
          ${
            this._repository.can_download
              ? ""
              : c`<ha-alert alert-type="error" .rtl=${y(this.hass)}>
                  ${this.hacs.localize(
          ...
          ${
            "integration" === this._repository.category
              ? c`<p>${this.hacs.localize("dialog_download.restart")}</p>`
              : ""
          }
          ${
        ...
        <mwc-button
          ...
          ${
            this._updating
              ? c`<ha-circular-progress active size="small"></ha-circular-progress>`
    ...
    `
        ...
        },
        {
          ...
          key: "_getChanglogURL",
          value: function () {
            return "commit" === this._repository.version_or_commit
              ? `https://github.com/${this._repository.full_name}/compare/${this._repository.installed_version}...${this._repository.available_version}`
              : `https://github.com/${this._repository.full_name}/releases`;
          },
        },
        {
          kind: "get",
