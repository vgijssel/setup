...
const A = window.trustedTypes,
  ...
  L = (e, t) => t !== e && (t == t || e == e),
  S = { attribute: !0, type: String, converter: k, reflect: !1, hasChanged: L };
class V extends HTMLElement {
  ...
  static finalizeStyles(e) {
    ...
    if (Array.isArray(e)) {
      ...
      for (const e of o) t.unshift(b(e));
  ...
  requestUpdate(e, t, o) {
    let r = !0;
    void 0 !== e &&
      (((o = o || this.constructor.getPropertyOptions(e)).hasChanged || L)(
        this[e],
        t
      )
...
const M = globalThis.trustedTypes,
  ...
  ee = j.createTreeWalker(j, 129, null, !1),
  te = (e, t) => {
    const o = e.length - 1,
      r = [];
    let i,
    ...
    return [void 0 !== E ? E.createHTML(s) : s, r];
  };
class oe {
  constructor({ strings: e, _$litType$: t }, o) {
    ...
    for (; null !== (r = ee.nextNode()) && s.length < a; ) {
      if (1 === r.nodeType) {
        ...
        if (r.data === z) s.push({ type: 2, index: i });
        else {
          let e = -1;
...
class ne {
  ...
  A(e) {
    ...
    for (const i of e)
      r === t.length
        ? t.push((o = new ne(this.M(N()), this.M(N()), this, this.options)))
        : (o = t[r]),
        o._$AI(i),
        r++;
...
var he, ge;
null == me || me(oe, ne),
  (null !== (x = globalThis.litHtmlVersions) && void 0 !== x
    ? x
...
const Se =
  null !=
  (null === (Le = window.HTMLSlotElement) || void 0 === Le
    ? void 0
    : Le.prototype.assignedElements)
...
const Te = (e) => {
  ...
  Oe = (e) => `#${je(e[0])}${je(e[1])}${je(e[2])}`,
  Ie = 0.137931034,
  Re = 0.12841855,
  De = (e) =>
    (e /= 255) <= 0.04045 ? e / 12.92 : ((e + 0.055) / 1.055) ** 2.4,
  Be = (e) => (e > 0.008856452 ? e ** (1 / 3) : e / Re + Ie),
  $e = (e) => 255 * (e <= 0.00304 ? 12.92 * e : 1.055 * e ** (1 / 2.4) - 0.055),
  Fe = (e) => (e > 0.206896552 ? e * e * e : Re * (e - Ie)),
  Ue = (e) => {
    const [t, o, r] = ((e) => {
        let [t, o, r] = e;
        return (
...
const We = (e, t, o, r, i) => {
    ...
    let d = s,
      c = {};
    if ((s && l && ((d = `${d}__dark`), (c = { ...xe })), "default" === s)) {
      var p;
  ...
  rt = {},
  it = Symbol.for("HA focus target"),
  nt = async (e, t, o, r, i, n = !0) => {
    var a;
    if (!(o in rt)) {
      if (!i)
        return void (
    ...
    if (
      (null !== (a = Je.history.state) && void 0 !== a && a.replaced
        ? ((rt[o].closedFocusTargets =
            rt[Je.history.state.dialog].closedFocusTargets),
          delete rt[Je.history.state.dialog].closedFocusTargets)
        : (rt[o].closedFocusTargets = ((e, t, o = !0) => {
            const r = new Set();
            for (; e; ) r.add(e), (e = et(e, t, o));
            return r;
          })(tt(), it)),
      n)
    ) {
      ...
      Je.history.replaceState(
        {
          ...
          open: !1,
          oldState:
            null !== (s = Je.history.state) &&
            void 0 !== s &&
            s.open &&
            (null === (l = Je.history.state) || void 0 === l
              ? void 0
              : l.dialog) !== o
              ? Je.history.state
              : null,
      ...
      try {
        ...
        Je.history.pushState({ dialog: o, dialogParams: null, open: !0 }, "");
      }
    }
    const d = await rt[o].element;
    d.addEventListener("dialog-closed", at), t.appendChild(d), d.showDialog(r);
  },
  at = async (e) => {
    const t = rt[e.detail.dialog].closedFocusTargets;
    if ((delete rt[e.detail.dialog].closedFocusTargets, !t)) return;
    let o = tt();
    o instanceof HTMLElement && o.blur(), await ot();
    for (const e of t)
      if (
        e instanceof HTMLElement &&
        (e.focus(), (o = tt()), o && o !== document.body)
      )
        return;
    __DEV__ &&
  ...
  lt = !(window.ShadyDOM && window.ShadyDOM.inUse);
let dt, ct;
function pt(e) {
  dt =
...
const ut = Boolean(window.ShadyCSS && window.ShadyCSS.disableRuntime);
window.ShadyCSS && void 0 !== window.ShadyCSS.nativeCss
  ? (dt = window.ShadyCSS.nativeCss)
  : window.ShadyCSS
  ? (pt(window.ShadyCSS), (window.ShadyCSS = void 0))
  : pt(window.WebComponents && window.WebComponents.flags);
const mt = dt;
class ht {
  constructor() {
    (this.start = 0),
      ...
      for (let r = 0, i = e.length; r < i; r++)
        if (e[r] === vt) {
          ...
          (o = new ht()),
            ...
            (o.previous = t),
            e.rules.push(o);
        } else e[r] === bt && ((o.end = r + 1), (o = o.parent || t));
      return t;
    })((e = e.replace(Ct.comments, "").replace(Ct.port, ""))),
    e
  );
}
function _t(e, t) {
  ...
  if (((e.parsedCssText = e.cssText = o.trim()), e.parent)) {
    ...
    (o = t.substring(r, e.start - 1)),
      ...
      (o = o.replace(Ct.multipleSpaces, " ")),
      (o = o.substring(o.lastIndexOf(";") + 1));
    let i = (e.parsedSelector = e.selector = o.trim());
    (e.atRule = 0 === i.indexOf(wt)),
      e.atRule
        ? 0 === i.indexOf(Ht)
          ? (e.type = yt.MEDIA_RULE)
          : i.match(Ct.keyframesRule) &&
            ((e.type = yt.KEYFRAMES_RULE),
            (e.keyframesName = e.selector.split(Ct.multipleSpaces).pop()))
        : 0 === i.indexOf(At)
        ? (e.type = yt.MIXIN_RULE)
        : (e.type = yt.STYLE_RULE);
  }
  let r = e.rules;
  if (r) for (let e, o = 0, i = r.length; o < i && (e = r[o]); o++) _t(e, t);
  return e;
}
function ft(e, t, o = "") {
  let r = "";
  if (e.cssText || e.rules) {
    ...
    if (
      ...
      !(function (e) {
        let t = e[0];
        return (
          Boolean(t) && Boolean(t.selector) && 0 === t.selector.indexOf(At)
        );
      })(o)
    )
      for (let e, i = 0, n = o.length; i < n && (e = o[i]); i++)
        r = ft(e, t, r);
    else
      (r = t
        ? e.cssText
        : (function (e) {
            return (function (e) {
              return e.replace(Ct.mixinApply, "").replace(Ct.varApply, "");
            })(
              (e = (function (e) {
                return e.replace(Ct.customProp, "").replace(Ct.mixinProp, "");
              })(e))
            );
          })(e.cssText)),
        (r = r.trim()),
  ...
  return (
    r &&
      (e.selector && (o += e.selector + " " + vt + "\n"),
      (o += r),
      e.selector && (o += bt + "\n\n")),
    o
  );
}
const yt = { STYLE_RULE: 1, KEYFRAMES_RULE: 7, MEDIA_RULE: 4, MIXIN_RULE: 1e3 },
  vt = "{",
  bt = "}",
  Ct = {
    comments: /\/\*[^*]*\*+([^/*][^*]*\*+)*\//gim,
...
function Et(e, t) {
  return e
    ? ("string" == typeof e && (e = gt(e)), t && zt(e, t), ft(e, mt))
    : "";
}
function Pt(e) {
  return (
    !e.__cssRules && e.textContent && (e.__cssRules = gt(e.textContent)),
    e.__cssRules || null
  );
}
function zt(e, t, o, r) {
  ...
  let i = !1,
    n = e.type;
  if (r && n === yt.MEDIA_RULE) {
    let t = e.selector.match(St);
    t && (window.matchMedia(t[1]).matches || (i = !0));
  }
  n === yt.STYLE_RULE
    ? t(e)
    : o && n === yt.KEYFRAMES_RULE
    ? o(e)
    : n === yt.MIXIN_RULE && (i = !0);
  let a = e.rules;
  if (a && !i)
    for (let e, i = 0, n = a.length; i < n && (e = a[i]); i++) zt(e, t, o, r);
}
function Tt(e, t) {
  let o = e.indexOf("var(");
  if (-1 === o) return t(e, "", "", "");
...
class Ut {
  ...
  detectMixin(e) {
    return (function (e) {
      const t = Lt.test(e) || kt.test(e);
      return (Lt.lastIndex = 0), (kt.lastIndex = 0), t;
    })(e);
  }
  gatherStyles(e) {
    const t = (function (e) {
      ...
      for (let e = 0; e < o.length; e++) {
        const r = o[e];
        Mt(r)
          ? lt || (xt(r), r.parentNode.removeChild(r))
  ...
  transformStyle(e, t = "") {
    let o = Pt(e);
    return this.transformRules(o, t), (e.textContent = Et(o)), o;
  }
  ...
  _consumeCssProperties(e, t) {
    ...
    for (; (o = Lt.exec(e)); ) {
      ...
      (e = `${l}${p}${d}`), (Lt.lastIndex = n + p.length);
    }
    return e;
  }
  _atApplyToCssProperties(e, t) {
    ...
    if ((r || (this._map.set(e, {}), (r = this._map.get(e))), r)) {
      ...
      for (i in s)
        (a = t && t[i]),
          (n = [i, ": var(", e, "_-_", i]),
          a && n.push(",", a.replace(Bt, "")),
          n.push(")"),
          Bt.test(s[i]) && n.push(" !important"),
          o.push(n.join(""));
    }
    return o.join("; ");
  }
  ...
  _invalidateMixinEntry(e) {
    if (Ft) for (let t in e.dependants) t !== this._currentElement && Ft(t);
  }
...
(Ut.prototype.detectMixin = Ut.prototype.detectMixin),
  (Ut.prototype.transformStyle = Ut.prototype.transformStyle),
  (Ut.prototype.transformCustomStyle = Ut.prototype.transformCustomStyle),
  (Ut.prototype.transformRules = Ut.prototype.transformRules),
  (Ut.prototype.transformRule = Ut.prototype.transformRule),
  (Ut.prototype.transformTemplate = Ut.prototype.transformTemplate),
  (Ut.prototype._separator = "_-_"),
  Object.defineProperty(Ut.prototype, "invalidCallback", {
    get: () => Ft,
    set(e) {
      Ft = e;
    },
...
const Zt = {},
  ...
  Gt = "_applyShimNextVersion",
  Kt = "_applyShimValidatingVersion",
  Yt = Promise.resolve();
function Wt(e) {
  let t = Zt[e];
  t &&
    (function (e) {
      (e[qt] = e[qt] || 0), (e[Kt] = e[Kt] || 0), (e[Gt] = (e[Gt] || 0) + 1);
    })(t);
}
function Xt(e) {
  return e[qt] === e[Gt];
...
let Jt,
  Qt = null,
  eo = (window.HTMLImports && window.HTMLImports.whenReady) || null;
function to(e) {
      ...
      : (Qt ||
          ...
          "complete" === document.readyState
            ...
            : document.addEventListener("readystatechange", () => {
                "complete" === document.readyState && Jt();
              })),
        Qt.then(function () {
          e && e();
        }));
...
const oo = "__shadyCSSCachedStyle";
let ro = null,
  io = null;
class no {
  constructor() {
  ...
  enqueueDocumentValidation() {
    !this.enqueued && io && ((this.enqueued = !0), to(io));
  }
  addCustomStyle(e) {
    e.__seenByShadyCSS ||
...
(no.prototype.addCustomStyle = no.prototype.addCustomStyle),
  (no.prototype.getStyleForCustomStyle = no.prototype.getStyleForCustomStyle),
  (no.prototype.processStyles = no.prototype.processStyles),
  Object.defineProperties(no.prototype, {
    ...
    validateCallback: {
      ...
      set(e) {
        let t = !1;
        io || (t = !0), (io = e), t && this.enqueueDocumentValidation();
      },
    },
  });
const ao = new Ut();
class so {
  constructor() {
    (this.customStyleInterface = null), (ao.invalidCallback = Wt);
  }
  ensure() {
  ...
  prepareTemplate(e, t) {
    if ((this.ensure(), Nt(e))) return;
    Zt[t] = e;
    let o = ao.transformTemplate(e, t);
    e._styleAst = o;
  }
  flushCustomStyles() {
    ...
    if (this.customStyleInterface.enqueued) {
      for (let t = 0; t < e.length; t++) {
        ...
        r && ao.transformCustomStyle(r);
      }
      this.customStyleInterface.enqueued = !1;
    }
  }
  styleSubtree(e, t) {
    if ((this.ensure(), t && Ot(e, t), e.shadowRoot)) {
      this.styleElement(e);
        ...
        (function (e) {
          (e[Kt] = e[Gt]),
            e._validating ||
              ((e._validating = !0),
              Yt.then(function () {
                (e[qt] = e[Gt]), (e._validating = !1);
              }));
        })(o));
      let r = e.shadowRoot;
      if (r) {
        let e = r.querySelector("style");
        e && ((e.__cssRules = o._styleAst), (e.textContent = Et(o._styleAst)));
      }
    }
  }
  styleDocument(e) {
...
if (!window.ShadyCSS || !window.ShadyCSS.ScopingShim) {
  ...
  (window.ShadyCSS = {
    ...
    getComputedStyleValue: (e, t) => It(e, t),
    flushCustomStyles() {
      e.flushCustomStyles();
    },
    nativeCss: mt,
...
let lo,
  ...
  uo = /(^\/[^\/])|(^#)|(^[\w-\d]*:)/;
function mo(e, t) {
  if (e && uo.test(e)) return e;
  if ("//" === e) return e;
  if (void 0 === lo) {
    lo = !1;
    try {
      const e = new URL("b", "http://a");
      (e.pathname = "c%20d"), (lo = "http://a/c%20d" === e.href);
    } catch (e) {}
  }
  if ((t || (t = document.baseURI || window.location.href), lo))
    try {
  ...
  return (
    co ||
      ...
      (co.base = co.createElement("base")),
      co.head.appendChild(co.base),
      (co.anchor = co.createElement("a")),
      co.body.appendChild(co.anchor)),
    (co.base.href = t),
    (co.anchor.href = e),
    co.anchor.href || e
  );
...
function ho(e, t) {
  return e.replace(po, function (e, o, r, i) {
    return o + "'" + mo(r.replace(/["']/g, ""), t) + "'" + i;
  });
}
function go(e) {
  return e.substring(0, e.lastIndexOf("/") + 1);
}
const _o = !window.ShadyDOM || !window.ShadyDOM.inUse;
...
let yo =
    ...
    go(document.baseURI || window.location.href),
  vo = (window.Polymer && window.Polymer.sanitizeDOMValue) || void 0,
  bo = (window.Polymer && window.Polymer.setPassiveTouchGestures) || !1,
  Co = (window.Polymer && window.Polymer.strictTemplatePolicy) || !1,
  Ao = (window.Polymer && window.Polymer.allowTemplateFromDomModule) || !1,
  Ho = (window.Polymer && window.Polymer.legacyOptimizations) || !1,
  wo = (window.Polymer && window.Polymer.legacyWarnings) || !1,
  ko = (window.Polymer && window.Polymer.syncInitialRender) || !1,
  Lo = (window.Polymer && window.Polymer.legacyUndefined) || !1,
  So = (window.Polymer && window.Polymer.orderedComputed) || !1,
  Vo = (window.Polymer && window.Polymer.removeNestedTemplates) || !1,
  xo = (window.Polymer && window.Polymer.fastDomIf) || !1,
  Mo = (window.Polymer && window.Polymer.suppressTemplateNotifications) || !1,
  Eo = (window.Polymer && window.Polymer.legacyNoObservedAttributes) || !1,
  Po =
...
let jo = {},
  No = {};
function Oo(e, t) {
  jo[e] = No[e.toLowerCase()] = t;
}
function Io(e) {
  return jo[e] || No[e.toLowerCase()];
}
    ...
    if (!this.__assetpath) {
      const e =
          window.HTMLImports && HTMLImports.importForElement
            ...
            : this.ownerDocument,
        t = mo(this.getAttribute("assetpath") || "", e.baseURI);
      this.__assetpath = go(t);
    }
...
(Ro.prototype.modules = jo), customElements.define("dom-module", Ro);
function Do(e) {
  return Ro.import(e);
}
function Bo(e) {
  const t = ho((e.body ? e.body : e).textContent, e.baseURI),
...
function $o(e) {
  const t = e.trim().split(/\s+/),
    o = [];
  for (let e = 0; e < t.length; e++) o.push(...Fo(t[e]));
  return o;
}
function Fo(e) {
  const t = Do(e);
  ...
  if (void 0 === t._styles) {
    ...
    o && e.push(...Uo(o, t.assetpath)), (t._styles = e);
  }
  return t._styles;
}
function Uo(e, t) {
  if (!e._styles) {
    ...
    for (let e = 0; e < r.length; e++) {
      ...
      n &&
        o.push(
          ...$o(n).filter(function (e, t, o) {
            return o.indexOf(e) === t;
          })
        ),
        t && (i.textContent = ho(i.textContent, t)),
        o.push(i);
    }
    e._styles = o;
  }
...
function ar(e) {
  return (
    rr[e] ||
    (rr[e] = e.indexOf("-") < 0 ? e : e.replace(ir, (e) => e[1].toUpperCase()))
  );
}
function sr(e) {
  return rr[e] || (rr[e] = e.replace(nr, "-$1").toLowerCase());
}
let lr = 0,
  dr = 0,
  cr = [],
...
const hr = {
  ...
  _r = {
    run: (e) => (ur || ((ur = !0), (mr.textContent = pr++)), cr.push(e), lr++),
    cancel(e) {
      const t = e - dr;
      if (t >= 0) {
        if (!cr[t]) throw new Error("invalid async handle: " + e);
        cr[t] = null;
      }
    },
  },
...
for (; br; ) {
  let e = Object.getOwnPropertyNames(br);
  for (let t = 0; t < e.length; t++) vr[e[t]] = !0;
...
const Cr = To((e) => {
    ...
    return class extends t {
      static createPropertiesForAttributes() {
        ...
        for (let t = 0; t < e.length; t++)
          this.prototype._createPropertyAccessor(ar(e[t]));
      }
      static attributeNameForProperty(e) {
        return sr(e);
      }
...
function kr(e) {
  (function () {
    if (!Hr) {
      ...
      (e.placeholder = "a"), (wr = e.placeholder === e.textContent);
    }
    return wr;
  })() &&
...
function Sr(e, t) {
  let o = t.parentInfo && Sr(e, t.parentInfo);
  if (!o) return e;
    ...
    class extends e {
      ...
      _stampTemplate(e, t) {
        ...
        for (let e, r = 0, a = o.length; r < a && (e = o[r]); r++) {
          let o = (n[r] = Sr(i, e));
          Vr(0, i.$, o, e), Mr(0, o, e, t), xr(this, o, e);
        }
        return i;
      }
...
function Rr(e, t) {
  if (t) {
    let o = t.name;
    return (
      o == e || !(!t.structured || !Wo(o, e)) || !(!t.wildcard || !Xo(o, e))
    );
  }
  return !0;
}
...
function Br(e, t, o) {
  let r = Yo(t);
  if (r !== t) {
    return $r(e, sr(r) + "-changed", o[t], t), !0;
  }
  return !1;
}
function $r(e, t, o, r) {
  let i = { value: o, queueProperty: !0 };
  r && (i.path = r), Go(e).dispatchEvent(new CustomEvent(t, { detail: i }));
}
function Fr(e, t, o, r, i, n) {
  let a = (n ? Yo(t) : t) != t ? t : null,
    s = a ? tr(e, a) : e.__data[t];
  a && void 0 === s && (s = o[t]), $r(e, i.eventName, s, a);
}
function Ur(e, t, o, r, i) {
  let n = e.__data[t];
  vo && (n = vo(n, i.attrName, "attribute", e)),
  ...
  if (i)
    if (So) {
      ...
      const n = (function (e) {
        ...
        a = [];
      for (let e in t) Gr(e, i, a, n, r);
      let s;
      for (; (s = a.shift()); )
        Kr(e, "", t, o, s) && Gr(s.methodInfo, i, a, n, r);
  ...
  Gr = (e, t, o, r, i) => {
    ...
    if (n)
      for (let t = 0; t < n.length; t++) {
        ...
        a.info.lastRun === Pr ||
          (i && !Rr(e, a.trigger)) ||
          ((a.info.lastRun = Pr), qr(a.info, o, r));
      }
  };
...
function Yr(e, t, o, r, i, n, a) {
  ...
  if (
    ...
    (s.listenerEvent = e || sr(i) + "-changed"), (s.listenerNegate = t);
  }
  let l = t.nodeInfoList.length;
  for (let o = 0; o < s.parts.length; o++) {
    let r = s.parts[o];
    (r.compoundIndex = o), Wr(e, t, s, r, l);
  }
}
  ...
  if (!r.literal)
    if ("attribute" === o.kind && "-" === o.target[0])
      ...
      for (let o = 0; o < n.length; o++) {
        let r = n[o];
        "string" == typeof r && ((r = ai(r)), (r.wildcard = !0)),
      ...
      (function (e, t, o, r, i) {
        ...
        if ("attribute" == o.kind) e._valueToNodeAttribute(t, i, o.target);
          ...
          t.__dataHasAccessor[r]
            ? (t[Tr.READ_ONLY] && t[Tr.READ_ONLY][r]) ||
...
function Jr(e, t) {
  if (t.isCompound) {
    ...
    (o[n] = i),
      t.literal &&
        "property" == t.kind &&
        ("className" === n && (e = Go(e)), (e[n] = t.literal));
  }
}
function Qr(e, t, o) {
  if (o.listenerEvent) {
    ...
    e.addEventListener(o.listenerEvent, function (e) {
      !(function (e, t, o, r, i) {
        let n,
          a = e.detail,
          s = a && a.path;
        s ? ((r = Jo(o, r, s)), (n = a && a.value)) : (n = e.currentTarget[o]),
          (n = i ? !n : n),
          (t[Tr.READ_ONLY] && t[Tr.READ_ONLY][r]) ||
...
function ni(e) {
  let t = e.match(/([^\s]+?)\(([\s\S]*)\)/);
  if (t) {
    let e = { methodName: t[1], static: !0, args: oi };
    if (t[2].trim()) {
      return (function (e, t) {
        return (
...
function li(e, t, o, r) {
  ...
  Lo && !e._overrideLegacyUndefined && (t.splices = i),
    e.notifyPath(o + ".splices", i),
    e.notifyPath(o + ".length", t.length),
    Lo && !e._overrideLegacyUndefined && (i.indexSplices = []);
}
function di(e, t, o, r, i, n) {
  li(e, t, o, [
...
const ci = To((e) => {
    ...
    return class extends t {
      ...
      _addPropertyEffect(e, t, o) {
        this._createPropertyAccessor(e, t == Tr.READ_ONLY);
        let r = Nr(this, t, !0)[e];
      ...
      _hasReadOnlyEffect(e) {
        return this._hasPropertyEffect(e, Tr.READ_ONLY);
      }
      _hasNotifyEffect(e) {
        return this._hasPropertyEffect(e, Tr.NOTIFY);
      }
      _hasReflectEffect(e) {
        return this._hasPropertyEffect(e, Tr.REFLECT);
      }
      _hasComputedEffect(e) {
        return this._hasPropertyEffect(e, Tr.COMPUTE);
      }
      _setPendingPropertyOrPath(e, t, o, r) {
        if (r || Yo(Array.isArray(e) ? e[0] : e) !== e) {
          if (!r) {
            let o = tr(this, e);
            if (!(e = or(this, e, t)) || !super._shouldPropertyChange(e, t, o))
              return !1;
          }
      ...
      _setUnmanagedPropertyToNode(e, t, o) {
        (o === e[t] && "object" != typeof o) ||
          ("className" === t && (e = Go(e)), (e[t] = o));
      }
      _setPendingProperty(e, t, o) {
        let r = this.__dataHasPaths && Ko(e),
        ...
        return (
          ...
          (this.__dataPending[e] = t),
          (r || (this[Tr.NOTIFY] && this[Tr.NOTIFY][e])) &&
      ...
      setProperties(e, t) {
        for (let o in e)
          (!t && this[Tr.READ_ONLY] && this[Tr.READ_ONLY][o]) ||
      ...
      _propertiesChanged(e, t, o) {
        ...
        (this.__dataHasPaths = !1),
          ...
          this._flushClients(),
          Or(this, this[Tr.REFLECT], t, o, i),
          Or(this, this[Tr.OBSERVE], t, o, i),
          r &&
            (function (e, t, o, r, i) {
              let n,
                a,
      ...
      _propagatePropertyChanges(e, t, o) {
        this[Tr.PROPAGATE] && Or(this, this[Tr.PROPAGATE], e, t, o),
          this.__templateInfo &&
            this._runEffectsForTemplate(this.__templateInfo, e, t, o);
      }
      _runEffectsForTemplate(e, t, o, r) {
        const i = (t, r) => {
          Or(this, e.propertyEffects, t, o, r, e.nodeList);
      ...
      set(e, t, o) {
        o
          ? or(o, e, t)
          : (this[Tr.READ_ONLY] && this[Tr.READ_ONLY][e]) ||
      ...
      push(e, ...t) {
        let o = { path: "" },
          ...
          i = r.length,
          n = r.push(...t);
        return t.length && di(this, r, o.path, i, t.length, []), n;
      }
      pop(e) {
        let t = { path: "" },
          o = tr(this, e, t),
          r = Boolean(o.length),
          i = o.pop();
        return r && di(this, o, t.path, o.length, 0, [i]), i;
      }
      splice(e, t, o, ...r) {
        let i,
          n = { path: "" },
        ...
        return (
          ...
          (r.length || i.length) && di(this, a, n.path, t, r.length, i),
          i
        );
      }
      shift(e) {
        let t = { path: "" },
          ...
          r = Boolean(o.length),
          i = o.shift();
        return r && di(this, o, t.path, 0, 0, [i]), i;
      }
      unshift(e, ...t) {
        let o = { path: "" },
          r = tr(this, e, o),
          i = r.unshift(...t);
        return t.length && di(this, r, o.path, 0, t.length, []), i;
      }
      notifyPath(e, t) {
        let o;
        if (1 == arguments.length) {
          let r = { path: "" };
          (t = tr(this, e, r)), (o = r.path);
      ...
      _createReadOnlyProperty(e, t) {
        var o;
        this._addPropertyEffect(e, Tr.READ_ONLY),
          t &&
      ...
      _createPropertyObserver(e, t, o) {
        ...
        this._addPropertyEffect(e, Tr.OBSERVE, {
          fn: Dr,
          info: r,
          trigger: { name: e },
        }),
          o &&
            this._addPropertyEffect(t, Tr.OBSERVE, {
              fn: Dr,
              info: r,
              trigger: { name: t },
            });
      ...
      _createMethodObserver(e, t) {
        ...
        ei(this, o, Tr.OBSERVE, ti, null, t);
      }
      _createNotifyingProperty(e) {
        this._addPropertyEffect(e, Tr.NOTIFY, {
          fn: Fr,
          info: { eventName: sr(e) + "-changed", property: e },
        });
      }
      _createReflectedProperty(e) {
        ...
        "-" === t[0]
          ...
          : this._addPropertyEffect(e, Tr.REFLECT, {
              fn: Ur,
              info: { attrName: t },
            });
      }
      _createComputedProperty(e, t, o) {
        ...
        const i = ei(this, r, Tr.COMPUTE, Kr, e, o);
        Nr(this, "__computeInfo")[e] = i;
      }
      _marshalArgs(e, t, o) {
        const r = this.__data,
          i = [];
        for (let n = 0, a = e.length; n < a; n++) {
          ...
          if (!c)
            if (l) {
              const e = Xo(a, t),
                i = si(r, o, e ? t : a);
              d = { path: e ? t : a, value: i, base: e ? tr(r, a) : i };
            } else d = s ? si(r, o, a) : r[a];
          if (
            Lo &&
            !this._overrideLegacyUndefined &&
            void 0 === d &&
      ...
      _stampTemplate(e, t) {
        (t = t || this._bindTemplate(e, !0)), pi.push(this);
        let o = super._stampTemplate(e, t);
        if ((pi.pop(), (t.nodeList = o.nodeList), !t.wasPreBound)) {
          let e = (t.childNodes = []);
      ...
      _removeBoundDom(e) {
        ...
        for (let e = 0; e < n.length; e++) {
          let t = n[e];
          Go(Go(t).parentNode).removeChild(t);
        }
      }
      static _parseTemplateNode(e, o, r) {
        ...
        if (e.nodeType === Node.TEXT_NODE) {
          ...
          t &&
            ((e.textContent = ii(t) || " "),
            Yr(this, o, r, "text", "textContent", t),
            (i = !0));
        }
        return i;
      }
      ...
      static _parseTemplateNestedTemplate(e, o, r) {
        ...
        if (xo && s)
          d &&
            ...
            Vo || (r.parentInfo.noted = !0));
        else {
          let e = "{";
          for (let t in d) {
            Yr(this, o, r, "property", "_host_" + t, [
    ...
    return class extends t {
      ...
      static get importPath() {
        if (
          ...
          if (e) this._importPath = go(e.url);
          else {
            const e = Ro.import(this.is);
            this._importPath =
              (e && e.assetpath) ||
      ...
      static _finalizeTemplate(e) {
        ...
        if (t && !t.__polymerFinalized) {
          ...
          r(this, t, e, o ? mo(o) : ""), this.prototype._bindTemplate(t);
        }
      }
      connectedCallback() {
      ...
      resolveUrl(e, t) {
        return !t && this.importPath && (t = mo(this.importPath)), mo(e, t);
      }
...
class gi {
  ...
  setConfig(e, t) {
    (this._asyncModule = e),
      ...
      (this._timer = this._asyncModule.run(() => {
        (this._timer = null), _i.delete(this), this._callback();
      }));
  }
  cancel() {
    this.isActive() && (this._cancelAsync(), _i.delete(this));
  }
  _cancelAsync() {
    this.isActive() &&
  ...
  static debounce(e, t, o) {
    return (
      e instanceof gi ? e._cancelAsync() : (e = new gi()), e.setConfig(t, o), e
    );
  }
}
let _i = new Set();
...
let vi = "string" == typeof document.head.style.touchAction,
  bi = "__polymerGestures",
  Ci = "__polymerGesturesHandled",
  Ai = "__polymerGesturesTouchAction",
  Hi = ["mousedown", "mousemove", "mouseup", "click"],
  wi = [0, 1, 4, 2],
  ki = (function () {
    try {
...
function Vi(e) {
  if (!Li(e) && "touchend" !== e)
    return vi && Si && bo ? { passive: !0 } : void 0;
}
!(function () {
  try {
...
let xi = navigator.userAgent.match(/iP(?:[oa]d|hone)|Android/);
const Mi = [],
  Ei = {
    button: !0,
    input: !0,
...
let Ti = function (e) {
  ...
  if (
    ...
    ((e[Ci] = { skip: !0 }), "click" === e.type)
  ) {
    let t = !1,
      r = Di(e);
    for (let e = 0; e < r.length; e++) {
      if (r[e].nodeType === Node.ELEMENT_NODE)
        if ("label" === r[e].localName) Mi.push(r[e]);
        else if (((o = r[e]), Ei[o.localName])) {
          let o = zi(r[e]);
          for (let e = 0; e < o.length; e++) t = t || Mi.indexOf(o[e]) > -1;
        }
      if (r[e] === Oi.mouse.target) return;
    }
    if (t) return;
...
function ji(e) {
  ...
  for (let o, r = 0; r < t.length; r++)
    (o = t[r]),
      e
        ? ((Mi.length = 0), document.addEventListener(o, Ti, !0))
        : document.removeEventListener(o, Ti, !0);
}
function Ni(e) {
  let t = e.type;
  if (!Li(t)) return !1;
  if ("mousemove" === t) {
    ...
    return (
      e instanceof window.MouseEvent && !ki && (t = wi[e.which] || 0),
      Boolean(1 & t)
    );
  }
...
document.addEventListener(
  "touchend",
  function (e) {
    Oi.mouse.mouseIgnoreJob || ji(!0),
      (Oi.mouse.target = Di(e)[0]),
      (Oi.mouse.mouseIgnoreJob = gi.debounce(
        Oi.mouse.mouseIgnoreJob,
        hr.after(2500),
        function () {
          ji(), (Oi.mouse.target = null), (Oi.mouse.mouseIgnoreJob = null);
        }
      ));
  },
  !!Si && { passive: !0 }
...
function Ui(e) {
  ...
  let i = r[o];
  if (i) {
    if (!e[Ci] && ((e[Ci] = {}), "touch" === o.slice(0, 5))) {
      let t = e.changedTouches[0];
      if (
        ("touchstart" === o &&
          1 === e.touches.length &&
          (Oi.touch.id = t.identifier),
        Oi.touch.id !== t.identifier)
      )
        return;
      vi ||
        ...
        (function (e) {
          let t = e.changedTouches[0],
            o = e.type;
          if ("touchstart" === o)
            (Oi.touch.x = t.clientX),
              (Oi.touch.y = t.clientY),
              (Oi.touch.scrollDecided = !1);
          else if ("touchmove" === o) {
            if (Oi.touch.scrollDecided) return;
            Oi.touch.scrollDecided = !0;
            let o = (function (e) {
                let t = "auto",
                  o = Di(e);
              ...
              r = !1,
              i = Math.abs(Oi.touch.x - t.clientX),
              n = Math.abs(Oi.touch.y - t.clientY);
            e.cancelable &&
              ("none" === o
                ? (r = !0)
                : "pan-x" === o
                ? (r = n > i)
                : "pan-y" === o && (r = i > n)),
              r ? e.preventDefault() : Wi("track");
          }
        })(e);
    }
    if (((t = e[Ci]), !t.skip)) {
      for (let o, r = 0; r < $i.length; r++)
        (o = $i[r]),
          i[o.name] &&
            !t[o.name] &&
            o.flow &&
      ...
      for (let r, n = 0; n < $i.length; n++)
        (r = $i[n]), i[r.name] && !t[r.name] && ((t[r.name] = !0), r[o](e));
    }
  }
}
function Zi(e, t, o) {
      ...
      for (let t, o, r = 0; r < i.length; r++)
        (t = i[r]),
          (xi && Li(t) && "click" !== t) ||
            ((o = a[t]),
            o || (a[t] = o = { _count: 0 }),
            0 === o._count && e.addEventListener(t, Ui, Vi(t)),
            (o[n] = (o[n] || 0) + 1),
            (o._count = (o._count || 0) + 1));
      e.addEventListener(t, o), r.touchAction && Ki(e, r.touchAction);
    })(e, t, o),
    !0)
  );
}
        ...
        for (let t, o, r = 0; r < i.length; r++)
          (t = i[r]),
            ...
            o &&
              ...
              0 === o._count && e.removeEventListener(t, Ui, Vi(t)));
      e.removeEventListener(t, o);
    })(e, t, o),
    !0)
  );
...
function Gi(e) {
  $i.push(e);
  for (let t = 0; t < e.emits.length; t++) Bi[e.emits[t]] = e;
}
function Ki(e, t) {
  vi &&
    e instanceof HTMLElement &&
...
function Yi(e, t, o) {
  ...
  if (((r.detail = o), Go(e).dispatchEvent(r), r.defaultPrevented)) {
...
function en(e, t, o) {
  let r = Math.abs(t.clientX - e.x),
    ...
    n = Fi(o || t);
  !n ||
    (Pi[n.localName] && n.hasAttribute("disabled")) ||
    ((isNaN(r) ||
      isNaN(i) ||
      (r <= 25 && i <= 25) ||
      (function (e) {
...
Gi({
  ...
  touchstart: function (e) {
    Xi("down", Fi(e), e.changedTouches[0], e);
  },
  touchend: function (e) {
    Xi("up", Fi(e), e.changedTouches[0], e);
  },
}),
  Gi({
    name: "track",
          ...
          Ji(o.info, r, i) &&
            ((o.info.state = o.info.started
              ? "mouseup" === e.type
                ...
                : "track"
              : "start"),
            "start" === o.info.state && Wi("tap"),
            o.info.addMove({ x: r, y: i }),
            Ni(e) || ((o.info.state = "end"), Ri(o.info)),
            t && Qi(o.info, t, e),
            (o.info.started = !0));
        };
      Ii(this.info, r, function (e) {
        o.info.started && r(e), Ri(o.info);
      }),
  ...
  Gi({
    ...
    mousedown: function (e) {
      Ni(e) && ((this.info.x = e.clientX), (this.info.y = e.clientY));
    },
    click: function (e) {
      Ni(e) && en(this.info, e);
    },
    ...
    touchend: function (e) {
      en(this.info, e.changedTouches[0], e);
    },
  });
const tn = To(
    (e) =>
      class extends e {
        _addEventListenerToNode(e, t, o) {
          Zi(e, t, o) || super._addEventListenerToNode(e, t, o);
        }
        _removeEventListenerFromNode(e, t, o) {
          qi(e, t, o) || super._removeEventListenerFromNode(e, t, o);
        }
      }
  ),
  on = /:host\(:dir\((ltr|rtl)\)\)/g,
  rn = /([\s\w-#\.\[\]\*]*):dir\((ltr|rtl)\)/g,
  nn = /:dir\((?:ltr|rtl)\)/,
  an = Boolean(window.ShadyDOM && window.ShadyDOM.inUse),
  sn = [];
let ln = null,
  dn = "";
function cn() {
  dn = document.documentElement.getAttribute("dir");
}
function pn(e) {
  if (!e.__autoDirOptOut) {
    e.setAttribute("dir", dn);
  }
}
function un() {
  cn(), (dn = document.documentElement.getAttribute("dir"));
  for (let e = 0; e < sn.length; e++) pn(sn[e]);
}
const mn = To((e) => {
  an ||
    ln ||
    (cn(),
    (ln = new MutationObserver(un)),
    ln.observe(document.documentElement, {
      attributes: !0,
      attributeFilter: ["dir"],
    }));
  const t = Cr(e);
  class o extends t {
    ...
    static _replaceDirInCssText(e) {
      let t = e;
      return (
        (t = t.replace(on, ':host([dir="$1"])')),
        (t = t.replace(rn, ':host([dir="$2"]) $1')),
        t
      );
    }
    constructor() {
    ...
    connectedCallback() {
      t.prototype.connectedCallback && super.connectedCallback(),
        this.constructor.__activateDir &&
          (ln && ln.takeRecords().length && un(), sn.push(this), pn(this));
    }
    disconnectedCallback() {
      if (
...
function _n(e, t, o, r, i, n) {
  ...
  if (
    (0 == t &&
      0 == i &&
      (s = (function (e, t, o) {
        for (let r = 0; r < o; r++) if (!yn(e[r], t[r])) return r;
        return o;
      })(e, r, d)),
    o == e.length &&
      n == r.length &&
    ...
    return [];
  if (t == o) {
    for (a = gn(t, [], 0); i < n; ) a.removed.push(r[i++]);
    return [a];
  }
  if (i == n) return [gn(t, [], o - t)];
  let c = (function (e) {
    let t = e.length - 1,
      o = e[0].length - 1,
      r = e[t][o],
    ...
    (function (e, t, o, r, i, n) {
      ...
      for (let o = 1; o < a; o++)
        for (let n = 1; n < s; n++)
          if (yn(e[t + n - 1], r[i + o - 1])) l[o][n] = l[o - 1][n - 1];
          else {
            let e = l[o - 1][n] + 1,
              t = l[o][n - 1] + 1;
            l[o][n] = e < t ? e : t;
  ...
  for (let e = 0; e < c.length; e++)
    switch (c[e]) {
      case 0:
        ...
        break;
      case 1:
        a || (a = gn(u, [], 0)), a.addedCount++, u++, a.removed.push(r[m]), m++;
        break;
      case 2:
        a || (a = gn(u, [], 0)), a.addedCount++, u++;
        break;
      case 3:
        a || (a = gn(u, [], 0)), a.removed.push(r[m]), m++;
    }
  return a && p.push(a), p;
}
function fn(e, t) {
  return _n(e, 0, e.length, t, 0, t.length);
}
function yn(e, t) {
  return e === t;
}
...
let bn = class {
  static getFlattenedNodes(e) {
    ...
    return vn(e)
      ...
      : Array.from(t.childNodes)
          .map((e) => (vn(e) ? Go(e).assignedNodes({ flatten: !0 }) : [e]))
  ...
  connect() {
    vn(this._target)
      ...
      : Go(this._target).children &&
        (this._listenSlots(Go(this._target).children),
        window.ShadyDOM
  ...
  disconnect() {
    vn(this._target)
      ...
      : Go(this._target).children &&
        (this._unlistenSlots(Go(this._target).children),
  ...
  _schedule() {
    this._scheduled || ((this._scheduled = !0), _r.run(() => this.flush()));
  }
  _processMutations(e) {
  ...
  _listenSlots(e) {
    for (let t = 0; t < e.length; t++) {
      let o = e[t];
      vn(o) && o.addEventListener("slotchange", this._boundSchedule);
    }
  }
  _unlistenSlots(e) {
    for (let t = 0; t < e.length; t++) {
      let o = e[t];
      vn(o) && o.removeEventListener("slotchange", this._boundSchedule);
    }
  }
};
const Cn = function () {
...
class kn {
  ...
  notifyObserver() {}
  deepContains(e) {
    if (Go(this.node).contains(e)) return !0;
    let t = e,
      o = e.ownerDocument;
    for (; t && t !== o && t !== this.node; )
      t = Go(t).parentNode || Go(t).host;
    return t === this.node;
  }
  getOwnerRoot() {
    return Go(this.node).getRootNode();
  }
  getDistributedNodes() {
    return "slot" === this.node.localName
      ? Go(this.node).assignedNodes({ flatten: !0 })
      : [];
  }
  getDestinationInsertionPoints() {
    let e = [],
      t = Go(this.node).assignedSlot;
    for (; t; ) e.push(t), (t = Go(t).assignedSlot);
    return e;
  }
  importNode(e, t) {
    let o = this.node instanceof Document ? this.node : this.node.ownerDocument;
    return Go(o).importNode(e, t);
  }
  getEffectiveChildNodes() {
    return bn.getFlattenedNodes(this.node);
  }
  queryDistributedElements(e) {
    let t = this.getEffectiveChildNodes(),
      o = [];
    for (let r, i = 0, n = t.length; i < n && (r = t[i]); i++)
      r.nodeType === Node.ELEMENT_NODE && wn(r, e) && o.push(r);
    return o;
  }
  get activeElement() {
    let e = this.node;
...
kn.prototype.cloneNode,
  kn.prototype.appendChild,
  kn.prototype.insertBefore,
  kn.prototype.removeChild,
  kn.prototype.replaceChild,
  kn.prototype.setAttribute,
  kn.prototype.removeAttribute,
  kn.prototype.querySelector,
  kn.prototype.querySelectorAll,
  kn.prototype.parentNode,
  kn.prototype.firstChild,
  kn.prototype.lastChild,
  kn.prototype.nextSibling,
  kn.prototype.previousSibling,
  kn.prototype.firstElementChild,
  kn.prototype.lastElementChild,
  kn.prototype.nextElementSibling,
  kn.prototype.previousElementSibling,
  kn.prototype.childNodes,
  kn.prototype.children,
  kn.prototype.classList,
  kn.prototype.textContent,
  kn.prototype.innerHTML;
let Vn = kn;
if (
  window.ShadyDOM &&
  ...
  Object.getOwnPropertyNames(kn.prototype).forEach((t) => {
    "activeElement" != t && (e.prototype[t] = kn.prototype[t]);
  }),
    Ln(e.prototype, ["classList"]),
    (Vn = e),
    Object.defineProperties(Sn.prototype, {
      localTarget: {
        get() {
          const e = this.event.currentTarget,
            t = e && xn(e).getOwnerRoot(),
            o = this.path;
          for (let e = 0; e < o.length; e++) {
            const r = o[e];
            if (xn(r).getOwnerRoot() === t) return r;
          }
        },
        configurable: !0,
      },
  ...
  !(function (e, t) {
    ...
    })(kn.prototype, ["textContent", "innerHTML", "className"]);
const xn = function (e) {
    if ((e = e || document) instanceof Vn) return e;
    if (e instanceof Sn) return e;
    let t = e.__domApi;
    return (
      t || ((t = e instanceof Event ? new Sn(e) : new Vn(e)), (e.__domApi = t)),
      t
    );
  },
  Mn = window.ShadyDOM,
    ...
    attributeChangedCallback(e, t, o, r) {
      "disable-upgrade" == e
        ? this.__isUpgradeDisabled &&
          ...
          Go(this).isConnected && super.connectedCallback())
        : super.attributeChangedCallback(e, t, o, r);
    }
    connectedCallback() {
...
const jn = To((e) => {
    ...
    class n extends o {
      ...
      setAttribute(e, t) {
        if (Eo && !this._legacyForceObservedAttributes) {
      ...
      static get observedAttributes() {
        return Eo && !this.prototype._legacyForceObservedAttributes
          ? (this.hasOwnProperty(
              JSCompiler_renameProperty("__observedAttributes", this)
        ...
        t !== o &&
          ("disable-upgrade" == e
            ? this.__isUpgradeDisabled &&
              ...
              (this._initializeProperties(),
              (this.__isUpgradeDisabled = !1),
              Go(this).isConnected && this.connectedCallback())
            : (super.attributeChangedCallback(e, t, o, r),
              this.attributeChanged(e, t, o)));
      }
      attributeChanged(e, t, o) {}
      _initializeProperties() {
        if (Ho && this.hasAttribute("disable-upgrade"))
          this.__isUpgradeDisabled = !0;
        else {
      ...
      queryDistributedElements(e) {
        return xn(this).queryDistributedElements(e);
      }
      ...
      getContentChildNodes(e) {
        ...
        return t ? xn(t).getDistributedNodes() : [];
      }
      ...
      isLightDescendant(e) {
        ...
        return (
          t !== e &&
          Go(t).contains(e) &&
          Go(t).getRootNode() === Go(e).getRootNode()
        );
      }
      isLocalDescendant(e) {
        return this.root === Go(e).getRootNode();
      }
      scopeSubtree(e, t = !1) {
        return (function (e, t = !1) {
          if (!Mn || !En) return null;
          if (!Mn.handlesDynamicScoping) return null;
          const o = En.ScopingShim;
          if (!o) return null;
          const r = o.scopeForNode(e),
            ...
            n = (e) => {
              if (!Pn(e, i)) return;
              const t = Array.from(
                Mn.nativeMethods.querySelectorAll.call(e, "*")
              );
              t.push(e);
      ...
      getComputedStyleValue(e) {
        return Tn.getComputedStyleValue(this, e);
      }
      debounce(e, t, o) {
        return (
          (this._debouncers = this._debouncers || {}),
          (this._debouncers[e] = gi.debounce(
            this._debouncers[e],
            o > 0 ? hr.after(o) : _r,
            t.bind(this)
          ))
      ...
      async(e, t) {
        return t > 0 ? hr.run(e.bind(this), t) : ~_r.run(e.bind(this));
      }
      cancelAsync(e) {
        e < 0 ? _r.cancel(~e) : hr.cancel(e);
      }
      create(e, t) {
      ...
      toggleAttribute(e, t) {
        ...
        return (
          ...
          t ? (Go(o).setAttribute(e, ""), !0) : (Go(o).removeAttribute(e), !1)
        );
      }
      toggleClass(e, t, o) {
        (o = o || this),
...
function Rn(e, t, o, r) {
  ...
  for (let e in Nn) t[e] && ((o[e] = o[e] || []), o[e].push(t[e]));
}
function Dn(e, t, o) {
  t = t || [];
...
function Fn(e, t, o) {
  ...
  class n extends t {
    ...
    static get properties() {
      const t = {};
      if (r) for (let e = 0; e < r.length; e++) Bn(t, r[e].properties);
      return Bn(t, e.properties), t;
    }
    ...
    _registered() {
      ...
      if (
        ...
        (e.__hasRegisterFinished = !0), super._registered(), Ho && a(e);
  ...
  if (o) {
    ...
    (r = Dn(o, null, e)), (n.prototype.behaviors = e ? e.concat(o) : r);
  }
  const a = (t) => {
    r &&
      (function (e, t, o) {
        for (let r = 0; r < t.length; r++) Rn(e, t[r], o, In);
      })(t, r, i),
      Rn(t, e, i, On);
  };
  return Ho || a(n.prototype), (n.generatedFrom = e), n;
}
const Un = function (e) {
  let t;
  return (
    (t = "function" == typeof e ? e : Un.Class(e)),
...
Un.Class = function (e, t) {
  e || console.warn("Polymer.Class requires `info` argument");
  let o = t ? t($n) : $n;
  return (o = Fn(e, o, e.behaviors)), (o.is = o.prototype.is = e.is), o;
};
const qn = To(
    (e) =>
      class extends e {
        _shouldPropertyChange(e, t, o) {
          return Zn(this, e, t, o, !0);
        }
      }
  ),
  Gn = To(
    (e) =>
      class extends e {
        ...
        _shouldPropertyChange(e, t, o) {
          return Zn(this, e, t, o, this.mutableData);
        }
      }
  );
qn._mutablePropertyChange = Zn;
let Kn = null;
function Yn() {
  return Kn;
}
Yn.prototype = Object.create(HTMLTemplateElement.prototype, {
  constructor: { value: Yn, writable: !0 },
});
const Wn = ci(Yn),
  Xn = qn(Wn);
const Jn = ci(class {});
      ...
      if (r.nodeType === Node.TEXT_NODE)
        ...
        if (e)
          (r.__polymerReplaced__ = document.createComment("hidden-slot")),
            Go(Go(r).parentNode).replaceChild(r.__polymerReplaced__, r);
        else {
          const e = r.__polymerReplaced__;
          e && Go(Go(e).parentNode).replaceChild(r, e);
        }
      else
        r.style &&
          (e
...
ea.prototype.__dataHost,
  ea.prototype.__templatizeOptions,
  ea.prototype._methodHost,
  ea.prototype.__templatizeOwner,
  ea.prototype.__hostProps;
const ta = qn(ea);
function oa(e) {
  let t = e.__dataHost;
...
function ra(e, t, o) {
  let r = o.mutableData ? ta : ea;
  sa.mixin && (r = sa.mixin(r));
...
function ia(e, t, o, r) {
  ...
  if (i && t.hasHostProps) {
    ...
    if ((e.__dataProto && Object.assign(e.__data, e.__dataProto), n))
      !(function (e, t) {
        (Kn = e), Object.setPrototypeOf(e, t.prototype), new t(), (Kn = null);
      })(e, a),
        (e.__dataTemp = {}),
        (e.__dataPending = null),
        (e.__dataOld = null),
...
function sa(e, t, o) {
  ...
  let r = (t ? t.constructor : ea)._parseTemplate(e),
    i = r.templatizeInstanceClass;
  i || ((i = ra(e, r, o)), (r.templatizeInstanceClass = i));
  const n = oa(e);
  ia(e, r, o, n);
...
customElements.define(
  ...
  class extends ca {
    ...
    connectedCallback() {
      da() || (this.style.display = "none"), this.render();
    }
    disconnectedCallback() {
      this.__removeChildren();
    }
    __insertChildren() {
      Go(Go(this).parentNode).insertBefore(this.root, this);
    }
    __removeChildren() {
      if (this.__children)
...
function ua(e) {
  ...
  if (e instanceof pa)
    return (function (e) {
      if (e instanceof pa) return e.value;
      throw new Error(
...
const ma = function (e, ...t) {
    ...
    return (o.innerHTML = t.reduce((t, o, r) => t + ua(o) + e[r + 1], e[0])), o;
  },
  ha = hi(HTMLElement),
  ga = Gn(ha);
class _a extends ga {
  ...
  static get properties() {
    return {
      ...
      delay: Number,
      renderedItemCount: { type: Number, notify: !Mo, readOnly: !0 },
  ...
  connectedCallback() {
    if (
      (super.connectedCallback(),
      da() || (this.style.display = "none"),
      this.__isDetached)
    ) {
      this.__isDetached = !1;
      let e = Go(Go(this).parentNode);
      ...
      (o[this.as] = !0),
        ...
        (this.__ctor = sa(t, this, {
          ...
          notifyInstanceProp: function (e, t, o) {
            if ((r = this.as) === (i = t) || Wo(r, i) || Xo(r, i)) {
  ...
  __debounceRender(e, t = 0) {
    (this.__renderDebouncer = gi.debounce(
      this.__renderDebouncer,
      t > 0 ? hr.after(t) : _r,
      e.bind(this)
    )),
      fi(this.__renderDebouncer);
  }
  render() {
    this.__debounceRender(this.__render), Cn();
  }
  __render() {
  ...
  __insertInstance(e, t, o) {
    ...
    return (
      Go(Go(this).parentNode).insertBefore(r.root, n),
...
class fa extends ha {
  ...
  __debounceRender() {
    (this.__renderDebouncer = gi.debounce(this.__renderDebouncer, _r, () =>
      this.__render()
    )),
      fi(this.__renderDebouncer);
  }
  disconnectedCallback() {
    super.disconnectedCallback();
    const e = Go(this).parentNode;
    (e && (e.nodeType != Node.DOCUMENT_FRAGMENT_NODE || Go(e).host)) ||
  ...
  __ensureTemplate() {
    if (!this.__template) {
      const e = this;
      let t = e._templateInfo ? e : Go(e).querySelector("template");
      if (!t) {
        let e = new MutationObserver(() => {
          if (!Go(this).querySelector("template"))
  ...
  __ensureInstance() {
    let e = Go(this).parentNode;
    if (this.__hasInstance()) {
      let t = this.__getInstanceNodes();
      if (t && t.length) {
        if (Go(this).previousSibling !== t[t.length - 1])
          for (let o, r = 0; r < t.length && (o = t[r]); r++)
            Go(e).insertBefore(o, this);
      }
    } else {
      if (!e) return !1;
...
const ya = xo
  ? class extends fa {
      ...
      __createAndInsertInstance(e) {
        ...
        (o.runEffects = (e, t, o) => {
          ...
          Go(e).insertBefore(this.__instance, this);
      }
      ...
      _showHideChildren() {
        ...
        this.__instance &&
          ...
          Qn(e, this.__instance.templateInfo.childNodes)),
  ...
  : class extends fa {
      ...
      __createAndInsertInstance(e) {
        this.__ctor ||
          (this.__ctor = sa(this.__template, this, {
            mutableData: !0,
            forwardHostProp: function (e, t) {
              this.__instance &&
                (this.if
                  ...
                  : ((this.__invalidProps =
                    ...
                    (this.__invalidProps[Yo(e)] = !0)));
            },
          })),
          (this.__instance = new this.__ctor()),
          Go(e).insertBefore(this.__instance.root, this);
      }
      __teardownInstance() {
        if (this.__instance) {
          let e = this.__instance.children;
          if (e && e.length) {
            let t = Go(e[0]).parentNode;
            if (t) {
              t = Go(t);
...
customElements.define(ya.is, ya);
let va = To((e) => {
    let t = hi(e);
    return class extends t {
      static get properties() {
...
customElements.define(Ca.is, Ca);
const Aa = new no();
window.ShadyCSS ||
  (window.ShadyCSS = {
    ...
    prepareTemplateStyles(e, t, o) {},
    styleSubtree(e, t) {
      Aa.processStyles(), Ot(e, t);
    },
    styleElement(e) {
      Aa.processStyles();
    },
    styleDocument(e) {
      Aa.processStyles(), Ot(document.body, e);
    },
    getComputedStyleValue: (e, t) => It(e, t),
    flushCustomStyles() {},
    nativeCss: mt,
  ...
  (window.ShadyCSS.CustomStyleInterface = Aa);
const Ha = window.ShadyCSS.CustomStyleInterface;
class wa extends HTMLElement {
  constructor() {
    super(), (this._style = null), Ha.addCustomStyle(this);
  }
  getStyle() {
        ...
        (e.textContent =
          (function (e) {
            let t = e.trim().split(/\s+/),
              o = "";
            for (let e = 0; e < t.length; e++) o += qo(t[e]);
            return o;
          })(t) + e.textContent)),
...
window.customElements.define("custom-style", wa), jn(HTMLElement).prototype;
const ka = ma`
<custom-style>
...
var La = document.createElement("style");
(La.textContent = "[hidden] { display: none !important; }"),
...
const za = {
  "add-repository": () => import("./c.7948d625.js"),
  "custom-repositories": () => import("./c.c436d42d.js"),
  generic: () => import("./c.b9fadbef.js"),
  download: () => import("./c.4fa7acdf.js"),
  navigate: () => import("./c.d124a3a6.js"),
  removed: () => import("./c.bdf06437.js"),
  update: () => import("./c.81a49b25.js"),
  progress: () => import("./c.d6d13164.js"),
};
s(
  [ye("hacs-event-dialog")],
  function (e, t) {
    return {
      F: class extends t {
        constructor(...t) {
...
const Na = async (e) => e.connection.sendMessagePromise({ type: "hacs/info" }),
  Oa = async (e) =>
    e.connection.sendMessagePromise({ type: "hacs/repositories/list" }),
  Ia = async (e) =>
    e.connection.sendMessagePromise({ type: "hacs/critical/list" }),
  Ra = async (e) =>
    e.connection.sendMessagePromise({ type: "hacs/repositories/removed" }),
  Da = async (e, t) =>
...
var rs =
  ...
  us = "M13 14H11V9H13M13 18H11V16H13M1 21H23L12 2L1 21Z",
  ms =
  ...
  _s = "M12,2L1,21H23M12,6L19.53,19H4.47M11,10V14H13V10M11,16V18H13V16",
  fs =
  ...
  ws = "M9,4H15V12H19.84L12,19.84L4.16,12H9V4Z",
  ks =
  ...
  Ss = "M20,11V13H8L13.5,18.5L12.08,19.92L4.16,12L12.08,4.08L13.5,5.5L8,11H20Z",
  Vs =
  ...
  pl = "M17,3H7A2,2 0 0,0 5,5V21L12,18L19,21V5C19,3.89 18.1,3 17,3Z",
  ul =
  ...
  wl = "M21,7L9,19L3.5,13.5L4.91,12.09L9,16.17L19.59,5.59L21,7Z",
  kl = "M9,20.42L2.79,14.21L5.62,11.38L9,14.77L18.88,4.88L21.71,7.71L9,20.42Z",
  Ll =
  ...
  El = "M7.41,8.58L12,13.17L16.59,8.58L18,10L12,16L6,10L7.41,8.58Z",
  Pl = "M15.41,16.58L10.83,12L15.41,7.41L14,6L8,12L14,18L15.41,16.58Z",
  zl = "M8.59,16.58L13.17,12L8.59,7.41L10,6L16,12L10,18L8.59,16.58Z",
  Tl =
  ...
  Ql = "M23 3H1V1H23V3M2 22H11V4H2V22M22 4H13V22H22V4Z",
  ed =
  ...
  nd = "M5,20H19V18H5M19,9H15V3H9V9H5L12,16L19,9Z",
  ad =
  ...
  ld = "M10 3H14V14H10V3M10 21V17H14V21H10Z",
  dd =
  ...
  _d = "M7,2V13H10V22L17,10H13L17,2H7Z",
  fd =
  ...
  wd = "M19,20H17V11H7V20H5V9L12,5L19,9V20M8,12H16V14H8V12Z",
  kd =
  ...
  Od = "M10,20V14H14V20H19V12H22L12,3L2,12H5V20H10Z",
  Id =
  ...
  Wd = "M11 15H6L13 1V9H18L11 23V15Z",
  Xd =
  ...
  nc = "M7,10L12,15L17,10H7Z",
  ac = "M7,15L12,10L17,15H7Z",
  sc =
  ...
  Hc = "M8,5.14V19.14L19,12.14L8,5.14Z",
  wc =
  ...
  Sc = "M19,13H13V19H11V13H5V11H11V5H13V11H19V13Z",
  Vc =
  ...
  Yc = "M16,4.5V7H5V9H16V11.5L19.5,8M16,12.5V15H5V17H16V19.5L19.5,16",
  Wc =
  ...
  sp = "M3,3V21H21V3",
  lp = "M3,3H21V21H3V3M5,5V19H19V5H5Z",
  dp =
  ...
  mp = "M21,9L17,5V8H10V10H17V13M7,11L3,15L7,19V16H14V14H7V11Z",
  hp =
  ...
  Lp = "M9,16V10H5L12,3L19,10H15V16H9M5,20V18H19V20H5Z",
  Sp =
  ...
  eu = "M3 4H21V8H19V20H17V8H7V20H5V8H3V4M8 9H16V11H8V9Z",
  tu = function (e, t) {
    return (
      (tu =
...
function iu(e, t, o, r) {
  var i,
    n = arguments.length,
    a =
      n < 3 ? t : null === r ? (r = Object.getOwnPropertyDescriptor(t, o)) : r;
...
function du(e) {
  return this instanceof du ? ((this.v = e), this) : new du(e);
}
...
function wu(e) {
  return !(!e || "object" != typeof e || e.type !== mu.number);
}
function ku(e) {
  return !(!e || "object" != typeof e || e.type !== mu.dateTime);
}
!(function (e) {
  ...
  for (var t = {}, o = 0, r = e; o < r.length; o++) {
    ...
    switch (i.stem) {
      ...
      case "integer-width":
        ...
        i.options[0].replace(Pu, function (e, o, r, i, n, a) {
    ...
    if (zu.test(i.stem)) t.minimumIntegerDigits = i.stem.length;
    else if (Mu.test(i.stem)) {
      if (i.options.length > 1)
        throw new RangeError(
          "Fraction-precision stems only accept a single optional option"
        );
      i.stem.replace(Mu, function (e, o, r, i, n, a) {
        return (
          "*" === r
      ...
      var n = i.options[0];
      "w" === n
        ? (t = ru(ru({}, t), { trailingZeroDisplay: "stripIfInteger" }))
        : n && (t = ru(ru({}, t), Tu(n)));
    } else if (Eu.test(i.stem)) t = ru(ru({}, t), Tu(i.stem));
    else {
      var a = ju(i.stem);
      a && (t = ru(ru({}, t), a));
      var s = Nu(i.stem);
...
function Bu(e) {
  ...
  return (
    ...
    (Du[o || ""] || Du[r || ""] || Du["".concat(r, "-001")] || Du["001"])[0]
  );
}
var $u = new RegExp("^".concat(Lu.source, "*")),
  Fu = new RegExp("".concat(Lu.source, "*$"));
function Uu(e, t) {
  return { start: e, end: t };
}
var Zu = !!String.prototype.startsWith,
  qu = !!String.fromCodePoint,
  Gu = !!Object.fromEntries,
  Ku = !!String.prototype.codePointAt,
  Yu = !!String.prototype.trimStart,
  Wu = !!String.prototype.trimEnd,
  Xu = !!Number.isSafeInteger
...
try {
  Ju =
    "a" ===
    (null ===
      (Ru = am("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu").exec("a")) ||
    void 0 === Ru
      ? void 0
      : Ru[0]);
} catch (U) {
...
if (Ju) {
  var sm = am("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu");
  Qu = function (e, t) {
    var o;
    return (
      (sm.lastIndex = t), null !== (o = sm.exec(e)[1]) && void 0 !== o ? o : ""
    );
  };
} else
  Qu = function (e, t) {
    for (var o = []; ; ) {
      var r = rm(e, t);
      if (void 0 === r || pm(r) || um(r)) break;
      o.push(r), (t += r >= 65536 ? 2 : 1);
    }
    return tm.apply(void 0, o);
  };
var lm = (function () {
  function e(e, t) {
    void 0 === t && (t = {}),
  ...
  return (
        ...
        if (123 === i) {
          ...
          if (35 !== i || ("plural" !== t && "selectordinal" !== t)) {
            if (60 === i && !this.ignoreTag && 47 === this.peek()) {
              if (o) break;
              return this.error(
                pu.UNMATCHED_CLOSING_TAG,
                Uu(this.clonePosition(), this.clonePosition())
              );
            }
            if (60 === i && !this.ignoreTag && dm(this.peek() || 0)) {
            ...
            this.bump(),
              r.push({ type: uu.pound, location: Uu(a, this.clonePosition()) });
          }
        }
      }
      ...
      if ((this.bumpSpace(), this.bumpIf("/>")))
        return {
          val: {
            type: uu.literal,
            value: "<".concat(r, "/>"),
            location: Uu(o, this.clonePosition()),
          },
          err: null,
        };
      if (this.bumpIf(">")) {
        ...
        if (this.bumpIf("</")) {
          if (this.isEOF() || !dm(this.char()))
            return this.error(pu.INVALID_TAG, Uu(a, this.clonePosition()));
          var s = this.clonePosition();
          return r !== this.parseTagName()
            ? this.error(pu.UNMATCHED_CLOSING_TAG, Uu(s, this.clonePosition()))
            : (this.bumpSpace(),
              this.bumpIf(">")
                ? {
                    val: {
                ...
                : this.error(pu.INVALID_TAG, Uu(a, this.clonePosition())));
        }
        return this.error(pu.UNCLOSED_TAG, Uu(o, this.clonePosition()));
      }
      return this.error(pu.INVALID_TAG, Uu(o, this.clonePosition()));
    }),
    (e.prototype.parseTagName = function () {
      var e = this.offset();
      for (this.bump(); !this.isEOF() && cm(this.char()); ) this.bump();
    ...
    (e.prototype.parseLiteral = function (e, t) {
      ...
      var s = Uu(o, this.clonePosition());
      return { val: { type: uu.literal, value: r, location: s }, err: null };
    }),
    (e.prototype.tryParseLeftAngleBracket = function () {
      return this.isEOF() ||
        60 !== this.char() ||
        (!this.ignoreTag && (dm((e = this.peek() || 0)) || 47 === e))
        ? null
        : (this.bump(), "<");
      var e;
    }),
    ...
    (e.prototype.parseArgument = function (e, t) {
      ...
      if ((this.bump(), this.bumpSpace(), this.isEOF()))
        return this.error(
          pu.EXPECT_ARGUMENT_CLOSING_BRACE,
          Uu(o, this.clonePosition())
        );
      if (125 === this.char())
        return (
          this.bump(),
          this.error(pu.EMPTY_ARGUMENT, Uu(o, this.clonePosition()))
        );
      var r = this.parseIdentifierIfPossible().value;
      if (!r)
        return this.error(pu.MALFORMED_ARGUMENT, Uu(o, this.clonePosition()));
    ...
    (e.prototype.parseIdentifierIfPossible = function () {
      var e = this.clonePosition(),
        ...
        r = t + o.length;
      return (
        this.bumpTo(r), { value: o, location: Uu(e, this.clonePosition()) }
      );
    }),
    (e.prototype.parseArgumentOptions = function (e, t, o, r) {
      ...
      switch (a) {
        case "":
          return this.error(pu.EXPECT_ARGUMENT_TYPE, Uu(n, s));
        case "number":
        case "date":
        case "time":
          this.bumpSpace();
          ...
          if (this.bumpIf(",")) {
            ...
            if (0 === (m = nm(f.val)).length)
              return this.error(
                pu.EXPECT_ARGUMENT_STYLE,
                Uu(this.clonePosition(), this.clonePosition())
              );
            l = { style: m, styleLocation: Uu(d, this.clonePosition()) };
          }
          if ((y = this.tryParseArgumentClose(r)).err) return y;
          var c = Uu(r, this.clonePosition());
          if (l && em(null == l ? void 0 : l.style, "::", 0)) {
            var p = im(l.style.slice(2));
            if ("number" === a)
            ...
            if (0 === p.length)
              return this.error(pu.EXPECT_DATE_TIME_SKELETON, c);
            var u = p;
            this.locale &&
              (u = (function (e, t) {
            ...
            var m = {
              ...
              parsedOptions: this.shouldParseSkeletons ? Vu(u) : {},
            };
            return {
              val: {
          ...
          return {
            val: {
              type:
                "number" === a ? uu.number : "date" === a ? uu.date : uu.time,
              value: o,
              location: c,
              style:
        ...
        case "select":
          ...
          if ((this.bumpSpace(), !this.bumpIf(",")))
            return this.error(
              pu.EXPECT_SELECT_ARGUMENT_OPTIONS,
              Uu(h, ru({}, h))
            );
          this.bumpSpace();
          ...
          if ("select" !== a && "offset" === g.value) {
            if (!this.bumpIf(":"))
              return this.error(
                pu.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,
                Uu(this.clonePosition(), this.clonePosition())
              );
            var f;
            if (
              ...
              (f = this.tryParseDecimalInteger(
                pu.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,
                pu.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE
              )).err)
            )
              return f;
            this.bumpSpace(),
          ...
          var y,
            v = this.tryParsePluralOrSelectOptions(e, a, t, g);
          if (v.err) return v;
          if ((y = this.tryParseArgumentClose(r)).err) return y;
          var b = Uu(r, this.clonePosition());
          return "select" === a
            ? {
                val: {
                  type: uu.select,
        ...
        default:
          return this.error(pu.INVALID_ARGUMENT_TYPE, Uu(n, s));
      }
    }),
      ...
      for (var e = 0, t = this.clonePosition(); !this.isEOF(); ) {
        switch (this.char()) {
          case 39:
            ...
            if (!this.bumpUntil("'"))
              return this.error(
                pu.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE,
                Uu(o, this.clonePosition())
              );
            this.bump();
            break;
    ...
    (e.prototype.parseNumberSkeletonFromString = function (e, t) {
      ...
      try {
        o = (function (e) {
          ...
          for (
            var t = e.split(xu).filter(function (e) {
                return e.length > 0;
              }),
              o = [],
              r = 0,
      ...
      return {
        val: {
          ...
          tokens: o,
          location: t,
          parsedOptions: this.shouldParseSkeletons ? Iu(o) : {},
        },
        err: null,
      };
    }),
    (e.prototype.tryParsePluralOrSelectOptions = function (e, t, o, r) {
      for (
        ...
        if (0 === l.length) {
          ...
          var p = this.tryParseDecimalInteger(
            pu.EXPECT_PLURAL_ARGUMENT_SELECTOR,
            pu.INVALID_PLURAL_ARGUMENT_SELECTOR
          );
          if (p.err) return p;
          (d = Uu(c, this.clonePosition())),
            (l = this.message.slice(c.offset, this.offset()));
        }
        if (s.has(l))
          return this.error(
            "select" === t
              ? pu.DUPLICATE_SELECT_ARGUMENT_SELECTOR
              : pu.DUPLICATE_PLURAL_ARGUMENT_SELECTOR,
            d
          );
        ...
        if (!this.bumpIf("{"))
          return this.error(
            "select" === t
              ? pu.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT
              : pu.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT,
            Uu(this.clonePosition(), this.clonePosition())
          );
        ...
        if (h.err) return h;
        a.push([l, { value: m.val, location: Uu(u, this.clonePosition()) }]),
          s.add(l),
          this.bumpSpace(),
      ...
      return 0 === a.length
        ? this.error(
            "select" === t
              ? pu.EXPECT_SELECT_ARGUMENT_SELECTOR
              : pu.EXPECT_PLURAL_ARGUMENT_SELECTOR,
            Uu(this.clonePosition(), this.clonePosition())
          )
        : this.requiresOtherClause && !n
        ? this.error(
            pu.MISSING_OTHER_CLAUSE,
            Uu(this.clonePosition(), this.clonePosition())
          )
        : { val: a, err: null };
    }),
    ...
    (e.prototype.bumpSpace = function () {
      for (; !this.isEOF() && pm(this.char()); ) this.bump();
    }),
...
function mm(e) {
  e.forEach(function (e) {
    if ((delete e.location, bu(e) || Cu(e)))
      for (var t in e.options)
        delete e.options[t].location, mm(e.options[t].value);
    else
      (fu(e) && wu(e.style)) || ((yu(e) || vu(e)) && ku(e.style))
...
function hm(e, t) {
  void 0 === t && (t = {}),
    (t = ru({ shouldParseSkeletons: !0, requiresOtherClause: !0 }, t));
  var o = new lm(e, t).parse();
  if (o.err) {
    var r = SyntaxError(pu[o.err.kind]);
    throw (
      ((r.location = o.err.location), (r.originalMessage = o.err.message), r)
    );
  }
  return (null == t ? void 0 : t.captureLocation) || mm(o.val), o.val;
}
function gm(e, t) {
  var o = t && t.cache ? t.cache : Hm,
    r = t && t.serializer ? t.serializer : bm;
  return (t && t.strategy ? t.strategy : vm)(e, { cache: o, serializer: r });
}
function _m(e, t, o, r) {
  var i,
    n =
...
function ym(e, t, o, r, i) {
  return o.bind(t, e, r, i);
}
function vm(e, t) {
  return ym(e, this, 1 === e.length ? _m : fm, t.cache.create(), t.serializer);
}
var bm = function () {
...
var Am,
  ...
  wm = {
    variadic: function (e, t) {
      return ym(e, this, fm, t.cache.create(), t.serializer);
    },
    monadic: function (e, t) {
      return ym(e, this, _m, t.cache.create(), t.serializer);
    },
  };
!(function (e) {
...
function Em(e, t, o, r, i, n, a) {
  if (1 === e.length && gu(e[0]))
    return [{ type: km.literal, value: e[0].value }];
  for (var s = [], l = 0, d = e; l < d.length; l++) {
    var c = d[l];
    if (gu(c)) s.push({ type: km.literal, value: c.value });
    else if (Au(c))
      "number" == typeof n &&
        s.push({ type: km.literal, value: o.getNumberFormat(t).format(n) });
    else {
      var p = c.value;
      if (!i || !(p in i)) throw new xm(p, a);
      var u = i[p];
      if (_u(c))
        (u && "string" != typeof u && "number" != typeof u) ||
          (u = "string" == typeof u || "number" == typeof u ? String(u) : ""),
          s.push({
            type: "string" == typeof u ? km.literal : km.object,
            value: u,
          });
      else if (yu(c)) {
        var m =
        ...
        s.push({
          type: km.literal,
          value: o.getDateTimeFormat(t, m).format(u),
        });
      } else if (vu(c)) {
        m =
          "string" == typeof c.style
        ...
        (m =
          ...
          s.push({
            type: km.literal,
            value: o.getNumberFormat(t, m).format(u),
          });
      } else {
        if (Hu(c)) {
          var h = c.children,
            g = c.value,
            _ = i[g];
          if (!Mm(_)) throw new Vm(g, "function", a);
          var f = _(
            Em(h, t, o, r, i, n).map(function (e) {
              return e.value;
            })
          );
          Array.isArray(f) || (f = [f]),
            s.push.apply(
              ...
              f.map(function (e) {
                return {
                  type: "string" == typeof e ? km.literal : km.object,
                  value: e,
                };
              })
            );
        ...
        if (bu(c)) {
          if (!(y = c.options[u] || c.options.other))
            throw new Sm(c.value, u, Object.keys(c.options), a);
          s.push.apply(s, Em(y.value, t, o, r, i));
        } else if (Cu(c)) {
          var y;
          ...
          if (!y) throw new Sm(c.value, u, Object.keys(c.options), a);
          s.push.apply(s, Em(y.value, t, o, r, i, u - (c.offset || 0)));
        } else;
      }
    }
  }
  return (function (e) {
    return e.length < 2
      ...
      : e.reduce(function (e, t) {
          var o = e[e.length - 1];
          return (
            o && o.type === km.literal && t.type === km.literal
              ? (o.value += t.value)
              : e.push(t),
            e
          );
        ...
        (this.formatters =
            ...
            (n = { number: {}, dateTime: {}, pluralRules: {} }),
          {
            getNumberFormat: gm(
              ...
              { cache: zm(n.number), strategy: wm.variadic }
            ),
            getDateTimeFormat: gm(
              function () {
                for (var e, t = [], o = 0; o < arguments.length; o++)
                  t[o] = arguments[o];
              ...
              { cache: zm(n.dateTime), strategy: wm.variadic }
            ),
            getPluralRules: gm(
              function () {
                for (var e, t = [], o = 0; o < arguments.length; o++)
              ...
              { cache: zm(n.pluralRules), strategy: wm.variadic }
            ),
          }));
    }
    return (
...
const Om = {
    bg_BG: {
      ...
      "entry.messages.disabled.constrains.description":
        "Вашата среда не е съвместима за изпълнение на HACS, проверете вашия лог файл за повече подробности.",
      ...
      "entry.messages.disabled.invalid_token.description":
        "Преконфигурирайте HACS и рестартирайте Home Assistant.",
      "entry.messages.disabled.invalid_token.title": "Невалиден токен",
      "entry.messages.disabled.load_hacs.description":
        "Проверете вашия лог файл за повече подробности",
      "entry.messages.disabled.load_hacs.title": "HACS не можа да се зареди",
      "entry.messages.disabled.removed.description":
        "HACS е премахнат, рестартирайте Home Assistant.",
      "entry.messages.disabled.removed.title": "Премахнато",
      "entry.messages.disabled.restore.description":
        "Проверете вашия лог файл за повече подробности",
      "entry.messages.disabled.restore.title":
        "Възстановяването на HACS не бе успешно",
      "entry.messages.disabled.title": "HACS е деактивиран",
      ...
      "entry.messages.setup.content":
        "HACS се настройва, през това време някои данни може да липсват или да са неправилни",
      "entry.messages.setup.title": "HACS се настройва",
      "entry.messages.startup.content":
        "HACS се стартира, през това време някои данни може да липсват или да са неправилни",
      "entry.messages.startup.title": "HACS стартира",
      "entry.messages.waiting.content":
        "HACS изчаква Home Assistant да завърши стартирането, преди да започне със своите стартови задачи",
      "entry.messages.waiting.title": "HACS изчаква",
      "entry.messages.wrong_frontend_installed.content":
        "Имате инсталиран {running} интерфейс на HACS, но се очаква версия {expected} , ако видите това съобщение Home Assistant не успя да инсталира новата версия, опитайте да рестартирате Home Assistant.",
      "entry.messages.wrong_frontend_installed.title":
        "Неочаквана версия на интерфейса",
      "entry.messages.wrong_frontend_loaded.content":
        "Изпълнява се версия {running} на HACS, но се очакваше версия {expected} , препоръчва се да изчистите кеша на браузъра си.",
      ...
      "options.abort.not_setup": "HACS не е настроен.",
      ...
      "search.downloaded": "Търсете изтеглени хранилища",
      "search.downloaded_new": "Търсете за изтеглени или нови хранилища",
      "search.placeholder": "Потърсете хранилище",
      "sections.about.description": "Показване на информация за HACS",
      "sections.about.title": "За",
      "sections.addon.description":
        "Няма добавки в HACS, но можете да натиснете тук, за да стигнете до супервайзъра.",
      ...
      "store.explore": "Разгледайте и изтеглете хранилища",
      "store.new_repositories_note": "Тук се показват някои нови хранилища",
    ...
    cs: {
      ...
      "entry.messages.disabled.constrains.description":
        "Vaše prostředí nepodporuje běh HACS, pro více detailů zkontrolujte logy.",
      "entry.messages.disabled.content":
      ...
      "entry.messages.disabled.load_hacs.title": "HACS nebylo možné načíst",
      ...
      "entry.messages.disabled.removed.description":
        "HACS odstraněn, restartuj Home Assistant.",
      "entry.messages.disabled.removed.title": "Odstraněno",
      "entry.messages.disabled.restore.title": "Obnova HACS selhala",
      "entry.messages.disabled.title": "HACS je deaktivován",
      "entry.messages.has_pending_tasks.content":
      ...
      "entry.messages.setup.content":
        "HACS se nastavuje, během této doby mohou některé informace chybět nebo být nesprávné",
      "entry.messages.setup.title": "HACS se nastavuje",
      "entry.messages.startup.content":
        "HACS se spouští, během této doby mohou některé informace chybět nebo být nesprávné",
      "entry.messages.startup.title": "HACS se spouští",
      "entry.messages.waiting.content":
        "HACS čeká na dokončení spuštění Home Assistant, než bude moci spustit své úlohy",
      "entry.messages.waiting.title": "HACS čeká",
      "entry.messages.wrong_frontend_loaded.content":
        "Používáte verzi {running} rozhraní HACS, ale je očekávána verze {expected}, měli byste vymazat mezipaměť prohlížeče.",
      "entry.messages.wrong_frontend_loaded.title":
      ...
      "options.abort.not_setup": "HACS není nastaven.",
      ...
      "sections.about.description": "Zobrazit informace o HACS",
      "sections.about.title": "O HACS",
      "sections.addon.description":
        "V HACS nejsou žádné doplňky, ale kliknutím sem se dostanete k Supervisoru",
    ...
    da: {
      ...
      "entry.messages.disabled.title": "HACS er deaktiveret",
      "entry.messages.has_pending_tasks.content":
      ...
      "entry.messages.setup.content":
        "HACS starter op. Der kan i dette tidsrum mangle nogle oplysninger, eller de kan være forkerte",
      "entry.messages.setup.title": "HACS starter op",
      "entry.messages.startup.content":
        "HACS starter op. Der kan i dette tidsrum mangle nogle oplysninger, eller de kan være ukorekte.",
      "entry.messages.startup.title": "HACS starter op",
      "entry.messages.waiting.content":
        "HACS venter på, at Home Assistant er færdig med at starte, inden start af opgaver gennemføres",
      "entry.messages.waiting.title": "HACS venter",
      "entry.messages.wrong_frontend_loaded.content":
        "Du kører version {running} af HACS-frontend, men version {expected} var forventet. Du bør rydde din browser-cache.",
      ...
      "options.abort.not_setup": "HACS er ikke konfigureret.",
      "options.step.user.data.appdaemon":
      ...
      "sections.about.description": "Vis information om HACS",
      "sections.about.title": "Om",
      "sections.addon.description":
        "Der er ingen tilføjelsesprogrammer i HACS, men du kan klikke her finde dem i Supervisor",
      "sections.automation.description":
    ...
    de: {
      ...
      "entry.messages.disabled.constrains.description":
        "Deine Umgebung ist nicht für die Ausführung von HACS kompatibel. Überprüfe die Protokolldatei für weitere Details.",
      ...
      "entry.messages.disabled.load_hacs.description":
        "Überprüfe die Logdatei für weitere Informationen",
      "entry.messages.disabled.load_hacs.title":
        "HACS konnte nicht geladen werden",
      "entry.messages.disabled.rate_limit.description":
      ...
      "entry.messages.disabled.removed.description":
        "HACS wurde entfernt, Home Assistant neu starten",
      "entry.messages.disabled.removed.title": "Entfernt",
      "entry.messages.disabled.restore.description":
        "Überprüfe die Logdatei für weitere Informationen",
      "entry.messages.disabled.restore.title":
        "Wiederherstellung von HACS fehlgeschlagen",
      "entry.messages.disabled.title": "HACS ist deaktiviert",
      "entry.messages.has_pending_tasks.content":
      ...
      "entry.messages.setup.content":
        "HACS wird gerade eingerichtet, während dieser Zeit könnten einige Informationen fehlen oder falsch sein",
      "entry.messages.setup.title": "HACS wird eingerichtet",
      "entry.messages.startup.content":
        "HACS wird gestartet, während dieser Zeit könnten einige Informationen fehlen oder falsch sein",
      "entry.messages.startup.title": "HACS startet",
      "entry.messages.waiting.content":
        "HACS wartet darauf, dass Home Assistant den Start beendet, bevor mit den Startaufgaben gestartet wird",
      "entry.messages.waiting.title": "HACS wartet",
      "entry.messages.wrong_frontend_installed.content":
        "Du hast {running} des HACS-Frontends installiert, aber Version {expected} wurde erwartet. Wenn diese Meldung angezeigt wird, dass Home Assistant die neue Version nicht installieren konnte, starte Home Assistant neu.",
      "entry.messages.wrong_frontend_installed.title":
        "Unerwartete Frontend-Version",
      "entry.messages.wrong_frontend_loaded.content":
        "Du führst die Version {running} des HACS-Frontends aus, aber es wurde die Version {expected} erwartet. Du solltest deinen Browser-Cache leeren.",
      "entry.messages.wrong_frontend_loaded.title":
        "Unerwartete Frontend-Version",
      ...
      "options.abort.not_setup": "HACS ist nicht eingerichtet.",
      ...
      "sections.about.description": "Informationen zu HACS anzeigen",
      "sections.about.title": "Über",
      "sections.addon.description":
        "Es gibt in HACS selbst keine Add-ons, aber du kannst hier klicken, um zum Supervisor zu gelangen",
      ...
      "store.new_repositories_note":
        "Hier werden einige neue Repositories angezeigt",
      "store.no_repositories": "Keine Repositories",
      "store.no_repositories_desc1":
        "Anscheinend hast Du in diesem Abschnitt noch keine Repositories heruntergeladen.",
      "store.no_repositories_desc2":
        "Klicken auf das + in der unteren Ecke, um dein erstes hinzuzufügen!",
      "store.no_repositories_found_desc1":
        'In diesem Abschnitt wurden keine installierten Repositories gefunden, die mit "{searchInput}" übereinstimmen.',
    ...
    en: {
      ...
      "entry.messages.restart.content":
        "You have {number} {pluralWording} for which a restart of Home Assistant is required. You can do that in the the 'System' section under the configuration part of Home Assistant UI.",
      ...
      "entry.messages.setup.title": "HACS is setting up",
      "entry.messages.startup.content":
        "HACS is starting up, during this time some information might be missing or incorrect",
      "entry.messages.startup.title": "HACS is starting up",
      "entry.messages.waiting.content":
        "HACS is waiting for Home Assistant to finish startup before starting startup tasks",
      "entry.messages.waiting.title": "HACS is waiting",
      "entry.messages.wrong_frontend_installed.content":
        "You have {running} of the HACS frontend installed, but version {expected} was expected, if this you see this message Home Assistant was not able to install the new version, try restarting Home Assistant.",
      "entry.messages.wrong_frontend_installed.title":
        "Unexpected frontend version",
      "entry.messages.wrong_frontend_loaded.content":
        "You are running version {running} of the HACS frontend, but version {expected} was expected, you should clear your browser cache.",
      "entry.messages.wrong_frontend_loaded.title":
        "Unexpected frontend version",
      ...
      "options.abort.not_setup": "HACS is not setup.",
      "options.abort.release_limit_value":
      ...
      "sections.about.description": "Show information about HACS",
      "sections.about.title": "About",
      "sections.addon.description":
        "There are no addons in HACS, but you can click here to get to the supervisor",
      "sections.addon.title": "Add-ons",
      "sections.automation.description":
    ...
    es: {
      ...
      "entry.messages.disabled.removed.description":
        "HACS está eliminado, reinicie Home Assistant.",
      "entry.messages.disabled.removed.title": "Eliminado",
      "entry.messages.disabled.restore.description":
        "Consulte su archivo de registro para obtener más detalles",
      "entry.messages.disabled.restore.title": "Falló la restauración de HACS",
      "entry.messages.disabled.title": "HACS está deshabilitado",
      "entry.messages.has_pending_tasks.content":
      ...
      "entry.messages.setup.content":
        "HACS se está configurando, durante este tiempo alguna información puede estar perdida o ser incorrecta",
      "entry.messages.setup.title": "HACS se está configurando",
      "entry.messages.startup.content":
        "HACS se está iniciando, durante este tiempo alguna información podría faltar o ser incorrecta",
      "entry.messages.startup.title": "HACS se está iniciando",
      "entry.messages.waiting.content":
        "HACS está esperando a que Home Assistant finalice el inicio antes de iniciar las tareas de inicio",
      "entry.messages.waiting.title": "HACS está esperando",
      "entry.messages.wrong_frontend_installed.content":
        "Tienes instalada la versión {running} de la interfaz de HACS, pero se esperaba la versión {expected}, si ves este mensaje, Home Assistant no pudo instalar la nueva versión, intenta reiniciar Home Assistant.",
      "entry.messages.wrong_frontend_installed.title":
        "Versión inesperada del frontend",
      "entry.messages.wrong_frontend_loaded.content":
        "Estás ejecutando la versión {running} de la interfaz HACS, pero se esperaba la versión {expected} , deberías de limpiar la memoria caché del navegador.",
      "entry.messages.wrong_frontend_loaded.title":
      ...
      "options.abort.not_setup": "HACS no está configurado.",
      "options.abort.release_limit_value":
      ...
      "sections.about.description": "Mostrar información sobre HACS",
      "sections.about.title": "Acerca de",
      "sections.addon.description":
        "No hay complementos (addons) en HACS, pero puede hacer clic aquí para ir a la pestaña Supervisor",
    ...
    et: {
      ...
      "entry.messages.disabled.removed.description":
        "HACS on eemaldatud, taaskäivita Home Assistant.",
      "entry.messages.disabled.removed.title": "Eemaldatud",
      "entry.messages.disabled.restore.description":
        "Lisateavet leiad oma logifailist",
      "entry.messages.disabled.restore.title": "HACS-i taastamine nurjus",
      "entry.messages.disabled.title": "HACS on keelatud",
      "entry.messages.has_pending_tasks.content":
      ...
      "entry.messages.setup.content":
        "HACS on seadistub. Selle aja jooksul võib osa teavet puududa või olla vale",
      "entry.messages.setup.title": "HACS seadistub",
      "entry.messages.startup.content":
        "HACS käivitub. Selle aja jooksul võib osa teavet puududa või olla vale",
      "entry.messages.startup.title": "HACS käivitub",
      "entry.messages.waiting.content":
        "HACS ootab Home Assistanti käivitumist",
      "entry.messages.waiting.title": "HACS on ootel",
      "entry.messages.wrong_frontend_installed.content":
        "Paigaldatud on HACS-i kasutajaliides {running} kuid eeldati versiooni {expected}. Kui näed seda teadet siis Home Assistant ei saanud uut versiooni paigaldada, proovi taaskäivitada Home Assistant.",
      "entry.messages.wrong_frontend_installed.title":
        "Ootamatu kasutajaliidese versioon",
      "entry.messages.wrong_frontend_loaded.content":
        "Paigaldatud on HACS'i kasutajaliides {running} kuid eeldatakse versiooni {expected}. Tühjenda oma veebilehitseja vahemälu.",
      "entry.messages.wrong_frontend_loaded.title":
        "Ootamatu kasutajaliidese versioon",
      ...
      "options.abort.not_setup": "HACS pole seadistatud.",
      ...
      "sections.about.description": "Kuva HACS-i teave",
      "sections.about.title": "Üldteave",
      "sections.addon.description":
        "HACS-is pole lisandmooduleid. Supervisorisse pääsemiseks klõpsa siin",
      ...
      "entry.messages.disabled.title": "HACS on poistettu käytöstä",
      ...
      "entry.messages.startup.title": "HACS käynnistyy",
      "entry.messages.wrong_frontend_loaded.title":
    ...
    fr: {
      ...
      "entry.messages.disabled.constrains.description":
        "Votre environnement n'est pas compatible pour exécuter HACS, vérifiez votre fichier journal pour plus de détails.",
      "entry.messages.disabled.constrains.title": "Contraintes",
      "entry.messages.disabled.content":
        "Vérifiez votre fichier journal pour plus de détails",
      "entry.messages.disabled.invalid_token.description":
        "Reconfigurez HACS puis redémarrez Home Assistant.",
      "entry.messages.disabled.invalid_token.title": "Jeton invalide",
      "entry.messages.disabled.load_hacs.description":
        "Vérifiez votre fichier journal pour plus de détails",
      "entry.messages.disabled.load_hacs.title": "HACS n'a pas pu charger",
      "entry.messages.disabled.rate_limit.description":
      ...
      "entry.messages.disabled.removed.description":
        "HACS est supprimé, redémarrez Home Assistant.",
      "entry.messages.disabled.removed.title": "Supprimé",
      "entry.messages.disabled.restore.description":
        "Vérifiez votre fichier journal pour plus de détails",
      "entry.messages.disabled.restore.title":
        "La restauration de HACS a échoué",
      "entry.messages.disabled.title": "HACS est désactivé",
      "entry.messages.has_pending_tasks.content":
      ...
      "entry.messages.restart.content":
        "Vous avez {number} {pluralWording} nécessitant un redémarrage de Home Assistant. Vous pouvez le faire depuis la section « Gestion du serveur » dans la partie configuration de l'interface utilisateur de Home Assistant.",
      "entry.messages.restart.title": "En attente de redémarrage",
      "entry.messages.setup.content":
        "HACS est en cours de configuration, pendant ce temps, certaines informations peuvent être manquantes ou incorrectes",
      "entry.messages.setup.title": "HACS se met en place",
      "entry.messages.startup.content":
        "HACS démarre, pendant ce temps, certaines informations peuvent être manquantes ou incorrectes",
      "entry.messages.startup.title": "HACS est en train de démarrer",
      "entry.messages.waiting.content":
        "HACS attend que Home Assistant termine le démarrage avant de démarrer les tâches de démarrage",
      "entry.messages.waiting.title": "HACS attend",
      "entry.messages.wrong_frontend_installed.content":
        "La version {running} de l'interface HACS est installée alors que la version {expected} était attendue. Si ce message s'affiche, Home Assistant n'a pas pu installer la nouvelle version ; essayez de redémarrer Home Assistant.",
      "entry.messages.wrong_frontend_installed.title":
        "Version de l'interface inattendue",
      "entry.messages.wrong_frontend_loaded.content":
        "Vous exécutez la version {running} de l'interface HACS alors que la version {expected} était attendue ; essayez de vider le cache de votre navigateur.",
      "entry.messages.wrong_frontend_loaded.title":
        "Version de l'interface inattendue",
      ...
      "options.abort.not_setup": "HACS n'est pas configuré.",
      "options.abort.release_limit_value":
      ...
      "sections.about.description":
        "Afficher des informations sur le système HACS",
      "sections.about.title": "À propos",
      "sections.addon.description":
        "Il n'y a pas de modules complémentaires dans HACS, mais vous pouvez cliquer ici pour aller au superviseur",
    ...
    he: {
      ...
      "entry.messages.disabled.constrains.description":
        "הסביבה שלך אינה תואמת להפעלת HACS, יש לבדוק את קובץ היומן שלך לקבלת פרטים נוספים.",
      "entry.messages.disabled.constrains.title": "אילוצים",
      "entry.messages.disabled.content":
        "יש לבדוק את קובץ היומן שלך לקבלת פרטים נוספים",
      "entry.messages.disabled.invalid_token.description":
        "יש להגדיר מחדש את HACS ולהפעיל מחדש את Home Assistant.",
      "entry.messages.disabled.invalid_token.title": "אסימון לא חוקי",
      "entry.messages.disabled.load_hacs.description":
        "יש לבדוק את קובץ היומן שלך לקבלת פרטים נוספים",
      "entry.messages.disabled.load_hacs.title": "טעינת HACS לא הצליחה",
      "entry.messages.disabled.rate_limit.description":
        "קריאות ה-API של GitHub מוגבלות, זה אמור להסתדר תוך פחות משעה.",
      "entry.messages.disabled.rate_limit.title": "רמה מוגבלת",
      "entry.messages.disabled.removed.description":
        "HACS הוסר, יש להפעיל מחדש את Home Assistant.",
      "entry.messages.disabled.removed.title": "הוסר",
      "entry.messages.disabled.restore.description":
        "יש לבדוק את קובץ היומן שלך לקבלת פרטים נוספים",
      "entry.messages.disabled.restore.title": "שחזור HACS נכשל",
      "entry.messages.disabled.title": "HACS מושבת",
      "entry.messages.has_pending_tasks.content":
      ...
      "entry.messages.setup.content":
        "HACS מוגדר, במהלך זמן זה מידע עלול להיות חסר או שגוי",
      "entry.messages.setup.title": "HACS מוגדר",
      "entry.messages.startup.content":
        "HACS מתחיל לפעול, במהלך זמן זה מידע עלול להיות חסר או שגוי",
      "entry.messages.startup.title": "HACS מתחיל לפעול",
      "entry.messages.waiting.content":
        "HACS ממתין ש-Home Assistant יסיים את ההפעלה לפני הפעלת משימות האתחול",
      "entry.messages.waiting.title": "HACS ממתין",
      "entry.messages.wrong_frontend_installed.content":
        "יש לך ממשק חזותי של HACS בגרסה {running}, אבל המערכת ציפתה לגרסה {expected}. איזו באסה, אם זו ההודעה שמוצגת לך, Home Assistant לא הצליח להתקין את הגרסה החדשה, יש לנסות להפעיל מחדש את Home Assistant.",
      "entry.messages.wrong_frontend_installed.title": "גרסת חזית לא צפויה",
      "entry.messages.wrong_frontend_loaded.content":
        "יש לך ממשק חזותי של HACS בגרסה {running}, אבל המערכת ציפתה לגרסה {expected}, יש לנקות את מטמון הדפדפן.",
      ...
      "options.abort.not_setup": "HACS אינו מוגדר.",
      "options.abort.release_limit_value":
      ...
      "sections.about.description": "הצגת מידע אודות HACS",
      "sections.about.title": "אודות",
      "sections.addon.description":
        "אין הרחבות ב-HACS, אבל היי אפשר ללחוץ כאן כדי להגיע למפקח",
    ...
    hu: {
      ...
      "entry.messages.disabled.constrains.description":
        "A futtatási környezet nem kompatibilis a HACS-al, további részletekért nézze meg a naplófájlokat.",
      "entry.messages.disabled.constrains.title": "Korlátozások",
      "entry.messages.disabled.content": "További részletek a naplófájlban",
      "entry.messages.disabled.invalid_token.description":
        "HACS újrakonfigurálása, és Home Assistant újraindítása.",
      "entry.messages.disabled.invalid_token.title": "Érvénytelen token",
      "entry.messages.disabled.load_hacs.description":
        "További részletek a naplófájlban",
      "entry.messages.disabled.load_hacs.title": "HACS betöltése nem sikerült",
      "entry.messages.disabled.rate_limit.description":
      ...
      "entry.messages.disabled.removed.description":
        "HACS eltávolításra került, most indítsa újra Home Assistant-ot.",
      "entry.messages.disabled.removed.title": "Eltávolítva",
      "entry.messages.disabled.restore.description":
        "További részletek a naplófájlban",
      "entry.messages.disabled.restore.title":
        "HACS visszaállítása nem sikerült",
      "entry.messages.disabled.title": "HACS le van tiltva",
      "entry.messages.has_pending_tasks.content":
      ...
      "entry.messages.setup.content":
        "HACS beállítása folyamatban van, ez idő alatt bizonyos információk hiányozhatnak vagy helytelenek lehetnek",
      "entry.messages.setup.title": "HACS beállítása folyamatban van",
      "entry.messages.startup.content":
        "HACS éppen indul, ez idő alatt bizonyos információk hiányozhatnak vagy helytelenek lehetnek",
      "entry.messages.startup.title": "HACS éppen indul",
      "entry.messages.waiting.content":
        "HACS az indítási feladatok megkezdése előtt arra vár, hogy Home Assistant befejezze saját indulását",
      "entry.messages.waiting.title": "HACS várakozik",
      "entry.messages.wrong_frontend_installed.content":
        "A HACS kezelőfelületének {running} verziója fut, miközben {expected} verziónak kellene lennie. Ha ezt az üzenetet látja, Home Assistant nem tudta a friss verziót telepíteni. Kérem próbálja meg újraindítani a rendszert.",
      "entry.messages.wrong_frontend_installed.title":
        "Nem várt frontend verzió",
      "entry.messages.wrong_frontend_loaded.content":
        "A HACS kezelőfelületének {running} verziója fut, miközben {expected} verziónak kellene lennie. Kérem, törölje a böngésző gyorsítótárát!",
      ...
      "options.abort.not_setup": "HACS nincs beállítva.",
      "options.abort.release_limit_value":
      ...
      "sections.about.description": "Információk megjelenítése HACS-ről",
      "sections.about.title": "Névjegy",
      "sections.addon.description":
        "HACS-ban nincsenek kiegészítők, de ide kattintva továbbmehet a supervisor-hoz",
    ...
    it: {
      ...
      "entry.messages.disabled.constrains.description":
        "Il tuo ambiente non è compatibile per eseguire HACS, controlla il tuo file di registro per maggiori dettagli.",
      "entry.messages.disabled.constrains.title": "Vincoli",
      "entry.messages.disabled.content":
        "Controlla il tuo file di registro per maggiori dettagli",
      "entry.messages.disabled.invalid_token.description":
        "Riconfigura HACS e riavvia Home Assistant.",
      "entry.messages.disabled.invalid_token.title": "Token non valido",
      "entry.messages.disabled.load_hacs.description":
        "Controlla il tuo file di registro per maggiori dettagli",
      "entry.messages.disabled.load_hacs.title": "Impossibile caricare HACS",
      "entry.messages.disabled.rate_limit.description":
      ...
      "entry.messages.disabled.removed.description":
        "HACS è stato rimosso, riavvia Home Assistant.",
      "entry.messages.disabled.removed.title": "Rimosso",
      "entry.messages.disabled.restore.description":
        "Controlla il tuo file di registro per maggiori dettagli",
      "entry.messages.disabled.restore.title":
        "Ripristino di HACS non riuscito",
      "entry.messages.disabled.title": "HACS è disabilitato",
      "entry.messages.has_pending_tasks.content":
      ...
      "entry.messages.setup.content":
        "HACS è in fase di configurazione, durante questo periodo alcune informazioni potrebbero essere mancanti o errate",
      "entry.messages.setup.title": "HACS si sta configurando",
      "entry.messages.startup.content":
        "HACS si sta avviando, durante questo periodo alcune informazioni potrebbero essere mancanti o errate",
      "entry.messages.startup.title": "HACS si sta avviando",
      "entry.messages.waiting.content":
        "HACS è in attesa che Home Assistant finisca l'avvio prima di iniziare le attività di avvio",
      "entry.messages.waiting.title": "HACS è in attesa",
      "entry.messages.wrong_frontend_installed.content":
        "Hai installato la versione {running} del frontend HACS, ma era attesa la versione {expected}, se vedi questo messaggio Home Assistant non è stato in grado di installare la nuova versione, prova a riavviare Home Assistant.",
      "entry.messages.wrong_frontend_installed.title":
        "Versione frontend inattesa",
      "entry.messages.wrong_frontend_loaded.content":
        "Stai eseguendo la versione {running} del frontend HACS, ma era prevista la versione {expected}, è necessario svuotare la cache del browser.",
      "entry.messages.wrong_frontend_loaded.title":
        "Versione frontend inattesa",
      ...
      "options.abort.not_setup": "HACS non è configurato.",
      "options.abort.release_limit_value":
      ...
      "sections.about.description": "Mostra informazioni su HACS",
      "sections.about.title": "Informazioni su",
      "sections.addon.description":
        "Non ci sono componenti aggiuntivi in HACS, ma puoi fare clic qui per accedere al Supervisor",
    ...
    nb: {
      ...
      "entry.messages.disabled.constrains.description":
        "Miljøet ditt er ikke kompatibelt for å kjøre HACS, sjekk loggfilen din for mer informasjon.",
      "entry.messages.disabled.constrains.title": "Begrensninger",
      "entry.messages.disabled.content":
        "Sjekk loggfilen din for mer informasjon",
      "entry.messages.disabled.invalid_token.description":
        "Konfigurer HACS på nytt og start Home Assistant på nytt.",
      "entry.messages.disabled.invalid_token.title": "Ugyldig token",
      "entry.messages.disabled.load_hacs.description":
        "Sjekk loggfilen din for mer informasjon",
      "entry.messages.disabled.load_hacs.title": "HACS kunne ikke lastes inn",
      "entry.messages.disabled.rate_limit.description":
        "GitHub API-anrop er begrenset, dette slettes på mindre enn 1 time.",
      "entry.messages.disabled.rate_limit.title": "Ratelimited",
      "entry.messages.disabled.removed.description":
        "HACS er fjernet, start Home Assistant på nytt.",
      "entry.messages.disabled.removed.title": "Fjernet",
      "entry.messages.disabled.restore.description":
        "Sjekk loggfilen din for mer informasjon",
      "entry.messages.disabled.restore.title":
        "Gjenoppretting av HACS mislyktes",
      "entry.messages.disabled.title": "HACS er deaktivert",
      "entry.messages.has_pending_tasks.content":
      ...
      "entry.messages.setup.content":
        "HACS starter opp, i løpet av denne tiden kan det hende at noe informasjon mangler eller er feil",
      "entry.messages.setup.title": "HACS settes opp",
      "entry.messages.startup.content":
        "HACS starter opp, i løpet av denne tiden kan det hende at noe informasjon mangler eller er feil",
      "entry.messages.startup.title": "HACS starter opp",
      "entry.messages.waiting.content":
        "HACS venter på at Home Assistant skal fullføre oppstart før oppstart av oppgaver",
      "entry.messages.waiting.title": "HACS venter",
      "entry.messages.wrong_frontend_installed.content":
        "Du har versjon {running} av HACS frontend installert, men versjon {expected} var forventet. Hvis du ser denne meldingen, kunne ikke Home Assistant installere den nye versjonen. Forsøk å starte Home Assistant på nytt.",
      "entry.messages.wrong_frontend_installed.title":
        "Uventet grensesnitt versjon",
      "entry.messages.wrong_frontend_loaded.content":
        "Du kjører versjon {running} av HACS grensesnittet, men versjon {expected} var forventet. Du bør tømme nettleserens hurtiglager.",
      "entry.messages.wrong_frontend_loaded.title":
        "Uventet grensesnitt versjon",
      ...
      "options.abort.not_setup": "HACS er ikke satt opp.",
      "options.abort.release_limit_value":
      ...
      "sections.about.description": "Vis informasjon om HACS",
      "sections.about.title": "Om",
      "sections.addon.description":
        "Det er ingen addons i HACS, men du kan klikke her for å komme til veilederen",
      "sections.addon.title": "Add-ons",
      "sections.automation.description":
    ...
    nl: {
      ...
      "entry.messages.disabled.constrains.description":
        "Uw omgeving is niet geschikt om HACS te draaien, controleer uw log bestand voor meer details.",
      "entry.messages.disabled.constrains.title": "Beperkingen",
      "entry.messages.disabled.content":
        "Controleer uw logbestand voor meer details",
      "entry.messages.disabled.invalid_token.description":
        "Herconfigureer HACS en herstart Home Assistant.",
      "entry.messages.disabled.invalid_token.title": "Ongeldige token",
      "entry.messages.disabled.load_hacs.description":
        "Controleer uw logbestand voor meer details",
      "entry.messages.disabled.load_hacs.title": "HACS kon niet worden geladen",
      "entry.messages.disabled.rate_limit.description":
        "GitHub API calls zijn gelimiteerd, dit zal over een uur weg zijn.",
      "entry.messages.disabled.rate_limit.title": "Ratelimiet",
      "entry.messages.disabled.removed.description":
        "HACS is verwijderd, start Home Assistant opnieuw.",
      "entry.messages.disabled.removed.title": "Verwijderd",
      "entry.messages.disabled.restore.description":
        "Controleer uw logbestand voor meer details",
      "entry.messages.disabled.restore.title": "Herstel van HACS mislukt",
      "entry.messages.disabled.title": "HACS is uitgeschakeld",
      "entry.messages.has_pending_tasks.content":
      ...
      "entry.messages.setup.content":
        "HACS is aan het opstarten, gedurende deze tijd kunnen sommige gegevens ontbreken of onjuist zijn",
      "entry.messages.setup.title": "HACS is aan het opstarten",
      "entry.messages.startup.content":
        "HACS is aan het opstarten, gedurende deze tijd kan er informatie ontbreken of onjuist zijn",
      "entry.messages.startup.title": "HACS is aan het opstarten",
      "entry.messages.waiting.content":
        "HACS wacht tot Home Assistant klaar is met opstarten voordat het begint met opstarttaken",
      "entry.messages.waiting.title": "HACS is aan het wachten",
      "entry.messages.wrong_frontend_installed.content":
        "U heeft {running} van de HACS-frontend geïnstalleerd, maar versie {expected} werd verwacht. Als u dit bericht ziet, kon Home Assistant de nieuwe versie niet installeren. Probeer Home Assistant opnieuw op te starten.",
      "entry.messages.wrong_frontend_installed.title":
        "Onverwachte frontend-versie",
      "entry.messages.wrong_frontend_loaded.content":
        "U gebruikt versie {running} van de HACS-frontend, maar versie {expected} werd verwacht, u moet uw browsercache wissen.",
      "entry.messages.wrong_frontend_loaded.title":
        "Onverwachte frontend-versie",
      ...
      "options.abort.not_setup": "HACS is niet ingesteld.",
      "options.abort.release_limit_value":
      ...
      "sections.about.description": "Toon informatie over HACS",
      "sections.about.title": "Over",
      "sections.addon.description":
        "Er zijn geen add-ons in HACS, maar u kunt hier klikken om naar de supervisor te gaan",
      "sections.addon.title": "Add-ons",
      "sections.automation.description":
    ...
    pl: {
      ...
      "entry.messages.disabled.constrains.description":
        "Twoje środowisko nie jest kompatybilne z HACS, sprawdź log, aby uzyskać więcej informacji.",
      "entry.messages.disabled.constrains.title": "Ograniczenia",
      "entry.messages.disabled.content":
        "Sprawdź log, aby uzyskać więcej informacji",
      "entry.messages.disabled.invalid_token.description":
        "Skonfiguruj ponownie HACS i uruchom ponownie Home Assistanta.",
      "entry.messages.disabled.invalid_token.title": "Nieprawidłowy token",
      "entry.messages.disabled.load_hacs.description":
        "Sprawdź log, aby uzyskać więcej informacji",
      "entry.messages.disabled.load_hacs.title": "Nie można załadować HACS",
      "entry.messages.disabled.rate_limit.description":
      ...
      "entry.messages.disabled.removed.description":
        "HACS został usunięty, uruchom ponownie Home Assistanta.",
      "entry.messages.disabled.removed.title": "Usunięto",
      "entry.messages.disabled.restore.description":
        "Sprawdź log, aby uzyskać więcej informacji",
      "entry.messages.disabled.restore.title":
        "Przywrócenie HACS nie powiodło się",
      "entry.messages.disabled.title": "HACS jest wyłączony",
      "entry.messages.has_pending_tasks.content":
      ...
      "entry.messages.setup.content":
        "HACS jest konfigurowany, w tym czasie może brakować niektórych informacji lub są one nieprawidłowe",
      "entry.messages.setup.title": "HACS jest konfigurowany",
      "entry.messages.startup.content":
        "HACS uruchamia się, w tym czasie może brakować pewnych informacji lub mogą one być nieprawidłowe.",
      "entry.messages.startup.title": "HACS uruchamia się",
      "entry.messages.waiting.content":
        "HACS czeka na zakończenie uruchamiania Home Assistanta przed rozpoczęciem własnych zadań",
      "entry.messages.waiting.title": "HACS czeka",
      "entry.messages.wrong_frontend_installed.content":
        "Masz zainstalowany interfejs HACS w wersji {running}, a wersja {expected} była oczekiwana. Komunikat ten oznacza, że Home Assistant nie mógł zainstalować nowej wersji interfejsu HACS, spróbuj ponownie uruchomić Home Assistanta.",
      "entry.messages.wrong_frontend_installed.title":
        "Nieoczekiwana wersja interfejsu",
      "entry.messages.wrong_frontend_loaded.content":
        "Używasz wersji {running} interfejsu HACS, a wersja {expected} była oczekiwana, powinieneś wyczyścić pamięć podręczną przeglądarki.",
      "entry.messages.wrong_frontend_loaded.title":
        "Nieoczekiwana wersja interfejsu",
      ...
      "options.abort.not_setup": "HACS nie jest skonfigurowany",
      "options.abort.release_limit_value":
      ...
      "sections.about.description": "Informacje o HACS",
      "sections.about.title": "O HACS",
      "sections.addon.description":
        "W HACS nie ma dodatków, ale możesz kliknąć tutaj, aby przejść do Supervisora",
    ...
    pt_BR: {
      ...
      "entry.messages.disabled.constrains.description":
        "Seu ambiente não é compatível para executar o HACS, verifique seu arquivo de log para obter mais detalhes.",
      "entry.messages.disabled.constrains.title": "Restrições",
      "entry.messages.disabled.content":
        "Verifique seu arquivo de log para mais detalhes.",
      "entry.messages.disabled.invalid_token.description":
        "Reconfigure o HACS e reinicie o Home Assistant.",
      "entry.messages.disabled.invalid_token.title": "Token inválido",
      "entry.messages.disabled.load_hacs.description":
        "Verifique seu arquivo de log para obter mais detalhes",
      "entry.messages.disabled.load_hacs.title": "HACS não pôde carregar",
      "entry.messages.disabled.rate_limit.description":
      ...
      "entry.messages.disabled.removed.description":
        "HACS foi removido, reinicie o Home Assistant.",
      "entry.messages.disabled.removed.title": "Removido",
      "entry.messages.disabled.restore.description":
        "Verifique seu arquivo de log para obter mais detalhes",
      "entry.messages.disabled.restore.title": "A restauração do HACS falhou",
      "entry.messages.disabled.title": "O HACS está desativado",
      "entry.messages.has_pending_tasks.content":
      ...
      "entry.messages.resources.content":
        "Existem {number} elementos da Dashboard que não estão carregados corretamente na Dashboard.",
      "entry.messages.resources.title": "Não carregado na Dashboard",
      "entry.messages.restart.content":
      ...
      "entry.messages.setup.content":
        "O HACS está sendo configurado, durante esse período, algumas informações podem estar ausentes ou incorretas",
      "entry.messages.setup.title": "HACS está se configurando",
      "entry.messages.startup.content":
        "O HACS está sendo iniciado, durante esse período algumas informações podem estar ausentes ou incorretas",
      "entry.messages.startup.title": "O HACS está iniciando",
      "entry.messages.waiting.content":
        "O HACS está esperando que o Home Assistant termine a inicialização antes de iniciar as tarefas de inicialização",
      "entry.messages.waiting.title": "HACS está esperando",
      "entry.messages.wrong_frontend_installed.content":
        "Você tem {running} do frontend HACS instalado, mas a versão {expected} era esperada, se você vir esta mensagem o Home Assistant não pôde instalar a nova versão, tente reiniciar o Home Assistant.",
      "entry.messages.wrong_frontend_installed.title":
        "Versão de front-end inesperada",
      "entry.messages.wrong_frontend_loaded.content":
        "Você está executando a versão {running} do frontend HACS, mas a versão {expected} era esperada. Por favor limpe o cache do seu navegador.",
      "entry.messages.wrong_frontend_loaded.title":
      ...
      "options.abort.not_setup": "O HACS não está configurado.",
      "options.abort.release_limit_value":
      ...
      "sections.about.description": "Exibir informações sobre o HACS",
      "sections.about.title": "Sobre",
      "sections.addon.description":
        "Não há add-ons no HACS, mas você pode clicar aqui para chegar ao supervisor",
      "sections.addon.title": "Add-ons",
      "sections.automation.description":
        "É aqui que você encontra python_scripts, aplicativos AppDaemon e aplicativos NetDaemon",
      "sections.automation.title": "Automação",
      "sections.frontend.description":
        "É aqui que você encontra temas, cartões personalizados e outros elementos para a Dashboard",
      "sections.frontend.title": "Frontend",
      "sections.integrations.description":
    ...
    pt: {
      ...
      "entry.messages.disabled.constrains.description":
        "Seu ambiente não é compatível para executar HACS, verifique seu arquivo de registro para obter mais detalhes.",
      "entry.messages.disabled.constrains.title": "Restrições",
      "entry.messages.disabled.content":
        "Verifique o seu ficheiro de log para obter mais detalhes",
      "entry.messages.disabled.invalid_token.description":
        "Reconfigurar o HACS e reiniciar o Home Assistant.",
      "entry.messages.disabled.invalid_token.title": "Token inválido",
      "entry.messages.disabled.load_hacs.description":
        "Verifique o seu ficheiro de registo para mais detalhes",
      "entry.messages.disabled.load_hacs.title": "HACS não podia carregar",
      "entry.messages.disabled.rate_limit.description":
        "As chamadas API do GitHub são limitadas, o que será resolvido em menos de 1 hora.",
      "entry.messages.disabled.rate_limit.title": "Ratelimited",
      "entry.messages.disabled.removed.description":
        "HACS é removido, reinicie Home Assistant.",
      "entry.messages.disabled.removed.title": "Removido",
      "entry.messages.disabled.restore.description":
        "Verifique o seu ficheiro de registo para mais detalhes",
      "entry.messages.disabled.restore.title": "A restauração do HACS falhou",
      "entry.messages.disabled.title": "HACS está desativado",
      "entry.messages.has_pending_tasks.content":
        "Alguns repositórios podem não aparecer até que isso seja concluído",
      "entry.messages.has_pending_tasks.title":
        "Tarefas em segundo plano pendentes",
      ...
      "entry.messages.restart.title": "Reinicialização pendente",
      "entry.messages.setup.content":
        "A HACS está a criar, durante este tempo pode faltar ou estar incorrecta alguma informação",
      "entry.messages.setup.title": "HACS está a estabelecer-se",
      "entry.messages.startup.content":
        "O HACS está a iniciar. Durante este tempo, algumas informações podem estar ausentes ou incorretas",
      "entry.messages.startup.title": "O HACS está a iniciar",
      "entry.messages.waiting.content":
        "HACS está à espera que o Home Assistant termine as tarefas de arranque antes de iniciar as tarefas de arranque",
      "entry.messages.waiting.title": "HACS está à espera",
      "entry.messages.wrong_frontend_installed.content":
        "Tem instalado o {running} do frontend HACS, mas a versão {expected} era esperada, se vir que esta mensagem Home Assistant não foi capaz de instalar a nova versão, tente reiniciar o Home Assistant.",
      "entry.messages.wrong_frontend_installed.title":
        "Versão inesperada do frontend",
      "entry.messages.wrong_frontend_loaded.content":
        "Está a executar a versão {running} do frontend HACS, mas a versão {expected} é a mais atualizada, deve limpar a cache do seu browser.",
      "entry.messages.wrong_frontend_loaded.title":
      ...
      "menu.reload": "Recarregar janela",
      "options.abort.not_setup": "HACS não está configurado.",
      "options.abort.release_limit_value":
      ...
      "search.placeholder": "Procurar repositório",
      "sections.about.description": "Mostrar informações sobre o HACS",
      "sections.about.title": "Sobre",
      "sections.addon.description":
        "Não existem suplementos no HACS, mas pode clicar aqui para chegar ao supervisor",
    ...
    ru: {
      ...
      "entry.messages.disabled.constrains.description":
        "Ваша среда несовместима с работой HACS, проверьте файл журнала для получения подробной информации.",
      "entry.messages.disabled.constrains.title": "Ограничения",
      "entry.messages.disabled.content":
        "Проверьте логи для получения более подробной информации.",
      "entry.messages.disabled.invalid_token.description":
        "Перенастройте HACS и перезапустите Home Assistant.",
      ...
      "entry.messages.disabled.load_hacs.title": "Не удалось загрузить HACS",
      "entry.messages.disabled.rate_limit.description":
      ...
      "entry.messages.disabled.removed.description":
        "HACS удален, перезапустите Home Assistant.",
      "entry.messages.disabled.removed.title": "Удалено",
      "entry.messages.disabled.restore.description":
        "Проверьте файл журнала для получения подробной информации",
      "entry.messages.disabled.restore.title": "Не удалось восстановить HACS",
      "entry.messages.disabled.title": "HACS отключен",
      "entry.messages.has_pending_tasks.content":
      ...
      "entry.messages.setup.content":
        "HACS настраивается, в это время некоторая информация может отсутствовать или быть неверной",
      "entry.messages.setup.title": "HACS настраивается",
      "entry.messages.startup.content":
        "HACS запускается, в течение этого времени некоторые сведения могут отсутствовать или быть неверными",
      "entry.messages.startup.title": "HACS запускается",
      "entry.messages.waiting.content":
        "HACS ожидает завершения запуска Home Assistant, прежде чем приступить к выполнению задач запуска",
      "entry.messages.waiting.title": "HACS ожидает",
      "entry.messages.wrong_frontend_installed.content":
        "У вас установлена версия {running} интерфейса HACS, однако ожидаемая версия — {expected}; если вы видите это сообщение, то Home Assistant не смог установить новую версию интерфейса; попробуйте перезапустить Home Assistant",
      "entry.messages.wrong_frontend_installed.title":
        "Неожиданная версия интерфейса",
      "entry.messages.wrong_frontend_loaded.content":
        "Вы используете версию {running} интерфейса HACS, однако ожидаемая версия — {expected}, попробуйте очистить кеш браузера.",
      "entry.messages.wrong_frontend_loaded.title":
        "Неожиданная версия интерфейса",
      ...
      "options.abort.not_setup": "HACS не настроен.",
      "options.abort.release_limit_value":
      ...
      "sections.about.description": "Показать информацию о HACS",
      "sections.about.title": "О проекте",
      "sections.addon.description":
        "В HACS нет дополнений, но вы можете кликнуть здесь, чтобы перейти в панель супервизора",
    ...
    sl: {
      ...
      "common.integration_plural": "Integracije",
      "common.lovelace": "Lovelace",
      "common.navigate": "pojdi",
      "common.netdaemon": "NetDaemon",
      "common.plugin": "Lovelace",
      "common.python_script": "Python skript",
      ...
      "dialog_add_repo.limit":
        "Prikazanih je samo prvih sto repozitorijev, uporabite iskalnik, da bi našli, kar potrebujete",
      ...
      "dialog_removed.link": "Zunanja povezava do več informacij",
      "dialog_removed.name": "Naziv repozitorija",
      "dialog_removed.reason": "Vzrok odstranitve",
      "dialog_removed.type": "Vrsta odstranitve",
      ...
      "entry.information": "Informacije",
      "entry.intro": "Posodobitve in pomembna sporočila bodo prikazana tukaj",
      "entry.messages.disabled.constrains.description":
        "Vaše okolje ni združljivo s HACS, preverite dnevnik za več informacij",
      "entry.messages.disabled.constrains.title": "Omejitve",
      "entry.messages.disabled.content": "Preveri dnevnike za več informacij",
      "entry.messages.disabled.invalid_token.description":
        "Ponovno nastavi HACS in ponovno zaženi Home Assistant",
      "entry.messages.disabled.invalid_token.title": "Neveljaven žeton",
      "entry.messages.disabled.load_hacs.description":
        "Preveri dnevnik za več informacij",
      "entry.messages.disabled.load_hacs.title":
        "HACS-a ni bilo mogoče naložiti",
      "entry.messages.disabled.rate_limit.description":
        "GitHub API klici so omejeni, to se bo ponastavilo v manj kot eni uri.",
      "entry.messages.disabled.rate_limit.title": "Omejeno",
      "entry.messages.disabled.removed.description":
        "HACS je odstranjen, ponovno zaženi Home Assistant",
      "entry.messages.disabled.removed.title": "Odstranjeno",
      "entry.messages.disabled.restore.description":
        "Preveri dnevnik za več informacij",
      "entry.messages.disabled.restore.title": "Obnovitev HACS ni uspela",
      "entry.messages.disabled.title": "HACS je onemogočen",
      "entry.messages.has_pending_tasks.content":
        "Nekateri repozitoriji mogoče ne bodo prikazani, dokler to ne bo dokončano",
      "entry.messages.has_pending_tasks.title": "Opravila se izvajajo v ozadju",
      "entry.messages.removed_repository":
        "Odstranjen repozitorij ''{repository}''",
      "entry.messages.resources.content":
        "{number} Lovelace elementov ni pravilno naloženo v Lovelace-u.",
      "entry.messages.resources.title": "Ni naloženo v Lovelace-u",
      "entry.messages.restart.content":
        'Imate {number} {pluralWording}, za kar je zahtevan ponovni zagon Home Assistanta. To lahko storite v razdelku "Orodja za razvijalce"v vmesniku Home Assistanta.',
      "entry.messages.restart.title": "Čakanje na ponovni zagon",
      "entry.messages.setup.content":
        "HACS se nastavlja, medtem so lahko nekatere informacije napačne ali pa manjkajo",
      "entry.messages.setup.title": "HACS se nastavlja",
      "entry.messages.startup.content":
        "HACS se zaganja, medtem so lahko nekatere informacije napačne ali pa manjkajo",
      "entry.messages.startup.title": "HACS se zaganja",
      "entry.messages.waiting.content":
        "HACS čaka, da Home Assistant konča z zagonom",
      "entry.messages.waiting.title": "HACS čaka",
      "entry.messages.wrong_frontend_installed.content":
        "Nameščeno imate {running} verzijo HACS, pričakuje pa se {expected} verzija. Če vidite to sporočilo, Home Assistant ni mogel namestiti nove verzije, poskusite s ponovnim zagonom.",
      "entry.messages.wrong_frontend_installed.title":
        "Nepričakovana verzija frontenda",
      "entry.messages.wrong_frontend_loaded.content":
        "Poganjate verzijo {running} HACS frontenda, pričakuje pa se verzija {expected}, počistite predpomnilnik vašega brskalnika.",
      "entry.messages.wrong_frontend_loaded.title":
        "Nepričakovana verzija frontenda",
      "entry.pending_updates": "Čakam na posodobitve",
      "menu.about": "O HACS",
      ...
      "options.abort.not_setup": "HACS ni nastavljen.",
      "options.abort.release_limit_value":
        "Omejitev izdaje mora biti med 1 in 100",
      "options.step.user.data.appdaemon":
      ...
      "search.downloaded": "Išči po prenešenih repozitorijih",
      "search.downloaded_new": "Išči po prenešenih ali novih repozitorijih",
      "search.placeholder": "Išči repozitorije",
      "sections.about.description": "Pokaži informacije o HACS",
      "sections.about.title": "O HACS",
      "sections.addon.description":
        "HACS nima dodatkov, lahko pa kliknete tukaj, da pridete do aplikacij Supervisorja",
      "sections.addon.title": "Dodatki",
      "sections.automation.description":
        "Tu najdete Python skripte, AppDaemon aplikacije in NetDaemon aplikacije",
      "sections.automation.title": "Avtomatizacija",
      "sections.frontend.description":
        "Tu najdete teme, kartice po meri in druge elemente",
      "sections.frontend.title": "Frontend",
      "sections.integrations.description":
        "Tu najdete integracije po meri (custom_components)",
      "sections.integrations.title": "Integracije",
      "sections.pending_repository_upgrade":
        "Poganjate verzijo {downloaded}, verzija {available} je na voljo",
      "store.explore": "Išči in prenesi repozitorije",
      "store.new_repositories_note":
        "Tu je prikazanih nekaj novih repozitorijev",
      "store.no_repositories": "Ni repozitorijev",
      "store.no_repositories_desc1":
        "Kaže, da nimate še nobenih repozitorijev v tem odseku",
      "store.no_repositories_desc2":
        "Kliknite na + v zgornjem kotu, da dodate prvega!",
      "store.no_repositories_found_desc1":
        'Ni prenešenih repozitorijev, ki bi ustrezali "{searchInput}".',
      "store.no_repositories_found_desc2": "Poskusite poiskati kaj drugega!",
    },
    sv: {
      "common.appdaemon": "AppDaemon",
      "common.close": "Stäng",
    ...
    vi: {
      ...
      "entry.messages.disabled.title": "HACS đã bị vô hiệu hoá",
      "entry.messages.has_pending_tasks.content":
      ...
      "entry.messages.startup.content":
        "HACS đang khởi động, suốt quá trình này có thể một số thông tin sẽ bị thiếu hoặc không chính xác",
      "entry.messages.startup.title": "HACS đang khởi động",
      "entry.messages.wrong_frontend_loaded.content":
        "Bạn đang chạy phiên bản {running} của HACS frontend, nhưng phiên bản được yêu cầu là {expected}, bạn nên xoá bộ đệm của trình duyệt web.",
      "entry.messages.wrong_frontend_loaded.title":
      ...
      "sections.about.description": "Hiển thị thông tin về HACS",
    ...
    zh_Hans: {
      ...
      "entry.messages.setup.content":
        "HACS 正在启动，在此期间，部分信息可能缺失或异常",
      "entry.messages.setup.title": "HACS 正在安装",
      "entry.messages.startup.content":
        "HACS 正在启动，在此期间，部分信息可能缺失或异常",
      "entry.messages.startup.title": "HACS 正在启动",
      "entry.messages.waiting.content":
        "待到 Home Assistant 启动完成后，HACS 的启动任务才会开始",
      "entry.messages.waiting.title": "HACS 正在等待",
      "entry.messages.wrong_frontend_installed.content":
        "您正在运行 HACS 前端版本 {running}，但是期望版本是 {expected}。如果看到此消息，说明 Home Assistant 未能安装新版本，请尝试重新启动 Home Assistant。",
      "entry.messages.wrong_frontend_installed.title": "非预期的前端版本",
      "entry.messages.wrong_frontend_loaded.content":
        "您正在运行 HACS 前端版本 {running}，但是期望版本是 {expected}，请清除浏览器缓存。",
      ...
      "menu.reload": "重新加载窗口",
      "options.abort.not_setup": "HACS 未设置完毕。",
      ...
      "sections.about.description": "显示关于 HACS 的信息",
      "sections.about.title": "关于",
      "sections.addon.description":
        "HACS 没有加载项，但点击此处可以前往 Supervisor 的相应页面",
...
function $m(e, t, o) {
  ...
  (!Im.has(i) && Om[i]) ||
    (Im.has(i) ||
      (null !== (n = Dm.language) && void 0 !== n && n.includes(i)) ||
      (Dm.language.push(i),
      Rm.warn(
        `Language '${i.replace(
          "_",
    ...
    (i = "en"));
  const a = (null === (r = Om[i]) || void 0 === r ? void 0 : r[t]) || Om.en[t];
  if (!a) return Rm.error(`Translation problem with '${t}' for '${i}'`), t;
  const s = t + a;
  let l = Bm[s];
  if (!l) {
    try {
      ...
      return Rm.error(`Translation problem with '${t}' for '${i}'`), t;
    }
    Bm[s] = l;
  }
  try {
...
const Fm = (e) => ({
      ...
      main: [
        {
          ...
          description: $m(e, "sections.integrations.description"),
          name: $m(e, "sections.integrations.title"),
        ...
        },
        {
          ...
          description: $m(e, "sections.frontend.description"),
          name: $m(e, "sections.frontend.title"),
          path: "/hacs/frontend",
          core: !0,
        },
        {
          ...
          description: $m(e, "sections.automation.description"),
          name: $m(e, "sections.automation.title"),
  ...
  Um = os((e, t) =>
    Fm(e).subsections.main.filter((e) => {
  ...
  Zm = (e, t) => {
    ...
    return Fm(e).subsections.main.find((e) => e.id === o);
  },
  qm = (e) =>
  ...
  Gm = (e, t) => {
    ...
    if (
      ...
      return !0;
    const i = qm({ repository: t, skipTag: !0 });
    return (
        ...
        },
        {
          ...
          value: function (e) {
            r(t(i.prototype), "updated", this).call(this, e),
              this.hacs.language &&
                this.hacs.info &&
                (this.hacs.sections = Um(this.hacs.language, this.hacs.info));
          },
        },
      ],
    };
...
(Jm.styles = [Xm]), (Jm = iu([ye("mwc-icon")], Jm));
const th = (e) => e.nodeType === Node.ELEMENT_NODE;
function oh(e) {
  return {
    addClass: (t) => {
      e.classList.add(t);
...
document.addEventListener("x", ih, nh), document.removeEventListener("x", ih);
const ah = rh,
  sh = (e = window.document) => {
...
var hh = ["touchstart", "pointerdown", "mousedown", "keydown"],
  gh = ["touchend", "pointerup", "mouseup", "contextmenu"],
  _h = [],
  fh = (function (e) {
    function t(o) {
      var r = e.call(this, ru(ru({}, t.defaultAdapter), o)) || this;
      return (
    ...
    return (
      ...
      (t.prototype.registerRootHandlers = function (e) {
        ...
        if (e) {
          try {
            for (var r = au(hh), i = r.next(); !i.done; i = r.next()) {
              var n = i.value;
      ...
      (t.prototype.registerDeactivationHandlers = function (e) {
        ...
        if ("keydown" === e.type)
          ...
          try {
            for (var r = au(gh), i = r.next(); !i.done; i = r.next()) {
              var n = i.value;
      ...
      (t.prototype.deregisterRootHandlers = function () {
        var e, t;
        try {
          for (var o = au(hh), r = o.next(); !r.done; r = o.next()) {
            var i = r.value;
      ...
      (t.prototype.deregisterDeactivationHandlers = function () {
        ...
        try {
          for (var o = au(gh), r = o.next(); !r.done; r = o.next()) {
            var i = r.value;
            ...
            if (!(r && void 0 !== e && r.type !== e.type))
              (o.isActivated = !0),
                ...
                _h.some(function (e) {
                  ...
                  : (void 0 !== e &&
                      (_h.push(e.target), this.registerDeactivationHandlers(e)),
...
class wh extends dh {
  constructor() {
    super(...arguments),
      ...
      (this.leftPos = ""),
      (this.topPos = ""),
      (this.mdcFoundationClass = yh);
  }
  get isActive() {
    return eh(this.parentElement || this, ":active");
  }
  createAdapter() {
    return {
...
iu([we(".mdc-ripple-surface")], wh.prototype, "mdcRoot", void 0),
  iu([be({ type: Boolean })], wh.prototype, "primary", void 0),
  iu([be({ type: Boolean })], wh.prototype, "accent", void 0),
  iu([be({ type: Boolean })], wh.prototype, "unbounded", void 0),
  iu([be({ type: Boolean })], wh.prototype, "disabled", void 0),
  iu([be({ type: Boolean })], wh.prototype, "activated", void 0),
  iu([be({ type: Boolean })], wh.prototype, "selected", void 0),
  iu(
    [be({ type: Boolean })],
    wh.prototype,
...
(Lh.styles = [kh]), (Lh = iu([ye("mwc-ripple")], Lh));
class Vh {
  constructor(e) {
    (this.startPress = (t) => {
      e().then((e) => {
...
iu([be({ type: Boolean, reflect: !0 })], zh.prototype, "disabled", void 0),
  iu([be({ type: String })], zh.prototype, "icon", void 0),
  iu(
    [Sh, be({ type: String, attribute: "aria-label" })],
    zh.prototype,
    "ariaLabel",
    void 0
  ),
  ...
  iu([we("button")], zh.prototype, "buttonElement", void 0),
  iu([ke("mwc-ripple")], zh.prototype, "ripple", void 0),
  iu([Ce()], zh.prototype, "shouldRenderRipple", void 0),
  iu([He({ passive: !0 })], zh.prototype, "handleRippleMouseDown", null),
  iu([He({ passive: !0 })], zh.prototype, "handleRippleTouchStart", null);
...
let jh = class extends zh {};
(jh.styles = [Th]), (jh = iu([ye("mwc-icon-button")], jh));
let Nh = s(
  [ye("ha-svg-icon")],
  function (e, t) {
    return {
      ...
      d: [
        { kind: "field", decorators: [be()], key: "path", value: void 0 },
        { kind: "field", decorators: [be()], key: "viewBox", value: void 0 },
        {
          kind: "method",
          key: "render",
          value: function () {
  ...
  function (e, t) {
    return {
      ...
      d: [
        {
          kind: "field",
          decorators: [be({ type: Boolean, reflect: !0 })],
          key: "disabled",
          value: () => !1,
        },
        {
          kind: "field",
          decorators: [be({ type: String })],
          key: "path",
          value: void 0,
        },
        {
        ...
        {
          kind: "field",
          decorators: [be({ type: String, attribute: "aria-haspopup" })],
          key: "ariaHasPopup",
          value: void 0,
        },
        {
        ...
        {
          kind: "field",
          decorators: [we("mwc-icon-button", !0)],
          key: "_button",
          value: void 0,
        },
        {
    ...
    function (e, o) {
      ...
      return {
        ...
        d: [
          ...
          { kind: "field", decorators: [be()], key: "label", value: void 0 },
          { kind: "field", decorators: [Ce()], key: "_icon", value: () => Ss },
          {
            kind: "method",
            key: "connectedCallback",
            value: function () {
              r(t(i.prototype), "connectedCallback", this).call(this),
                setTimeout(() => {
                  this._icon =
                    "ltr" === window.getComputedStyle(this).direction ? Ss : Vs;
                }, 100);
            },
          },
          {
...
const Oh = (e) => {
      ...
      (e[t] = {
        ...
        subscribe(t) {
          a++,
            1 === a &&
              (() => {
                if (void 0 !== n) return clearTimeout(n), void (n = void 0);
                r && (i = r(e, s)),
  ...
  Rh = (e, t, o, r, i) => Ih(r, e, t, o).subscribe(i),
  Dh = (e) => e.sendMessagePromise({ type: "persistent_notification/get" }),
  Bh = (e, t) =>
    e.subscribeEvents(
      () => Dh(e).then((e) => t.setState(e, !0)),
  ...
  function (e, o) {
    ...
    return {
      ...
      d: [
        ...
        { kind: "field", decorators: [be()], key: "narrow", value: void 0 },
        {
          kind: "field",
          decorators: [be({ attribute: !1 })],
          key: "hass",
    ...
    function (e, t) {
      return {
        ...
        d: [
          ...
          { kind: "field", decorators: [be()], key: "error", value: void 0 },
          {
            kind: "method",
            key: "render",
            value: function () {
...
iu([be({ type: Boolean, reflect: !0 })], $h.prototype, "indeterminate", void 0),
  iu([be({ type: Number, reflect: !0 })], $h.prototype, "progress", void 0),
  iu([be({ type: Number, reflect: !0 })], $h.prototype, "density", void 0),
  iu([be({ type: Boolean, reflect: !0 })], $h.prototype, "closed", void 0),
  iu(
    [Sh, be({ type: String, attribute: "aria-label" })],
    $h.prototype,
    "ariaLabel",
    ...
    function (e, t) {
      return {
        ...
        d: [
          ...
          {
            kind: "field",
            decorators: [be({ type: Boolean, attribute: "no-toolbar" })],
            key: "noToolbar",
            value: () => !1,
          },
          {
...
let Zh = s(
  ...
  function (e, o) {
    ...
    return {
      F: i,
      d: [
        { kind: "field", decorators: [be()], key: "route", value: void 0 },
            ...
            if (o.beforeRender) {
              ...
              if (void 0 !== e) {
                for (s = e, l = o.routes[s]; "string" == typeof l; )
                  (s = l), (l = o.routes[s]);
                n && st(`${n.prefix}/${e}${location.search}`, { replace: !0 });
              }
            }
          ...
          value: function () {
            r(t(i.prototype), "connectedCallback", this).call(this),
              this._listeners.push(
                Wm("(min-width: 1040px)", (e) => {
                  this._wide = e;
                })
              ),
              this._listeners.push(
                Wm("(min-width: 1296px)", (e) => {
                  this._wideSidebar = e;
                })
              ),
          ...
          value: () => ({
            ...
            routes: {
              _my_redirect: {
                ...
                load: () => import("./c.e2a8d067.js"),
              },
              entry: {
                tag: "hacs-entry-panel",
                load: () => import("./c.ecbce863.js"),
              },
              integrations: {
                tag: "hacs-store-panel",
                load: () => import("./c.0f6bb17e.js"),
              },
              frontend: {
                tag: "hacs-store-panel",
                load: () => import("./c.0f6bb17e.js"),
  ...
  function (e, o) {
    ...
    return {
      ...
      d: [
        ...
        {
          kind: "field",
          decorators: [we("#hacs-dialog")],
          key: "_hacsDialog",
          value: void 0,
        },
        {
          kind: "field",
          decorators: [we("#hacs-dialog-secondary")],
        ...
        },
        {
          ...
          value: function (e) {
            r(t(i.prototype), "firstUpdated", this).call(this, e),
              ...
              Qa(this.hass, () => this._updateProperties("status"), ja.STATUS),
              Qa(this.hass, () => this._updateProperties("status"), ja.STAGE),
              Qa(
                this.hass,
              ...
              "" === this.route.path && st("/hacs/entry", { replace: !0 }),
              ...
              Je.matchMedia("(prefers-color-scheme: dark)").addEventListener(
                "change",
                (e) => this._applyTheme()
              ),
              ((e, t) => {
        ...
        },
        {
          ...
          value: async function (e = "all") {
            const t = {},
              o = {};
            "all" === e
              ? ([o.repositories, o.info, o.critical, o.resources, o.removed] =
                  await Promise.all([
                    Oa(this.hass),
                    Na(this.hass),
                    Ia(this.hass),
              ...
              : "info" === e
              ? (o.info = await Na(this.hass))
              : "repositories" === e
              ? (o.repositories = await Oa(this.hass))
              : "lovelace" === e && (o.resources = await Ka(this.hass)),
              Object.keys(o).forEach((e) => {
                void 0 !== o[e] && (t[e] = o[e]);
              }),
              t && this._updateHacs(t);
          },
        },
        {
          kind: "method",
