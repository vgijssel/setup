...
import "./c.bc5a73e9.js";
import { e as C } from "./c.50bfd408.js";
import "./c.97b7c4b0.js";
import { r as E } from "./c.4204ca09.js";
import { g as T } from "./c.f2bb3724.js";
import { s as U } from "./c.4266acdb.js";
import "./c.a5f69ed4.js";
import { f as D } from "./c.fe747ba2.js";
import { m as K } from "./c.f6611997.js";
  ...
  function (o, t) {
    return {
      ...
      d: [
        ...
        { kind: "field", decorators: [e()], key: "header", value: void 0 },
        {
          kind: "field",
          decorators: [e({ type: Boolean, attribute: "main-page" })],
          key: "mainPage",
          value: () => !1,
        },
        {
          kind: "field",
          decorators: [e({ type: String, attribute: "back-path" })],
          key: "backPath",
          value: void 0,
        },
        {
    ...
    `;
        ...
        {
          kind: "method",
          decorators: [a({ passive: !0 })],
          key: "_saveScrollPos",
          value: function (o) {
            this._savedScrollPos = o.target.scrollTop;
          },
        },
        {
          kind: "method",
...
let M = o(
  ...
  function (o, t) {
    ...
    return {
      ...
      d: [
        ...
        { kind: "field", decorators: [n()], key: "_error", value: void 0 },
        {
          ...
          value: function () {
            h(l(a.prototype), "connectedCallback", this).call(this),
        ...
        },
        {
          ...
          value: function () {
            h(l(a.prototype), "disconnectedCallback", this).call(this),
        ...
        },
        {
          ...
          value() {
            return (o) => {
              if (
                !(o.ctrlKey || o.shiftKey || o.metaKey || o.altKey) &&
                "m" === o.key &&
                c.location.pathname.startsWith("/hacs/repository/")
              ) {
                ...
                window.open(
                  `https://my.home-assistant.io/create-link/?${o.toString()}`,
                  "_blank"
                );
              }
            };
        ...
        },
        {
          ...
          value: async function (o) {
            h(l(a.prototype), "firstUpdated", this).call(this, o);
            const t = C();
            if (Object.entries(t).length) {
              let o;
              const e = `${t.owner}/${t.repository}`;
              if (
                ((o = this.hacs.repositories.find(
                  (o) =>
                    o.full_name.toLocaleLowerCase() === e.toLocaleLowerCase()
                )),
                !o && t.category)
              ) {
                if (
                ...
                try {
                  await d(this.hass, e, t.category),
                    (this.hacs.repositories = await p(this.hass)),
                    (o = this.hacs.repositories.find(
                      (o) =>
                        o.full_name.toLocaleLowerCase() ===
                        e.toLocaleLowerCase()
                    ));
                } catch (o) {
              ...
              const o = this.route.path.indexOf("/", 1),
                t = this.route.path.substr(o + 1);
              if (!t)
                return void (this._error = "Missing repositoryId from route");
        ...
        },
        {
          ...
          key: "updated",
          value: function (o) {
            h(l(a.prototype), "updated", this).call(this, o),
              o.has("repositories") &&
                this._repository &&
        ...
        },
        {
          ...
          value: async function (o) {
            try {
              this._repository = await D(
                this.hass,
                o || String(this._repository.id)
              );
            } catch (o) {
              this._error = null == o ? void 0 : o.message;
            }
          },
        },
        {
          ...
          value: () =>
            u((o) => {
              const t = [];
              if (!o.authors) return t;
              if (
                (o.authors.forEach((o) => t.push(o.replace("@", ""))),
                0 === t.length)
              ) {
                const e = o.full_name.split("/")[0];
                if (
                  [
                    "custom-cards",
                    "custom-components",
        ...
        },
        {
          ...
          value: function () {
            if (this._error)
              return i`<hass-error-screen .error=${this._error}></hass-error-screen>`;
            if (!this._repository)
              return i`<hass-loading-screen></hass-loading-screen>`;
            const o = this._getAuthors(this._repository);
            return i`
      <hass-subpage
        .hass=${this.hass}
        .narrow=${this.narrow}
        ...
        <ha-icon-overflow-menu
          ...
          .items=${[
            ...
            },
            {
              ...
              action: () =>
                c.open(
                  `https://github.com/hacs/integration/issues/new?assignees=ludeeus&labels=flag&template=removal.yml&repo=${this._repository.full_name}&title=Request for removal of ${this._repository.full_name}`,
                  "_blank",
                  "noreferrer=true"
                ),
            },
            ...
            (o) =>
              (!o.category || this._repository.category === o.category) &&
              (!o.hideForId || String(this._repository.id) !== o.hideForId) &&
              (!o.hideForUninstalled || this._repository.installed_version)
          )}
        >
        </ha-icon-overflow-menu>
        <div class="content">
          <div class="chips">
            ${
              this._repository.installed
                ? i`
                  <ha-chip title="${this.hacs.localize(
            ...
            ${
              o
                ? o.map(
                    (o) => i`<hacs-link .url="https://github.com/${o}">
                    <ha-chip title="${this.hacs.localize(
                      "dialog_info.author"
                    )}" hasIcon>
            ...
            ${
              this._repository.downloads
                ? i` <ha-chip hasIcon title="${this.hacs.localize(
            ...
            <hacs-link .url="https://github.com/${
    ...
    `;
            ...
            this.dispatchEvent(
              new CustomEvent("hacs-dialog", {
                detail: {
                  ...
                  content: this.hacs.localize("dialog.remove.message", {
                    name: this._repository.name,
                  }),
                  confirm: async () => {
        ...
        {
          kind: "method",
          key: "_repositoryRemove",
          value: async function () {
            var o;
            if (
              "plugin" === this._repository.category &&
              "yaml" !==
                (null === (o = this.hacs.info) || void 0 === o
                  ? void 0
                  : o.lovelace_mode)
            ) {
              (await L(this.hass))
                .filter((o) =>
                  o.url.startsWith(
                    `/hacsfiles/${this._repository.full_name.split("/")[1]}/${
                      this._repository.file_name
                    }`
                  )
                )
                .forEach(async (o) => {
                  await S(this.hass, String(o.id));
                });
            }
            await F(this.hass, String(this._repository.id)), history.back();
          },
        },
        {
          kind: "method",
          key: "_refreshReopsitoryInfo",
          value: async function () {
            await I(this.hass, String(this._repository.id));
          },
        },
        {
          kind: "get",
...
export { M as HacsRepositoryPanel };
