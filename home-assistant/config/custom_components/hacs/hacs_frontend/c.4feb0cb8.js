import { a6 as t, a7 as i, a8 as a } from "./main-ad130be7.js";
t({
  _template: i`
    <style>
      :host {
...
`,
  ...
  get target() {
    var t = a(this).parentNode,
      i = a(this).getOwnerRoot();
    return this.for
      ? a(i).querySelector("#" + this.for)
  ...
  show: function () {
    if (!this._showing) {
      if ("" === a(this).textContent.trim()) {
        for (
          var t = !0, i = a(this).getEffectiveChildNodes(), n = 0;
          n < i.length;
          n++
        )
          if ("" !== i[n].textContent.trim()) {
            t = !1;
            break;
          }
        if (t) return;
  ...
  updatePosition: function () {
    if (this._target && this.offsetParent) {
      ...
      var i,
        ...
        e = this._target.getBoundingClientRect(),
        o = this.getBoundingClientRect(),
        s = (e.width - o.width) / 2,
        r = (e.height - o.height) / 2,
        l = e.left - n.left,
        p = e.top - n.top;
      switch (this.position) {
        case "top":
          (i = l + s), (a = p - o.height - t);
          break;
        case "bottom":
          (i = l + s), (a = p + e.height + t);
          break;
        case "left":
          (i = l - o.width - t), (a = p + r);
          break;
      ...
      this.fitToVisibleBounds
        ? (n.left + i + o.width > window.innerWidth
            ? ((this.style.right = "0px"), (this.style.left = "auto"))
            : ((this.style.left = Math.max(0, i) + "px"),
              (this.style.right = "auto")),
          n.top + a + o.height > window.innerHeight
            ? ((this.style.bottom = n.height - p + t + "px"),
              (this.style.top = "auto"))
            : ((this.style.top = Math.max(-n.top, a) + "px"),
              (this.style.bottom = "auto")))
        : ((this.style.left = i + "px"), (this.style.top = a + "px"));
    }
  },
  ...
  _delayChange: function (t) {
    500 !== t && this.updateStyles({ "--paper-tooltip-delay-in": t + "ms" });
  },
  ...
  _getAnimationType: function (t) {
    if ("entry" === t && "" !== this.animationEntry) return this.animationEntry;
    if ("exit" === t && "" !== this.animationExit) return this.animationExit;
    if (
      ...
      if (
        ...
        var i = this.animationConfig[t][0].timing.delay;
        "entry" === t
          ? this.updateStyles({ "--paper-tooltip-delay-in": i + "ms" })
          : "exit" === t &&
            this.updateStyles({ "--paper-tooltip-delay-out": i + "ms" });
      }
