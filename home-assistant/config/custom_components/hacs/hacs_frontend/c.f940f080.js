...
import { d as g, i as f, u as v, r as _, b as y } from "./c.aa05d073.js";
import "./c.82eccc94.js";
import { c as b, M as k } from "./c.d2e52e5a.js";
import { a as w } from "./c.4a97632a.js";
import { a as $, s as x } from "./c.4266acdb.js";
import "./c.710a50fc.js";
import "./c.d262aab0.js";
import "./c.3f859915.js";
import "./c.9b92f489.js";
import "./c.8e28b461.js";
import "@lit-labs/virtualizer/layouts/grid";
...
const j = new Map(),
  C = new WeakSet(),
  z = () => new Promise((t) => requestAnimationFrame(t)),
  O = (t, e) => {
    const i = t - e;
    return 0 === i ? void 0 : i;
  },
  ...
  class extends g {
    ...
    v() {
      ...
      return (
        this.options.properties.forEach((s) => {
          var n;
          const o =
              null !== (n = e[s]) && void 0 !== n ? n : D[s] ? void 0 : i[s],
            a = Number(o);
          t[s] = isNaN(a) ? o + "" : a;
        }),
        t
    ...
    async hostUpdated() {
      ...
      if (void 0 !== this.g) {
        ...
        const i = j.get(this.options.inId);
        if (i) {
    ...
    async disconnected() {
      ...
      if (!this.o) return;
      if (
        (void 0 !== this.options.id && j.set(this.options.id, this.g),
    ...
    calculateKeyframes(t, e, i = !1) {
      ...
      return (
        (n.transformOrigin = o.transformOrigin =
  ...
  function (t, e) {
    return {
      ...
      d: [
        ...
        { kind: "field", decorators: [o()], key: "currentItem", value: void 0 },
        { kind: "field", decorators: [a()], key: "_uploading", value: () => 0 },
        {
          ...
          value: function () {
            return this.currentItem &&
              f(this.currentItem.media_content_id || "")
              ? r`
      <mwc-button
        .label=${
          this._uploading > 0
          ...
          },
          {
            ...
            value: async function () {
              ...
              try {
                await Promise.all(
                  t.map(async (t) => {
                    await _(this.hass, t.media_content_id),
                      (this._currentItem = {
                        ...this._currentItem,
