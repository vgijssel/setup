...
import { f as z } from "./c.3243a8b0.js";
import { c as j } from "./c.4a97632a.js";
import "./c.f1291e50.js";
import "./c.2d5ed670.js";
import "./c.97b7c4b0.js";
import { r as F } from "./c.4204ca09.js";
import { i as P } from "./c.21c042d4.js";
import { s as I } from "./c.2645c235.js";
  ...
  function (e, t) {
    ...
    `;
        ...
        },
        {
          ...
          key: "_rippleHandlers",
          value() {
            return new n(() => ((this._shouldRenderRipple = !0), this._ripple));
          },
        },
        {
          kind: "method",
      ...
      return {
        ...
        d: [
          ...
          },
          {
            ...
            key: "_getTabs",
            value() {
              return d((e, t, i, a, s, r, n) => {
                const l = e.filter(
                  (e) =>
                    (!e.component || e.core || P(this.hass, e.component)) &&
                    (!e.advancedOnly || i)
                );
                if (l.length < 2) {
                  if (1 === l.length) {
            ...
            value: function (e) {
              if (
                ...
                (t && t.language === this.hass.language) ||
                  (this.rtl = j(this.hass));
              }
              p(u(a.prototype), "willUpdate", this).call(this, e);
            },
          },
          {
            kind: "method",
  ...
  function (e, t) {
    return {
      ...
      d: [
            ...
            return d((e, t) => [
              (null == e
                ...
                : e.filter((e) => {
                    var i, a, s;
                    return (
                      (null === (i = this.hacs.sections) ||
                      void 0 === i ||
                      null === (a = i.find((e) => e.id === t)) ||
                      void 0 === a ||
                      null === (s = a.categories) ||
                      void 0 === s
                        ? void 0
                        : s.includes(e.category)) && e.installed
                    );
                  })) || [],
              (null == e
                ? void 0
        ...
        { kind: "field", key: "_filterRepositories", value: () => d(z) },
        {
          kind: "get",
        ...
        },
        {
          ...
          value: function () {
            ...
            if (!this.filters[this.section] && this.hacs.info.categories) {
              var i;
              const e =
                null === (i = f(this.hacs.language, this.route)) || void 0 === i
                  ? void 0
                  : i.categories;
              (this.filters[this.section] = []),
                null == e ||
                  e
                    .filter((e) => {
                      var t;
                      return null === (t = this.hacs.info) || void 0 === t
                        ? void 0
        ...
        .items=${[
          {
            ...
            action: () =>
              m.open("https://hacs.xyz/", "_blank", "noreferrer=true"),
          },
          {
            path: k,
            label: "GitHub",
            action: () =>
              m.open("https://github.com/hacs", "_blank", "noreferrer=true"),
          },
          {
            path: g,
      ...
      >
        ...
        },
        {
          ...
          value: async function () {
            ...
            await $(this.hass, {
              categories:
                (null === (e = f(this.hacs.language, this.route)) ||
                void 0 === e
                  ? void 0
                  : e.categories) || [],
            });
