  ...
  function (i, a) {
    return {
      ...
      d: [
        ...
        { kind: "field", decorators: [s()], key: "_params", value: void 0 },
        {
          kind: "field",
          decorators: [o("ha-textfield")],
          key: "_textField",
          value: void 0,
        },
        {
            ...
            return (
              !(
                (null !== (i = this._params) &&
                  void 0 !== i &&
                  i.confirmation) ||
                (null !== (a = this._params) && void 0 !== a && a.prompt)
              ) &&
        ...
        },
        {
          ...
          key: "render",
          value: function () {
            if (!this._params) return e``;
            const i = this._params.confirmation || this._params.prompt;
            return e`
      <ha-dialog
        open
        ?scrimClickAction=${i}
