...
import { S as d } from "./c.79c8c092.js";
import { a as u, b as l, c, d as m, U as h } from "./c.811f664e.js";
import { s as p } from "./c.468b43fb.js";
import { f as _ } from "./c.128a6b66.js";
import { i as f, a as v, b as y, d as g } from "./c.8d65df0a.js";
import { p as b } from "./c.aaeac12d.js";
import { u as k } from "./c.d8036e66.js";
import { c as w } from "./c.d2f13ac1.js";
import { a as $ } from "./c.04ecc0ad.js";
import { c as j } from "./c.fa0ef026.js";
...
const x = { s: 1, min: 60, h: 3600, d: 86400 };
b && (await b);
const D = (e, t) => I(t).format(e),
  I = e(
    (e) =>
      new Intl.DateTimeFormat(
        "en" !== e.language || k(e) ? e.language : "en-u-hc-h23",
        { hour: "numeric", minute: "2-digit", hour12: k(e) }
      )
  );
e(
  (e) =>
...
const B = (e, t, a, i) =>
    T(e, a, t.entity_id, t.attributes, void 0 !== i ? i : t.state),
  T = (e, t, a, i, o) => {
    if (o === u || o === l) return e(`state.default.${o}`);
    if (f(i)) {
      if (
        "duration" === i.device_class &&
        i.unit_of_measurement &&
        x[i.unit_of_measurement]
      )
        try {
          return (
            (s = o), (r = i.unit_of_measurement), p(parseFloat(s) * x[r]) || "0"
          );
        } catch (e) {}
      if ("monetary" === i.device_class)
        try {
          return v(o, t, {
            style: "currency",
            currency: i.unit_of_measurement,
            minimumFractionDigits: 2,
          });
        } catch (e) {}
      const e = i.unit_of_measurement
        ? "%" === i.unit_of_measurement
          ? ((e) => {
              switch (e.language) {
                case "cz":
    ...
    if ("input_datetime" === n) {
      if (void 0 === o) {
        let e;
        return i.has_date && i.has_time
          ? ((e = new Date(i.year, i.month - 1, i.day, i.hour, i.minute)),
            y(e, t))
          : i.has_date
          ? ((e = new Date(i.year, i.month - 1, i.day)), _(e, t))
          : i.has_time
          ? ((e = new Date()), e.setHours(i.hour, i.minute), D(e, t))
          : o;
      }
      try {
        const e = o.split(" ");
        if (2 === e.length) return y(new Date(e.join("T")), t);
        if (1 === e.length) {
          if (o.includes("-")) return _(new Date(`${o}T00:00`), t);
          if (o.includes(":")) {
            const e = new Date();
            return D(new Date(`${e.toISOString().split("T")[0]}T${o}`), t);
          }
        }
        return o;
      } catch (e) {
    ...
    if ("humidifier" === n && "on" === o && i.humidity)
      return `${i.humidity} %`;
    if ("counter" === n || "number" === n || "input_number" === n)
      return v(o, t);
    if (
      "button" === n ||
      "input_button" === n ||
      "scene" === n ||
      ("sensor" === n && "timestamp" === i.device_class)
    )
      try {
        return y(new Date(o), t);
      } catch (e) {
        return o;
      }
    var d;
    return "update" === n
      ? "on" === o
        ? c(i)
          ? $(i, m) && "number" == typeof i.in_progress
            ? e("ui.card.update.installing_with_progress", {
                progress: i.in_progress,
              })
            : e("ui.card.update.installing")
          : i.latest_version
        : i.skipped_version === i.latest_version
        ? null !== (d = i.latest_version) && void 0 !== d
          ? d
          : e("state.default.unavailable")
        : e("ui.card.update.up_to_date")
      : (i.device_class && e(`component.${n}.state.${i.device_class}.${o}`)) ||
          e(`component.${n}.state._.${o}`) ||
          o;
  },
  q = {
    alarm_control_panel: [
                ...
                this.entityId && e
                  ? ((e, t) => {
                      ...
                      switch (
                        (!t && a in q
                          ? i.push(...q[a])
                          : t && a in F && t in F[a] && i.push(...F[a][t]),
                        a)
                      ) {
                        case "climate":
                          t
                      ...
                      label: this.attribute
                        ? g(this.hass, t)
                        : B(this.hass.localize, e, this.hass.locale, t),
                    }))
                  : [];
            }
          },
