...
import { g as l } from "./c.f2bb3724.js";
import { d as c } from "./c.36ae07d6.js";
import { c as u } from "./c.874c8cfd.js";
import { b as h } from "./c.07e395f8.js";
import "./c.6795ddb8.js";
import "./c.8e28b461.js";
import "./c.7a38bd55.js";
import "./c.54b4c8e8.js";
e(
  [d("ha-config-entry-picker")],
  function (e, i) {
    return {
      F: class extends i {
        constructor(...i) {
      ...
      d: [
        ...
        { kind: "field", decorators: [t()], key: "integration", value: void 0 },
        { kind: "field", decorators: [t()], key: "label", value: void 0 },
        { kind: "field", decorators: [t()], key: "value", value: () => "" },
        ...
        },
        {
          ...
          value() {
            return (e) => {
              var i;
              return n`<mwc-list-item twoline graphic="icon">
    <span
      >${
        e.title ||
        this.hass.localize(
    ...
    <img
      ...
      src=${h({
        ...
        type: "icon",
        darkOptimized:
          null === (i = this.hass.themes) || void 0 === i ? void 0 : i.darkMode,
      })}
          ...
          value: async function () {
            l(this.hass, {
              ...
              this._configEntries = e
                .map((e) => ({
                  ...e,
                  localized_domain_name: c(this.hass.localize, e.domain),
                }))
                .sort((e, i) =>
                  u(
    ...
    return {
      ...
      d: [
        ...
        },
        {
          ...
          value: function () {
            var e;
            return n`<ha-config-entry-picker
      .hass=${this.hass}
      .value=${this.value}
      .label=${this.label}
      .helper=${this.helper}
...
export { v as HaConfigEntrySelector };
