...
import { c as g } from "./c.6795ddb8.js";
import { b as f } from "./c.11013a9d.js";
import { c as v } from "./c.6fde4307.js";
import { M as _ } from "./c.d131aa61.js";
import { i as b, u as y, r as k, b as w } from "./c.eac4de83.js";
import { a as $, s as j } from "./c.14416bd9.js";
...
import "./c.14856cd1.js";
import "./c.10b44dbb.js";
import "./c.80763e9e.js";
import "./c.f18e6e02.js";
import "./c.704dab74.js";
import "./c.b0145069.js";
...
const A = new Map(),
  C = new WeakSet(),
  O = () => new Promise((t) => requestAnimationFrame(t)),
  z = (t, e) => {
    const i = t - e;
    return 0 === i ? void 0 : i;
  },
  ...
  F = { duration: 333, easing: "ease-in-out" },
  P = ["left", "top", "width", "height", "opacity", "color", "background"],
  U = new WeakMap();
const E = t(
  class extends g {
    constructor(t) {
    ...
    u(t) {
      ...
      void 0 !== s &&
        ((t = { ...s.defaultOptions, ...t }).keyframeOptions = {
          ...s.defaultOptions.keyframeOptions,
          ...t.keyframeOptions,
        }),
    ...
    v() {
      ...
      return (
        this.options.properties.forEach((s) => {
          var o;
          const n =
              null !== (o = e[s]) && void 0 !== o ? o : D[s] ? void 0 : i[s],
            a = Number(n);
          t[s] = isNaN(a) ? n + "" : a;
        }),
        t
    ...
    async hostUpdated() {
      if (
        ...
        return;
      let t;
      this.prepare(), await O;
      const e = this._(),
        i = this.A(this.options.keyframeOptions, e),
        s = this.v();
      if (void 0 !== this.g) {
        const { from: i, to: o } = this.O(this.g, s, e);
        this.log("measured", [this.g, s, i, o]),
          (t = this.calculateKeyframes(i, o));
      } else {
        const i = A.get(this.options.inId);
        if (i) {
          A.delete(this.options.inId);
          const { from: o, to: n } = this.O(i, s, e);
          (t = this.calculateKeyframes(o, n)),
            (t = this.options.in
              ? [
    ...
    async disconnected() {
      ...
      if (!this.o) return;
      if (
        (void 0 !== this.options.id && A.set(this.options.id, this.g),
    ...
    O(t, e, i) {
      ...
      return (
        void 0 !== s &&
          (s.forEach((t) => {
            t.width && (o /= t.width), t.height && (n /= t.height);
          }),
          void 0 !== t.left &&
            void 0 !== e.left &&
            ((t.left = o * t.left), (e.left = o * e.left)),
          void 0 !== t.top &&
            void 0 !== e.top &&
    ...
    calculateKeyframes(t, e, i = !1) {
      ...
      return (
        (o.transformOrigin = n.transformOrigin =
          i ? "center center" : "top left"),
        (this.animatingProperties = r),
        a ? [o, n] : void 0
      );
    }
  ...
  function (t, e) {
    return {
      ...
      d: [
        ...
        { kind: "field", decorators: [n()], key: "currentItem", value: void 0 },
        { kind: "field", decorators: [a()], key: "_uploading", value: () => 0 },
        {
          kind: "method",
          key: "render",
          value: function () {
            return this.currentItem &&
              b(this.currentItem.media_content_id || "")
              ? r`
      <mwc-button
        .label=${
          this._uploading > 0
            ...
            (t.type = "file"),
              ...
              t.addEventListener(
                ...
                async () => {
                  ...
                  (this._uploading = 0), d(this, "media-refresh");
                },
                { once: !0 }
              ),
    ...
    function (t, e) {
      return {
        ...
        d: [
          ...
          { kind: "field", decorators: [a()], key: "_params", value: void 0 },
          {
            kind: "field",
            decorators: [a()],
            key: "_uploading",
          ...
          },
          {
            ...
            value: function () {
              this._filesChanged &&
                ...
                d(this, "dialog-closed", { dialog: this.localName });
            },
          },
          {
            kind: "method",
        ...
        ${
          this._currentItem
            ...
            `
              ...
              ${
                null !== (i = this._currentItem) &&
                void 0 !== i &&
                null !== (s = i.children) &&
                void 0 !== s &&
                s.length
                  ? r`<span class="folders"
                    >${this.hass.localize(
          ...
          },
          {
            ...
            value: async function () {
              ...
              try {
                await Promise.all(
                  t.map(async (t) => {
                    await k(this.hass, t.media_content_id),
                      (this._currentItem = {
                        ...this._currentItem,
