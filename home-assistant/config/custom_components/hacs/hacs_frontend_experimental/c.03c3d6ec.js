...
`,
  ...
  v = (e, t) => {
    ...
    return {
      path: `/${t.url_path}`,
      icon: null !== (a = t.icon) && void 0 !== a ? a : "mdi:view-dashboard",
      title:
        t.url_path === e.defaultPanel
          ? e.localize("panel.states")
          : e.localize(`panel.${t.title}`) ||
            t.title ||
            (t.url_path ? h(t.url_path) : ""),
    };
  };
e(
  [d("ha-navigation-picker")],
  function (e, t) {
    return {
      F: class extends t {
        constructor(...t) {
      ...
      d: [
        ...
        { kind: "field", decorators: [i()], key: "_opened", value: () => !1 },
        { kind: "field", key: "navigationItemsLoaded", value: () => !1 },
        { kind: "field", key: "navigationItems", value: () => r },
        {
          kind: "field",
    ...
    `;
        ...
        },
        {
          ...
          value: async function () {
            ...
            for (const t of e) {
              this.navigationItems.push(v(this.hass, t));
              const e = i.get(t.id);
              e &&
                e.views.forEach((e, a) =>
                  this.navigationItems.push(u(t.url_path, e, a))
                );
            }
