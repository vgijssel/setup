...
var l = function (e, n) {
    ...
    for (
      ...
      c.push(i.index),
        l.push(i.index + i[0].length),
        e.position <= i.index && s < 0 && (s = l.length - 2);
    s < 0 && (s = l.length - 1);
    var u,
      p,
      f = "",
...
var h = new u("tag:yaml.org,2002:null", {
  kind: "scalar",
  resolve: function (e) {
    if (null === e) return !0;
    var t = e.length;
...
var g = new u("tag:yaml.org,2002:bool", {
  kind: "scalar",
  resolve: function (e) {
    if (null === e) return !1;
    var t = e.length;
...
var b = new u("tag:yaml.org,2002:int", {
    kind: "scalar",
    resolve: function (e) {
      if (null === e) return !1;
      var t,
...
var A = /^[-+]?[0-9]+e/;
var w = new u("tag:yaml.org,2002:float", {
    kind: "scalar",
    resolve: function (e) {
    ...
    represent: function (e, n) {
      ...
      return (i = e.toString(10)), A.test(i) ? i.replace("e", ".e") : i;
    },
    defaultStyle: "lowercase",
  }),
  k = d.extend({ implicit: [h, g, b, w] }),
  x = new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9])-([0-9][0-9])$"),
  C = new RegExp(
    "^([0-9][0-9][0-9][0-9])-([0-9][0-9]?)-([0-9][0-9]?)(?:[Tt]|[ \\t]+)([0-9][0-9]?):([0-9][0-9]):([0-9][0-9])(?:\\.([0-9]*))?(?:[ \\t]*(Z|([-+])([0-9][0-9]?)(?::([0-9][0-9]))?))?$"
  );
var I = new u("tag:yaml.org,2002:timestamp", {
  kind: "scalar",
  resolve: function (e) {
    return null !== e && (null !== x.exec(e) || null !== C.exec(e));
  },
  construct: function (e) {
    var t,
      n,
      ...
      s = 0,
      u = null;
    if ((null === (t = x.exec(e)) && (t = C.exec(e)), null === t))
...
var O = new u("tag:yaml.org,2002:merge", {
    kind: "scalar",
    resolve: function (e) {
      return "<<" === e || null === e;
    },
...
var S = new u("tag:yaml.org,2002:binary", {
    kind: "scalar",
    resolve: function (e) {
      if (null === e) return !1;
      var t,
...
var F = new u("tag:yaml.org,2002:omap", {
    kind: "sequence",
    resolve: function (e) {
      if (null === e) return !0;
      var t,
      ...
      for (t = 0, n = l.length; t < n; t += 1) {
        if (((i = l[t]), (o = !1), "[object Object]" !== N.call(i))) return !1;
        for (r in i)
          if (T.call(i, r)) {
            if (o) return !1;
            o = !0;
...
var L = new u("tag:yaml.org,2002:pairs", {
    kind: "sequence",
    resolve: function (e) {
      if (null === e) return !0;
      var t,
      ...
      for (o = new Array(a.length), t = 0, n = a.length; t < n; t += 1) {
        if (((i = a[t]), "[object Object]" !== M.call(i))) return !1;
...
var _ = new u("tag:yaml.org,2002:set", {
    kind: "mapping",
    resolve: function (e) {
      if (null === e) return !0;
      var t,
        n = e;
      for (t in n) if (E.call(n, t) && null !== n[t]) return !1;
      return !0;
    },
    construct: function (e) {
      return null !== e ? e : {};
  ...
  q = k.extend({ implicit: [I, O], explicit: [S, F, L, _] }),
...
for (var J = new Array(256), H = new Array(256), X = 0; X < 256; X++)
  (J[X] = Q(X) ? 1 : 0), (H[X] = Q(X));
function ee(e, t) {
  (this.input = e),
...
function ie(e, t) {
  e.onWarning && e.onWarning.call(null, te(e, t));
}
var re = {
  YAML: function (e, t, n) {
    var i, r, o;
    null !== e.version && ne(e, "duplication of %YAML directive"),
      1 !== n.length && ne(e, "YAML directive accepts exactly one argument"),
      null === (i = /^([0-9]+)\.([0-9]+)$/.exec(n[0])) &&
        ne(e, "ill-formed argument of the YAML directive"),
      (r = parseInt(i[1], 10)),
      (o = parseInt(i[2], 10)),
      1 !== r && ne(e, "unacceptable YAML version of the document"),
      (e.version = n[0]),
      (e.checkLineBreaks = o < 2),
      1 !== o && 2 !== o && ie(e, "unsupported YAML version of the document");
  },
  TAG: function (e, t, n) {
    var i, r;
    2 !== n.length && ne(e, "TAG directive accepts exactly two arguments"),
      (i = n[0]),
      (r = n[1]),
      B.test(i) ||
        ne(e, "ill-formed tag handle (first argument) of the TAG directive"),
      D.call(e.tagMap, i) &&
        ne(
          e,
      ...
      K.test(r) ||
        ne(e, "ill-formed tag prefix (second argument) of the TAG directive");
    try {
      r = decodeURIComponent(r);
    } catch (t) {
      ne(e, "tag prefix is malformed: " + r);
    }
    e.tagMap[i] = r;
  },
};
  ...
  if (t < n) {
    if (((l = e.input.slice(t, n)), i))
      for (r = 0, o = l.length; r < o; r += 1)
        9 === (a = l.charCodeAt(r)) ||
          (32 <= a && a <= 1114111) ||
          ne(e, "expected valid JSON character");
    else U.test(l) && ne(e, "the stream contains non-printable characters");
    e.result += l;
  }
}
function ae(e, n, i, r) {
  ...
  for (
    ...
    (a = o[l]), D.call(n, a) || ((n[a] = i[a]), (r[a] = !0));
}
function le(e, t, n, i, r, o, a, l, c) {
  var s, u;
  if (Array.isArray(r))
    for (s = 0, u = (r = Array.prototype.slice.call(r)).length; s < u; s += 1)
      Array.isArray(r[s]) &&
        ne(e, "nested arrays are not supported inside keys"),
        "object" == typeof r &&
          "[object Object]" === W(r[s]) &&
          (r[s] = "[object Object]");
  if (
    ...
    if (Array.isArray(o))
      for (s = 0, u = o.length; s < u; s += 1) ae(e, t, o[s], n);
    else ae(e, t, o, n);
  else
    e.json ||
      D.call(n, r) ||
...
function se(e, t, n) {
  for (var i = 0, r = e.input.charCodeAt(e.position); 0 !== r; ) {
    ...
    if (!P(r)) break;
    for (
      ce(e), r = e.input.charCodeAt(e.position), i++, e.lineIndent = 0;
      32 === r;
  ...
  return (
    -1 !== n && 0 !== i && e.lineIndent < n && ie(e, "deficient indentation"), i
  );
}
function ue(e) {
  var t,
...
function fe(e, t) {
  ...
  for (
    ...
    (-1 !== e.firstTabInLine &&
      ...
      ne(e, "tab characters must not be used in indentation")),
    45 === i) &&
    G(e.input.charCodeAt(e.position + 1));

  )
    if (((l = !0), e.position++, se(e, !0, -1) && e.lineIndent <= t))
      ...
      ne(e, "bad indentation of a sequence entry");
...
function de(e) {
  ...
  if (
    (null !== e.tag && ne(e, "duplication of a tag property"),
    ...
    e.position < e.length
      ? ((i = e.input.slice(t, e.position)),
        (r = e.input.charCodeAt(++e.position)))
      : ne(e, "unexpected end of the stream within a verbatim tag");
  } else {
    for (; 0 !== r && !G(r); )
      33 === r &&
        (a
          ? ne(e, "tag suffix cannot contain exclamation marks")
          : ((n = e.input.slice(t - 1, e.position + 1)),
            B.test(n) ||
              ne(e, "named tag handle cannot contain such characters"),
            (a = !0),
            (t = e.position + 1))),
        (r = e.input.charCodeAt(++e.position));
    (i = e.input.slice(t, e.position)),
      R.test(i) && ne(e, "tag suffix cannot contain flow indicator characters");
  }
  i && !K.test(i) && ne(e, "tag name cannot contain such characters: " + i);
  try {
    i = decodeURIComponent(i);
  } catch (t) {
    ne(e, "tag name is malformed: " + i);
  }
  return (
    o
      ? (e.tag = i)
...
function he(e) {
  ...
  for (
    null !== e.anchor && ne(e, "duplication of an anchor property"),
  ...
  return (
    e.position === t &&
      ne(e, "name of an anchor node must contain at least one character"),
        ...
        ? (c &&
                ...
                for (
                  ...
                  if (
                    ...
                    if (
                      ...
                      break;
                    if (e.line === o) {
                      for (s = e.input.charCodeAt(e.position); $(s); )
                        s = e.input.charCodeAt(++e.position);
                      if (58 === s)
                  ...
                  if (
                    ((e.line === o || e.lineIndent > t) &&
                      ...
                      y || (le(e, f, d, h, g, m, a, l, c), (h = g = m = null)),
                      se(e, !0, -1),
                      (s = e.input.charCodeAt(e.position))),
                    (e.line === o || e.lineIndent > t) && 0 !== s)
                  )
                    ne(e, "bad indentation of a mapping entry");
                  else if (e.lineIndent < t) break;
                }
                return (
                  y && le(e, f, d, h, g, null, a, l, c),
                  b &&
                    ((e.tag = u),
                    (e.anchor = p),
                    (e.kind = "mapping"),
          ...
          (function (e, t) {
            ...
            for (
              ...
              if ((se(e, !0, t), (d = e.input.charCodeAt(e.position)) === a))
                return (
                  e.position++,
                  (e.tag = g),
                  (e.anchor = m),
              ...
              h
                ? 44 === d && ne(e, "expected the node content, but found ','")
                : ne(e, "missed comma between flow collection entries"),
                (f = null),
                (l = c = !1),
                63 === d &&
                  G(e.input.charCodeAt(e.position + 1)) &&
                  ((l = c = !0), e.position++, se(e, !0, t)),
                (n = e.line),
                (i = e.lineStart),
                (r = e.position),
                ge(e, t, 1, !1, !0),
                ...
                (!c && e.line !== n) ||
                  ...
                  (f = e.result)),
                s
                  ? le(e, o, y, p, u, f, n, i, r)
                  : l
                  ? o.push(le(e, null, y, p, u, f, n, i, r))
                  : o.push(u),
                se(e, !0, t),
          ...
          : ((l &&
              (function (e, n) {
                ...
                for (e.kind = "scalar", e.result = ""; 0 !== a; )
                  if (43 === (a = e.input.charCodeAt(++e.position)) || 45 === a)
                    1 === c
                      ? (c = 43 === a ? 3 : 2)
                      : ne(e, "repeat of a chomping mode identifier");
                  else {
                    ...
                    0 === o
                      ...
                      : u
                      ? ne(e, "repeat of an indentation width identifier")
                      : ((p = n + o - 1), (u = !0));
                  }
                if ($(a)) {
                  do {
                ...
                for (; 0 !== a; ) {
                  for (
                    ce(e), e.lineIndent = 0, a = e.input.charCodeAt(e.position);
                    (!u || e.lineIndent < p) && 32 === a;

                  )
                    e.lineIndent++, (a = e.input.charCodeAt(++e.position));
                  if ((!u && e.lineIndent > p && (p = e.lineIndent), P(a))) f++;
                  else {
                    if (e.lineIndent < p) {
                      3 === c
                        ? (e.result += t.repeat("\n", s ? 1 + f : f))
            ...
            (function (e, t) {
              ...
              for (
                ...
                if (34 === l) return oe(e, n, e.position, !0), e.position++, !0;
                if (92 === l) {
                  if (
                    (oe(e, n, e.position, !0),
                    P((l = e.input.charCodeAt(++e.position))))
                  )
                    se(e, !1, t);
                  else if (l < 256 && J[l]) (e.result += H[l]), e.position++;
                  else if (
                    (a =
                      120 === (c = l) ? 2 : 117 === c ? 4 : 85 === c ? 8 : 0) >
                    0
                  ) {
                    for (r = a, o = 0; r > 0; r--)
                      (a = Z((l = e.input.charCodeAt(++e.position)))) >= 0
                        ? (o = (o << 4) + a)
                        : ne(e, "expected hexadecimal character");
                    (e.result += z(o)), e.position++;
                  } else ne(e, "unknown escape sequence");
                  n = i = e.position;
                } else
                  P(l)
                    ? (oe(e, n, i, !0),
              ...
              : !(function (e) {
                  ...
                  return (
                    ...
                    D.call(e.anchorMap, n) ||
                      ne(e, 'unidentified alias "' + n + '"'),
              ...
              ? (function (e, t, n) {
                  var i,
                    ...
                    f = e.result;
                  if (
                    G((u = e.input.charCodeAt(e.position))) ||
                    V(u) ||
                    35 === u ||
                    38 === u ||
                    42 === u ||
                  ...
                  if (
                    (63 === u || 45 === u) &&
                    (G((i = e.input.charCodeAt(e.position + 1))) || (n && V(i)))
                  )
                    return !1;
                  for (
                    e.kind = "scalar",
                    ...
                    if (58 === u) {
                      if (
                        G((i = e.input.charCodeAt(e.position + 1))) ||
                        (n && V(i))
                      )
                        break;
                    } else if (35 === u) {
                      ...
                      if ((e.position === e.lineStart && ue(e)) || (n && V(u)))
                        break;
                      if (P(u)) {
                        if (
                          ((l = e.line),
              ...
              : ((y = !0),
                (null === e.tag && null === e.anchor) ||
                  ne(e, "alias node should not have any properties")),
    ...
    f || ne(e, "unknown tag !<" + e.tag + ">"),
      ...
      f.resolve(e.result, e.tag)
        ? ((e.result = f.construct(e.result, e.tag)),
          null !== e.anchor && (e.anchorMap[e.anchor] = e.result))
        : ne(e, "cannot resolve a node with !<" + e.tag + "> explicit tag");
  }
  return (
...
function me(e) {
  ...
  for (
    ...
    for (
      i = [],
        (n = e.input.slice(t, e.position)).length < 1 &&
          ne(e, "directive name must not be less than one character in length");
      0 !== r;

    ) {
      for (; $(r); ) r = e.input.charCodeAt(++e.position);
      if (35 === r) {
        do {
          r = e.input.charCodeAt(++e.position);
        } while (0 !== r && !P(r));
    ...
    0 !== r && ce(e),
      D.call(re, n)
        ? re[n](e, n, i)
        : ie(e, 'unknown document directive "' + n + '"');
  }
  se(e, !0, -1),
    0 === e.lineIndent &&
    ...
    45 === e.input.charCodeAt(e.position + 2)
      ...
      : a && ne(e, "directives end mark is expected"),
    ge(e, e.lineIndent - 1, 4, !1, !0),
    se(e, !0, -1),
    e.checkLineBreaks &&
    ...
    e.position === e.lineStart && ue(e)
      ...
      : e.position < e.length - 1 &&
        ne(e, "end of the stream or a document separator is expected");
}
function ye(e, t) {
  (t = t || {}),
    0 !== (e = String(e)).length &&
  ...
  var n = new ee(e, t),
    i = e.indexOf("\0");
  for (
    -1 !== i && ((n.position = i), ne(n, "null byte is not allowed in input")),
      n.input += "\0";
