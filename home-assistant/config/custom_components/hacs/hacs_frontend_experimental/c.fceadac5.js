...
import { g as v, d as u } from "./c.1e0e1850.js";
import { f as h, b as k } from "./c.6f18200a.js";
import { S as p } from "./c.0294c25c.js";
  ...
  function (e, i) {
    ...
    return {
      ...
      d: [
        ...
        { kind: "field", decorators: [c()], key: "_entities", value: void 0 },
        { kind: "field", decorators: [t()], key: "value", value: void 0 },
        ...
        },
        {
          ...
          value: function () {
            var e, i, t, d, a, l, c, r;
            return null !== (e = this.selector.device) &&
              void 0 !== e &&
              e.integration &&
              !this._entitySources
              ? s``
      ...
      <ha-devices-picker
        ...
        .includeDomains=${
          null !== (d = this.selector.device.entity) && void 0 !== d && d.domain
            ...
            return (e) => {
              const i =
                this._entitySources && this._entities
                  ...
                  : void 0;
              return !this.selector.device || k(this.selector.device, e, i);
            };
          },
        },
      ],
