...
import { d as ue } from "./c.10855172.js";
import { c as he } from "./c.6fde4307.js";
import { s as ve, c as pe } from "./c.874c8cfd.js";
import { L as ge, s as me } from "./c.11013a9d.js";
import { d as fe } from "./c.6795ddb8.js";
import { f as ye, c as ke } from "./c.29de58d6.js";
import "./c.b67c3ba9.js";
import { s as _e } from "./c.468b43fb.js";
import { e as be } from "./c.cbce77f6.js";
import { c as $e } from "./c.6eb9fcd4.js";
import { e as xe, c as we, a as Ce } from "./c.1e0e1850.js";
import { d as ze } from "./c.36ae07d6.js";
import { s as Me, a as Oe, b as Ae } from "./c.14416bd9.js";
import "./c.80a9cb4c.js";
import { d as Te } from "./c.7a38bd55.js";
import "./c.cc8d7708.js";
import "./c.35107a2a.js";
import "./c.a46c9500.js";
import { f as Pe } from "./c.d9d8b90e.js";
import { c as Ue } from "./c.fa0ef026.js";
import "./c.6944d48e.js";
import "./c.d131aa61.js";
import "./c.8e28b461.js";
import "./c.54b4c8e8.js";
import "./c.f18e6e02.js";
import "./c.707059e4.js";
import "./c.62bcca49.js";
import "./c.743a15a1.js";
import "./c.2610e8cd.js";
import "./c.a0946910.js";
import "./c.46ce3076.js";
import "./c.1024e243.js";
import "./c.d2f13ac1.js";
import "./c.bb05724a.js";
import "./c.704dab74.js";
import "./c.04ecc0ad.js";
import "./c.5fe2e3ab.js";
import "./c.5bcc4ef4.js";
import "./c.0294c25c.js";
import "./c.4f015773.js";
import "./c.073e82b2.js";
...
let Fe;
const Ie = async () => (
  Fe || (Fe = (await import("./c.c177bbc3.js")).default), Fe
);
...
function* De(e, t, i, a) {
  (function (e) {
    return Ne(e) && "function" == typeof e[Symbol.iterator];
  })(e) || (e = [e]);
  for (const o of e) {
    const e = Be(o, t, i, a);
    e && (yield e);
...
function* qe(e, t, i) {
  ...
  if (
    n &&
    ((e = t.coercer(e, d)),
    s && "type" !== t.type && Ne(t.schema) && Ne(e) && !Array.isArray(e))
  )
...
class We {
  constructor(e) {
    ...
    (this.type = t),
      ...
      (this.entries = s),
      (this.coercer = n),
      (this.validator = a ? (e, t) => De(a(e, t), t, this, e) : () => []),
      (this.refiner = o ? (e, t) => De(o(e, t), t, this, e) : () => []);
  }
  assert(e) {
    return Re(e, this);
  }
  ...
  mask(e) {
    return (function (e, t) {
      const i = Ve(e, t, { coerce: !0, mask: !0 });
      if (i[0]) throw i[0];
      return i[1];
    })(e, this);
  }
  validate(e, t) {
    return void 0 === t && (t = {}), Ve(e, this, t);
  }
}
function Re(e, t) {
  const i = Ve(e, t);
...
function Ye(e, t) {
  return new We({ type: e, schema: null, validator: t });
}
function Ge(e) {
  return new We({
    type: "array",
    ...
    *entries(t) {
    ...
    validator: (e) =>
      Array.isArray(e) || "Expected an array value, but received: " + Se(e),
  });
}
function Je() {
...
function He(e) {
  ...
  return new We({
    ...
    validator: (i) =>
      i === e || "Expected the literal `" + t + "`, but received: " + Se(i),
  });
}
function Qe() {
  return Ye(
    ...
    (e) =>
      ...
      "Expected a number, but received: " + Se(e)
  );
}
function Ze(e) {
  ...
  return new We({
    ...
    *entries(a) {
    ...
    validator: (e) => Ne(e) || "Expected an object, but received: " + Se(e),
    coercer: (e) => (Ne(e) ? { ...e } : e),
  });
}
function et(e) {
...
function tt() {
  return Ye(
    "string",
    (e) => "string" == typeof e || "Expected a string, but received: " + Se(e)
  );
}
function it(e) {
  ...
  return new We({
    ...
    schema: e,
    *entries(i) {
      if (Ne(i)) for (const a of t) yield [a, i[a], e[a]];
    },
    validator: (e) => Ne(e) || "Expected an object, but received: " + Se(e),
  });
}
...
const ot = (e, t) => {
  if (!(t instanceof Le)) return { warnings: [t.message], errors: void 0 };
  const i = [],
    a = [];
...
const nt = (e, t) => e.callWS({ type: "validate_config", ...t }),
  ...
  ut = (e) => {
    ...
    if ("service" in e) {
      if ("metadata" in e) {
        if (Ke(e, ct)) return "activate_scene";
        if (Ke(e, lt)) return "play_media";
      }
      return "service";
    }
    return "unknown";
  ...
  mt = (e) => {
    ...
    if ("object" == typeof e) {
      return (Array.isArray(e) ? e : Object.values(e)).some((e) => e && mt(e));
    }
    return !1;
  },
  ft = (e, t) =>
  ...
  bt = (e, t) => {
    ...
    for (const i in e) if (_t.includes(i) && !Object.is(e[i], t[i])) return !1;
    for (const i in t) if (_t.includes(i) && !Object.is(e[i], t[i])) return !1;
    return !0;
  },
  $t = (e, t) => {
  ...
  zt = (e, t, i = !1) => {
    ...
    if ("numeric_state" === e.platform && e.entity_id) {
      ...
      const a = t.states[e.entity_id],
        o = a ? $e(a) : e.entity_id;
      if (
        (e.attribute && (i += ` ${ye(e.attribute)} from`),
        (i += ` ${o} is`),
    ...
    if ("state" === e.platform) {
      ...
      if (
        ...
        e.entity_id && (a = o[e.entity_id] ? $e(o[e.entity_id]) : e.entity_id);
    ...
    if ("time" === e.platform && e.at) {
      const i = be(e.at).map((e) =>
          e.toString().includes(".")
            ? `entity ${t.states[e] ? $e(t.states[e]) : e}`
            : e
        ),
        a = i.splice(-1, 1)[0];
    ...
    if ("zone" === e.platform && e.entity_id && e.zone) {
      ...
      else i = n[e.entity_id] ? $e(n[e.entity_id]) : e.entity_id;
      ...
      } else a = n[e.zone] ? $e(n[e.zone]) : e.zone;
    ...
    if ("device" === e.platform) {
      ...
      return `${o ? $e(o) : i.entity_id} ${i.type}`;
    }
  ...
  Mt = (e, t, i = !1) => {
    ...
    if (!e.condition) {
      const t = ["and", "or", "not"];
      for (const i of t)
        i in e && be(e[i]) && (e = { condition: i, conditions: e[i] });
    }
    if ("or" === e.condition) {
      const t = be(e.conditions);
    ...
    if ("state" === e.condition) {
      let i = "Confirm";
      const a = t.states[e.entity_id],
        o = a ? $e(a) : e.entity_id ? e.entity_id : "an entity";
    ...
    if ("zone" === e.condition && e.entity_id && e.zone) {
      ...
      } else i = s[e.entity_id] ? $e(s[e.entity_id]) : e.entity_id;
      if (Array.isArray(e.zone)) {
        e.zone.length > 1 && (n = !0);
        for (const [t, i] of e.zone.entries())
          s[i] &&
      ...
      } else o = s[e.zone] ? $e(s[e.zone]) : e.zone;
  ...
  Ot = (e, t, i, a = !1) => {
        ...
        for (const [a, o] of Object.entries({
          ...
          for (const i of n) {
            ...
            if ("entity_id" === a)
              if (i.includes(".")) {
                const a = e.states[i];
                a ? t.push($e(a)) : t.push(i);
              } else {
                const a = xe(e.entities)[i];
                a ? t.push(we(e, a) || i) : t.push("unknown entity");
              }
            else if ("device_id" === a) {
              const a = e.devices[i];
              a ? t.push(Ce(a, e)) : t.push("unknown device");
            } else if ("area_id" === a) {
              const a = e.areas[i];
    ...
    if ("play_media" === i) {
      ...
      } on ${o ? $e(o) : a || "a media player"}`;
    }
    if ("wait_for_trigger" === i) {
      const i = be(t.wait_for_trigger);
      return i && 0 !== i.length
        ? `Wait for ${i.map((t) => zt(t, e)).join(", ")}`
        : "Wait for a trigger";
    }
    if ("variables" === i) {
      const e = t;
    ...
    if ("check_condition" === i) return Mt(t, e);
    if ("stop" === i) {
      const e = t;
    ...
    if ("choose" === i) {
      const e = t;
      if (e.choose) {
        const t = be(e.choose).length + (e.default ? 1 : 0);
    ...
    if ("repeat" === i) {
      ...
      if ("count" in i.repeat) {
        ...
        "while" in i.repeat
          ? (a += ` while ${be(i.repeat.while)
              .map((t) => Mt(t, e))
              .join(", ")} is true`)
          : "until" in i.repeat
          ? (a += ` until ${be(i.repeat.until)
              .map((t) => Mt(t, e))
              .join(", ")} is true`)
          : "for_each" in i.repeat &&
            (a += ` for every item: ${be(i.repeat.for_each)
              .map((e) => JSON.stringify(e))
              .join(", ")}`);
      return a;
    }
    if ("check_condition" === i) return `Test ${Mt(t, e)}`;
    if ("device_action" === i) {
      const i = t;
      ...
      return `${i.type || "Perform action with"} ${o ? $e(o) : i.entity_id}`;
    }
    if ("parallel" === i) {
      const e = be(t.parallel).length;
  ...
  g(
    ...
    `;
          ...
          },
          {
            ...
            value: function (e) {
              ...
              const t = e.detail.value,
                i = e.target.idx,
                a = this.action.choose ? [...be(this.action.choose)] : [];
              (a[i].conditions = t),
                C(this, "value-changed", {
          ...
          },
          {
            ...
            key: "_addOption",
            value: function () {
              const e = this.action.choose ? [...be(this.action.choose)] : [];
          ...
          },
          {
            ...
            value: function (e) {
              const t = e.currentTarget.idx,
                i = this.action.choose ? [...be(this.action.choose)] : [];
              i.splice(t, 1),
                C(this, "value-changed", {
        ...
        },
        {
          ...
          value: async function () {
            const e = await Ae(this, {
                ...
                inputType: "string",
                placeholder: ke(Mt(this.condition, this.hass, !0)),
...
const Et = "NO_AUTOMATION",
  jt = "UNKNOWN_AUTOMATION";
let Ft = g(
  null,
  function (e, t) {
    class i extends t {
      ...
      d: [
        ...
        { kind: "field", key: "_createNoAutomation", value: void 0 },
        {
          ...
          value: function () {
            ...
            if (!this._automations.length) return Et;
            const e = this._automations.findIndex((e) => bt(e, this.value));
            return -1 === e ? jt : `${this._automations[e].device_id}_${e}`;
          },
        },
        {
          kind: "method",
    ...
    `;
        ...
        },
        {
          ...
          key: "_setValue",
          value: function (e) {
            if (this.value && bt(e, this.value)) return;
            const t = { ...e };
    ...
    `;
          ...
          },
          {
            ...
            value: function (e) {
              ...
              t && !bt(t, this.condition) && this._getCapabilities();
            },
          },
          {
            kind: "method",
...
const It = (e) => {
  ...
  Lt = Ze({ platform: tt(), id: et(tt()), enabled: et(Je()) }),
  Nt = Ze({
    days: et(Qe()),
    hours: et(Qe()),
    minutes: et(Qe()),
...
const Bt = ["sun", "mon", "tue", "wed", "thu", "fri", "sat"];
g(
      ...
      d: [
        ...
        },
        {
          ...
          value: () =>
            Y((e, t, i, a) => {
              const o = Pe(t),
                n = Bt.slice(o, Bt.length).concat(Bt.slice(0, o));
              return [
                {
                  name: "mode_after",
                  type: "select",
...
const Dt = (e) => "latitude" in e.attributes && "longitude" in e.attributes;
function qt(e) {
  return Dt(e) && "zone" !== Ue(e);
}
const Wt = ["zone"];
g(
  ...
  g(
    ...
    `
          ...
          {
            kind: "method",
            key: "_enterReOrderMode",
            value: async function (e) {
              this.nested || (e.stopPropagation(), (this.reOrderMode = !0));
            },
          },
          {
            kind: "method",
          ...
          },
          {
            ...
            value: function (e) {
              ...
              const t = e.target.index;
              C(this, "value-changed", {
                value: this.conditions.concat(ue(this.conditions[t])),
              });
            },
          },
          {
    ...
    function (e, t) {
      ...
      ${
        i
          ...
          : _`
            <div>
              ${fe(`ha-automation-condition-${e.condition}`, {
                hass: this.hass,
                condition: e,
                reOrderMode: this.reOrderMode,
                disabled: this.disabled,
            ...
            value: function (e) {
              e.has("action") &&
                (this.action && mt(this.action)
                  ...
                  : (this._timeData = It(this.action.delay)));
            },
          },
          {
            kind: "method",
      ...
      return {
        ...
        d: [
          ...
          },
          {
            ...
            value: function () {
              var e, t;
              const i = this._deviceId || this.action.device_id;
              return _`
      <ha-device-picker
        .value=${i}
        .disabled=${this.disabled}
    ...
    `;
          ...
          },
          {
            ...
            value: function (e) {
              e.stopPropagation(),
                e.detail.isValid &&
                  ((this._actionData = e.detail.value), di(this, e));
            },
          },
          {
            kind: "method",
...
const Kt = ["count", "while", "until"],
  Vt = (e) => Kt.find((t) => t in e);
g(
  ...
  function (e, t) {
    ...
    `;
        ...
        },
        {
          ...
          value: function (e) {
            const t = e.target.value;
            if (!t || t === Vt(this.action.repeat)) return;
            const i = "count" === t ? 2 : [];
            C(this, "value-changed", {
              value: {
                ...this.action,
        ...
        },
        {
          ...
          value: function (e) {
            ...
            C(this, "value-changed", {
              value: {
                ...this.action,
                repeat: { ...this.action.repeat, [Vt(this.action.repeat)]: t },
              },
            });
          },
        },
    ...
    `;
          ...
          },
          {
            ...
            value: function (e) {
              ...
              t && !bt(t, this.trigger) && this._getCapabilities();
            },
          },
          {
            kind: "method",
...
const Yt = {},
  ...
  Jt = async (e) => e.callWS({ type: "config/auth/list" });
g(
  [M("ha-user-badge")],
  function (e, t) {
    class i extends t {
...
customElements.define("ha-user-picker", Ht),
  g(
    [M("ha-users-picker")],
    function (e, t) {
      class i extends t {
  ...
  g(
    ...
    `;
          ...
          },
          {
            ...
            key: "_dataChanged",
            value: function (e) {
              e.stopPropagation(), e.detail.isValid && ai(this, e);
            },
          },
          {
            kind: "method",
        ...
        },
        {
          ...
          value: function () {
            const e = It(this.trigger.for),
              t = {
                ...this.trigger,
                entity_id: be(this.trigger.entity_id),
                for: e,
              },
    ...
    `
        ...
        },
        {
          ...
          value: async function () {
            ...
            ).sort((e, t) => pe(e.name || e.id, t.name || t.id));
          },
        },
        {
          kind: "method",
              ...
              t
                ...
                : _`
                  ...
                  <div @ui-mode-not-available=${this._handleUiModeNotAvailable}>
                    ${fe(`ha-automation-trigger-${this.trigger.platform}`, {
                      hass: this.hass,
        ...
        },
        {
          ...
          value: async function () {
            const e = await Ae(this, {
                ...
                inputType: "string",
                placeholder: ke(zt(this.trigger, this.hass, !0)),
    ...
    `;
          ...
          },
          {
            ...
            value: function (e) {
              ...
              const t = e.target.index;
              C(this, "value-changed", {
                value: this.triggers.concat(ue(this.triggers[t])),
              });
            },
          },
          {
      ...
      return {
        ...
        d: [
          ...
          },
          {
            ...
            value: function () {
              var e;
              const t = It(this.action.timeout);
              return _`
      <ha-duration-input
        .label=${this.hass.localize(
    ...
    return {
      ...
      d: [
        ...
        },
        {
          ...
          value: function (e) {
            e.has("action") &&
              ((this._uiModeAvailable = void 0 !== si(this.action)),
        ...
        },
        {
          ...
          value: async function () {
            const e = await Ae(this, {
                ...
                inputType: "string",
                placeholder: ke(Ot(this.hass, this.action, void 0, !0)),
    ...
    `;
          ...
          },
          {
            ...
            value: function (e) {
              ...
              const t = e.target.index;
              C(this, "value-changed", {
                value: this.actions.concat(ue(this.actions[t])),
              });
            },
          },
          {
