    ...
    return {
      ...
      d: [
        ...
        },
        {
          ...
          value: function () {
            var e, t, i;
            const s = "box" === this.selector.number.mode;
            return l`
      <div class="input">
        ${
          s
        ...
        <ha-textfield
          .inputMode=${
            (this.selector.number.step || 1) % 1 != 0 ? "decimal" : "numeric"
          }
    ...
    `;
        ...
        },
        {
          ...
          value: function (e) {
            ...
            this.value !== t && s(this, "value-changed", { value: t });
          },
        },
        {
          kind: "method",
