import { _ as e, H as i, e as t, y as s, n as o } from "./main-ec7846c8.js";
import "./c.9fcc4119.js";
import "./c.d3381c6c.js";
import "./c.8e28b461.js";
let c = e(
  [o("hacs-progress-dialog")],
  function (e, i) {
    return {
      F: class extends i {
        constructor(...i) {
      ...
      d: [
        ...
        },
        {
          ...
          value: function () {
            return this.active
              ? s`
      <hacs-dialog .active=${this.active} .hass=${this.hass} title=${
                  this.title || ""
                }>
        <div class="content">
          ${this.content || ""}
...
export { c as HacsProgressDialog };
