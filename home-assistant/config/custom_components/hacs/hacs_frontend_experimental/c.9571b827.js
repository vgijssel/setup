  ...
  !(function (t) {
    ...
    (A.prototype = {
      ...
      (I.prototype = {
        ...
        pad: function (t) {
          ...
          return R(O(i.x - n, i.y - o), O(e.x + n, e.y + o));
        },
        equals: function (t) {
          return (
            !!t &&
    ...
    G.prototype = {
      ...
      untransform: function (t, i) {
        return (
          (i = i || 1),
          new A((t.x / i - this._b) / this._a, (t.y / i - this._d) / this._c)
        );
      },
    };
    var Y = e({}, U, {
    ...
    function Gt(t, i, e) {
      return (
        "touchstart" === i && $t(),
        Ut[i]
          ? ((e = Ut[i].bind(this, e)), t.addEventListener(Wt[i], e, !1), e)
          : (console.warn("wrong event specified:", i), L.Util.falseFn)
      );
    }
    function Kt(t, i, e) {
      Wt[i]
        ? t.removeEventListener(Wt[i], e, !1)
    ...
    var ee = {
      ...
      oe = k.extend({
        ...
        _getMapPanePos: function () {
          return Si(this._mapPane) || new A(0, 0);
        },
        _moved: function () {
          var t = this._getMapPanePos();
    ...
    var ve,
      ye = { Events: E },
      xe = Nt.touch ? "touchstart mousedown" : "mousedown",
      we = k.extend({
        ...
        enable: function () {
          this._enabled ||
            (Di(this._dragStartTarget, xe, this._onDown, this),
            (this._enabled = !0));
        },
        disable: function () {
          this._enabled &&
            (we._dragging === this && this.finishDrag(!0),
            Hi(this._dragStartTarget, xe, this._onDown, this),
            (this._enabled = !1),
            (this._moved = !1));
        },
        _onDown: function (t) {
          if (
            ...
            if (t.touches && 1 !== t.touches.length)
              ...
              var i = t.touches ? t.touches[0] : t,
                e = Ii(this._element);
              (this._startPoint = new A(i.clientX, i.clientY)),
    ...
    function be(t, i) {
      ...
      var e = i * i;
      return (t = Te((t = ze(t, e)), e));
    }
    function Pe(t, i, e) {
      return Math.sqrt(ke(t, i, e, !0));
    }
    function Le(t, i, e) {
      return ke(t, i, e);
    }
    ...
    function Me(t, i, e, n, o) {
      var s,
        ...
        h = 0;
      for (r = n + 1; r <= o - 1; r++)
        (a = ke(t[r], t[n], t[o], !0)) > h && ((s = r), (h = a));
      h > e && ((i[s] = 1), Me(t, i, e, n, s), Me(t, i, e, s, o));
    }
    function ze(t, i) {
      for (var e = [t[0]], n = 1, o = 0, s = t.length; n < s; n++)
        Ee(t[n], t[o]) > i && (e.push(t[n]), (o = n));
    ...
    function Oe(t, i) {
      ...
      Ae(t) ||
        ...
        (t = t[0]));
      var u = [];
      for (var c in t) u.push(i.project(H(t[c])));
      var d = u.length;
    ...
    function Re(t, i, e) {
      var n,
        ...
        c,
        d = [1, 4, 2, 8];
      for (o = 0, l = t.length; o < l; o++) t[o]._code = Se(t[o], i);
      for (r = 0; r < 4; r++) {
        for (u = d[r], n = [], o = 0, s = (l = t.length) - 1; o < l; s = o++)
          (a = t[o]),
            ...
            a._code & u
              ? h._code & u ||
                (((c = Ze(h, a, u, i, e))._code = Se(c, i)), n.push(c))
              : (h._code & u &&
                  (((c = Ze(h, a, u, i, e))._code = Se(c, i)), n.push(c)),
                n.push(a));
        t = n;
    ...
    function Ne(t, i) {
      ...
      Ae(t) ||
        ...
        (t = t[0]));
      var c = [];
      for (var d in t) c.push(i.project(H(t[d])));
      var _ = c.length;
    ...
    var De = { __proto__: null, clipPolygon: Re, polygonCenter: Ne },
      je = {
        project: function (t) {
      ...
      He = {
        ...
        project: function (t) {
          ...
          return (
            (n = -e * Math.log(Math.max(a, 1e-10))), new A(t.lng * i * e, n)
          );
        },
        unproject: function (t) {
          for (
      ...
      Fe = { __proto__: null, LonLat: je, Mercator: He, SphericalMercator: q },
      We = e({}, U, {
        code: "EPSG:3395",
        projection: He,
        transformation: (function () {
    ...
    var Qe = Je.extend({
        ...
        _getIconUrl: function (t) {
          return (
            "string" != typeof Qe.imagePath &&
              (Qe.imagePath = this._detectIconPath()),
            (this.options.imagePath || Qe.imagePath) +
    ...
    var on = qe.extend({
      ...
      sn = on.extend({
        ...
        setStyle: function (t) {
          ...
          return on.prototype.setStyle.call(this, t), this.setRadius(i), this;
        },
        _project: function () {
    ...
    var ln = on.extend({
      ...
      closestLayerPoint: function (t) {
        for (
          var i, e, n = 1 / 0, o = null, s = ke, r = 0, a = this._parts.length;
          r < a;
          r++
        )
      ...
      getCenter: function () {
        ...
        return Oe(this._defaultShape(), this._map.options.crs);
      },
      getBounds: function () {
        return this._bounds;
      },
      ...
      _defaultShape: function () {
        return Ae(this._latlngs) ? this._latlngs : this._latlngs[0];
      },
      _convertLatLngs: function (t) {
        for (var i = [], e = Ae(t), n = 0, o = t.length; n < o; n++)
          e
      ...
      _containsPoint: function (t, i) {
        ...
        for (e = 0, s = this._parts.length; e < s; e++)
          for (n = 0, o = (r = (a = this._parts[e]).length) - 1; n < r; o = n++)
            if ((i || 0 !== n) && Pe(t, a[o], a[n]) <= h) return !0;
        return !1;
      },
    });
    function un(t, i) {
    ...
    var cn = ln.extend({
      ...
      _setLatLngs: function (t) {
        ln.prototype._setLatLngs.call(this, t),
          Ae(this._latlngs) && (this._latlngs = [this._latlngs]);
      },
      _defaultShape: function () {
        return Ae(this._latlngs[0]) ? this._latlngs[0] : this._latlngs[0][0];
      },
      _clipPoints: function () {
        var t = this._renderer._bounds,
        ...
        if (
          ...
          if (this.options.noClip) this._parts = this._rings;
            ...
            for (var n, o = 0, s = this._rings.length; o < s; o++)
              (n = Re(this._rings[o], t, !0)).length && this._parts.push(n);
      },
      _updatePath: function () {
    ...
    function pn(t, i) {
      var e,
        ...
        h = [],
        l = i && i.pointToLayer,
        u = (i && i.coordsToLatLng) || fn;
      if (!a && !r) return null;
      switch (r.type) {
        case "Point":
          return mn(l, t, (e = u(a)), i);
        case "MultiPoint":
          for (o = 0, s = a.length; o < s; o++)
            (e = u(a[o])), h.push(mn(l, t, e, i));
          return new Ye(h);
        case "LineString":
        case "MultiLineString":
          return (n = gn(a, "LineString" === r.type ? 0 : 1, u)), new ln(n, i);
        case "Polygon":
        case "MultiPolygon":
          return (n = gn(a, "Polygon" === r.type ? 1 : 2, u)), new cn(n, i);
    ...
    function mn(t, i, e, n) {
      return t ? t(i, e) : new en(e, n && n.markersInheritOptions && n);
    }
    function fn(t) {
    ...
    function gn(t, i, e) {
      for (var n, o = [], s = 0, r = t.length; s < r; s++)
        (n = i ? gn(t[s], i - 1, e) : (e || fn)(t[s])), o.push(n);
      return o;
    }
    function vn(t, i) {
    ...
    function yn(t, i, e, n) {
      for (var o = [], s = 0, r = t.length; s < r; s++)
        o.push(i ? yn(t[s], Ae(t[s]) ? 0 : i - 1, e, n) : vn(t[s], n));
      return !i && e && o.push(o[0]), o;
    }
    function xn(t, i) {
      return t.feature ? e({}, t.feature, { geometry: i }) : wn(i);
    }
    function wn(t) {
    ...
    en.include(bn),
      ...
      ln.include({
        toGeoJSON: function (t) {
          var i = !Ae(this._latlngs);
          return xn(this, {
            type: (i ? "Multi" : "") + "LineString",
            coordinates: yn(this._latlngs, i ? 1 : 0, !1, t),
          });
        },
      }),
      cn.include({
        toGeoJSON: function (t) {
          var i = !Ae(this._latlngs),
            e = i && !Ae(this._latlngs[0]),
            n = yn(this._latlngs, e ? 2 : i ? 1 : 0, !0, t);
          return (
            i || (n = [n]),
            xn(this, { type: (e ? "Multi" : "") + "Polygon", coordinates: n })
          );
        },
      }),
      Ge.include({
        toMultiPoint: function (t) {
          ...
          return (
            ...
            xn(this, { type: "MultiPoint", coordinates: i })
          );
        },
        toGeoJSON: function (t) {
          var i =
        ...
        onAdd: function (t) {
          En.prototype.onAdd.call(this, t),
            ...
            this._source &&
              ...
              this._source instanceof on || this._source.on("preclick", qi));
        },
        onRemove: function (t) {
          En.prototype.onRemove.call(this, t),
            ...
            this._source &&
              ...
              this._source instanceof on || this._source.off("preclick", qi));
        },
        getEvents: function () {
        ...
        _adjustPan: function (t) {
          if (this.options.autoPan) {
            ...
            var i = this._map,
              ...
              s = new A(this._containerLeft, -n - this._containerBottom);
            s._add(Si(this._container));
            var r = i.layerPointToContainerPoint(s),
              a = O(this.options.autoPanPadding),
              h = O(this.options.autoPanPaddingTopLeft || a),
    ...
    oe.mergeOptions({ closePopupOnClick: !0 }),
      oe.include({
        openPopup: function (t, i, e) {
          return this._initOverlay(kn, t, i, e).openOn(this), this;
        },
      ...
      qe.include({
        bindPopup: function (t, i) {
          return (
            (this._popup = this._initOverlay(kn, this._popup, t, i)),
        ...
        _openPopup: function (t) {
          if (this._popup && this._map) {
            ...
            this._popup._source !== i || i instanceof on
    ...
    var jn = Nn.extend({
      ...
      _removeTile: function (t) {
        ...
        if (i)
          return (
            i.el.setAttribute("src", y), Nn.prototype._removeTile.call(this, t)
          );
      },
      _tileReady: function (t, i, e) {
    ...
    var Un = qe.extend({
        ...
        onAdd: function () {
          this._container ||
            (this._initContainer(),
            this._zoomAnimated && wi(this._container, "leaflet-zoom-animated")),
            this.getPane().appendChild(this._container),
            this._update(),
    ...
    var $n = cn.extend({
      initialize: function (t, i) {
        cn.prototype.initialize.call(this, this._boundsToLatLngs(t), i);
      },
      setBounds: function (t) {
    ...
    oe.addInitHook("addHandler", "boxZoom", to),
    ...
    oe.addInitHook("addHandler", "doubleClickZoom", io),
      oe.mergeOptions({
        dragging: !0,
        inertia: !0,
    ...
    oe.addInitHook("addHandler", "dragging", eo),
    ...
    oe.addInitHook("addHandler", "keyboard", no),
      oe.mergeOptions({
        scrollWheelZoom: !0,
    ...
    oe.addInitHook("addHandler", "scrollWheelZoom", oo);
    var so = 600;
    oe.mergeOptions({
    ...
    var ro = ge.extend({
      ...
      _onDown: function (t) {
        if ((clearTimeout(this._holdTimeout), 1 === t.touches.length)) {
          var i = t.touches[0];
          (this._startPos = this._newPos = new A(i.clientX, i.clientY)),
    ...
    oe.addInitHook("addHandler", "tapHold", ro),
    ...
    oe.addInitHook("addHandler", "touchZoom", ao),
      (oe.BoxZoom = to),
      (oe.DoubleClickZoom = io),
      (oe.Drag = eo),
      (oe.Keyboard = no),
      (oe.ScrollWheelZoom = oo),
      (oe.TapHold = ro),
      (oe.TouchZoom = ao),
      (t.Bounds = I),
      (t.Browser = Nt),
