...
import { n as v, m as w, a as g, r as k, c as D } from "./c.7a38bd55.js";
import { c as x } from "./c.6fde4307.js";
import "./c.8a53c3e6.js";
import "./c.8e28b461.js";
import "./c.11013a9d.js";
const T = Intl && Intl.DateTimeFormat,
  C = [38, 33, 36],
  S = [40, 34, 35],
  $ = new Set([37, ...C]),
  F = new Set([39, ...S]),
  ...
  L = e(
    class extends t {
      constructor(e) {
        super(e), (this.et = new WeakMap());
      }
      render(e) {
        return [e];
      }
      update(e, [t]) {
        if (v(this.it) && (!v(t) || this.it.strings !== t.strings)) {
          const t = w(e).pop();
          let r = this.et.get(this.it.strings);
          if (void 0 === r) {
            const e = document.createDocumentFragment();
            (r = a(i, e)), r.setConnected(!1), this.et.set(this.it.strings, r);
          }
          g(r, [t]), k(r, void 0, t);
        }
        if (v(t)) {
          if (!v(this.it) || this.it.strings !== t.strings) {
            const a = this.et.get(t.strings);
            if (void 0 !== a) {
              const t = w(a).pop();
              D(e), k(e, void 0, t), g(e, [t]);
            }
          }
          this.it = t;
        } else this.it = void 0;
...
const E = r`<svg height="24" viewBox="0 0 24 24" width="24"><path d="M15.41 7.41L14 6l-6 6 6 6 1.41-1.41L10.83 12z"></path></svg>`,
  Y = r`<svg height="24" viewBox="0 0 24 24" width="24"><path d="M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"></path></svg>`,
  V = o`
button {
...
function P({
  ...
  const b = (function ({
    ...
    let s = n < o,
      l = n > r;
    if (A(o, r) < 864e5) return i;
    let d = s || l || t.has(i.getUTCDay()) || a.has(n);
    if (!d) return i;
    let c = 0,
      h = s === l ? i : new Date(s ? o - 864e5 : 864e5 + r);
    const u = h.getUTCFullYear(),
      p = h.getUTCMonth();
    let y = h.getUTCDate();
    for (; d; )
      (s || (!l && U.has(e))) && (y += 1),
        ...
        s ||
          ((s = c < o),
          s && ((h = new Date(o)), (c = +h), (y = h.getUTCDate()))),
        l ||
          ((l = c > r),
          l && ((h = new Date(r)), (c = +h), (y = h.getUTCDate()))),
        (d = t.has(h.getUTCDay()) || a.has(c));
    return h;
  })({
    keyCode: t,
    maxTime: s,
...
function K(e) {
  const t = T(e, {
    ...
    a = T(e, { timeZone: "UTC", day: "numeric" }),
    i = T(e, {
      timeZone: "UTC",
      year: "numeric",
      month: "short",
    ...
    r = T(e, { timeZone: "UTC", year: "numeric", month: "long" }),
    o = T(e, { timeZone: "UTC", weekday: "long" }),
    n = T(e, { timeZone: "UTC", weekday: "narrow" }),
    s = T(e, { timeZone: "UTC", year: "numeric" });
  return {
    locale: e,
    dateFormat: I(t),
    dayFormat: I(a),
    fullDateFormat: I(i),
    longMonthYearFormat: I(r),
    longWeekdayFormat: I(o),
    narrowWeekdayFormat: I(n),
    yearFormat: I(s),
  };
}
function Z(e, t) {
  const a = (function (e, t) {
      ...
      let n = o;
      return (
        "first-4-day-week" === e && (n = 3),
        "first-day-of-year" === e && (n = 6),
        "first-full-week" === e && (n = 0),
        M(a, i, r - o + n)
      );
    })(e, t),
    i = M(a.getUTCFullYear(), 0, 1),
    r = 1 + (+a - +i) / 864e5;
...
function q(e) {
  const {
    ...
    m = null == h ? Number.MIN_SAFE_INTEGER : +h,
    f = null == c ? Number.MAX_SAFE_INTEGER : +c,
    _ = (function (e) {
      const {
          firstDayOfWeek: t = 0,
          showWeekNumber: a = !1,
        ...
        d = Array.from(Array(7)).reduce((e, t, a) => {
          const i = M(2017, 0, n + a);
          return e.push({ label: r(i), value: o(i) }), e;
        }, l);
      return d;
    })({
      longWeekdayFormat: r,
    ...
    g = [-1, 0, 1].map((e) => {
      ...
      const _ = (function (e) {
        const {
            ...
            showWeekNumber: c = !1,
            weekLabel: h = "Week",
            weekNumberType: u = "first-4-day-week",
          } = e || {},
          p = B(o),
          y = t.getUTCFullYear(),
          m = t.getUTCMonth(),
          f = M(y, m, 1),
          _ = new Set(r.map((e) => R(e, p, c))),
          b = new Set(i.map((e) => +e)),
          v = [
            f.toJSON(),
            p,
            ...
            .join(":"),
          w = R(f.getUTCDay(), p, c),
          g = null == d ? +new Date("2000-01-01") : +d,
          k = null == l ? +new Date("2100-12-31") : +l,
          D = c ? 8 : 7,
          x = M(y, 1 + m, 0).getUTCDate(),
          T = [];
        let C = [],
          S = !1,
          $ = 1;
        for (const e of [0, 1, 2, 3, 4, 5]) {
          for (const t of [0, 1, 2, 3, 4, 5, 6].concat(7 === D ? [] : [7])) {
            const i = t + e * D;
            if (!S && c && 0 === t) {
              const t = Z(u, M(y, m, $ - (e < 1 ? p : 0))),
                a = `${h} ${t}`;
              C.push({
                fullDate: null,
                label: a,
        ...
        return {
          disabledDatesSet: b,
          calendar: T,
          disabledDaysSet: new Set(r.map((e) => B(e))),
          key: v,
        };
      })({
        dayFormat: t,
    ...
    x = new Set();
  for (const e of g) {
    const { disabledDatesSet: t, disabledDaysSet: a, ...i } = e;
    if (i.calendar.length > 0) {
      if (a.size > 0) for (const e of a) x.add(e);
      if (t.size > 0) for (const e of t) D.add(e);
    }
    k.push(i);
  }
  return {
...
function J(e) {
  const t = null == e ? new Date() : new Date(e),
    ...
    i = "number" == typeof e && e > 0 && isFinite(e);
  let r = t.getFullYear(),
    o = t.getMonth(),
    n = t.getDate();
  return (
    (a || i) &&
      ((r = t.getUTCFullYear()), (o = t.getUTCMonth()), (n = t.getUTCDate())),
    M(r, o, n)
  );
}
function X(e, t) {
...
function ae(e, t) {
  if (A(e, t) < 864e5) return [];
  const a = e.getUTCFullYear();
  return Array.from(Array(t.getUTCFullYear() - a + 1), (e, t) => t + a);
}
function ie(e, t, a) {
  const i = "number" == typeof e ? e : +e,
    r = +t,
    o = +a;
  return i < r ? r : i > o ? o : e;
}
function re(e) {
  const { clientX: t, clientY: a, pageX: i, pageY: r } = e,
    o = Math.max(i, t),
    n = Math.max(r, a),
    s = e.identifier || e.pointerId;
  return { x: o, y: n, id: null == s ? 0 : s };
}
function oe(e, t) {
  const a = t.changedTouches;
  if (null == a) return { newPointer: re(t), oldPointer: e };
  const i = Array.from(a, (e) => re(e)),
    r = null == e ? i[0] : i.find((t) => t.id === e.id);
  return { newPointer: r, oldPointer: e };
}
function ne(e, t, a) {
  e.addEventListener(t, a, !!n && { passive: !0 });
}
class se {
  constructor(e, t) {
    (this._element = e), (this._startPointer = null);
    const { down: a, move: i, up: r } = t;
    (this._down = this._onDown(a)),
      (this._move = this._onMove(i)),
      (this._up = this._onUp(r)),
      e &&
        e.addEventListener &&
        (e.addEventListener("mousedown", this._down),
        ne(e, "touchstart", this._down),
        ne(e, "touchmove", this._move),
        ne(e, "touchend", this._up));
  }
  disconnect() {
  ...
  _onDown(e) {
    return (t) => {
      ...
      const { newPointer: a } = oe(this._startPointer, t);
  ...
  _updatePointers(e, t, a) {
    ...
    const { newPointer: i, oldPointer: r } = oe(this._startPointer, t);
    e(i, r, t), (this._startPointer = a ? null : i);
  }
}
class le extends h {
  constructor() {
    super(),
      ...
      (this.landscape = !1),
      (this.locale =
        (T && T().resolvedOptions && T().resolvedOptions().locale) || "en-US"),
      (this.disabledDays = ""),
      (this.disabledDates = ""),
      (this.weekLabel = "Wk"),
      (this.inline = !1),
    ...
    (this.value = a),
      ...
      (this._max = new Date(i)),
      (this._todayDate = e),
      (this._maxDate = i),
      (this._yearList = ae(e, i)),
  ...
  get min() {
    return this._hasMin ? te(this._min) : "";
  }
  set min(e) {
    const t = J(e),
      a = H(e, t);
  ...
  get max() {
    return this._hasMax ? te(this._max) : "";
  }
  set max(e) {
    const t = J(e),
      a = H(e, t);
  ...
  get value() {
    return te(this._focusedDate);
  }
  set value(e) {
    const t = J(e),
      a = H(e, t) ? t : this._todayDate;
    (this._focusedDate = new Date(a)),
      (this._selectedDate = this._lastSelectedDate = new Date(a));
  }
  disconnectedCallback() {
    super.disconnectedCallback(),
      this._tracker && (this._tracker.disconnect(), (this._tracker = void 0));
  }
  render() {
    this._formatters.locale !== this.locale &&
      (this._formatters = K(this.locale));
    const e =
      ...
      t = this.inline
        ? null
        : r`<div class="datepicker-header" part="header">${this._renderHeaderSelectorButton()}</div>`;
    return r`
    ${t}
  ...
  firstUpdated() {
    ...
    (e =
      ...
      j(this, "datepicker-first-updated", {
  ...
  async updated(e) {
    ...
    if (e.has("min") || e.has("max")) {
      (this._yearList = ae(this._min, this._max)),
      ...
      if (A(e, a) > 864e5) {
        ...
        let i = t;
        t < e && (i = e), t > a && (i = a), (this.value = te(new Date(i)));
      }
    }
    if (e.has("_startView") || e.has("startView")) {
      if ("yearList" === t) {
        ...
        !(function (e, t) {
          if (null == e.scrollTo) {
            const { top: a, left: i } = t || {};
            (e.scrollTop = a || 0), (e.scrollLeft = i || 0);
          } else e.scrollTo(t);
        ...
        if (e) {
          const r = {
            ...
            move: (r, o) => {
              ...
              const n = this._dx,
                s =
                  (n < 0 && X(e, "has-max-date")) ||
                  (n > 0 && X(e, "has-min-date"));
              !s &&
                Math.abs(n) > 0 &&
                t &&
                ((a = !0), (e.style.transform = `translateX(${G(n)}px)`)),
                (this._dx = s ? 0 : n + (r.x - o.x));
            },
            up: async (r, o, n) => {
              if (t && a) {
                const r = this._dx,
                  o = e.getBoundingClientRect().width / 3,
                  n = Math.abs(r) > Number(this.dragRatio) * o,
                  s = 350,
                ...
                (i = !0),
                  ...
                  j(this, "datepicker-animation-finished");
              } else
                t &&
                  (this._updateFocusedDate(n),
                  (t = a = !1),
                  (this._dx = -1 / 0));
            },
          };
          this._tracker = new se(e, r);
        }
      }
      e.get("_startView") &&
        "calendar" === t &&
  ...
  _renderDatepickerCalendar() {
    const {
      ...
      n = ee(this.disabledDays, Number),
      s = ee(this.disabledDates, J),
      l = this.showWeekNumber,
      d = this._focusedDate,
      c = this.firstDayOfWeek,
      h = J(),
      p = this._selectedDate,
      y = this._max,
      m = this._min,
      {
        calendars: f,
      ...
      w = !f[0].calendar.length,
      g = !f[2].calendar.length,
      k = v.map(
        (e) => r`<th
      ...
      D = x(
        ...
        ({ calendar: t }, a) => {
          if (!t.length)
            return r`<div class="calendar-container" part="calendar"></div>`;
          const i = `calendarcaption${a}`,
            o = t[1][1].fullDate,
            n = 1 === a,
            s =
              n && !this._isInVisibleMonth(d, p)
                ? P({
                    disabledDaysSet: _,
                    disabledDatesSet: b,
                    hasAltKey: !1,
      ...
      <div class="calendar-container" part="calendar">
        <table class="calendar-table" part="table" role="grid" aria-labelledby="${i}">
          ...
          <tbody role="rowgroup">${t.map(
            (e) =>
              r`<tr role="row">${e.map((e, t) => {
                const { disabled: a, fullDate: i, label: o, value: c } = e;
                if (!i && c && l && t < 1)
                  return r`<th
                    ...
                    >${c}</th>`;
                if (!c || !i)
                  return r`<td class="full-calendar__day day--empty" part="calendar-day"></td>`;
                const p = +new Date(i),
                  y = +d === p,
                  m = n && s.getUTCDate() === Number(c);
                return r`
                  <td
                    tabindex="${m ? "0" : "-1"}"
                    class="${u({
    ...
    return Q(() => {
      "calendar" === e &&
        (this._selectedDate = this._lastSelectedDate =
          new Date(ie(this._focusedDate, this._min, this._max))),
        (this._startView = e);
    });
  }
  _updateMonth(e) {
    return Q(() => {
      ...
      const t = this._lastSelectedDate || this._selectedDate,
        ...
        i = this._max,
        r = "previous" === e,
        o = M(t.getUTCFullYear(), t.getUTCMonth() + (r ? -1 : 1), 1),
        n = o.getUTCFullYear(),
        s = o.getUTCMonth(),
        l = a.getUTCFullYear(),
        d = a.getUTCMonth(),
  ...
  _updateYear(e) {
    const t = z(e, (e) => X(e, "year-list-view__list-item"));
    if (null == t) return;
    const a = ie(
  ...
  _updateFocusedDateWithKeyboard(e) {
    ...
    this._isInVisibleMonth(i, a) ||
      (this._selectedDate = this._lastSelectedDate = i),
      (this._focusedDate = i),
...
(le.styles = [
  ...
  s([l({ type: Number, reflect: !0 })], le.prototype, "firstDayOfWeek", void 0),
  s(
  ...
  s([l({ type: String, reflect: !0 })], le.prototype, "weekNumberType", void 0),
  s([l({ type: Boolean, reflect: !0 })], le.prototype, "landscape", void 0),
  s([l({ type: String, reflect: !0 })], le.prototype, "startView", null),
  s([l({ type: String, reflect: !0 })], le.prototype, "min", null),
  s([l({ type: String, reflect: !0 })], le.prototype, "max", null),
  s([l({ type: String })], le.prototype, "value", null),
  s([l({ type: String })], le.prototype, "locale", void 0),
  s([l({ type: String })], le.prototype, "disabledDays", void 0),
  s([l({ type: String })], le.prototype, "disabledDates", void 0),
  s([l({ type: String })], le.prototype, "weekLabel", void 0),
  s([l({ type: Boolean })], le.prototype, "inline", void 0),
  s([l({ type: Number })], le.prototype, "dragRatio", void 0),
  s([l({ type: Date, attribute: !1 })], le.prototype, "_selectedDate", void 0),
  s([l({ type: Date, attribute: !1 })], le.prototype, "_focusedDate", void 0),
  s([l({ type: String, attribute: !1 })], le.prototype, "_startView", void 0),
  s(
    [d(".year-list-view__full-list")],
    le.prototype,
    "_yearViewFullList",
    void 0
  ),
  s([d(".btn__year-selector")], le.prototype, "_buttonSelectorYear", void 0),
  s(
    [d(".year-list-view__list-item")],
    le.prototype,
    "_yearViewListItem",
    void 0
  ),
  s([c({ passive: !0 })], le.prototype, "_updateYear", null),
  s([c({ passive: !0 })], le.prototype, "_updateFocusedDateWithKeyboard", null),
  (de = "app-datepicker"),
  (ce = le),
  window.customElements &&
    !window.customElements.get(de) &&
    window.customElements.define(de, ce);
let he = p(
  [b("ha-dialog-date-picker")],
  function (e, t) {
    return {
      F: class extends t {
        constructor(...t) {
      ...
      d: [
        { kind: "field", decorators: [l()], key: "hass", value: void 0 },
        { kind: "field", decorators: [l()], key: "value", value: void 0 },
        {
          kind: "field",
          decorators: [l({ type: Boolean })],
          key: "disabled",
          value: () => !1,
        },
        { kind: "field", decorators: [l()], key: "label", value: void 0 },
        { kind: "field", decorators: [y()], key: "_params", value: void 0 },
        { kind: "field", decorators: [y()], key: "_value", value: void 0 },
        {
          kind: "method",
          key: "showDialog",
          value: async function (e) {
            await m(), (this._params = e), (this._value = e.value);
          },
        },
        {
          kind: "method",
          ...
          value: function () {
            (this._params = void 0),
              f(this, "dialog-closed", { dialog: this.localName });
          },
        },
        {
          kind: "method",
          ...
          value: function () {
            return this._params
              ? r`<ha-dialog open @closed=${this.closeDialog}>
      <app-datepicker
        .value=${this._value}
...
export { he as HaDialogDatePicker };
