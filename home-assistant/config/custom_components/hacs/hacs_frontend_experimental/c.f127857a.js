...
import { x as a, eI as r } from "./main-ec7846c8.js";
import { i as n, a as i, b as o } from "./c.aaeac12d.js";
  ...
  if (
    (n >= u - 1
      ...
      ? ((r = "".concat(r.slice(0, n + 1), ".").concat(r.slice(n + 1))),
        (o = n + 1))
      : ((r = "0.".concat(_("0", -n - 1)).concat(r)), (o = 1)),
    r.indexOf(".") >= 0 && a > t)
  ) {
...
function x(e, t, a) {
  ...
  if (o < 1e21) r = o.toString();
    ...
    var l = (r = o.toString()).split("e"),
      s = l[0],
      c = l[1];
    (r = s.replace(".", "")), (r += _("0", Math.max(+c - r.length + 1, 0)));
  }
  if (0 !== i) {
    var m = r.length;
    if (m <= i) (r = _("0", i + 1 - m) + r), (m = i + 1);
    var f = r.slice(0, m - i),
      d = r.slice(m - i);
...
function U(e, t, a) {
  ...
  var o = z(r(e), t);
  return 0 === o.roundedNumber || I(o.roundedNumber) === n - i
    ? [i, n]
    ...
    case "unit":
      ...
      if (L) S = X(a, e.roundedNumber * Math.pow(10, u), t.units.simple[k][O]);
        ...
        var I = k.split("-per-"),
          ...
          N = I[1];
        L = t.units.simple[_];
        var B = X(a, e.roundedNumber * Math.pow(10, u), t.units.simple[_][O]),
...
var re = Object.freeze({
    ...
    InitializeNumberFormat: function (e, t, a, r) {
      ...
      var v = n(l, f, p, ["nu"], o, c),
        h = o[v.dataLocale];
      j(!!h, "Missing locale data for ".concat(v.dataLocale));
      var y = i(e);
      (y.locale = v.locale),
    ...
    PartitionPattern: function (e) {
      for (
        ...
        j((r = e.indexOf("}", a)) > a, "Invalid pattern ".concat(e)),
...
var ve = e(function (e, t) {
  ...
  t.InitializeDateTimeFormat = function (e, t, n, i) {
    ...
    if (((F.timeStyle = _), void 0 === k && void 0 === _))
      ...
      for (var B = 0, j = ue.DATE_TIME_PROPS; B < j.length; B++) {
        if (void 0 !== (G = v[(R = j[B])]))
          throw new TypeError(
      ...
      O = (0, ge.DateTimeStyleFormat)(k, _, C);
    }
    ...
    if (void 0 !== F.hour) {
      ...
      (F.hourCycle = N),
        "h11" === N || "h12" === N
          ? ((L = O.pattern12), (I = O.rangePatterns12))
          : ((L = O.pattern), (I = O.rangePatterns));
    } else (F.hourCycle = void 0), (L = O.pattern), (I = O.rangePatterns);
    return (F.pattern = L), (F.rangePatterns = I), e;
  };
});
    ...
    for (var M = 0, k = i.patternParts; M < k.length; M++) {
      ...
      _ =
        L === re.RangePatternType.startRange || L === re.RangePatternType.shared
          ...
          : r;
      for (
        var N = (0, re.PartitionPattern)(I),
          B = (0, se.FormatDateTimePattern)(e, N, _, n),
          j = 0,
          R = B;
        j < R.length;
        j++
