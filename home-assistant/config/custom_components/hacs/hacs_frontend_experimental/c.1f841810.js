...
import { S as u } from "./c.0294c25c.js";
import { f as n } from "./c.29de58d6.js";
  ...
  function (e, t) {
    return {
      ...
      d: [
        ...
        {
          kind: "field",
          decorators: [i({ type: Array, attribute: "hide-attributes" })],
          key: "hideAttributes",
          value: void 0,
        },
        {
    ...
    `;
        ...
        },
        {
          ...
          value: function (e) {
            var t;
            if (
              (s(l(a.prototype), "updated", this).call(this, e),
              !this.value ||
              ...
              return;
            const i = e.get("context");
            if (
              !this.context ||
              (null == i ? void 0 : i.filter_entity) ===
            ...
            o && r(this, "value-changed", { value: void 0 });
          },
        },
      ],
    };
...
export { c as HaSelectorAttribute };
