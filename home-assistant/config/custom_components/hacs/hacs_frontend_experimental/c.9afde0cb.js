...
import { c as U, b as q } from "./c.eea05cf6.js";
import { p as K } from "./c.aaeac12d.js";
import { L as V } from "./c.840a95b4.js";
import { d as G, s as Y } from "./c.0e3055bd.js";
import "./c.fbbe4b73.js";
import { b as X } from "./c.07e395f8.js";
import { m as Z } from "./c.551b8e45.js";
import { a as J } from "./c.cb96fbc8.js";
import { r as Q, a as ee } from "./c.0193255c.js";
import "./c.27e9c060.js";
import { d as te } from "./c.10855172.js";
import { i as ie } from "./c.21c042d4.js";
import "./c.8e28b461.js";
import "./c.743a15a1.js";
import "./c.2610e8cd.js";
import "./c.a0946910.js";
import "./c.55291b50.js";
import "./c.48e5c8c7.js";
...
const oe = [
    {
      ...
      _findParent: function () {
        this.assignParentResizable(null),
          ...
          this._parentResizable ? ae.delete(this) : ae.add(this);
      },
    },
    {
      listeners: {
...
const ne = { second: 45, minute: 45, hour: 22, day: 5, week: 4, month: 11 };
K && (await K);
const ce = r(
    ...
    `;
        ...
        },
        {
          ...
          value: async function (e) {
            b(this, "value-changed", { value: String(e) });
          },
        },
        {
          kind: "method",
...
const he = Symbol("Comlink.proxy"),
  ue = Symbol("Comlink.endpoint"),
  fe = Symbol("Comlink.releaseProxy"),
  pe = Symbol("Comlink.thrown"),
  be = (e) => ("object" == typeof e && null !== e) || "function" == typeof e,
  me = new Map([
    [
      "proxy",
      {
        canHandle: (e) => be(e) && e[he],
        serialize(e) {
          const { port1: t, port2: i } = new MessageChannel();
          return _e(e, t), [i, [i]];
        },
        deserialize: (e) => (e.start(), ge(e)),
      },
    ],
    [
      "throw",
      {
        canHandle: (e) => be(e) && pe in e,
        serialize({ value: e }) {
          let t;
          return (
            (t =
    ...
    try {
      ...
      switch (s) {
        case "GET":
          ...
          break;
        case "SET":
          (t[l.slice(-1)[0]] = Re(a.data.value)), (n = !0);
          break;
        case "APPLY":
          n = i.apply(t, r);
          break;
    ...
    Promise.resolve(n)
      ...
      .then((e) => {
        ...
        t.postMessage(Object.assign(Object.assign({}, a), { id: o }), l),
          "RELEASE" === s && (t.removeEventListener("message", i), ve(t));
      });
  }),
    t.start && t.start();
}
...
function ke(e, t = [], i = function () {}) {
  let a = !1;
  const o = new Proxy(i, {
    get(i, s) {
      if ((ye(a), s === fe))
        return () =>
          ze(e, { type: "RELEASE", path: t.map((e) => e.toString()) }).then(
            () => {
              ve(e), (a = !0);
            }
          );
      if ("then" === s) {
        ...
        const i = ze(e, { type: "GET", path: t.map((e) => e.toString()) }).then(
          Re
        );
    ...
    apply(i, o, s) {
      ...
      if (l === ue) return ze(e, { type: "ENDPOINT" }).then(Re);
      if ("bind" === l) return ke(e, t.slice(0, -1));
      const [r, n] = we(s);
      return ze(
        e,
...
function $e(e) {
  ...
  return [{ type: "RAW", value: e }, xe.get(e) || []];
}
function Re(e) {
  switch (e.type) {
    case "HANDLER":
      return me.get(e.name).deserialize(e.value);
    case "RAW":
      return e.value;
  }
}
  ...
  function (e, t) {
    ...
    return {
      ...
      d: [
        ...
        { kind: "field", decorators: [v()], key: "_filter", value: () => "" },
        { kind: "field", decorators: [v()], key: "_sortColumn", value: void 0 },
        {
          kind: "field",
          decorators: [v()],
          key: "_sortDirection",
        ...
        { kind: "field", decorators: [v()], key: "_items", value: () => [] },
        ...
        },
        {
          ...
          value() {
            return (e) => {
              ...
              b(this, "row-click", { id: i }, { bubbles: !1 });
            };
          },
        },
        {
          ...
          value: function () {
            this._items.length && (this._items = [...this._items]),
              b(this, "selection-changed", { value: this._checkedRows });
          },
        },
        {
          kind: "method",
          ...
          },
          {
            ...
            value() {
              return r((e, t, i, a, o, s, l) => {
                const r = e.filter(
                  (e) =>
                    (!e.component || e.core || ie(this.hass, e.component)) &&
                    (!e.advancedOnly || i)
                );
                if (r.length < 2) {
                  if (1 === r.length) {
...
let Se = n(
  [_("hass-tabs-subpage-data-table")],
  function (e, t) {
    return {
      F: class extends t {
        constructor(...t) {
        ...
        },
        {
          ...
          value: function (e) {
            this.filter !== e.detail.value &&
              ((this.filter = e.detail.value),
              b(this, "search-changed", { value: this.filter }));
          },
        },
        {
          kind: "method",
...
n(
  ...
  n(
    [_("hacs-tabs-subpage-data-table")],
    function (e, t) {
      class i extends t {
        constructor(...t) {
          super(...t), e(this);
...
const Ee = {
  ...
  Fe = { title: "", hidden: !0, filterable: !0 };
let Le = n(
  [_("hacs-experimental-panel")],
  function (e, t) {
    return {
      F: class extends t {
        constructor(...t) {
      ...
      d: [
        ...
        {
          kind: "field",
          decorators: [V("hacs-table-filters", !0, !1)],
          key: "activeFilters",
          value: void 0,
        },
        {
          kind: "field",
          decorators: [V("hacs-table-columns", !0, !1)],
          key: "_tableColumns",
          value: () => Ee,
        },
        {
          ...
          value() {
            return () => {
              var e;
              const t = this._filterRepositories(
                ...
                i = t.filter((e) => e.new),
                a = t.filter((e) => !e.new),
                o = "explore" === this.section && 0 !== i.length;
    ...
    >
        ...
        .items=${[
          {
            ...
            action: () =>
              E.open("https://hacs.xyz/", "_blank", "noreferrer=true"),
          },
          {
            path: F,
            label: "GitHub",
            action: () =>
              E.open("https://github.com/hacs", "_blank", "noreferrer=true"),
          },
          {
            path: L,
      ...
      ${
        this.narrow
          ? " "
          : u` <ha-button-menu slot="filter-menu" corner="BOTTOM_START" multi>
            <ha-icon-button
              slot="trigger"
            ...
            ${Object.keys(Ee[this.section]).map(
              (e) => u`
                <ha-check-list-item
                  ...
                  .column=${e}
                  .selected=${
                    this._tableColumns[this.section][e] || Ee[this.section][e]
                  }
                  left
                >
      ...
      ${
        "entry" === this.section
          ? u`
            <a href="/hacs/explore" slot="fab">
              <ha-fab .label=${this.hacs.localize(
                "common.explore"
        ...
        },
        {
          ...
          value() {
            return r((e, t, i) => ({
              icon: {
                ...
                hidden: this.narrow || "entry" !== this.section,
                type: "icon",
                template: (e, t) => {
                  var i;
                  return u`
          ...
          `;
              ...
              name: {
                ...
                main: !0,
                sortable: !0,
                direction: "explore" === this.section || t ? void 0 : "asc",
                hidden: !i[this.section].name,
                grows: !0,
                template: (t, i) => u`
            ${
              i.new
          ...
          `,
              ...
              downloads: {
                ...
                hidden: e || !i[this.section].downloads,
                sortable: !0,
                width: "10%",
                template: (e) => u`${e || "-"}`,
              },
              stars: {
                ...
                hidden: e || !i[this.section].stars,
                direction: "entry" === this.section || t ? void 0 : "desc",
                sortable: !0,
                width: "10%",
              },
              last_updated: {
                ...
                hidden: e || !i[this.section].last_updated,
                sortable: !0,
                width: "15%",
                template: (e) => de(new Date(e), this.hass.locale),
              },
              category: {
                ...Fe,
                title: this.hacs.localize("column.category"),
                hidden: e || !i[this.section].category,
                sortable: !0,
                width: "10%",
        ...
        },
        {
          ...
          value: function (e) {
            ...
            this._tableColumns = {
              ...this._tableColumns,
              [this.section]: Object.keys(Ee[this.section]).reduce(
                (e, i) => ({ ...e, [i]: t[i] || Ee[this.section][i] }),
                {}
              ),
            };
          },
...
export { Le as HacsExperimentalPanel };
