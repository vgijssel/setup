...
customElements.define("ha-entity-marker", v);
      ...
      d: [
        ...
        },
        {
          ...
          value: function (e) {
            ...
            else if (this._loaded && i && this.entities)
              for (const e of this.entities)
                if (i.states[g(e)] !== this.hass.states[g(e)]) {
                  this._drawEntities();
                  break;
                }
            if (
              ...
              !e.has("darkMode") &&
                (!e.has("hass") ||
                  (i && i.themes.darkMode === this.hass.themes.darkMode)))
            )
              return;
            const o =
            ...
            this.shadowRoot.getElementById("map").classList.toggle("dark", o);
          },
        },
        {
          kind: "method",
          ...
          value: async function () {
            ...
            ([this.leafletMap, this.Leaflet] = await (async (e) => {
              ...
              const t = (await import("./c.9571b827.js")).default;
