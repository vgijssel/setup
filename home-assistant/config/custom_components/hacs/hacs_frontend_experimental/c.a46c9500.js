...
import { T as p, l as u, b as c } from "./c.7a38bd55.js";
const m = {
...
class x extends p {
  ...
  render() {
    const t = this.charCounter && -1 !== this.maxLength,
      ...
      i = t && !e,
      l = !!this.helper || !!this.validationMessage || i,
      o = {
  ...
  renderInput() {
    const t = this.label ? "label" : void 0,
      ...
      s = this.autocapitalize ? this.autocapitalize : void 0;
    return a`
      <textarea
          aria-labelledby=${l(t)}
...
t([e("textarea")], x.prototype, "formElement", void 0),
  t([i({ type: Number })], x.prototype, "rows", void 0),
  t([i({ type: Number })], x.prototype, "cols", void 0),
  t([i({ converter: m })], x.prototype, "charCounter", void 0);
const f = o`.mdc-text-field{height:100%}.mdc-text-field__input{resize:none}`;
r(
  [h("ha-textarea")],
  function (t, e) {
    class a extends e {
    ...
    return {
      ...
      d: [
        ...
        },
        {
          ...
          key: "updated",
          value: function (t) {
            d(n(a.prototype), "updated", this).call(this, t),
              this.autogrow &&
                t.has("value") &&
