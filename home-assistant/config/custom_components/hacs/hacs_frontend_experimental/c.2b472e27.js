...
import { c as X, b as Q } from "./c.11013a9d.js";
import { p as Z } from "./c.62bcca49.js";
import { L as J } from "./c.14856cd1.js";
import { d as ee, s as te } from "./c.7a38bd55.js";
import { b as ie } from "./c.07e395f8.js";
import { m as ae } from "./c.09d3089c.js";
import { a as oe } from "./c.14416bd9.js";
import { r as se, a as le } from "./c.ce9d0b69.js";
import "./c.80763e9e.js";
import { d as re } from "./c.10855172.js";
import { i as ne } from "./c.21c042d4.js";
import "./c.8e28b461.js";
import "./c.743a15a1.js";
import "./c.2610e8cd.js";
import "./c.a0946910.js";
import "./c.6fde4307.js";
...
const de = [
    {
      ...
      _findParent: function () {
        this.assignParentResizable(null),
          ...
          this._parentResizable ? ce.delete(this) : ce.add(this);
      },
    },
    {
      listeners: {
...
const pe = { second: 45, minute: 45, hour: 22, day: 5, week: 4, month: 11 };
Z && (await Z);
const me = r(
...
const ve = Symbol("Comlink.proxy"),
  _e = Symbol("Comlink.endpoint"),
  ge = Symbol("Comlink.releaseProxy"),
  ye = Symbol("Comlink.thrown"),
  ke = (e) => ("object" == typeof e && null !== e) || "function" == typeof e,
  we = new Map([
    [
      "proxy",
      {
        canHandle: (e) => ke(e) && e[ve],
        serialize(e) {
...
function xe(e, t = self) {
  t.addEventListener("message", function i(a) {
    ...
    try {
      ...
      switch (s) {
        case "GET":
          ...
          break;
        case "SET":
          (t[l.slice(-1)[0]] = De(a.data.value)), (n = !0);
          break;
        case "APPLY":
          n = i.apply(t, r);
          break;
    ...
    Promise.resolve(n)
      .catch((e) => ({ value: e, [ye]: 0 }))
      .then((e) => {
        const [a, l] = Fe(e);
        t.postMessage(Object.assign(Object.assign({}, a), { id: o }), l),
          "RELEASE" === s && (t.removeEventListener("message", i), $e(t));
      });
  }),
    t.start && t.start();
}
...
function Se(e, t = [], i = function () {}) {
  let a = !1;
  const o = new Proxy(i, {
    get(i, s) {
      if ((ze(a), s === ge))
        return () =>
          He(e, { type: "RELEASE", path: t.map((e) => e.toString()) }).then(
            () => {
              $e(e), (a = !0);
            }
          );
      if ("then" === s) {
        ...
        const i = He(e, { type: "GET", path: t.map((e) => e.toString()) }).then(
          De
        );
    ...
    apply(i, o, s) {
      ...
      if (l === _e) return He(e, { type: "ENDPOINT" }).then(De);
      if ("bind" === l) return Se(e, t.slice(0, -1));
      const [r, n] = Ce(s);
      return He(
        e,
...
function Fe(e) {
  ...
  return [{ type: "RAW", value: e }, Te.get(e) || []];
}
function De(e) {
  switch (e.type) {
    case "HANDLER":
      return we.get(e.name).deserialize(e.value);
    case "RAW":
      return e.value;
  }
}
          ...
          },
          {
            ...
            value() {
              return r((e, t, i, a, o, s, l) => {
                const r = e.filter(
                  (e) =>
                    (!e.component || e.core || ne(this.hass, e.component)) &&
                    (!e.advancedOnly || i)
                );
                if (r.length < 2) {
                  if (1 === r.length) {
...
const je = {
  ...
  Oe = { title: "", hidden: !0, filterable: !0 };
let Ne = n(
  ...
  function (e, t) {
    ...
    return {
      ...
      d: [
        ...
        {
          kind: "field",
          decorators: [J("hacs-table-filters", !0, !1)],
          key: "activeFilters",
          value: () => [],
        },
        {
          kind: "field",
          decorators: [J("hacs-table-sort", !0, !1)],
          key: "activeSort",
          value: void 0,
        },
        {
          kind: "field",
          decorators: [J("hacs-active-search", !0, !1)],
          key: "_activeSearch",
          value: void 0,
        },
        {
          kind: "field",
          decorators: [J("hacs-table-active-columns", !0, !1)],
          key: "_tableColumns",
          value: () => Ae,
        },
        {
      ...
      <ha-button-menu slot="filter-menu" corner="BOTTOM_START" multi>
        ...
        },
        {
          ...
          `;
                ...
                last_updated: {
                  ...
                  template: (e, t) => {
                    try {
                      return be(new Date(e), this.hass.locale);
                    } catch (e) {
                      return "-";
                    }
                  },
        ...
        },
        {
          ...
          value: function (e) {
            ...
            this._tableColumns = Object.keys(Ae).reduce((e, i) => {
              var a;
              return {
                ...e,
                [i]: null !== (a = t[i]) && void 0 !== a ? a : Ae[i],
              };
            }, {});
          },
        },
...
export { Ne as HacsExperimentalPanel };
