    ...
    return {
      ...
      d: [
        ...
        },
        {
          ...
          key: "render",
          value: function () {
            var e, i, t, o, n, r, s, a, u, h, v, c, m, p, b;
            const f =
              "box" ===
      ...
      <div class="input">
        ...
        <ha-textfield
          .inputMode=${
            ((null === (r = this.selector.number) || void 0 === r
              ? void 0
              : r.step) || 1) %
              1 !=
            0
          ...
          class=${d({
            single:
              "box" ===
              (null === (a = this.selector.number) || void 0 === a
                ? void 0
                : a.mode),
          })}
          .min=${
            null === (u = this.selector.number) || void 0 === u ? void 0 : u.min
          }
          .max=${
            null === (h = this.selector.number) || void 0 === h ? void 0 : h.max
          }
          .value=${null !== (v = this.value) && void 0 !== v ? v : ""}
          .step=${
            null !==
              (c =
                null === (m = this.selector.number) || void 0 === m
                  ? void 0
                  : m.step) && void 0 !== c
              ? c
              : 1
          ...
          .required=${this.required}
          .suffix=${
            null === (p = this.selector.number) || void 0 === p
              ? void 0
    ...
    `;
        ...
        },
        {
          ...
          value: function (e) {
            ...
            this.value !== i && o(this, "value-changed", { value: i });
          },
        },
        {
          kind: "get",
