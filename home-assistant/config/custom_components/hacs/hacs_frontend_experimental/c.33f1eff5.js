...
import { g as n, d as c } from "./c.1e0e1850.js";
import { f as u, a as h, b as v } from "./c.6f18200a.js";
import { S as k } from "./c.0294c25c.js";
    ...
    `;
        ...
        },
        {
          ...
          value: async function (e) {
            (this.value = e), a(this, "value-changed", { value: e });
          },
        },
        {
          kind: "method",
  ...
  function (e, a) {
    return {
      ...
      d: [
        ...
        { kind: "field", key: "_deviceIntegrationLookup", value: () => o(n) },
        {
          kind: "method",
          key: "hassSubscribe",
          value: function () {
            return [
              c(this.hass.connection, (e) => {
        ...
        },
        {
          ...
          value: function () {
            var e, i, a, r, s;
            return ((null !== (e = this.selector.area) &&
              void 0 !== e &&
              null !== (i = e.device) &&
              void 0 !== i &&
              i.integration) ||
              ...
              !this._entitySources
              ? t``
              : null !== (s = this.selector.area) && void 0 !== s && s.multiple
              ? t`
      <ha-areas-picker
        .hass=${this.hass}
        .value=${this.value}
          ...
          value() {
            return (e) => {
              ...
              return (
                ...
                void 0 === i ||
                !i.entity ||
                h(this.selector.area.entity, e, this._entitySources)
              );
            };
          },
        },
            ...
            return (e) => {
              ...
              const t =
                this._entitySources && this._entities
                  ...
                  : void 0;
              return v(this.selector.area.device, e, t);
            };
          },
        },
      ],
