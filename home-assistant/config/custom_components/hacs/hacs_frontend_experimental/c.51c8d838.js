...
import { n as _, m as v, a as w, r as g, c as k } from "./c.0e3055bd.js";
import { c as D } from "./c.55291b50.js";
import "./c.d3381c6c.js";
import "./c.8e28b461.js";
import "./c.eea05cf6.js";
const x = Intl && Intl.DateTimeFormat,
  T = [38, 33, 36],
  C = [40, 34, 35],
  S = new Set([37, ...T]),
  $ = new Set([39, ...C]),
  ...
  W = e(
    class extends t {
      ...
      update(e, [t]) {
        if (_(this.it) && (!_(t) || this.it.strings !== t.strings)) {
          const t = v(e).pop();
        ...
        if (_(t)) {
          if (!_(this.it) || this.it.strings !== t.strings) {
            const a = this.et.get(t.strings);
            if (void 0 !== a) {
              const t = v(a).pop();
              k(e), g(e, void 0, t), w(e, [t]);
            }
          }
          this.it = t;
        } else this.it = void 0;
...
const M = r`<svg height="24" viewBox="0 0 24 24" width="24"><path d="M15.41 7.41L14 6l-6 6 6 6 1.41-1.41L10.83 12z"></path></svg>`,
  E = r`<svg height="24" viewBox="0 0 24 24" width="24"><path d="M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"></path></svg>`,
  Y = o`
button {
...
function I(e) {
  const t = x(e, {
    ...
    a = x(e, { timeZone: "UTC", day: "numeric" }),
    i = x(e, {
      timeZone: "UTC",
      year: "numeric",
      month: "short",
    ...
    r = x(e, { timeZone: "UTC", year: "numeric", month: "long" }),
    o = x(e, { timeZone: "UTC", weekday: "long" }),
    n = x(e, { timeZone: "UTC", weekday: "narrow" }),
    s = x(e, { timeZone: "UTC", year: "numeric" });
  return {
    locale: e,
    dateFormat: z(t),
    dayFormat: z(a),
    fullDateFormat: z(i),
    longMonthYearFormat: z(r),
    longWeekdayFormat: z(o),
    narrowWeekdayFormat: z(n),
    yearFormat: z(s),
  };
}
function K(e, t) {
...
function re(e, t) {
  ...
  if (null == a) return { newPointer: ie(t), oldPointer: e };
  const i = Array.from(a, (e) => ie(e)),
...
class ne {
  constructor(e, t) {
    ...
    (this._down = this._onDown(a)),
      ...
      e &&
        ...
        oe(e, "touchstart", this._down),
        oe(e, "touchmove", this._move),
        oe(e, "touchend", this._up));
  }
  disconnect() {
  ...
  _onDown(e) {
    return (t) => {
      ...
      const { newPointer: a } = re(this._startPointer, t);
  ...
  _updatePointers(e, t, a) {
    ...
    const { newPointer: i, oldPointer: r } = re(this._startPointer, t);
...
class se extends h {
  constructor() {
    super(),
      ...
      (this.landscape = !1),
      (this.locale =
        (x && x().resolvedOptions && x().resolvedOptions().locale) || "en-US"),
      (this.disabledDays = ""),
      (this.disabledDates = ""),
      (this.weekLabel = "Wk"),
      (this.inline = !1),
  ...
  get min() {
    return this._hasMin ? ee(this._min) : "";
  }
  set min(e) {
    const t = q(e),
      a = X(e, t);
  ...
  get max() {
    return this._hasMax ? ee(this._max) : "";
  }
  set max(e) {
    const t = q(e),
      a = X(e, t);
  ...
  get value() {
    return ee(this._focusedDate);
  }
  set value(e) {
    const t = q(e),
      a = X(e, t) ? t : this._todayDate;
  ...
  render() {
    this._formatters.locale !== this.locale &&
      (this._formatters = I(this.locale));
    const e =
  ...
  firstUpdated() {
    ...
    (e =
      ...
      P(this, "datepicker-first-updated", {
  ...
  async updated(e) {
    ...
    if (e.has("min") || e.has("max")) {
      (this._yearList = te(this._min, this._max)),
      ...
      if (O(e, a) > 864e5) {
        ...
        let i = t;
        t < e && (i = e), t > a && (i = a), (this.value = ee(new Date(i)));
      }
    }
        ...
        if (e) {
          const r = {
            ...
            move: (r, o) => {
              ...
              const n = this._dx,
                s =
                  (n < 0 && J(e, "has-max-date")) ||
                  (n > 0 && J(e, "has-min-date"));
              !s &&
                Math.abs(n) > 0 &&
                t &&
                ((a = !0), (e.style.transform = `translateX(${H(n)}px)`)),
            ...
            up: async (r, o, n) => {
              if (t && a) {
                ...
                (i = !0),
                  ...
                  P(this, "datepicker-animation-finished");
              } else
                t &&
  ...
  _renderDatepickerCalendar() {
    const {
      ...
      n = Q(this.disabledDays, Number),
      s = Q(this.disabledDates, q),
    ...
    return G(() => {
      "calendar" === e &&
        (this._selectedDate = this._lastSelectedDate =
          new Date(ae(this._focusedDate, this._min, this._max))),
        (this._startView = e);
    });
  }
  _updateMonth(e) {
    return G(() => {
      ...
      const t = this._lastSelectedDate || this._selectedDate,
        ...
        i = this._max,
        r = "previous" === e,
        o = L(t.getUTCFullYear(), t.getUTCMonth() + (r ? -1 : 1), 1),
        n = o.getUTCFullYear(),
        s = o.getUTCMonth(),
        l = a.getUTCFullYear(),
        d = a.getUTCMonth(),
  ...
  _updateYear(e) {
    const t = j(e, (e) => J(e, "year-list-view__list-item"));
    if (null == t) return;
    const a = ae(
...
(se.styles = [
  ...
  s([l({ type: Number, reflect: !0 })], se.prototype, "firstDayOfWeek", void 0),
  s(
  ...
  s([l({ type: String, reflect: !0 })], se.prototype, "weekNumberType", void 0),
  s([l({ type: Boolean, reflect: !0 })], se.prototype, "landscape", void 0),
  s([l({ type: String, reflect: !0 })], se.prototype, "startView", null),
  s([l({ type: String, reflect: !0 })], se.prototype, "min", null),
  s([l({ type: String, reflect: !0 })], se.prototype, "max", null),
  s([l({ type: String })], se.prototype, "value", null),
  s([l({ type: String })], se.prototype, "locale", void 0),
  s([l({ type: String })], se.prototype, "disabledDays", void 0),
  s([l({ type: String })], se.prototype, "disabledDates", void 0),
  s([l({ type: String })], se.prototype, "weekLabel", void 0),
  s([l({ type: Boolean })], se.prototype, "inline", void 0),
  s([l({ type: Number })], se.prototype, "dragRatio", void 0),
  s([l({ type: Date, attribute: !1 })], se.prototype, "_selectedDate", void 0),
  s([l({ type: Date, attribute: !1 })], se.prototype, "_focusedDate", void 0),
  s([l({ type: String, attribute: !1 })], se.prototype, "_startView", void 0),
  s(
  ...
  s([d(".btn__year-selector")], se.prototype, "_buttonSelectorYear", void 0),
  s(
  ...
  s([c({ passive: !0 })], se.prototype, "_updateYear", null),
  s([c({ passive: !0 })], se.prototype, "_updateFocusedDateWithKeyboard", null),
  (le = "app-datepicker"),
  (de = se),
  window.customElements &&
    !window.customElements.get(le) &&
    window.customElements.define(le, de);
let ce = p(
    ...
    return {
      ...
      d: [
        ...
        { kind: "field", decorators: [y()], key: "_value", value: void 0 },
        {
          ...
          key: "showDialog",
          value: function (e) {
            (this._params = e), (this._value = e.value);
          },
        },
        {
          kind: "method",
          ...
          value: function () {
            (this._params = void 0),
              m(this, "dialog-closed", { dialog: this.localName });
          },
        },
        {
          kind: "method",
...
export { ce as HaDialogDatePicker };
