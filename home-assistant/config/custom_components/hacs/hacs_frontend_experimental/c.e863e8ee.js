...
import { a as p } from "./c.14416bd9.js";
import { b as v } from "./c.7a38bd55.js";
  ...
  function (e, i) {
    ...
    return {
      ...
      d: [
        ...
        { kind: "field", decorators: [t()], key: "accept", value: void 0 },
        { kind: "field", decorators: [t()], key: "icon", value: void 0 },
        { kind: "field", decorators: [t()], key: "label", value: void 0 },
        { kind: "field", decorators: [t()], key: "value", value: () => null },
        {
          kind: "field",
        ...
        { kind: "field", decorators: [a()], key: "_drag", value: () => !1 },
        {
          kind: "field",
          decorators: [l("#input")],
          key: "_input",
        ...
        },
        {
          ...
          key: "firstUpdated",
          value: function (e) {
            d(n(h.prototype), "firstUpdated", this).call(this, e),
      ...
      ${
        this.uploading
          ...
          : o`
            <label
              for="input"
              class="mdc-text-field mdc-text-field--filled ${s({
    ...
    `;
          ...
          value: function (e) {
            ...
            e.preventDefault(),
              ...
              null !== (i = e.dataTransfer) &&
                void 0 !== i &&
                i.files &&
                c(this, "file-picked", { files: e.dataTransfer.files }),
              (this._drag = !1);
          },
        },
        {
        ...
        },
        {
          ...
          value: function (e) {
            c(this, "file-picked", { files: e.target.files });
          },
        },
        {
          kind: "method",
          key: "_clearValue",
          value: function (e) {
            e.preventDefault(), (this.value = null), c(this, "change");
          },
        },
        {
          kind: "get",
  ...
  function (e, i) {
    ...
    return {
      ...
      d: [
        ...
        { kind: "field", decorators: [a()], key: "_filename", value: void 0 },
        { kind: "field", decorators: [a()], key: "_busy", value: () => !1 },
        {
          kind: "method",
          key: "render",
          value: function () {
      ...
      <ha-file-upload
        .hass=${this.hass}
        .accept=${
          null === (e = this.selector.file) || void 0 === e ? void 0 : e.accept
        }
        .icon=${f}
        .label=${this.label}
        ...
        .value=${
          this.value
            ? (null === (i = this._filename) || void 0 === i
                ? void 0
                : i.name) || "Unknown file"
            : ""
        }
    ...
    `;
        ...
        },
        {
          ...
          key: "willUpdate",
          value: function (e) {
            d(n(l.prototype), "willUpdate", this).call(this, e),
              e.has("value") &&
                this._filename &&
        ...
        },
        {
          ...
          value: async function (e) {
            ...
            try {
              ...
              (this._filename = { fileId: e, name: i.name }),
                c(this, "value-changed", { value: e });
            } catch (e) {
              p(this, {
        ...
        },
        {
          ...
          value() {
            return async () => {
              ...
              try {
                await (async (e, i) =>
                  e.callApi("DELETE", "file_upload", { file_id: i }))(
                  this.hass,
                  this.value
                );
              } catch (e) {
