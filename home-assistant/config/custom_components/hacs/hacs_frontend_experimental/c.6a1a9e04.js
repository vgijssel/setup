...
var e = t(function (t, i) {
  !(function (t) {
    ...
    function Di(t, i, e, n) {
      ...
      else for (var s = 0, r = (i = _(i)).length; s < r; s++) Ui(t, i[s], e, n);
      return this;
    }
    ...
    function Be(t, i) {
      ...
      var _ = u.length;
      for (e = 0, n = 0; e < _ - 1; e++) n += u[e].distanceTo(u[e + 1]) / 2;
      if (0 === n) l = u[0];
      else
        for (e = 0, s = 0; e < _ - 1; e++)
    ...
    function Ne(t, i) {
      ...
      Oe(t) ||
        ...
        (t = t[0]));
      var c = [];
      for (var _ in t) c.push(i.project(H(t[_])));
      var d = c.length;
      for (a = h = l = 0, e = 0, n = d - 1; e < d; n = e++)
        (o = c[e]),
          ...
          (l += (o.y + s.y) * r),
          (a += 3 * r);
      return (u = 0 === a ? c[0] : [h / a, l / a]), i.unproject(B(u));
    }
    ...
    var ln = on.extend({
      ...
      _convertLatLngs: function (t) {
        for (var i = [], e = Oe(t), n = 0, o = t.length; n < o; n++)
          e
    ...
    var cn = ln.extend({
      ...
      _defaultShape: function () {
        return Oe(this._latlngs[0]) ? this._latlngs[0] : this._latlngs[0][0];
      },
      _clipPoints: function () {
        var t = this._renderer._bounds,
    ...
    function yn(t, i, e, n) {
      for (var o = [], s = 0, r = t.length; s < r; s++)
        o.push(i ? yn(t[s], Oe(t[s]) ? 0 : i - 1, e, n) : vn(t[s], n));
    ...
    oe.mergeOptions({ closePopupOnClick: !0 }),
      ...
      qe.include({
        ...
        openPopup: function (t) {
          return (
            this._popup &&
              (this instanceof Ye || (this._popup._source = this),
      ...
      qe.include({
        bindTooltip: function (t, i) {
          return (
            ...
            (this._tooltip = this._initOverlay(An, this._tooltip, t, i)),
        ...
        openTooltip: function (t) {
          return (
            this._tooltip &&
              (this instanceof Ye || (this._tooltip._source = this),
    ...
    (Xn.create = Yn),
      (Xn.pointsToPath = $),
      (dn.geometryToLayer = pn),
      (dn.coordsToLatLng = fn),
      (dn.coordsToLatLngs = gn),
      (dn.latLngToCoords = vn),
      (dn.latLngsToCoords = yn),
      (dn.getFeature = xn),
      (dn.asFeature = wn),
