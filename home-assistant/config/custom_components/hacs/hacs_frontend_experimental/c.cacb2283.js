...
import { b as g, s as f, d as b, a as $, g as x } from "./c.84dcc549.js";
import { f as j, a as F, b as D } from "./c.6f18200a.js";
import { S as z } from "./c.79c8c092.js";
import { c as C } from "./c.3db34379.js";
import "./c.27e9c060.js";
import { e as w } from "./c.3f62d98e.js";
import { c as I } from "./c.d2f13ac1.js";
import { c as P } from "./c.6eb9fcd4.js";
import "./c.980b1140.js";
import "./c.2f01b935.js";
import "./c.15aadbf5.js";
  ...
  function (e, v) {
    return {
      ...
      d: [
        ...
        { kind: "field", decorators: [t()], key: "_addMode", value: void 0 },
        {
          kind: "field",
          decorators: [a("#input")],
          key: "_inputElement",
        ...
        },
        {
          ...
          value: function () {
            return [
              g(this.hass.connection, (e) => {
                const i = {};
                for (const t of e) i[t.area_id] = t;
                this._areas = i;
              }),
              f(this.hass.connection, (e) => {
                const i = {};
                for (const t of e) i[t.id] = t;
                this._devices = i;
              }),
              b(this.hass.connection, (e) => {
                this._entities = e;
              }),
            ];
          },
      ...
      <div class="mdc-chip-set items">
        ${
          null !== (e = this.value) && void 0 !== e && e.area_id
            ? w(this.value.area_id).map((e) => {
                const i = this._areas[e];
        ...
        ${
          null !== (i = this.value) && void 0 !== i && i.device_id
            ? w(this.value.device_id).map((e) => {
                const i = this._devices[e];
                return this._renderChip(
                  "device_id",
                  e,
                  i ? $(i, this.hass) : e,
        ...
        ${
          null !== (t = this.value) && void 0 !== t && t.entity_id
            ? w(this.value.entity_id).map((e) => {
                const i = this.hass.states[e];
                return this._renderChip("entity_id", e, i ? P(i) : e, i);
              })
            : ""
        }
      </div>
    `;
      ...
      ${
        this.helper
          ? d`<ha-input-helper-text>${this.helper}</ha-input-helper-text>`
          : ""
      }
    `;
          },
    ...
    `;
        ...
        },
        {
          ...
          value: function (e) {
            ...
            (t.value = ""),
              ...
              h(this, "value-changed", {
                value: this.value
                  ? {
                      ...this.value,
                      [t.type]: this.value[t.type]
                        ? [...w(this.value[t.type]), i]
                        : i,
                    }
                  : { [t.type]: i },
              });
        ...
        },
        {
          ...
          value: function (e) {
            ...
            a.length && (d = this._addItems(d, "entity_id", a)),
              t.length && (d = this._addItems(d, "device_id", t)),
              (d = this._removeItem(d, i.type, i.id)),
              h(this, "value-changed", { value: d });
          },
        },
        {
          kind: "method",
        ...
        },
        {
          ...
          value: function (e, i, t) {
            return { ...e, [i]: e[i] ? w(e[i]).concat(t) : t };
          },
        },
        {
          kind: "method",
          key: "_removeItem",
          value: function (e, i, t) {
            const a = w(e[i]).filter((e) => String(e) !== t);
            if (a.length) return { ...e, [i]: a };
            const d = { ...e };
            return delete d[i], Object.keys(d).length ? d : void 0;
          },
        },
        {
          kind: "method",
          ...
          value: function (e) {
            var i;
            const t =
              null === (i = this._entities) || void 0 === i
                ? void 0
                : i.filter((i) => i.device_id === e.id);
            if (this.includeDomains) {
              if (!t || !t.length) return !1;
              if (!t.some((e) => this.includeDomains.includes(I(e.entity_id))))
                return !1;
            }
        ...
        },
        {
          ...
          value: function (e) {
            ...
            if (
              this.includeDomains &&
              !this.includeDomains.includes(I(e.entity_id))
            )
              return !1;
            if (this.includeDeviceClasses) {
              const i = this.hass.states[e.entity_id];
              ...
              if (
                !i.attributes.device_class ||
                !this.includeDeviceClasses.includes(i.attributes.device_class)
              )
                return !1;
            }
  ...
  function (e, a) {
    ...
    return {
      ...
      d: [
        ...
        { kind: "field", decorators: [t()], key: "_entities", value: void 0 },
        { kind: "field", key: "_deviceIntegrationLookup", value: () => m(x) },
        {
          kind: "method",
          key: "hassSubscribe",
          value: function () {
        ...
        },
        {
          ...
          value: function (e) {
            var i, t;
            y(k(s.prototype), "updated", this).call(this, e),
              e.has("selector") &&
                ((null !== (i = this.selector.target.device) &&
                  void 0 !== i &&
                  i.integration) ||
        ...
        },
        {
          ...
          value: function () {
            ...
            return ((null !== (e = this.selector.target.device) &&
              void 0 !== e &&
              e.integration) ||
              (null !== (i = this.selector.target.entity) &&
                void 0 !== i &&
                i.integration)) &&
              !this._entitySources
              ? d``
        ...
        },
        {
          ...
          value() {
            return (e) =>
              ...
              F(this.selector.target.entity, e, this._entitySources);
          },
        },
        {
          kind: "field",
            ...
            return (e) => {
              ...
              const i =
                this._entitySources && this._entities
                  ...
                  : void 0;
              return D(this.selector.target.device, e, i);
            };
          },
        },
        {
