...
import { f as c, a as o } from "./c.6f18200a.js";
    ...
    return {
      ...
      d: [
        ...
        },
        {
          kind: "field",
          decorators: [
            t({ type: Array, attribute: "include-unit-of-measurement" }),
          ],
        ...
        {
          kind: "field",
          decorators: [t({ type: Array, attribute: "include-entities" })],
          key: "includeEntities",
          value: void 0,
        },
        {
        ...
        {
          kind: "field",
          decorators: [t({ attribute: "picked-entity-label" })],
          key: "pickedEntityLabel",
          value: void 0,
        },
        {
          kind: "field",
          decorators: [t({ attribute: "pick-entity-label" })],
          key: "pickEntityLabel",
          value: void 0,
        },
        {
    ...
    `;
        ...
        },
        {
          ...
          value: async function (e) {
            (this.value = e), d(this, "value-changed", { value: e });
          },
        },
        {
          kind: "method",
          ...
          value: function (e) {
            ...
            const i = e.currentTarget.curValue,
              t = e.detail.value;
            if (t === i || (void 0 !== t && ((s = t), !h.test(s)))) return;
            var s;
            const d = this._currentEntities;
            t && !d.includes(t)
              ? this._updateEntities(d.map((e) => (e === i ? t : e)))
              : this._updateEntities(d.filter((e) => e !== i));
          },
        },
        {
          kind: "method",
          ...
          value: async function (e) {
            ...
            const t = this._currentEntities;
            t.includes(i) || this._updateEntities([...t, i]);
          },
        },
        {
          kind: "field",
    ...
    return {
      ...
      d: [
        ...
        },
        {
          ...
          value: function () {
            var e, i, t;
            return null !== (e = this.selector.entity) &&
              void 0 !== e &&
              e.multiple
              ? s`
    ...
    `
      ...
      ></ha-entity-picker>`;
        ...
        },
        {
          ...
          value: function (e) {
            var i;
            r(u(d.prototype), "updated", this).call(this, e),
              e.has("selector") &&
          ...
          value() {
            return (e) => {
              ...
              return (
                ...
                void 0 === i ||
                !i.entity ||
                o(this.selector.entity, e, this._entitySources)
              );
            };
          },
        },
