...
import { y as o } from "./main-ec7846c8.js";
    ...
    !(function (e) {
      ...
      function G(e, n, t) {
        ...
        try {
          ...
          if (n.walkTokens) {
            if (n.async)
              return Promise.all(G.walkTokens(l, n.walkTokens))
                .then(function () {
                  return Z.parse(l, n);
                })
                .catch(s);
            G.walkTokens(l, n.walkTokens);
          }
          return Z.parse(l, n);
        } catch (e) {
          s(e);
        ...
        (G.walkTokens = function (e, n) {
          for (
            var t,
              ...
              o = function () {
                var e = t.value;
                switch (((r = r.concat(n.call(G, e))), e.type)) {
                  case "table":
                    for (var o, i = a(e.header); !(o = i()).done; ) {
                      var s = o.value;
                      r = r.concat(G.walkTokens(s.tokens, n));
                    }
                    for (var l, u = a(e.rows); !(l = u()).done; )
                      for (var c, d = a(l.value); !(c = d()).done; ) {
                        var h = c.value;
                        r = r.concat(G.walkTokens(h.tokens, n));
                      }
                    break;
                  case "list":
                    r = r.concat(G.walkTokens(e.items, n));
                    break;
                  default:
                    ...
                    G.defaults.extensions.childTokens[e.type]
                      ? G.defaults.extensions.childTokens[e.type].forEach(
                          function (t) {
                            r = r.concat(G.walkTokens(e[t], n));
                          }
                        )
                      : e.tokens && (r = r.concat(G.walkTokens(e.tokens, n)));
                }
              },
              i = a(e);
            !(t = i()).done;
