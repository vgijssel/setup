...
const d = ["more-info", "toggle", "navigate", "url", "call-service", "none"];
e(
  [l("hui-action-editor")],
  function (e, i) {
    return {
      ...
      d: [
        { kind: "field", decorators: [t()], key: "config", value: void 0 },
        { kind: "field", decorators: [t()], key: "label", value: void 0 },
        { kind: "field", decorators: [t()], key: "actions", value: void 0 },
        { kind: "field", decorators: [t()], key: "tooltipText", value: void 0 },
          ...
          value() {
            return s((e) => {
              ...
              return {
                ...
                data:
                  null !== (i = e.data) && void 0 !== i ? i : e.service_data,
                target: e.target,
              };
            });
          },
        },
        {
          ...
          value: function () {
            ...
            const c = null !== (e = this.actions) && void 0 !== e ? e : d;
            return a`
      <div class="dropdown">
        <ha-select
          .label=${this.label}
      ...
      ${
        "navigate" ===
        (null === (o = this.config) || void 0 === o ? void 0 : o.action)
          ? a`
      ...
      ${
        "url" ===
        (null === (n = this.config) || void 0 === n ? void 0 : n.action)
          ? a`
            <ha-textfield
              .label=${this.hass.localize(
      ...
      ${
        "call-service" ===
        (null === (l = this.config) || void 0 === l ? void 0 : l.action)
          ? a`
            <ha-service-control
              .hass=${this.hass}
              .value=${this._serviceAction(this.config)}
              .showAdvanced=${
                null === (s = this.hass.userData) || void 0 === s
                  ? void 0
                  : s.showAdvanced
              }
              narrow
        ...
        },
        {
          ...
          value: function (e) {
            ...
            if (
              ...
              return;
            if ("default" === t)
              return void c(this, "value-changed", { value: void 0 });
            let a;
            switch (t) {
              case "url":
            ...
            c(this, "value-changed", { value: { action: t, ...a } });
          },
        },
        {
          kind: "method",
          ...
          value: function (e) {
            ...
            const i = e.target,
              t = e.target.value;
            this[`_${i.configValue}`] !== t &&
              i.configValue &&
              c(this, "value-changed", {
                value: { ...this.config, [i.configValue]: t },
              });
          },
        },
        {
          ...
          value: function (e) {
            ...
            "service_data" in i && delete i.service_data,
              c(this, "value-changed", { value: i });
          },
        },
        {
          kind: "method",
          key: "_navigateValueChanged",
          value: function (e) {
            e.stopPropagation();
            const i = { ...this.config, navigation_path: e.detail.value };
            c(this, "value-changed", { value: i });
          },
        },
        {
  ...
  function (e, i) {
    return {
      ...
      <hui-action-editor
        ...
        .config=${this.value}
        .actions=${
          null === (e = this.selector["ui-action"]) || void 0 === e
            ? void 0
            : e.actions
        }
...
export { h as HaSelectorUiAction };
