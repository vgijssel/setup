#!/usr/bin/env python3
"""
Coder Log Streamer for DevPod Build Process

This script streams build logs from DevPod to the Coder workspace UI.
...
class CoderLogStreamer:
    ...
    def register_log_source(self, display_name: str = "DevPod Build") -> str:
        """
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  # Stream from stdin (pipe DevPod output)
  devpod up myrepo 2>&1 | python log-streamer.py
...
Environment variables:
  ...
  CODER_AGENT_TOKEN - Coder agent token (required)
    ...
    parser.add_argument(
        "--source-name",
        "-n",
        default="DevPod Build",
        help="Display name for the log source (default: 'DevPod Build')",
    )
